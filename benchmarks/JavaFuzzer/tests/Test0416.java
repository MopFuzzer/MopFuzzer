...
public class Test0416 {
    ...
    static {
        FuzzerUtils.init(Test0416.lArrFld, 21636L);
        FuzzerUtils.init(Test0416.sArrFld, (short) 4413);
    }
    ...
    public static int iMeth1() {
        ...
        for (i2 = 3; i2 < 148; i2++) {
            Test0416.sArrFld[i2 + 1] -= (short) i2;
            f1 -= i3;
            if (b) continue;
            switch (((i2 % 10) * 5) + 73) {
                case 101:
                    Test0416.instanceCount = i3;
                    break;
                case 99:
                    Test0416.instanceCount = -1;
                    for (i4 = 1; 11 > i4; ++i4) {
                        Test0416.instanceCount >>= i4;
                        i5 += (((i4 * Test0416.instanceCount) + Test0416.instanceCount) - Test0416.instanceCount);
                        iArr1[i2 + 1] = (int) Test0416.instanceCount;
                        i6 = 1;
                        while (++i6 < 2) {
                            fArr = fArr;
                            d *= i3;
    ...
    public static int iMeth(int i1, byte by, float f) {
        ...
        Test0416.lArrFld[(i1 >>> 1) % N] = Math.max(-12524 - (13 - (i1 - -33178)), (5 - iMeth1()) + i1);
        i7 = 1;
        while (++i7 < 323) {
            for (i8 = 1; i8 < 5; ++i8) {
                if (b1) {
            ...
            for (i10 = 1; 5 > i10; i10 += 3) {
                i11 += (i10 + Test0416.instanceCount);
            }
    ...
    public void vMeth(long l) {
        ...
        for (i12 = 19; i12 < 364; i12++) {
            ...
            if (true) {
                ...
                for (i14 = 1; 5 > i14; ++i14) {
                    Test0416.sFld += (short) (42 + (i14 * i14));
                    try {
                        i13 = (i13 % -227);
                        i15 = (i13 / -205);
                    ...
                    for (i16 = 2; i16 > 1; i16 -= 3) {
                        i15 += (int) d2;
                        Test0416.instanceCount += (((i16 * i12) + i17) - i16);
                    }
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i -= (int) ((iArr[(i >>> 1) % N] % ((i - i) | 1)) - (Test0416.instanceCount * i));
        vMeth(-32870L);
        Test0416.lArrFld[(i >>> 1) % N] *= i;
        for (i18 = 15; i18 < 260; i18++) {
            ...
            i20 = 1;
            while (++i20 < 103) {
                Test0416.iFld -= (int) f3;
                for (i21 = 1; i21 < 1; ++i21) {
                    bFld = bFld;
                    Test0416.instanceCount = -24803;
                    i22 = i22;
                    Test0416.instanceCount += i21;
                    fArr1[i21] -= i;
                    d3 = Test0416.instanceCount;
                    try {
                        i22 = (i19 % -833323981);
                        i22 = (i21 % 503256350);
                        i22 = (i % 227);
        ...
        for (i23 = 5; i23 < 217; i23++) {
            switch (((i23 % 9) * 5) + 78) {
                case 102:
                    for (i26 = 2; i26 < 118; ++i26) {
                        if (bFld) {
                            ...
                            for (i28 = 1; i28 < 2; i28++) {
                                i22 = i24;
                                Test0416.lArrFld[i28] *= (long) 94.128813;
                            }
                        }
                        iArr[i26 - 1] -= i22;
                    }
                ...
                case 105:
                    ...
                    break;
                case 101:
                    Test0416.instanceCount = 14;
                    break;
                case 115:
                    Test0416.sFld += (short) i26;
                    break;
                default:
                    i19 *= (int) Test0416.instanceCount;
            }
        }
        ...
        FuzzerUtils.out.println("Test0416.instanceCount Test0416.iFld Test0416.sFld = " + Test0416.instanceCount + "," + Test0416.iFld +
                "," + Test0416.sFld);
        FuzzerUtils.out.println("bFld Test0416.lArrFld Test0416.sArrFld = " + (bFld ? 1 : 0) + "," +
                FuzzerUtils.checkSum(Test0416.lArrFld) + "," + FuzzerUtils.checkSum(Test0416.sArrFld));
