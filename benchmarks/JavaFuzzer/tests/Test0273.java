...
public class Test0273 {
    ...
    static {
        FuzzerUtils.init(Test0273.lArrFld, 6L);
    }
            ...
            for (i8 = 5; i8 > 1; i8--) {
                ...
                switch (((i8 % 6) * 5) + 44) {
                    case 68:
                        ...
                        i11 += (((i8 * Test0273.instanceCount) + Test0273.instanceCount) - i8);
                    case 54:
                        dArr[i7] = i7;
                        break;
                    case 71:
                    ...
                    case 47:
                        ...
                        break;
                    case 45:
                        iArr1[i8 - 1] -= (int) Test0273.instanceCount;
                        break;
                    default:
                        i9 += i11;
                }
    ...
    public static void vMeth1(int i2, int i3) {
        ...
        Test0273.lArrFld[(i3 >>> 1) % N] = -39278L;
        ...
        for (i4 = 2; i4 < 218; ++i4) {
            ...
            while (++i12 < 7) {
                iArr[i12][i4] -= (int) d;
                s1 -= (short) Test0273.instanceCount;
                i5 <<= (int) Test0273.instanceCount;
                fArr[i12 - 1] += i2;
                Test0273.fFld = i4;
                Test0273.instanceCount *= i2;
                i5 <<= i5;
            }
        }
    ...
    public void vMeth(int i1) {
        ...
        for (i13 = 12; i13 < 271; i13++) {
            Test0273.lArrFld[i13 - 1] *= i1;
            Test0273.instanceCount = i13;
        }
        iArr2[(i1 >>> 1) % N] = i14;
        Test0273.instanceCount = (long) d1;
        Test0273.fFld -= i13;
        Test0273.instanceCount ^= Test0273.sFld;
        Test0273.fFld -= Test0273.fFld;
        i1 = 122;
        i14 <<= -13;
        Test0273.byFld = (byte) i1;
        d1 -= i14;
        Test0273.fFld = -30069;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i <<= (int) (((Test0273.byFld - Test0273.instanceCount) - (f / (i | 1))) - ((i++) - i));
        s = (short) i;
        vMeth(-18);
        for (i15 = 17; i15 < 274; ++i15) {
            ...
            iArrFld[i15 - 1] = i16;
            i += (i15 * i15);
            iArrFld[i15] <<= (int) Test0273.instanceCount;
            d2 = i16;
            for (i17 = 2; i17 < 98; ++i17) {
                iArrFld[i17 - 1] = (int) Test0273.instanceCount;
                l = 1;
                while (++l < 2) {
                    Test0273.instanceCount += (long) d2;
                    i = i18;
                }
                i18 /= (int) (l | 1);
                i16 *= i17;
        ...
        l1 = 1;
        do {
            Test0273.fFld = Test0273.byFld;
            i16 %= (int) (i15 | 1);
            Test0273.instanceCount += l1;
        } while (++l1 < 152);
        bFld = bFld;
        for (i19 = 13; 263 > i19; i19++) {
            byArr[i19 + 1] = (byte) Test0273.fFld;
            Test0273.instanceCount *= i;
            i18 += (((i19 * i20) + i20) - i20);
        }
        ...
        FuzzerUtils.out.println("Test0273.instanceCount Test0273.byFld Test0273.fFld = " + Test0273.instanceCount + "," + Test0273.byFld +
                "," + Float.floatToIntBits(Test0273.fFld));
        FuzzerUtils.out.println("Test0273.sFld bFld Test0273.lArrFld = " + Test0273.sFld + "," + (bFld ? 1 : 0) + "," +
