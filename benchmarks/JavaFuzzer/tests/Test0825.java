...
public class Test0825 {
    ...
    public static int iMeth1(int i4, int i5, int i6) {
        ...
        iArr[(i6 >>> 1) % N] <<= i4;
        vMeth(i14, Test0825.byFld, -35562);
        i15 = 1;
        while (++i15 < 213) {
            int i19 = -7;
            i5 = (int) f2;
            ...
            switch (((i4 >>> 1) % 4) + 52) {
                case 52:
                    fArr1[i15] -= 11;
                    Test0825.instanceCount -= -47501;
                    i4 |= (int) Test0825.instanceCount;
                    for (i16 = 1; 8 > i16; ++i16) {
                        int i18 = -209;
                        i14 += (i16 * i16);
                        if (b1) continue;
    ...
    public int iMeth() {
        ...
        Test0825.instanceCount |= (long) ((92.1011F + (iFld * -7967)) * (++Test0825.byFld));
        for (i2 = 12; i2 < 220; ++i2) {
            fArr[i2 + 1] = iMeth1(105, i2, -73);
            i3 -= (int) Test0825.instanceCount;
            iFld += (((i2 * Test0825.instanceCount) + i2) - i3);
            Test0825.fFld += i2;
            i20 = 8;
            do {
                d2 += iFld;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 11; 202 > i; i++) {
            i1 = (int) (s += (short) ((Test0825.instanceCount + i) - i));
            f *= ((Test0825.instanceCount++) ^ (++i1));
            f *= (i >>> iMeth());
            if (b2) {
                i23 = 1;
                do {
                    ...
                    switch (((iFld >>> 1) % 3) + 116) {
                        case 116:
                            ...
                            break;
                        case 117:
                            lArr[i23 - 1] -= Test0825.instanceCount;
                            break;
                        case 118:
                            Test0825.instanceCount += i1;
                    }
                    Test0825.instanceCount += (-7745L + (i23 * i23));
                } while (++i23 < 131);
            }
        }
        ...
        FuzzerUtils.out.println("Test0825.instanceCount iFld Test0825.byFld = " + Test0825.instanceCount + "," + iFld + "," +
                Test0825.byFld);
        FuzzerUtils.out.println("Test0825.fFld Test0825.dFld iArrFld = " + Float.floatToIntBits(Test0825.fFld) + "," +
                Double.doubleToLongBits(Test0825.dFld) + "," + FuzzerUtils.checkSum(iArrFld));
