...
public class Test0396 {
        ...
        for (i = 17; 322 > i; ++i) {
            ...
            for (i2 = 1; i2 < 5; i2++) {
                ...
                for (i4 = 1; i4 < 2; ++i4) {
                    ...
                    vMeth(i3, i19, byFld);
                    lArr1[(49 >>> 1) % N] += Test0396.instanceCount;
                    i19 = i19;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0396.instanceCount <<= -13;
        i20 = 1;
        do {
            Test0396.iFld += (((i20 * Test0396.iFld) + f2) - i20);
            f2 += (((i20 * i20) + Test0396.instanceCount) - i20);
            fArr[i20 - 1] = s2;
        } while ((i20 += 3) < 221);
        b1 = b1;
        for (i21 = 11; i21 < 241; i21++) {
            d = 1;
            while (++d < 109) {
                dFld *= Test0396.instanceCount;
                if (b1) {
                    Test0396.instanceCount -= Test0396.iFld;
                    f2 += 8444959570498155921L;
                } else if (b1) {
                    i22 *= (int) d;
                    for (i23 = 1; i23 < 1; i23++) {
                        i24 += (((i23 * i22) + f2) - Test0396.iFld);
                    }
                    i24 += (int) f2;
                } else {
                    i24 -= 234;
                    switch ((int) (((d % 2) * 5) + 80)) {
                        case 86:
                            ...
                            for (i25 = (int) (d); i25 < 1; i25++) {
                                i26 += (int) Test0396.instanceCount;
                            }
                            break;
                        case 87:
                            ...
                            for (i27 = 1; i27 < 1; i27 += 3) {
                                try {
                                    Test0396.iFld = (Test0396.iFld / -22);
                                    i26 = (-14221 / i26);
                                    i24 = (-215 / i20);
                                ...
                                switch (((i23 >>> 1) % 7) + 70) {
                                    ...
                                    case 73:
                                        dFld = 27;
                                    case 74:
                                        Test0396.instanceCount += (long) f2;
                                        break;
                                    case 75:
                                        Test0396.instanceCount += (((i27 * i22) + Test0396.iFld) - i28);
                                        break;
                                    case 76:
                                        i24 = i29;
                                    default:
                                        i22 -= (int) Test0396.instanceCount;
                                }
                            }
                    }
                }
        ...
        FuzzerUtils.out.println("Test0396.instanceCount byFld dFld = " + Test0396.instanceCount + "," + byFld + "," +
                Double.doubleToLongBits(dFld));
        FuzzerUtils.out.println("Test0396.iFld iArrFld sArrFld = " + Test0396.iFld + "," + FuzzerUtils.checkSum(iArrFld) + ","
