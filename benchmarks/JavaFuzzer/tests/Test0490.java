...
public class Test0490 {
    ...
    public static void vMeth1() {
        ...
        for (i11 = 7; i11 < 152; i11++) {
            ...
            for (i13 = 1; i13 < 11; ++i13) {
                ...
                while (++i15 < 2) {
                    s ^= (short) i10;
                    bArr[i11 + 1] = Test0490.bFld;
                }
                i12 -= (int) Test0490.lFld;
                i16 = 1;
                do {
                    iArr[i13] *= by1;
                    f += (i16 - i9);
        ...
        for (i1 = 1; i1 < 354; ++i1) {
            switch ((i1 % 1) + 32) {
                case 32:
                    for (i3 = i1; i3 < 5; i3++) {
                        for (i5 = 1; i5 < 1; ++i5) {
                            Test0490.lFld += ((--i6) - Test0490.instanceCount);
                            i2 >>>= (int) (((Test0490.lFld - i5) - (++i6)) * ((++by) << iMeth(true, 145, i5)));
                            i2 = s2;
                            i2 |= i2;
                            Test0490.lFld = i5;
                            Test0490.instanceCount += (i5 | i3);
                            i2 += i5;
                            switch (((i5 % 6) * 5) + 16) {
                                case 23:
                                    if (Test0490.bFld) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        switch ((((i >>> 1) % 10) * 5) + 19) {
            case 30:
                iArr2[(i >>> 1) % N] >>= (int) Test0490.instanceCount;
            case 34:
                i20 = 1;
                while (++i20 < 256) {
                    float f2 = 2.1018F;
                            ...
                            for (i23 = 179; i23 > 10; --i23) {
                                for (i25 = 148; i25 > i23; i25--) {
                                    if (Test0490.bFld) {
                                        for (i27 = 1; i27 < 1; ++i27) {
                                            i22 = i20;
                                            iArr2[i25] -= (int) Test0490.fFld;
                                            switch (((i22 >>> 1) % 8) + 109) {
                                                case 109:
                                                    if (Test0490.bFld) continue;
                                                    Test0490.bFld = Test0490.bFld;
                                                    i26 &= 15731;
                                                case 110:
        ...
        FuzzerUtils.out.println("Test0490.instanceCount Test0490.lFld Test0490.bFld = " + Test0490.instanceCount + "," + Test0490.lFld +
                "," + (Test0490.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0490.fFld Test0490.fFld1 Test0490.byFld = " + Float.floatToIntBits(Test0490.fFld) + "," +
                Float.floatToIntBits(Test0490.fFld1) + "," + Test0490.byFld);
