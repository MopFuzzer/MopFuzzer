...
public class Test0568 {
    ...
    static {
        FuzzerUtils.init(Test0568.fArrFld, -2.523F);
    }
    ...
    public void vMeth2(int i5, int i6) {
        ...
        do {
            for (i8 = 1; i8 < 6; ++i8) {
                ...
                lArrFld[i8 + 1] <<= 165;
                for (i10 = 1; i10 < 2; ++i10) {
                    Test0568.instanceCount = i7;
                    if (false) {
                        Test0568.instanceCount -= Test0568.instanceCount;
                    } else {
                        lArrFld = lArrFld;
                        Test0568.instanceCount += (i10 + f1);
                    }
                    iArrFld[i8] *= i9;
                    i9 >>>= i7;
                    Test0568.instanceCount = -123L;
                    Test0568.instanceCount &= i7;
                }
                f1 -= Test0568.instanceCount;
            }
        } while (++i7 < 271);
    ...
    public void vMeth(int i1, int i2) {
        ...
        vMeth1(Test0568.fFld, -53169, 8055);
                ...
                switch (((i14 >>> 1) % 10) + 87) {
                    case 87:
                        ...
                        for (i18 = 1; i18 < 2; i18++) {
                            ...
                            i17 = i15;
                            i17 -= (int) Test0568.instanceCount;
                            Test0568.instanceCount *= -2;
                            i1 -= (int) f2;
                        }
                        break;
                    case 88:
    ...
    public void mainTest(String[] strArr1) {
            ...
            switch ((((i >>> 1) % 3) * 5) + 92) {
                case 102:
                    ...
                    for (i25 = 124; i25 > 4; i25--) {
                        i22 += i25;
                        i22 = i;
                        Test0568.fArrFld[i21 - 1][i25] += -40124;
                    }
                    break;
                case 100:
                    i22 *= i22;
                    if (b1) {
                        byFld = (byte) -53868;
                        i22 = i26;
                        sFld += (short) (((i21 * i25) + Test0568.instanceCount) - i);
                    } else {
                        i26 |= (int) Test0568.instanceCount;
                        i22 = (int) Test0568.instanceCount;
                    }
                    Test0568.fFld *= (float) d2;
                    iArr1 = iArr1;
                    break;
                case 97:
                    if (b1) {
        ...
        FuzzerUtils.out.println("Test0568.instanceCount Test0568.fFld byFld = " + Test0568.instanceCount + "," +
                Float.floatToIntBits(Test0568.fFld) + "," + byFld);
        FuzzerUtils.out.println("sFld byArrFld lArrFld = " + sFld + "," + FuzzerUtils.checkSum(byArrFld) + "," +
                FuzzerUtils.checkSum(lArrFld));
        FuzzerUtils.out.println("iArrFld Test0568.fArrFld = " + FuzzerUtils.checkSum(iArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0568.fArrFld)));
