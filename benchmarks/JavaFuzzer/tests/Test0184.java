...
public class Test0184 {
    ...
    static {
        FuzzerUtils.init(Test0184.iArrFld, 138);
    }
    ...
    public static void vMeth2(int i3) {
        ...
        for (i4 = 1; i4 < 174; ++i4) {
            for (i6 = 9; i6 > 1; i6--) {
                ...
                for (i8 = 1; i8 < 2; i8++) {
                    i7 += (i8 ^ i5);
                    Test0184.instanceCount = 5;
                    f2 = i7;
                    b = true;
                    Test0184.iArrFld[i4] = i8;
                    Test0184.byFld = (byte) 11;
                    switch ((i8 % 4) + 123) {
                        case 123:
                            i7 = i6;
                            dArr[i8 - 1] -= i5;
                        ...
                        case 124:
                            i5 <<= 99;
                        case 125:
                            Test0184.byFld = (byte) 35023;
                            break;
                        case 126:
                            Test0184.iArrFld[i8] = i6;
                            break;
                    }
                }
            }
    ...
    public static void vMeth1(int i1, int i2) {
        ...
        for (i10 = 239; i10 > 5; --i10) {
            ...
            while (++i12 < 7) {
                ...
                for (i13 = 1; i13 < 1; i13++) {
                    i2 ^= -15666;
                    Test0184.instanceCount += i13;
                    i2 += (((i13 * i13) + Test0184.instanceCount) - f1);
                }
                Test0184.byFld >>= (byte) -107;
                Test0184.instanceCount += i12;
            }
            i1 += (((i10 * Test0184.instanceCount) + i1) - i14);
        }
    ...
    public static void vMeth(float f) {
        ...
        Test0184.iArrFld[(i >>> 1) % N] += (int) (~(long) ((f + 226L) - (Test0184.instanceCount++)));
        vMeth1(i, i);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (byte by : byArr) {
            ...
            for (l = 63; l > 3; l--) {
                ...
                i15 = -251;
                lArrFld[(int) (l + 1)] = -11;
                lArrFld[(int) (l - 1)] ^= Test0184.instanceCount;
                for (f4 = l; f4 < 2; f4++) {
                    Test0184.instanceCount = 90L;
                }
                for (i18 = 1; i18 < 2; ++i18) {
                    f3 += 155;
                    i16 = i15;
                    Test0184.instanceCount *= i16;
                    b1 = b1;
                }
                d1 %= 0.15803;
                Test0184.iArrFld[(int) (l)] *= (int) Test0184.instanceCount;
            }
            i20 = 1;
            do {
                i17 = (int) f3;
        ...
        FuzzerUtils.out.println("Test0184.instanceCount Test0184.byFld Test0184.iArrFld = " + Test0184.instanceCount + "," + Test0184.byFld
                + "," + FuzzerUtils.checkSum(Test0184.iArrFld));
