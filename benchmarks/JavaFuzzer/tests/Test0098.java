...
public class Test0098 {
    ...
    static {
        FuzzerUtils.init(Test0098.iArrFld, 63023);
    }
                ...
                switch ((i11 % 1) + 97) {
                    case 97:
                        ...
                        for (i13 = 1; 2 > i13; i13++) {
                            ...
                            l2 = i12;
                            i12 = i11;
                            i14 += (((i13 * l2) + l1) - Test0098.instanceCount);
                            Test0098.instanceCount -= l2;
                            i14 = i12;
                            i14 = i11;
                            i12 |= i14;
                            f += Test0098.instanceCount;
                        }
                        break;
                }
            }
    ...
    public void vMeth() {
        ...
        Test0098.iArrFld[(-56003 >>> 1) % N] += (int) (((i4--) + (i4 * -9744)) * ((i4 >> Test0098.instanceCount) * (-50372 -
                i4)));
        for (i5 = 5; i5 < 126; i5++) {
            for (i7 = 13; i7 > 1; i7 -= 2) {
                float f2 = -1.831F;
                ...
                for (f3 = 1; 3 > f3; ++f3) {
                    i4 -= i5;
                    i6 += (int) (20785L + (f3 * f3));
                    Test0098.instanceCount += (long) (f3 * f3);
                    i6 = i7;
                }
                for (i21 = i7; i21 < 3; ++i21) {
                    i20 -= (int) 80.64237;
                    i20 += (((i21 * i20) + i5) - i5);
                    Test0098.instanceCount &= i6;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            i1 += i;
            for (i2 = 4; i2 < 94; ++i2) {
                i1 -= (int) (Test0098.iArrFld[i2 - 1] = (int) ((Test0098.instanceCount & Test0098.instanceCount) +
                        (Test0098.instanceCount >>= -3941154575L)));
                vMeth();
                i1 -= i1;
                i3 += (((i2 * i3) + i3) - i3);
                Test0098.instanceCount += i2;
                lArr2[i2 - 1] *= i3;
            }
            Test0098.iArrFld[i - 1] += i3;
            if (Test0098.bFld) break;
            Test0098.instanceCount += (i * i);
            Test0098.bFld = Test0098.bFld;
        } while (++i < 267);
        lArr2[(i >>> 1) % N] -= i2;
        ...
        FuzzerUtils.out.println("Test0098.instanceCount Test0098.bFld Test0098.iFld = " + Test0098.instanceCount + "," + (Test0098.bFld ? 1
                : 0) + "," + Test0098.iFld);
        FuzzerUtils.out.println("Test0098.iArrFld = " + FuzzerUtils.checkSum(Test0098.iArrFld));
