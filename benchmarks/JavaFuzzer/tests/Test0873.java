...
public class Test0873 {
    ...
    static {
        FuzzerUtils.init(Test0873.fArrFld, 126.143F);
    }
                ...
                case 160:
                    for (i13 = 1; i13 < 8; ++i13) {
                        for (i15 = 1; i15 < 2; ++i15) {
                            i16 += i15;
                            i16 += (int) d;
                            lArr1[i13] >>= Test0873.instanceCount;
                            i16 = i15;
                            i16 *= by1;
                            iArr[i11][i11 - 1] += 172;
                            iArr[i13 + 1][i11] >>= i15;
                            Test0873.instanceCount = i14;
                            i14 *= (int) Test0873.instanceCount;
                            i12 = by1;
                        }
                        iArr[i11][i11] -= (int) f;
                    }
                case 147:
                    byArr[i11] += (byte) Test0873.instanceCount;
                    break;
                case 156:
                    try {
                        i12 = (60746 / i15);
    ...
    public static void vMeth(int i8, int i9, int i10) {
        ...
        vMeth1();
        Test0873.fFld -= i8;
        Test0873.instanceCount += i10;
        iArr2[(i9 >>> 1) % N][(-88 >>> 1) % N] *= (int) Test0873.fFld;
        switch (((i10 >>> 1) % 4) + 51) {
            case 51:
            ...
            case 52:
                ...
                break;
            case 53:
                Test0873.fFld *= (float) 0.36388;
                break;
            case 54:
                i19 = (int) Test0873.instanceCount;
                break;
            default:
                i8 *= Test0873.sFld;
        }
        ...
        while (++i7 < 249) {
            ...
            for (i22 = 1; 7 > i22; i22++) {
                ...
                for (i24 = 1; 2 > i24; i24 += 2) {
                    i23 <<= i6;
                    Test0873.fFld += i24;
                    Test0873.instanceCount = i7;
                    i25 >>= i22;
                    Test0873.sFld -= (short) i23;
                    i26 *= i7;
                    Test0873.fArrFld[i7 - 1] -= i25;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 18; i < 351; ++i) {
            for (i2 = 1; i2 < 76; ++i2) {
                for (i4 = i; 2 > i4; i4++) {
                    ...
                    by ^= (byte) (s + lMeth(Test0873.instanceCount, i5));
                    try {
                        i1 = (-425000026 / i4);
                        i1 = (i / i2);
                        i3 = (i3 % 20);
                ...
                switch ((i % 7) + 62) {
                    case 62:
                        Test0873.fFld = -12705L;
                        Test0873.instanceCount = 26;
                        i1 = (int) Test0873.instanceCount;
                        break;
                    case 63:
                        i3 += i4;
                        i27 = 1;
                    ...
                    case 65:
                        ...
                        break;
                    case 66:
                        Test0873.instanceCount += (((i2 * i1) + Test0873.fFld) - i27);
                        i5 += (-31682 + (i2 * i2));
                    case 67:
                        i29 >>= (int) Test0873.instanceCount;
                        i30 = 1;
                        do {
                            Test0873.instanceCount += (i30 * Test0873.fFld);
                            i1 <<= 12;
                            i5 <<= i27;
                            i5 += i30;
                        } while (++i30 < 2);
        ...
        FuzzerUtils.out.println("Test0873.instanceCount Test0873.fFld Test0873.sFld = " + Test0873.instanceCount + "," +
                Float.floatToIntBits(Test0873.fFld) + "," + Test0873.sFld);
        FuzzerUtils.out.println("Test0873.fArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0873.fArrFld)));
