...
public class Test0804 {
    ...
    static {
        FuzzerUtils.init(Test0804.lArrFld, 3359530141L);
        FuzzerUtils.init(Test0804.iArrFld, 227);
    }
    ...
    public static void vMeth1() {
        ...
        i6 = (int) Test0804.instanceCount;
        for (i7 = 6; i7 < 122; i7++) {
            i6 += (i7 * i7);
            i9 = 13;
            do {
                Test0804.lArrFld[i7 - 1] = Test0804.instanceCount;
                s = (short) Test0804.instanceCount;
                i6 -= i7;
                for (i10 = 1; i10 < 3; ++i10) {
                    boolean b = false;
                    if (true) {
                        Test0804.instanceCount -= i7;
                        fArr[i10] -= Test0804.instanceCount;
                        i6 += (3623 + (i10 * i10));
                    } else if (b) {
                        Test0804.instanceCount -= 1529140390L;
                    } else if (b) {
                        d2 -= i9;
                    } else {
                        i8 += i6;
    ...
    public static void vMeth(int i2, double d1) {
        ...
        for (i3 = 17; i3 < 393; i3++) {
            vMeth1();
            d1 *= s1;
            i2 += (((i3 * Test0804.instanceCount) + i3) - f1);
            for (i12 = 1; i12 < 4; i12++) {
                for (l = 1; 2 > l; l++) {
                    iArr[(int) (l)] = i13;
                    f1 += -18974;
                    switch ((i12 % 3) + 43) {
                        case 43:
                            Test0804.iArrFld = Test0804.iArrFld;
                            Test0804.lArrFld[(int) (l + 1)] += i12;
                            i13 = 230;
                            break;
                        case 44:
                            i13 = i14;
    ...
    public static float fMeth(float f) {
        ...
        i1 -= i1;
        vMeth(i1, Test0804.dFld);
        for (i15 = 362; i15 > 7; i15--) {
            i17 = 1;
            do {
                Test0804.instanceCount += (-10 + (i17 * i17));
                i18 = 1;
                do {
                    i16 -= (int) Test0804.dFld;
                    if (true) continue;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (d = 7; d < 378; d++) {
            Test0804.lArrFld[(int) (d - 1)] += (long) fMeth(fFld);
        }
        for (i19 = 179; i19 > 1; i19 -= 3) {
            ...
            fFld += (i19 * i19);
            i22 += (i19 * Test0804.instanceCount);
            i22 += (i19 ^ l1);
        ...
        FuzzerUtils.out.println("Test0804.instanceCount Test0804.dFld Test0804.iFld = " + Test0804.instanceCount + "," +
                Double.doubleToLongBits(Test0804.dFld) + "," + Test0804.iFld);
        FuzzerUtils.out.println("fFld Test0804.lArrFld Test0804.iArrFld = " + Float.floatToIntBits(fFld) + "," +
