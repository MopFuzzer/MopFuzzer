...
public class Test0969 {
                ...
                switch ((i7 % 2) + 83) {
                    ...
                    case 84:
                        ...
                        for (i9 = i7; i9 < 1; ++i9) {
                            i4 -= i5;
                            f -= by;
                            iArr1[i7] >>>= (int) Test0969.instanceCount;
                            f += ((long) i9 ^ (long) i7);
                            i4 = i7;
                            Test0969.instanceCount += i9;
                            i4 |= -41520;
                            lArr[i9 - 1] &= i9;
                        }
                        break;
    ...
    public static void vMeth1(long l, int i2, int i3) {
        ...
        vMeth2(i2, i2);
        Test0969.byFld *= (byte) i2;
        iArr2[(i3 >>> 1) % N] *= i2;
        switch (((i3 >>> 1) % 10) + 89) {
            case 89:
                for (i11 = 136; i11 > 2; i11 -= 3) {
                    if (true) {
                        Test0969.instanceCount *= (long) f1;
                        if (i2 != 0) {
        ...
        for (i15 = 3; i15 < 133; ++i15) {
            for (i17 = 1; i17 < 12; i17++) {
                ...
                for (i19 = 2; i19 > 1; --i19) {
                    ...
                    i18 = i17;
                    f2 -= i18;
                    Test0969.instanceCount *= i15;
                }
                for (i21 = 1; i21 < 2; ++i21) {
                    iFld = i21;
                    Test0969.instanceCount = -110;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = 128;
        do {
            iFld -= (int) (d - (Test0969.instanceCount - (iFld % 42826L)));
            iArr[i] += i;
            vMeth(Test0969.iFld1);
            Test0969.iFld1 *= iFld;
            iArr[i - 1] = Test0969.sFld;
            Test0969.iFld1 = (int) d;
            for (i23 = 4; i23 < 196; i23++) {
                Test0969.instanceCount *= (long) f3;
                iFld = i24;
                Test0969.iFld1 = Test0969.byFld;
                switch (((Test0969.iFld1 >>> 1) % 1) + 73) {
                    case 73:
                        for (i25 = 2; i25 > 1; i25 -= 2) {
                            i26 += (((i25 * Test0969.iFld1) + Test0969.instanceCount) - Test0969.sFld);
                            Test0969.iFld1 -= (int) d;
                            i26 -= i;
                            Test0969.sFld -= (short) 134;
                            Test0969.iFld1 += i25;
                        }
                        break;
                    default:
            ...
            for (i27 = i; i27 < 196; i27++) {
                d += iFld;
                iArr[i] = (int) Test0969.instanceCount;
                f3 += ((long) i27 | (long) Test0969.instanceCount);
                i26 += (int) 60.974F;
                for (d2 = 1; d2 < 1; ++d2) {
                    i28 += (int) (((d2 * Test0969.instanceCount) + Test0969.instanceCount) - iFld);
                    iFld >>= i24;
                    Test0969.instanceCount += i23;
                    if (Test0969.bFld) break;
                }
        ...
        FuzzerUtils.out.println("Test0969.instanceCount iFld Test0969.bFld = " + Test0969.instanceCount + "," + iFld + "," +
                (Test0969.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0969.byFld Test0969.iFld1 Test0969.sFld = " + Test0969.byFld + "," + Test0969.iFld1 + "," + Test0969.sFld);
