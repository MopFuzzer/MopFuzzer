...
public class Test0424 {
    ...
    static {
        FuzzerUtils.init(Test0424.byArrFld, (byte) 7);
        FuzzerUtils.init(Test0424.iArrFld, 248);
    }
    ...
    public static void vMeth2() {
        ...
        i10 = 1;
        while ((i10 += 3) < 283) {
            Test0424.instanceCount = (long) f;
            Test0424.instanceCount += i10;
            i11 += (45 + (i10 * i10));
            if (b1) continue;
            i11 = i10;
                ...
                do {
                    ...
                    switch ((i14 % 10) + 7) {
                        ...
                        case 9:
                            i11 = i13;
                        case 10:
                            Test0424.instanceCount += i14;
                            break;
                        case 11:
                            Test0424.instanceCount += (i14 * i14);
                            break;
                        case 12:
                        case 13:
                            i11 = i14;
    ...
    public static void vMeth(int i2, int i3, int i4) {
        ...
        iArr[(i2 >>> 1) % N] = (Test0424.byArrFld[(i4 >>> 1) % N][(-48 >>> 1) % N] - (i3--));
        i5 = 1;
        while ((i5 += 3) < 159) {
            for (i6 = 29; i6 > 1; i6 -= 2) {
                b = (b && (iMeth() != (i5 + Test0424.instanceCount)));
                vMeth1(i2);
                f1 = i4;
                i3 += (int) Test0424.instanceCount;
            }
            if (b) {
                for (i18 = 1; i18 < 29; ++i18) {
                    i2 = i4;
                    Test0424.sFld = (short) 1.62922;
                    d2 = -82016060L;
                }
                b = b;
            } else {
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 7; i < 191; i++) {
            vMeth(i, i, i1);
            Test0424.instanceCount -= i1;
            i1 = i1;
            Test0424.iArrFld[i + 1] *= i;
            i1 >>= i;
            for (i20 = 5; 136 > i20; i20++) {
                switch ((((i >>> 1) % 3) * 5) + 6) {
                    case 7:
                        Test0424.iArrFld[i20] = i20;
                        dArr1 = dArr1;
                        i1 -= (int) Test0424.instanceCount;
                        break;
                    case 8:
                        i1 = i;
                        i1 = i21;
                ...
                Test0424.instanceCount ^= i22;
                for (i24 = 2; i24 > 1; i24--) {
                    i25 = 50901;
                    i23 = i;
                    Test0424.instanceCount += i24;
                    Test0424.instanceCount += (4 + (i24 * i24));
                    i23 = (int) Test0424.instanceCount;
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0424.instanceCount Test0424.sFld Test0424.byArrFld = " + Test0424.instanceCount + "," + Test0424.sFld
                + "," + FuzzerUtils.checkSum(Test0424.byArrFld));
        FuzzerUtils.out.println("Test0424.iArrFld = " + FuzzerUtils.checkSum(Test0424.iArrFld));
