...
public class Test0795 {
        ...
        for (i10 = 6; i10 < 299; ++i10) {
            ...
            for (d1 = 1; d1 < 6; ++d1) {
                for (i14 = 1; i14 < 2; ++i14) {
                    ...
                    i13 = (int) Test0795.instanceCount;
    ...
    public void vMeth() {
        ...
        for (i6 = 5; i6 < 275; i6++) {
            for (i8 = 1; i8 < 6; i8 += 3) {
                vMeth1();
                i9 = (int) Test0795.instanceCount;
                iFld -= (int) -3647356710435006396L;
                bArr[i8 - 1] = Test0795.bFld;
            }
            d2 += d2;
            f1 *= Test0795.fFld;
            switch (((i7 >>> 1) % 5) + 84) {
                case 84:
                    ...
                    switch ((i6 % 10) + 1) {
                        case 1:
                            for (f2 = 1; 6 > f2; f2++) {
                                f1 = i16;
                                lArr[(int) (f2 + 1)] = Test0795.instanceCount;
                                Test0795.instanceCount += (long) f2;
                            }
                            break;
                        case 2:
                            iArrFld[i6] *= (int) Test0795.instanceCount;
                        case 3:
                            Test0795.fFld -= i16;
                            break;
                        case 4:
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            Test0795.instanceCount *= i9;
                            break;
                        case 8:
                            Test0795.instanceCount = iFld;
                            break;
                        case 9:
                            byFld = (byte) iFld;
                            break;
                        case 10:
                            iArrFld[i6 - 1] += (int) Test0795.instanceCount;
                            break;
                        default:
                            byFld += (byte) i6;
                    }
    ...
    public void mainTest(String[] strArr1) {
            ...
            if (Test0795.bFld) {
                ...
                while (++i3 < 102) {
                    for (i4 = 1; i4 < 1; i4++) {
                        ...
                        i2 <<= i5;
                        vMeth();
                        Test0795.instanceCount = i3;
                    }
                    iFld += (i3 - i);
                    iArr[i3] = (int) Test0795.instanceCount;
                    if (Test0795.bFld) continue;
                    iArr[i3 + 1] += i4;
                    switch ((i3 % 7) + 101) {
                        case 101:
                            for (i17 = 1; i17 < 1; i17++) {
                                ...
                                i18 += (int) -5305L;
                                i2 = i4;
                                Test0795.fFld = 2489605200L;
                                iArrFld = iArr;
                                i5 = (int) Test0795.instanceCount;
                                iFld = (int) Test0795.instanceCount;
                                if (Test0795.bFld) continue;
                                i18 += i18;
                            }
                            for (i19 = 1; i19 < 1; i19++) {
                                Test0795.instanceCount += i19;
                                Test0795.fFld *= (float) Test0795.dFld;
                                i20 = (int) Test0795.instanceCount;
                                Test0795.fFld += (i19 * Test0795.fFld);
                            }
                            break;
                        case 102:
                            Test0795.instanceCount *= Test0795.instanceCount;
                            break;
                        case 103:
                            i18 >>= (int) Test0795.instanceCount;
                            break;
                        case 104:
                            i2 += i3;
                            break;
        ...
        FuzzerUtils.out.println("Test0795.instanceCount iFld byFld = " + Test0795.instanceCount + "," + iFld + "," + byFld);
        FuzzerUtils.out.println("Test0795.bFld Test0795.fFld Test0795.dFld = " + (Test0795.bFld ? 1 : 0) + "," +
                Float.floatToIntBits(Test0795.fFld) + "," + Double.doubleToLongBits(Test0795.dFld));
