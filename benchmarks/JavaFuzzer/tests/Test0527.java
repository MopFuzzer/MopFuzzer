...
public class Test0527 {
    ...
    static {
        FuzzerUtils.init(Test0527.byArrFld, (byte) 64);
        FuzzerUtils.init(Test0527.iArrFld, -43000);
        FuzzerUtils.init(Test0527.fArrFld, -2.559F);
    }
    ...
    public static void vMeth2(int i5) {
        ...
        Test0527.byArrFld = Test0527.byArrFld;
        for (i6 = 1; i6 < 315; i6++) {
            f1 += (i6 * i6);
            i7 *= i6;
            i5 += (int) (1629321347593541948L + (i6 * i6));
            Test0527.instanceCount /= (Test0527.instanceCount | 1);
            for (i8 = 1; i8 < 5; i8 += 2) {
                short s = 4061;
                i5 = i5;
                i9 += (int) Test0527.instanceCount;
                f1 += ((long) i8 | (long) i8);
                d -= Test0527.instanceCount;
                i7 += i8;
                f1 += (((i8 * s) + Test0527.instanceCount) - i6);
                by += (byte) (((i8 * i7) + i8) - i5);
                if (i8 != 0) {
    ...
    public static void vMeth1(long l1, long l2) {
        ...
        do {
            ...
            i4 = -4;
            Test0527.fArrFld = Test0527.fArrFld;
        } while (++i3 < 200);
        Test0527.fFld = (float) d1;
        i13 |= i10;
        Test0527.instanceCount %= (i3 | 1);
    ...
    public static void vMeth(long l, float f) {
        ...
        vMeth1(l, Test0527.instanceCount);
        Test0527.instanceCount -= -1277557618L;
        for (long l3 : lArr) {
            Test0527.byArrFld = Test0527.byArrFld;
            for (i14 = 1; i14 < 4; ++i14) {
                double d2 = -2.78700;
                ...
                d2 = i;
                for (i16 = 1; 2 > i16; ++i16) {
                    l4 = Test0527.instanceCount;
                    Test0527.instanceCount = l4;
                    if (b) continue;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(-6L, Test0527.fFld);
        Test0527.fFld += Test0527.fFld;
        Test0527.instanceCount += i18;
        for (i19 = 6; i19 < 194; ++i19) {
            for (l5 = i19; l5 < 133; ++l5) {
                if (b1) break;
                for (i22 = (int) (l5); i22 < 1; i22++) {
                    i21 += i20;
                    Test0527.iArrFld[i19 - 1] *= i18;
                    Test0527.instanceCount <<= -11;
                    Test0527.instanceCount += (((i22 * l5) + l5) - Test0527.fFld);
                    i20 -= i23;
                }
                b1 = b1;
                i18 >>= (int) l5;
                Test0527.instanceCount += s2;
                for (i24 = 1; i24 < 1; i24++) {
                    Test0527.iArrFld = Test0527.iArrFld;
                    Test0527.instanceCount -= i21;
                    i23 = (int) 1.467F;
                }
                i18 *= i22;
                i18 += (int) (l5 | i22);
        ...
        FuzzerUtils.out.println("Test0527.instanceCount Test0527.fFld Test0527.byArrFld = " + Test0527.instanceCount + "," +
                Float.floatToIntBits(Test0527.fFld) + "," + FuzzerUtils.checkSum(Test0527.byArrFld));
        FuzzerUtils.out.println("Test0527.iArrFld Test0527.fArrFld = " + FuzzerUtils.checkSum(Test0527.iArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0527.fArrFld)));
