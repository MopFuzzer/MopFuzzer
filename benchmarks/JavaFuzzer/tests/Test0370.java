...
public class Test0370 {
            ...
            for (f1 = 1; f1 < 4; ++f1) {
                ...
                switch (((i10 >>> 1) % 4) + 49) {
                    ...
                    case 50:
                        ...
                        break;
                    case 51:
                        Test0370.instanceCount += (2605020694L + (f1 * f1));
                    case 52:
                        by += (byte) (((f1 * l1) + l1) - Test0370.instanceCount);
                        break;
                }
            }
        }
    ...
    public static boolean bMeth(long l, int i7) {
        ...
        byArr[(i8 >>> 1) % N] *= (byte) (Long.reverseBytes((long) (i7 - Test0370.fFld)) - iMeth1(Test0370.fFld, i8,
                Test0370.instanceCount));
        for (i15 = 10; i15 < 203; ++i15) {
            i8 += (i15 + Test0370.instanceCount);
            byArr[i15 + 1] = (byte) s2;
            i8 *= i8;
            for (i17 = 1; i17 < 8; ++i17) {
                i8 %= (int) ((long) (Test0370.fFld) | 1);
                i8 -= -227;
            }
            i8 += (int) l;
            if (b1) continue;
    ...
    public static int iMeth(int i6, double d) {
        ...
        b = ((i6 == iArr[(11 >>> 1) % N]) && bMeth(Test0370.instanceCount, i6));
        for (i20 = 17; i20 < 382; i20++) {
            for (i22 = i20; i22 < 5; ++i22) {
                ...
                switch (((i22 % 2) * 5) + 42) {
                    case 46:
                        Test0370.instanceCount += (((i22 * i22) + Test0370.fFld) - i20);
                        i23 = (int) Test0370.instanceCount;
                        lArr[i20 - 1][i22 + 1] += -8;
                        i21 *= (int) d;
                        break;
                    case 50:
                        i21 += (43492 + (i22 * i22));
                        Test0370.fFld += (i22 * i22);
                        break;
                    default:
                        i23 *= i22;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++i < 391) {
            for (i1 = i; i1 < 64; ++i1) {
                ...
                for (i3 = 1; 1 > i3; i3++) {
                    ...
                    i4 = (int) (i4 = (int) ((i2 * i2) - Math.abs(Test0370.instanceCount)));
                    i4 += i3;
        ...
        FuzzerUtils.out.println("Test0370.instanceCount bFld Test0370.fFld = " + Test0370.instanceCount + "," + (bFld ? 1 : 0) +
                "," + Float.floatToIntBits(Test0370.fFld));
