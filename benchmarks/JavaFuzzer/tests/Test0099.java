...
public class Test0099 {
    ...
    static {
        FuzzerUtils.init(Test0099.iArrFld, -52308);
    }
    ...
    public static int iMeth() {
        ...
        vMeth1(i6);
        for (i7 = 2; i7 < 225; ++i7) {
            Test0099.iArrFld[i7] += Test0099.sFld;
            i6 = (int) f;
            Test0099.dFld -= Test0099.instanceCount;
            i8 -= i6;
            i6 = (int) f;
            if (i7 != 0) {
            }
            for (i9 = 7; i9 > 1; --i9) {
                ...
                i11 = 1;
                do {
                    i6 += (((i11 * i7) + Test0099.instanceCount) - i9);
                    Test0099.instanceCount += i7;
                    i6 += (i11 | i11);
                    i8 = i7;
                } while (++i11 < 2);
            }
    ...
    public static void vMeth(int i, byte by, boolean b) {
        ...
        i = (int) (i = (int) ((i * i) - (--Test0099.dFld)));
        for (d = 5; 174 > d; d++) {
            Test0099.instanceCount += (29 + (d * d));
        }
        i1 += (iMeth() * i1);
        Test0099.dFld += i12;
        for (i13 = 235; i13 > 14; --i13) {
            for (i15 = 1; i15 < 7; i15++) {
                i12 = (int) Test0099.instanceCount;
            }
            i17 = 1;
            do {
                i14 *= i16;
                f1 += Test0099.instanceCount;
                i1 = Test0099.sFld;
                i1 -= (int) 88.496F;
                f1 += (i17 - i17);
                if (b) continue;
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++d2 < 262) {
            for (i18 = (int) (d2); i18 < 96; ++i18) {
                ...
                switch ((int) ((d2 % 2) + 57)) {
                    case 57:
                        Test0099.instanceCount += (long) d2;
                        break;
                    case 58:
                        Test0099.instanceCount = iFld;
                        iFld1 %= (int) (i19 | 1);
                        for (f3 = 1; 1 > f3; ++f3) {
                            Test0099.instanceCount = 59519;
                            b2 = b2;
                        }
                        iFld += Test0099.sFld;
                        break;
        ...
        FuzzerUtils.out.println("Test0099.instanceCount Test0099.dFld Test0099.sFld = " + Test0099.instanceCount + "," +
                Double.doubleToLongBits(Test0099.dFld) + "," + Test0099.sFld);
        FuzzerUtils.out.println("iFld iFld1 byFld = " + iFld + "," + iFld1 + "," + byFld);
        FuzzerUtils.out.println("Test0099.iArrFld dArrFld = " + FuzzerUtils.checkSum(Test0099.iArrFld) + "," +
