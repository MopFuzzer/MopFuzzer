...
public class Test0781 {
    ...
    static {
        FuzzerUtils.init(Test0781.lArrFld, -1964209424294906693L);
        FuzzerUtils.init(Test0781.iArrFld1, 35050);
    }
    ...
    public static double dMeth(int i8, int i9, int i10) {
        ...
        i11 = 1;
        while (++i11 < 220) {
            Test0781.instanceCount = Test0781.byFld;
            if (b1) {
                Test0781.instanceCount = Test0781.byFld;
                i10 *= (int) Test0781.instanceCount;
            } else {
                i9 += i11;
                b1 = b1;
                if (b1) {
                    ...
                    switch ((i11 % 1) + 11) {
                        case 11:
                            i9 = (int) Test0781.dFld;
                            break;
                        default:
                            i12 = 1;
                            while (++i12 < 7) {
                                iArr2[i12] >>= i12;
                                Test0781.instanceCount = i12;
                            }
                    }
                } else {
                    if (i11 != 0) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(i17, Test0781.instanceCount);
        d1 *= f3;
        for (i18 = 9; i18 < 151; ++i18) {
            f3 = 3;
            for (i20 = 4; i20 < 177; i20++) {
                for (i22 = 1; i22 < 2; i22++) {
                    iArrFld[i22] = (int) Test0781.instanceCount;
                    iArrFld[i18 - 1] >>= (int) Test0781.instanceCount;
                    if (b2) break;
                    b2 = b2;
                    iArrFld[i22 - 1] -= (int) Test0781.instanceCount;
                }
                i23 += (int) Test0781.instanceCount;
                Test0781.instanceCount = (long) f3;
                l2 = 1;
                while (++l2 < 2) {
                    Test0781.lArrFld[i20] -= Test0781.byFld;
                    i19 = (int) l2;
                }
                i24 = -13;
                i21 = -121;
                for (i25 = 1; 2 > i25; ++i25) {
                    Test0781.dFld = l2;
                    Test0781.instanceCount += (long) (0.969F + (i25 * i25));
                    Test0781.instanceCount += (((i25 * i17) + i17) - i18);
                    i24 = (int) Test0781.instanceCount;
                    i19 >>= i22;
                    s += (short) i26;
                    i24 += i25;
                }
            ...
            l3 -= i20;
            Test0781.iArrFld1[i18 - 1] *= (int) Test0781.dFld;
        ...
        FuzzerUtils.out.println("Test0781.instanceCount Test0781.byFld Test0781.dFld = " + Test0781.instanceCount + "," + Test0781.byFld +
                "," + Double.doubleToLongBits(Test0781.dFld));
        FuzzerUtils.out.println("iArrFld Test0781.lArrFld Test0781.iArrFld1 = " + FuzzerUtils.checkSum(iArrFld) + "," +
                FuzzerUtils.checkSum(Test0781.lArrFld) + "," + FuzzerUtils.checkSum(Test0781.iArrFld1));
