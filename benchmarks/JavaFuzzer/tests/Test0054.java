...
public class Test0054 {
    ...
    static {
        FuzzerUtils.init(Test0054.iArrFld, 25552);
    }
    ...
    public static int iMeth1(long l, int i10, long l1) {
        ...
        do {
            for (i12 = 1; i12 < 5; i12++) {
                Test0054.fFld -= l1;
                Test0054.fFld *= Test0054.instanceCount;
                fArr1[i11 - 1] += i10;
            }
            for (i14 = 5; 1 < i14; --i14) {
                if (i15 != 0) {
    ...
    public static int iMeth(int i4, int i5, int i6) {
        ...
        for (int i7 : iArr1) {
            ...
            i8 = 4;
            do {
                s += (short) (((Test0054.instanceCount % (i6 | 1)) - 2) * Math.abs(i6));
                Test0054.instanceCount -= (iArr1[i8 + 1]--);
                f1 += i8;
            } while (--i8 > 0);
            i6 -= (int) (i7 * Test0054.instanceCount);
            i9 = 4;
            do {
                i5 += (int) ((iMeth1(Test0054.instanceCount, i8, Test0054.instanceCount) + Test0054.instanceCount) - i7);
                f1 += (i9 * i9);
                by1 = (byte) 2;
            } while ((i9 -= 2) > 0);
            Test0054.iFld <<= 197;
                ...
                for (d = 1; d > 1; d -= 2) {
                    ...
                    switch ((int) (((d % 10) * 5) + 53)) {
                        case 81:
                            ...
                            break;
                        case 93:
                            Test0054.instanceCount -= iArr[i2 + 1][i];
                            if (bArr[i2 - 1]) continue;
                            iArr[i2][i] = (int) (((Test0054.instanceCount >> -12) - Math.max(i3, -53059)) |
                                    (Test0054.instanceCount--));
                            iMeth(i1, i3, i1);
                            break;
                        case 59:
                            sArr[i2 + 1][i] += (short) i;
                            Test0054.instanceCount >>= i1;
                            break;
                        case 62:
                            i1 -= (int) -20.813F;
                        case 95:
                        ...
                        case 87:
                            Test0054.instanceCount += (long) (d * Test0054.instanceCount);
                            break;
                        case 76:
                        case 101:
                            iArr[(int) (d + 1)][i + 1] -= (int) Test0054.fFld;
                            break;
                    }
                }
            } while (++i2 < 5);
    ...
    public void mainTest(String[] strArr1) {
        ...
        f3 = 1;
        while (++f3 < 243) {
            Test0054.iArrFld[(int) (f3)] -= -252;
            Test0054.iFld += (int) (f3 * Test0054.instanceCount);
            Test0054.iFld /= (int) ((long) (f3) | 1);
            Test0054.iFld = Test0054.iFld;
            switch ((int) ((f3 % 2) + 64)) {
                case 64:
                    switch ((int) (((f3 % 10) * 5) + 10)) {
                        case 36:
                            Test0054.dFld = Test0054.iFld;
                            break;
                        case 28:
                            Test0054.iFld += (int) (((f3 * Test0054.iFld) + sFld) - Test0054.iFld);
                        case 52:
                            Test0054.instanceCount = Test0054.instanceCount;
                            f4 = 1;
                            while (++f4 < 103) {
                                Test0054.iFld += (int) (f4 * Test0054.iFld);
                                for (i18 = 1; 1 > i18; i18++) {
                                    Test0054.instanceCount += (7814854250319029223L + (i18 * i18));
                                }
                                Test0054.iFld = i19;
                            }
                        ...
                        case 15:
                            i24 |= i24;
                        case 12:
                            Test0054.instanceCount += (long) f3;
                            break;
                        case 57:
                            i19 -= (int) -111.986F;
                        case 17:
        ...
        FuzzerUtils.out.println("Test0054.instanceCount Test0054.bFld Test0054.fFld = " + Test0054.instanceCount + "," + (Test0054.bFld ? 1
                : 0) + "," + Float.floatToIntBits(Test0054.fFld));
        FuzzerUtils.out.println("Test0054.iFld Test0054.dFld sFld = " + Test0054.iFld + "," + Double.doubleToLongBits(Test0054.dFld) +
                "," + sFld);
        FuzzerUtils.out.println("Test0054.iArrFld = " + FuzzerUtils.checkSum(Test0054.iArrFld));
