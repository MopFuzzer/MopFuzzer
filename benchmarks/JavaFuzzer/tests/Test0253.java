...
public class Test0253 {
    ...
    static {
        FuzzerUtils.init(Test0253.iArrFld, 253);
    }
    ...
    public static void vMeth1(float f, long l1) {
        ...
        Test0253.iArrFld[(239 >>> 1) % N] = (int) (-((i3 - i3) + (0.584F + (f - i3))));
        switch ((((-(-(i3 + s))) >>> 1) % 5) + 6) {
            case 6:
                i3 *= (int) ((-Test0253.iArrFld[(177 >>> 1) % N]) * ((l1 * -4136189576L) * i3));
                lMeth();
            case 7:
                for (i7 = 183; i7 > 4; i7 -= 2) {
                    Test0253.instanceCount -= l1;
                    i8 &= (int) Test0253.instanceCount;
                    Test0253.instanceCount = i3;
                }
                i3 = 27490;
                d /= (l1 | 1);
                break;
            ...
            default:
                fArr[(i10 >>> 1) % N] = fArr[(Test0253.iFld >>> 1) % N];
        }
        ...
        while ((l2 += 3) < 281) {
            for (d1 = 17; d1 > l2; d1--) {
                for (i13 = 1; i13 < 1; i13++) {
                    ...
                    i15 = 2609;
                    i14 += i13;
                    Test0253.iArrFld[(int) (d1 + 1)] -= i14;
                }
                i14 -= i2;
                Test0253.iFld >>= byFld;
                try {
                    Test0253.iFld = (1389111523 / i2);
                    Test0253.iFld = (i13 % i13);
                    i12 = (-44515 % Test0253.iArrFld[(int) (l2)]);
                } catch (ArithmeticException a_e) {
                }
                if (Test0253.bFld) break;
                for (i16 = 1; i16 < 1; i16++) {
                    i12 = i13;
                    Test0253.iFld <<= i18;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 5; i < 293; i++) {
            lArr[i + 1] *= Test0253.instanceCount;
            i1 += (int) ((-(--Test0253.instanceCount)) + (i1++));
            vMeth(i1, Test0253.instanceCount);
            for (i19 = 87; i19 > i; --i19) {
                byFld += (byte) i19;
                if (Test0253.bFld) {
                    i21 = 1;
                    do {
                        Test0253.sFld += (short) (((i21 * i) + Test0253.instanceCount) - Test0253.instanceCount);
                        i20 = -108;
                    } while (++i21 < 1);
                    i1 += 110;
                    Test0253.instanceCount = i21;
                    Test0253.iFld -= i1;
                } else if (Test0253.bFld) {
                    i22 = i19;
                } else {
                    if (Test0253.bFld) {
                        f3 -= i19;
                        Test0253.instanceCount += (long) dFld;
                        i23 = 1;
                        do {
                            switch ((i23 % 4) + 80) {
                                case 80:
                                    Test0253.sFld *= (short) f3;
                                    Test0253.iFld1 = Test0253.sFld;
                                    i20 <<= byFld;
                                    break;
                                case 81:
                                    i22 = i21;
                                    Test0253.iArrFld[i19 + 1] -= i22;
                                    i20 *= Test0253.iFld1;
                                    break;
                                case 82:
                                    i22 = (int) f3;
                                    Test0253.iFld <<= Test0253.sFld;
                                case 83:
                                    dFld *= 15996;
                                    Test0253.sFld >>= (short) i;
                                    i1 >>>= i20;
                                    break;
                                default:
                                    i22 /= (int) ((long) (dFld) | 1);
        ...
        FuzzerUtils.out.println("Test0253.instanceCount Test0253.iFld Test0253.bFld = " + Test0253.instanceCount + "," + Test0253.iFld +
                "," + (Test0253.bFld ? 1 : 0));
        FuzzerUtils.out.println("dFld byFld Test0253.sFld = " + Double.doubleToLongBits(dFld) + "," + byFld + "," +
                Test0253.sFld);
        FuzzerUtils.out.println("Test0253.iFld1 Test0253.iArrFld = " + Test0253.iFld1 + "," + FuzzerUtils.checkSum(Test0253.iArrFld));
