...
public class Test0686 {
    ...
    static {
        FuzzerUtils.init(Test0686.lArrFld, -9L);
        FuzzerUtils.init(Test0686.fArrFld, -42.631F);
    }
    ...
    public static void vMeth1() {
        ...
        i5 = i5;
        d2 += i5;
        Test0686.lArrFld[(i5 >>> 1) % N] |= i6;
        for (i7 = 1; i7 < 187; i7 += 3) {
            if (b) {
                for (i9 = 1; 25 > i9; i9++) {
                    for (i11 = 1; 2 > i11; i11++) {
                        b = b;
                        iArr3[i11 - 1] ^= (int) Test0686.instanceCount;
                        i12 += (i11 * i11);
                    }
                    switch ((i9 % 2) + 55) {
                        case 55:
                            Test0686.instanceCount += (((i9 * Test0686.instanceCount) + i11) - i11);
                            f2 *= 133L;
                            Test0686.instanceCount *= Test0686.sFld;
                            break;
                        case 56:
                            b = b;
                        default:
    ...
    public static void vMeth(float f, byte by) {
        ...
        Test0686.fArrFld[(i13 >>> 1) % N] = -8392259492624343970L;
        if (true) {
            for (d3 = 7; 370 > d3; ++d3) {
                i15 -= i13;
                for (d4 = 1; d4 < 5; d4++) {
                    i14 = (int) Test0686.instanceCount;
                    switch ((int) (((d3 % 1) * 5) + 16)) {
                        case 18:
                    }
                    i15 = i15;
                }
                i15 += (int) (((d3 * Test0686.instanceCount) + i13) - i16);
            }
            Test0686.instanceCount &= 0;
        } else {
            i14 += by;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (f4 = 3; f4 < 227; f4++) {
            switch ((int) ((f4 % 6) + 122)) {
                case 122:
                    i17 += (int) (f4 * f4);
                    Test0686.iFld = (int) Test0686.instanceCount;
                    break;
                case 123:
                    Test0686.instanceCount += (long) f4;
                    iArr = iArr;
                    if (b1) {
                        iArr[(int) (f4 - 1)] >>= i17;
                        i17 += (int) f4;
                ...
                case 124:
                    for (i20 = 112; i20 > 3; i20 -= 3) {
                        f3 -= i20;
                        dArr[i20] += Test0686.instanceCount;
                        iArr[(int) (f4)] = i17;
                        Test0686.instanceCount += 13L;
                        iArr[i20 + 1] >>>= -54;
                    }
                case 125:
                    Test0686.iFld = i21;
                    for (i22 = 112; 4 < i22; --i22) {
                        if (b1) break;
                        i19 = i17;
                        Test0686.instanceCount >>= -96;
                    }
                case 126:
                    Test0686.iFld += (int) f4;
                case 127:
                    Test0686.lArrFld[(int) (f4 + 1)] -= i21;
                default:
                    i19 -= 41150;
            }
        }
        ...
        FuzzerUtils.out.println("Test0686.instanceCount Test0686.sFld Test0686.iFld = " + Test0686.instanceCount + "," + Test0686.sFld +
                "," + Test0686.iFld);
        FuzzerUtils.out.println("Test0686.lArrFld Test0686.fArrFld = " + FuzzerUtils.checkSum(Test0686.lArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0686.fArrFld)));
