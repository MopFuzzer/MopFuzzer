...
public class Test0848 {
    ...
    static {
        FuzzerUtils.init(Test0848.dArrFld, 114.124620);
    }
    ...
    public static void vMeth1(double d, int i7) {
        ...
        while (++i18 < 217) {
            ...
            i20 = 1;
            while (++i20 < 7) {
                Test0848.dArrFld[i20 - 1] = i7;
                for (i21 = 1; i21 < 1; i21 += 2) {
                    i7 = (int) Test0848.fFld;
                    lArr[i20 - 1] = lArr[i20];
                    Test0848.fFld -= i21;
                }
                i7 += (int) 2.902F;
                i7 = (int) Test0848.instanceCount;
                Test0848.dArrFld[i18 - 1] = 35449;
                i23 ^= (int) Test0848.instanceCount;
                i22 += (int) Test0848.instanceCount;
            }
        }
    ...
    public void vMeth(int i2) {
        ...
        for (i3 = 23; 378 > i3; ++i3) {
            for (i5 = 1; i5 < 5; ++i5) {
                vMeth1(65.108646, i3);
                for (i24 = 2; 1 < i24; --i24) {
                    Test0848.instanceCount += (i24 ^ s);
                    s >>= (short) -219L;
                    Test0848.fFld = -5;
                    Test0848.instanceCount *= Test0848.instanceCount;
                    Test0848.instanceCount += (-9L + (i24 * i24));
                    if (b1) break;
                    i25 += (i24 * i24);
                    Test0848.instanceCount >>= 1;
                }
                for (f1 = 1; f1 < 2; f1++) {
                    Test0848.byFld -= (byte) i6;
                    i2 = (int) -106.427F;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0848.instanceCount = i;
        Test0848.instanceCount = i1;
        for (i27 = 6; i27 < 227; ++i27) {
            for (f2 = 6; f2 < 114; f2++) {
                for (i30 = 1; i30 < 2; ++i30) {
                    double d2 = -80.100220;
                    i29 >>= (int) Test0848.instanceCount;
                    s1 *= (short) i30;
                    iArr1[(int) (f2 - 1)][(int) (f2 + 1)] += (int) d2;
                    i31 |= (int) Test0848.instanceCount;
                    lArr1 = lArr1;
                    Test0848.instanceCount += (long) d2;
                    try {
            ...
            switch (((i27 >>> 1) % 1) + 111) {
                case 111:
                    lArr1 = lArr1;
                default:
                    Test0848.instanceCount += (((i27 * i30) + Test0848.fFld) - Test0848.fFld);
            }
            for (i32 = 114; i32 > i27; --i32) {
                for (i34 = 1; i34 < 1; i34 += 2) {
                    ...
                    if (b2) break;
                    i29 += (((i34 * i31) + i30) - i28);
                    sArr[i34 - 1] = (short) Test0848.instanceCount;
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0848.instanceCount Test0848.fFld Test0848.byFld = " + Test0848.instanceCount + "," +
                Float.floatToIntBits(Test0848.fFld) + "," + Test0848.byFld);
        FuzzerUtils.out.println("Test0848.dArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0848.dArrFld)));
