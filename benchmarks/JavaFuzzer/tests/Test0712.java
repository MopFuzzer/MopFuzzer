...
public class Test0712 {
    ...
    static {
        FuzzerUtils.init(Test0712.bArrFld, false);
    }
        ...
        for (f = 243; f > 15; f -= 3) {
            ...
            switch ((((i4 >>> 1) % 2) * 5) + 127) {
                case 135:
                    i5 = 1;
                    do {
                        iArr1[(int) (f)] += (int) Test0712.instanceCount;
                        for (l1 = 1; l1 < 1; ++l1) {
                            lArr[(int) (l1 + 1)][(int) (f)] = i5;
                            i2 = i5;
                            i6 -= (int) l1;
                            i6 >>= (int) Test0712.instanceCount;
                            Test0712.bArrFld[(int) (l1)] = b;
                            iArr1[(int) (l1 - 1)] *= i6;
                            iArr1[(int) (l1 + 1)] = i5;
                            iArr1[(int) (l1)] -= (int) f;
                        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            sFld <<= byFld;
            Test0712.instanceCount *= i;
            i15 = 1;
            while (++i15 < 172) {
                if (bFld) {
                    i16 <<= (int) Test0712.instanceCount;
                    sFld >>>= (short) i16;
                } else if (bFld) {
                    i17 = 1;
                    do {
                        ...
                        Test0712.instanceCount = 144;
                        i /= (int) ((long) (Test0712.dFld) | 1);
                    } while (++i17 < 1);
                    if (bFld) continue;
                    if (false) {
                        i18 = (int) Test0712.instanceCount;
                    } else if (bFld) {
                        i += (((i15 * i16) + i15) - Test0712.instanceCount);
                    } else if (bFld) {
                        i16 += (i15 - fFld);
                        Test0712.dFld = i14;
                        switch (((i18 >>> 1) % 9) + 2) {
                            case 2:
                                switch ((i14 % 7) + 89) {
                                    ...
                                    case 92:
                                        ...
                                        break;
                                    case 93:
                                        Test0712.instanceCount = (long) 1.117623;
                                        break;
                                    case 94:
                                        i += i20;
                                    case 95:
                                        i20 *= (int) Test0712.dFld;
                                    default:
                                        byFld *= (byte) sFld;
                                }
                                break;
                            ...
                            case 9:
                                ...
                                break;
                            case 10:
                                Test0712.instanceCount += (i15 + i19);
                                break;
                        }
                    }
                } else {
        ...
        FuzzerUtils.out.println("Test0712.instanceCount Test0712.dFld fFld = " + Test0712.instanceCount + "," +
                Double.doubleToLongBits(Test0712.dFld) + "," + Float.floatToIntBits(fFld));
        FuzzerUtils.out.println("sFld byFld bFld = " + sFld + "," + byFld + "," + (bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0712.bArrFld = " + FuzzerUtils.checkSum(Test0712.bArrFld));
