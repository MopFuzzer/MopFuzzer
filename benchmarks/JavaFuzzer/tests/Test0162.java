...
public class Test0162 {
    ...
    static {
        FuzzerUtils.init(Test0162.fArrFld, -85.354F);
    }
    ...
    public static int iMeth1() {
        ...
        d1 = 1;
        do {
            byArr[(int) (d1)] <<= (byte) Test0162.instanceCount;
        } while (++d1 < 226);
        for (i7 = 308; i7 > 12; --i7) {
            for (i9 = i7; i9 < 6; ++i9) {
                iArr1[i9 + 1] = i9;
    ...
    public int iMeth(int i4, byte by) {
        ...
        if (false) {
            ...
            Test0162.sFld = (short) Test0162.instanceCount;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 9; 227 > i; ++i) {
            ...
            for (i2 = i; 115 > i2; i2++) {
                ...
                for (i13 = 1; i13 < 1; i13 += 3) {
                    ...
                    switch ((i2 % 5) + 28) {
                        case 28:
                            Test0162.fArrFld[i2 - 1] -= i;
                            i14 = i1;
                            if (b1) continue;
                            i3 = (int) Test0162.instanceCount;
                            break;
                        case 29:
                            i15 = (int) d;
                            break;
                        case 30:
                            switch ((i13 % 8) + 94) {
                                case 94:
                                    ...
                                    switch (((i2 % 3) * 5) + 58) {
                                        case 67:
                                            Test0162.instanceCount = i;
                                            iArr[i2 - 1] += (int) Test0162.instanceCount;
                                            i3 += (((i13 * i2) + i2) - Test0162.instanceCount);
                                            i1 += (((i13 * i13) + i1) - by2);
                                            break;
                                        case 65:
                                            try {
                                        ...
                                        case 68:
                                            i14 *= -8363;
                                            Test0162.instanceCount += (((i13 * i14) + i14) - Test0162.instanceCount);
                                            if (b1) {
                                                Test0162.instanceCount += (-89 + (i13 * i13));
                                                i3 *= (int) Test0162.instanceCount;
                                            }
                                            if (b1) continue;
                                            break;
                                ...
                                case 95:
                                    ...
                                    break;
                                case 96:
                                    i14 = (int) Test0162.instanceCount;
                                case 97:
                                case 98:
                                    i3 *= i2;
                                    break;
                                case 99:
                                    ...
                                    break;
                                case 100:
                                    Test0162.instanceCount += (((i13 * by2) + i15) - i2);
                                    break;
                                case 101:
                                    Test0162.instanceCount = i;
                                    break;
        ...
        FuzzerUtils.out.println("Test0162.instanceCount Test0162.sFld iFld = " + Test0162.instanceCount + "," + Test0162.sFld + "," +
                iFld);
        FuzzerUtils.out.println("Test0162.fArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0162.fArrFld)));
