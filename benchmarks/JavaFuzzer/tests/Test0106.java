...
public class Test0106 {
    ...
    static {
        FuzzerUtils.init(Test0106.iArrFld, 29852);
    }
    ...
    public static double dMeth(int i4) {
        ...
        Test0106.iArrFld[(i4 >>> 1) % N] -= (int) (i4 = (int) (Test0106.instanceCount = (Test0106.instanceCount * Test0106.sFld)));
        d1 -= Test0106.instanceCount;
        for (i5 = 7; i5 < 136; ++i5) {
            vMeth(b1, Test0106.sFld);
            for (i7 = 1; i7 < 12; i7++) {
                if (b1) continue;
            }
    ...
    public static long lMeth(long l) {
        ...
        for (i2 = 8; 249 > i2; i2++) {
            ...
            for (i11 = 1; i11 < 7; ++i11) {
                ...
                d2 = l;
                i12 = i12;
                Test0106.iArrFld[i11 + 1] = i2;
                i12 += (int) Test0106.instanceCount;
            }
            if (b2) continue;
            iArr1[i2] = i11;
            i12 = (int) -2704095041L;
    ...
    public void mainTest(String[] strArr1) {
        ...
        lArr[(i >>> 1) % N] = byFld;
        if (b3) {
            i -= (int) ((28145 * Math.min(Test0106.instanceCount, Test0106.instanceCount)) + ((i + i) - byFld));
            d = 1;
            do {
                switch (((((i += i) >>> 1) % 9) * 5) + 110) {
                    case 140:
                        vMeth(Test0106.iArrFld[(int) (d - 1)] != ((f * i) + (Test0106.instanceCount + i)), (short) (s1 =
                                (short) 7935));
                        iArr[(int) (d - 1)] = (int) ((i--) - ((-3 - (iArr[(int) (d)]--)) << lMeth(Test0106.instanceCount)));
                        break;
                    case 131:
                        if (true) break;
                        break;
                    case 120:
                        Test0106.instanceCount <<= Test0106.sFld;
                        Test0106.iArrFld[(int) (d - 1)] = i;
                        break;
                    case 147:
                        f += i;
                        i13 = 1;
                        ...
                        do {
                            switch ((i14 % 7) + 47) {
                                case 47:
                                    ...
                                    iArr[i14 + 1] >>= i;
                                    for (f1 = 1; 1 > f1; ++f1) {
                                        f += (f1 * Test0106.instanceCount);
                                    }
                                case 48:
                                    Test0106.sFld = (short) 115;
                                    l1 += Test0106.instanceCount;
                                    f = i13;
                                    iArr[i14 - 1] = 8;
                                case 49:
                                    for (f2 = 1; f2 < 1; f2 += 3) {
                                        iArr[(int) (f2)] -= i14;
                                        i15 <<= (int) Test0106.instanceCount;
                                        Test0106.instanceCount = (long) -93.84467;
                                        f += i15;
                                        i16 *= 39936;
                                    }
                                    break;
                                ...
                                case 51:
                                    ...
                                    break;
                                case 52:
                                    Test0106.iArrFld[(int) (d - 1)] ^= (int) 1190398592169133942L;
                                    break;
                                case 53:
                                    lArr[i14 + 1] *= i14;
                                    break;
                    ...
                    case 127:
                        byFld <<= (byte) Test0106.instanceCount;
                    case 154:
                }
            } while (++d < 267);
        } else if (b3) {
            Test0106.instanceCount *= -1;
        } else if (b3) {
            Test0106.sFld = (short) -62;
        }
        ...
        FuzzerUtils.out.println("Test0106.instanceCount byFld Test0106.sFld = " + Test0106.instanceCount + "," + byFld + "," +
                Test0106.sFld);
        FuzzerUtils.out.println("Test0106.iArrFld = " + FuzzerUtils.checkSum(Test0106.iArrFld));
