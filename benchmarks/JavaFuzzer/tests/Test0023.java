...
public class Test0023 {
    ...
    static {
        ...
        FuzzerUtils.init(Test0023.sArrFld, (short) 24794);
    }
    ...
    public static void vMeth2(byte by, int i4, double d) {
        ...
        Test0023.instanceCount %= (Test0023.instanceCount | 1);
        i5 = i4;
        b = b;
        i5 += i4;
    ...
    public static void vMeth1(long l1) {
        ...
        for (d2 = 19; 385 > d2; d2++) {
            for (i8 = (int) (d2); i8 < 5; i8++) {
                for (i10 = 1; i10 < 1; i10++) {
                    i6 >>>= (int) Test0023.instanceCount;
                }
                i11 = (int) l1;
                iArr1[i8 + 1] += i11;
                switch (((i8 % 2) * 5) + 39) {
                    case 45:
                        Test0023.iArrFld[i8 + 1] &= i8;
                        break;
                    case 46:
                        by1 = (byte) d2;
                        break;
    ...
    public static int iMeth(int i2, int i3) {
        ...
        for (long l2 : lArr) {
            ...
            Test0023.iArrFld[(5 >>> 1) % N] = i3;
            Test0023.iArrFld[(i3 >>> 1) % N] *= s1;
            iArr2 = iArr2;
        }
        d3 *= f;
        for (i12 = 20; i12 < 325; ++i12) {
            ...
            for (i14 = i12; i14 < 5; ++i14) {
                i16 = 1;
                while (--i16 > 0) {
                    Test0023.instanceCount += i16;
                    i15 += i13;
                }
                i2 += (int) Test0023.instanceCount;
                Test0023.instanceCount = i12;
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(--Test0023.instanceCount, iFld, (int) (Integer.reverseBytes(iMeth(iFld, iFld)) + f1));
        iFld = (int) l3;
        iFld = iFld;
        d4 = 1;
        while (++d4 < 377) {
        ...
        l3 ^= iFld;
        Test0023.iArrFld[(iFld >>> 1) % N] += -74;
        Test0023.sArrFld[(iFld >>> 1) % N] %= (short) (iFld | 1);
        for (l5 = 7; l5 < 206; l5++) {
            ...
            switch (((i17 >>> 1) % 10) + 102) {
                case 102:
                    ...
                    for (i18 = 2; i18 < 126; ++i18) {
                        iFld += (i18 ^ Test0023.instanceCount);
                    }
                    Test0023.iArrFld[(int) (l5)] = (int) Test0023.instanceCount;
                    break;
                case 103:
                    iFld -= i19;
                    f1 += l5;
                ...
                case 104:
                    ...
                    switch (((i17 >>> 1) % 10) + 61) {
                        ...
                        case 64:
                            try {
                                Test0023.iArrFld[(int) (l5 - 1)] = (i21 % -400090064);
                                Test0023.iArrFld[(int) (l5 + 1)] = (52087 / Test0023.iArrFld[(int) (l5 - 1)]);
                                Test0023.iArrFld[(int) (l5)] = (i21 % 62738);
                            } catch (ArithmeticException a_e) {
                            }
                        case 65:
                            Test0023.iArrFld[(int) (l5 + 1)] = iFld;
                            break;
                        case 66:
                            i19 = (int) Test0023.instanceCount;
                        case 67:
                            lArr1[(int) (l5)] -= i19;
                        case 68:
                            i19 += Test0023.sFld;
                ...
                case 106:
                    ...
                    break;
                case 107:
                    Test0023.iArrFld[(int) (l5 - 1)] = (int) l5;
                case 108:
                    f1 = iFld;
                    break;
                case 109:
        ...
        FuzzerUtils.out.println("Test0023.instanceCount iFld Test0023.bFld = " + Test0023.instanceCount + "," + iFld + "," +
                (Test0023.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0023.sFld iFld1 Test0023.iArrFld = " + Test0023.sFld + "," + iFld1 + "," +
                FuzzerUtils.checkSum(Test0023.iArrFld));
        FuzzerUtils.out.println("Test0023.sArrFld = " + FuzzerUtils.checkSum(Test0023.sArrFld));
