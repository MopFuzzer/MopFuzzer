...
public class Test0394 {
    ...
    static {
        FuzzerUtils.init(Test0394.fArrFld, 49.1019F);
    }
    ...
    public static int iMeth1() {
        ...
        while (++i2 < 303) {
            ...
            if (b) {
                i3 >>>= i3;
                for (i4 = 1; i4 < 5; ++i4) {
                    Test0394.fArrFld[i2] += i3;
                    i5 -= i5;
                    f1 = Test0394.instanceCount;
                    for (i6 = 1; i6 < 2; i6++) {
                        i7 = i7;
                        try {
                            i5 = (iArr[i2 + 1] / -6);
    ...
    public static int iMeth(double d, byte by, int i1) {
        ...
        Test0394.instanceCount *= (i1++);
        vMeth(Test0394.instanceCount, Test0394.instanceCount);
        for (d1 = 6; d1 < 192; ++d1) {
        ...
        do {
            ...
            i1 = i9;
            i11 /= (int) (Test0394.instanceCount | 1);
        } while (++i9 < 385);
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = (int) ((i++) - (--Test0394.instanceCount));
        i = (int) (((i = i) - (Test0394.instanceCount++)) | byArrFld[(i >>> 1) % N]);
        f = iMeth(dFld, Test0394.byFld, i);
        if (b2) {
            Test0394.byFld *= (byte) 106;
        } else {
            for (i12 = 12; i12 < 344; ++i12) {
                i += (i12 * i12);
                Test0394.instanceCount <<= -24443;
                i += (i12 * i12);
                i14 = 76;
                while ((i14 -= 2) > 0) {
                    i13 = -38;
                    lArr[i12 + 1] >>= Test0394.instanceCount;
                }
                i13 <<= i12;
                switch (((i12 % 9) * 5) + 39) {
                    case 44:
                        for (i15 = i12; i15 < 76; ++i15) {
                            ...
                            switch (((i13 >>> 1) % 7) + 43) {
                                ...
                                case 45:
                                    ...
                                    break;
                                case 46:
                                    sFld = (short) Test0394.instanceCount;
                                case 47:
                                    i += (((i15 * i17) + f2) - i19);
                                    break;
                                case 48:
                        ...
                        break;
                    case 52:
                        Test0394.fArrFld[i12 - 1] *= Test0394.instanceCount;
                        break;
                    case 75:
                        Test0394.instanceCount ^= Test0394.instanceCount;
                    case 55:
                    case 73:
                        Test0394.instanceCount >>= -13L;
                        break;
                    case 74:
                        i18 -= i18;
                    case 41:
        ...
        FuzzerUtils.out.println("Test0394.instanceCount dFld Test0394.byFld = " + Test0394.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + Test0394.byFld);
        FuzzerUtils.out.println("sFld byArrFld Test0394.fArrFld = " + sFld + "," + FuzzerUtils.checkSum(byArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0394.fArrFld)));
