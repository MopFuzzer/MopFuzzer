...
public class Test0631 {
    ...
    public static void vMeth(long l1) {
        ...
        vMeth1(Test0631.instanceCount, -11);
        i13 = 1;
        do {
            int i14 = 13;
            i14 >>>= i13;
            Test0631.fFld -= 46853L;
        } while (++i13 < 274);
    ...
    public static long lMeth(int i1, int i2) {
        ...
        for (i3 = 6; 171 > i3; i3++) {
            for (i5 = 1; i5 < 10; ++i5) {
                i6 -= (int) Test0631.instanceCount;
                for (i7 = 1; i7 < 2; ++i7) {
                    l -= (i4++);
                    if (i4 != 0) {
                    }
                    lArr[i5 + 1] = (long) (((i8 + s) + Math.abs(f)) + Math.abs((int) (Test0631.instanceCount % (i3 | 1))));
                    vMeth(-3877635910413487727L);
                    i6 += (int) (-5284694058350978910L + (i7 * i7));
                    sArr[(-5 >>> 1) % N] = (short) 982304291L;
                    lArr[i3 - 1] /= (Test0631.instanceCount | 1);
                }
            }
            iArr1[i3][i3] -= -6;
            for (d1 = 1; d1 < 10; ++d1) {
                f += (float) d1;
                Test0631.fFld += (float) ((long) d1 | (long) i6);
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i21 = 256; i21 > 3; i21--) {
            i22 = (int) Test0631.instanceCount;
            for (i23 = 3; i23 < 99; ++i23) {
                ...
                for (i27 = i23; i27 < 2; ++i27) {
                    iArr2[i23] = (int) Test0631.fFld;
                    i22 += i27;
                }
                Test0631.dFld = i21;
                for (i29 = 1; i29 < 2; ++i29) {
                    i24 &= i30;
                    Test0631.instanceCount /= (i27 | 1);
                    if (Test0631.bFld) continue;
                    i30 += i27;
                    Test0631.instanceCount += i29;
                    i30 = i23;
                    i22 = i24;
                    iFld += i29;
                    Test0631.fFld += by2;
                    switch ((((i28 >>> 1) % 4) * 5) + 109) {
                        case 119:
                            ...
                            break;
                        case 121:
                            Test0631.fFld += (64 + (i29 * i29));
                            break;
                        case 127:
                            Test0631.instanceCount += i21;
                            break;
                        case 124:
                            i28 += (((i29 * Test0631.instanceCount) + Test0631.fFld) - by2);
                        default:
                            Test0631.instanceCount = i25;
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0631.instanceCount Test0631.fFld Test0631.bFld = " + Test0631.instanceCount + "," +
                Float.floatToIntBits(Test0631.fFld) + "," + (Test0631.bFld ? 1 : 0));
        FuzzerUtils.out.println("iFld Test0631.dFld = " + iFld + "," + Double.doubleToLongBits(Test0631.dFld));
