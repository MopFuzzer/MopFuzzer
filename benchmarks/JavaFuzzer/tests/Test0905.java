...
public class Test0905 {
    ...
    static {
        FuzzerUtils.init(Test0905.iArrFld, 59371);
    }
    ...
    public static void vMeth2(long l, float f, int i4) {
        ...
        for (i5 = 10; i5 < 277; ++i5) {
            for (i7 = 1; i7 < 6; i7++) {
                i6 = (int) f;
                i8 += (((i7 * i7) + s) - Test0905.instanceCount);
                Test0905.iArrFld[i7] = -6;
                for (i9 = 1; i9 < 2; i9 += 3) {
                    i10 += (i9 | i4);
                    i8 += (-38115 + (i9 * i9));
                    switch (((i5 % 9) * 5) + 47) {
    ...
    public static void vMeth1(int i3) {
        ...
        vMeth2(Test0905.instanceCount, -101.988F, -57079);
        ...
        while (++i11 < 356) {
            for (i12 = 5; i12 > 1; i12--) {
                ...
                switch ((i11 % 5) + 51) {
                    ...
                    case 52:
                        f1 = i3;
                        i13 >>= (int) Test0905.instanceCount;
                        Test0905.iArrFld[i12 + 1] = 31381;
                        break;
                    case 53:
                    case 54:
                        i13 += (-13 + (i12 * i12));
    ...
    public static void vMeth(int i) {
        ...
        for (i1 = 6; i1 < 162; i1 += 2) {
            ...
            for (i14 = i1; i14 < 20; i14++) {
                ...
                for (i16 = 1; 1 > i16; ++i16) {
                    f2 += (i16 - Test0905.instanceCount);
                    i17 = i15;
                    i2 >>= i1;
                    i15 = (int) Test0905.instanceCount;
                }
                i18 = 1;
                while (++i18 < 1) {
                    i += (((i18 * i2) + Test0905.instanceCount) - i17);
                    i += (((i18 * Test0905.instanceCount) + i18) - s1);
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
            ...
            switch (((8 >>> 1) % 3) + 116) {
                case 116:
                    for (i22 = 5; i22 < 91; i22++) {
                        ...
                        i25 *= i25;
                        Test0905.instanceCount += (i22 - Test0905.instanceCount);
                        switch ((((-51536 >>> 1) % 10) * 5) + 124) {
                            case 138:
                            case 128:
                                i19 = (int) Test0905.instanceCount;
                                for (i26 = 1; i26 < 2; ++i26) {
                                    Test0905.instanceCount |= Test0905.instanceCount;
                                    i27 += (i26 - i24);
                                    s2 |= (short) i25;
                                    switch (((i26 % 8) * 5) + 47) {
                                        case 79:
                                            Test0905.iArrFld[i26 - 1] = (int) Test0905.instanceCount;
                                            i19 >>>= i19;
                                            i27 = (int) Test0905.instanceCount;
                                            break;
                                        case 83:
                                            Test0905.instanceCount = (long) f3;
                                            i19 += i27;
                                            i21 = 0;
                                            s2 += (short) i26;
                                            break;
        ...
        FuzzerUtils.out.println("Test0905.instanceCount bFld Test0905.iArrFld = " + Test0905.instanceCount + "," + (bFld ? 1 : 0) +
                "," + FuzzerUtils.checkSum(Test0905.iArrFld));
