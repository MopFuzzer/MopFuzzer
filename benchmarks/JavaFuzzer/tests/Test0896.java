...
public class Test0896 {
    ...
    static {
        FuzzerUtils.init(Test0896.iArrFld, 20);
        FuzzerUtils.init(Test0896.lArrFld, 1717776140L);
    }
    ...
    public static void vMeth1(int i9) {
        ...
        sArr[(Test0896.iFld >>> 1) % N] = (short) Test0896.iFld;
    ...
    public static void vMeth(long l) {
        ...
        l = ((Test0896.iFld++) - Test0896.lArrFld[(Test0896.iFld >>> 1) % N]);
        Test0896.iFld = (int) Math.abs(Math.abs(Test0896.iFld - Test0896.instanceCount));
        for (i7 = 14; i7 < 231; i7++) {
            vMeth1(Test0896.iFld);
            l *= i8;
            f1 -= i8;
            Test0896.iArrFld[i7] ^= i8;
            d = 1;
            while (++d < 7) {
                Test0896.iFld %= (int) (i7 | 1);
                by *= (byte) 1.68872;
                i8 += (int) (d + Test0896.iFld);
                for (i10 = 1; i10 < 1; i10++) {
                    double d1 = 34.75618;
                    d1 += -72.78264;
                    bArr[(int) (d + 1)] = b;
                    Test0896.iArrFld = FuzzerUtils.int1array(N, (int) 38418);
                }
            }
        }
    ...
    public static int iMeth(int i5) {
        ...
        for (f = 300; f > 7; f -= 2) {
            ...
            for (d2 = 1; d2 < 11; ++d2) {
                ...
                switch ((int) ((f % 1) + 42)) {
                    case 42:
                        Test0896.iArrFld[(int) (d2 + 1)] = (int) 28.481F;
                        break;
                }
                Test0896.lArrFld[(int) (f - 1)] += -1;
                i12 %= (int) ((long) (f2) | 1);
                Test0896.instanceCount += (long) (d2 - i6);
            }
            for (i14 = (int) (f); i14 < 11; ++i14) {
                Test0896.iArrFld[(int) (f + 1)] = Test0896.iFld;
            }
            i15 += (int) f;
            i15 += (int) (((f * by1) + i6) - i6);
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 9; i < 146; i++) {
            for (i2 = 3; i2 < 183; i2++) {
                ...
                i4 = 1;
                do {
                    Test0896.iArrFld[i2 - 1] = (int) ((Test0896.iArrFld[i4 - 1] - iMeth(Test0896.iFld)) & 525619873415198594L);
                } while (++i4 < 2);
                i16 = 1;
                while (++i16 < 2) {
                    d3 = 0.80711;
            ...
            Test0896.instanceCount += (i | Test0896.iFld);
        }
        i3 >>= i;
        s += (short) i2;
        for (i17 = 14; i17 < 230; i17++) {
            Test0896.lArrFld[i17 + 1] >>= i16;
            Test0896.iFld = i3;
            try {
                Test0896.iArrFld[i17] = (150 % i1);
                Test0896.iArrFld[i17 + 1] = (Test0896.iArrFld[i17 + 1] % i18);
                Test0896.iFld = (i18 % 31610);
            ...
            switch ((i17 % 4) + 125) {
                case 125:
                    for (d4 = 5; d4 < 116; ++d4) {
                        fArr[(int) (d4 - 1)] = 2;
                        i19 |= (int) Test0896.instanceCount;
                    }
                ...
                case 126:
                    Test0896.iArrFld[i17 + 1] -= i21;
                case 127:
                    i1 = (int) Test0896.instanceCount;
                    break;
                case 128:
                    Test0896.iFld += (int) -12L;
                    break;
            }
        }
        ...
        FuzzerUtils.out.println("Test0896.instanceCount Test0896.iFld Test0896.bFld = " + Test0896.instanceCount + "," + Test0896.iFld +
                "," + (Test0896.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0896.iArrFld Test0896.lArrFld = " + FuzzerUtils.checkSum(Test0896.iArrFld) + "," +
                FuzzerUtils.checkSum(Test0896.lArrFld));
