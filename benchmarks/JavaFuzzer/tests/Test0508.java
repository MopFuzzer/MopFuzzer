...
public class Test0508 {
    ...
    static {
        FuzzerUtils.init(Test0508.lArrFld, 2740L);
        FuzzerUtils.init(Test0508.byArrFld, (byte) -101);
    }
    ...
    public static void vMeth() {
        ...
        vMeth1(19728);
        Test0508.instanceCount = i14;
        for (i15 = 12; i15 < 241; ++i15) {
            for (l = i15; l < 7; ++l) {
                iArr2[(int) (l - 1)] >>>= i16;
                Test0508.instanceCount += l;
                i16 |= i14;
                for (f2 = l; f2 < 1; ++f2) {
                    if (Test0508.bFld) {
                        i17 = 0;
                    } else if (Test0508.bFld) {
                        Test0508.instanceCount %= (i16 | 1);
                        Test0508.lArrFld[(int) (f2)] += i15;
                        Test0508.instanceCount >>>= i18;
                        i17 = i15;
                        vMeth_check_sum += i14 + i15 + i16 + l + i17 + Float.floatToIntBits(f2) + i18 +
                                FuzzerUtils.checkSum(iArr2);
                        return;
                    } else {
                        Test0508.lArrFld[(int) (l)] = (long) f2;
                    }
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i19 = 10; i19 < 229; ++i19) {
            Test0508.instanceCount >>= i19;
            i20 = (int) f3;
        }
        i21 -= (int) 3L;
        for (i22 = 7; i22 < 148; ++i22) {
            for (i24 = i22; i24 < 178; i24++) {
                Test0508.instanceCount = -29730;
            }
            Test0508.instanceCount -= i23;
            i21 -= (int) Test0508.instanceCount;
            for (i26 = i22; 178 > i26; ++i26) {
                ...
                i25 += i19;
                i27 += (((i26 * i22) + i27) - i20);
                Test0508.byArrFld[i26] *= (byte) i22;
            }
        }
        for (i28 = 8; i28 < 206; ++i28) {
            d *= Test0508.instanceCount;
        ...
        FuzzerUtils.out.println("Test0508.instanceCount Test0508.bFld Test0508.lArrFld = " + Test0508.instanceCount + "," + (Test0508.bFld
                ? 1 : 0) + "," + FuzzerUtils.checkSum(Test0508.lArrFld));
        FuzzerUtils.out.println("Test0508.byArrFld = " + FuzzerUtils.checkSum(Test0508.byArrFld));
