...
public class Test0565 {
    ...
    public static int iMeth() {
        ...
        for (i7 = 7; i7 < 391; i7++) {
            i8 += i8;
            i8 = (int) Test0565.instanceCount;
            for (i9 = 1; i9 < 4; i9++) {
                if (b) {
                    d2 = 75.75960;
                    lArr[i7 + 1] += (long) Test0565.fFld;
                    i10 += i9;
                } else {
                    i8 >>= 122;
                    i10 += i9;
                    lArr[i9] = Test0565.instanceCount;
                    by1 -= (byte) i10;
                }
                for (i11 = 2; i11 > 1; --i11) {
                    i10 -= i7;
        ...
        for (i1 = 124; i1 > 7; i1--) {
            for (i3 = 1; i3 < 13; ++i3) {
                ...
                while (++i5 < 2) {
                    ...
                    i2 += (i5 * i5);
                    i2 += (i5 | i4);
                    f *= (Test0565.instanceCount--);
                    Test0565.fFld += (float) (Test0565.instanceCount - (i5 - (d - i4)));
    ...
    public void mainTest(String[] strArr1) {
                ...
                for (i15 = 2; i15 > 1; i15--) {
                    ...
                    switch ((i13 % 8) + 86) {
                        case 86:
                            i16 |= i16;
                            iArr[i13] -= i16;
                            i16 = (int) Test0565.instanceCount;
                            break;
                        case 87:
                            lArr2[i13 - 1] += i15;
                        ...
                        case 89:
                            lArr2[i13] = -4;
                            Test0565.instanceCount = i13;
                            i16 <<= i15;
                        case 90:
                            i14 += i15;
                            i16 += i15;
                            iArr[i15 - 1] <<= (int) Test0565.instanceCount;
                            break;
                        case 91:
                            i14 = (int) Test0565.instanceCount;
                            bArrFld[i15 + 1] = b1;
                        case 92:
                            i <<= 246;
                            Test0565.fFld += i15;
        ...
        FuzzerUtils.out.println("Test0565.instanceCount Test0565.fFld bArrFld = " + Test0565.instanceCount + "," +
                Float.floatToIntBits(Test0565.fFld) + "," + FuzzerUtils.checkSum(bArrFld));
