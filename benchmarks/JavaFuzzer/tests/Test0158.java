...
public class Test0158 {
    ...
    static {
        FuzzerUtils.init(Test0158.fArrFld, -78.580F);
    }
                ...
                do {
                    switch ((((-22 >>> 1) % 2) * 5) + 12) {
                        case 16:
                            ...
                            f *= i4;
                        case 21:
                            i6 -= (int) Test0158.instanceCount;
                            f /= (Test0158.instanceCount | 1);
                            break;
                    }
                    i4 += (-84 + (i17 * i17));
                } while ((i17 -= 3) > 0);
    ...
    public static void vMeth() {
        ...
        vMeth1(i18, 161, i18);
        i18 = -23;
        for (float f1 : Test0158.fArrFld) {
            Test0158.fArrFld[(i18 >>> 1) % N] -= i18;
            for (i19 = 1; i19 < 4; i19++) {
                i20 /= (int) (Test0158.instanceCount | 1);
                s += (short) (((i19 * i18) + i19) - Test0158.instanceCount);
                d1 -= i19;
                Test0158.instanceCount <<= by1;
                i20 = i18;
                for (i21 = 1; i21 < 2; ++i21) {
                    i20 >>= -57051;
                    i20 += (i21 | i21);
    ...
    public void mainTest(String[] strArr1) {
            ...
            switch ((i31 % 1) + 15) {
                case 15:
                    ...
                    for (i33 = 2; i33 < 74; i33++) {
                        Test0158.instanceCount += (-64542L + (i33 * i33));
                    }
                    break;
            }
            s1 += (short) i31;
        ...
        for (i35 = 24; i35 < 392; i35 += 2) {
            fFld %= (Test0158.instanceCount | 1);
            i37 = 1;
            do {
                i30 |= (int) Test0158.instanceCount;
                fFld *= 7675;
            } while (++i37 < 136);
        }
        ...
        FuzzerUtils.out.println("Test0158.instanceCount fFld Test0158.fArrFld = " + Test0158.instanceCount + "," +
                Float.floatToIntBits(fFld) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0158.fArrFld)));
