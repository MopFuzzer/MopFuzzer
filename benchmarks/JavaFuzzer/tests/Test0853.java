...
public class Test0853 {
    ...
    static {
        FuzzerUtils.init(Test0853.iArrFld, -145);
    }
    ...
    public static int iMeth1() {
        ...
        Test0853.iArrFld[(12 >>> 1) % N] -= (int) Test0853.instanceCount;
        Test0853.iArrFld[(-57783 >>> 1) % N] += (int) Test0853.instanceCount;
        d1 += i9;
        lArr[(i9 >>> 1) % N] *= i9;
        Test0853.instanceCount |= -23710;
        for (i10 = 8; 329 > i10; i10 += 2) {
            Test0853.iArrFld[i10] = i11;
            Test0853.instanceCount += 5L;
            i11 += (i10 ^ i9);
            i11 = i10;
        }
        switch ((((i11 >>> 1) % 2) * 5) + 41) {
            case 45:
                for (i12 = 5; i12 < 348; ++i12) {
                    Test0853.instanceCount /= (i9 | 1);
                    Test0853.bFld = Test0853.bFld;
                    i11 += (i12 * i10);
                }
                break;
            case 43:
    ...
    public static short sMeth() {
        ...
        for (i6 = 6; i6 < 245; ++i6) {
            ...
            do {
                ...
                Test0853.fFld -= iMeth1();
                lArr1[i8] = Test0853.instanceCount;
                for (i14 = 1; i14 < 1; ++i14) {
                    double d2 = -47.107678;
                    Test0853.iArrFld[i14] = (int) Test0853.instanceCount;
                    Test0853.fFld -= Test0853.instanceCount;
                    i7 = (int) d2;
                    Test0853.bFld = Test0853.bFld;
                    if (Test0853.bFld) continue;
                    i15 = 44;
                    i15 <<= by;
                    i15 -= 7;
                    i15 ^= i14;
    ...
    public static int iMeth(int i2, long l) {
        ...
        for (i3 = 3; i3 < 240; ++i3) {
            ...
            i16 = 1;
            do {
                Test0853.iArrFld[i16] = i3;
                for (l1 = 1; l1 < 1; ++l1) {
                    Test0853.iArrFld = FuzzerUtils.int1array(N, (int) 30275);
                    i2 = s;
                    i2 += (int) (((l1 * i2) + i2) - l);
                    i17 <<= i3;
                    fArr[(int) (l1 - 1)] += Test0853.fFld;
                    Test0853.iArrFld[(int) (l1 - 1)] += (int) -45.651F;
                    i2 >>>= i17;
                    i4 *= (int) 12L;
                    Test0853.iArrFld[i16] >>>= i3;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (d = 6; d < 384; d++) {
            for (f = 1; 67 > f; ++f) {
                Test0853.instanceCount = ((++i) | iMeth(i, Test0853.instanceCount));
                Test0853.instanceCount += (long) (f * f);
                i = 5657;
                i1 += (int) (f - i1);
                Test0853.fFld -= i1;
                i += (75 + (f * f));
                if (true) {
                    Test0853.fFld += ((long) f ^ (long) i1);
                    for (i19 = (int) (f); i19 < 2; i19++) {
                        lArr2[i19 + 1][i19] = Test0853.instanceCount;
                        Test0853.iArrFld[(int) (d)] *= i;
                        i /= (int) 1.1019F;
                        i20 += (i19 * i19);
                        Test0853.instanceCount -= i1;
                        i += (i19 - i20);
                        i = -7;
                    }
                    Test0853.fFld *= -27798;
                    ...
                    i1 -= 3;
                    for (i21 = 1; i21 < 2; i21++) {
                        i20 += (int) Test0853.instanceCount;
                        s1 = (short) i1;
                        Test0853.iArrFld[(int) (f)] *= (int) 2736630806L;
                        fArrFld[i21] -= i;
                        i1 += i21;
                        Test0853.iArrFld[i21 + 1] -= by1;
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0853.instanceCount Test0853.fFld Test0853.bFld = " + Test0853.instanceCount + "," +
                Float.floatToIntBits(Test0853.fFld) + "," + (Test0853.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0853.lFld Test0853.iArrFld fArrFld = " + Test0853.lFld + "," +
                FuzzerUtils.checkSum(Test0853.iArrFld) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(fArrFld)));
