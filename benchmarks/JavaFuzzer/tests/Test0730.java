...
public class Test0730 {
    ...
    static {
        FuzzerUtils.init(Test0730.iArrFld, 0);
    }
    ...
    public static void vMeth1(long l, long l1, int i3) {
        ...
        vMeth2(i3, Test0730.instanceCount, i3);
        iArr1[(i3 >>> 1) % N] -= i3;
        ...
        try {
            i3 = -10;
            iArr1 = new int[i3];
            Test0730.byFld = (byte) f2;
            for (i8 = 10; i8 < 210; i8++) {
                i9 += (-8197 + (i8 * i8));
                i3 &= (int) Test0730.instanceCount;
                l1 = i3;
                switch ((i8 % 4) + 70) {
                    case 70:
                        for (l3 = 1; l3 < 8; ++l3) {
    ...
    public static void vMeth(int i, short s, int i1) {
        ...
        for (f = 15; f < 386; ++f) {
            vMeth1(Test0730.instanceCount, Test0730.instanceCount, i2);
            i1 -= 2225;
            b1 = b1;
            lArr1[(int) (f)] = i1;
    ...
    public void mainTest(String[] strArr1) {
            ...
            switch (((i15 >>> 1) % 2) + 4) {
                case 4:
                    ...
                    for (i16 = 2; i16 < 167; i16++) {
                        ...
                        i15 = s1;
                        Test0730.iArrFld[i16] <<= (int) Test0730.instanceCount;
                        i18 = i15;
                        i19 = 1;
                        while (++i19 < 152) {
                            i18 = i17;
                            fArr[(i17 >>> 1) % N] += Test0730.byFld;
                            i18 = Test0730.byFld;
                        }
                        fFld += Test0730.instanceCount;
                        lArr2[i16 + 1] = Test0730.byFld;
                    }
                    for (d1 = 4; d1 < 167; d1++) {
                        i17 += (int) ((long) d1 | i17);
                        i20 -= i20;
                        i18 += (int) (((d1 * Test0730.byFld) + fFld) - Test0730.byFld);
                    }
                    i21 = 207;
                    do {
                        i20 = -5;
                        Test0730.instanceCount = i21;
                        i20 -= s1;
                        Test0730.byFld >>>= (byte) i18;
                        Test0730.iArrFld[i21] <<= (int) Test0730.instanceCount;
                        Test0730.iArrFld[i21 - 1] = (int) fFld;
                        i18 -= (int) Test0730.instanceCount;
                        fFld += (((i21 * i16) + i15) - Test0730.instanceCount);
                    } while ((i21 -= 3) > 0);
                case 5:
                    i17 = i15;
                    break;
        ...
        FuzzerUtils.out.println("Test0730.instanceCount Test0730.byFld fFld = " + Test0730.instanceCount + "," + Test0730.byFld + "," +
                Float.floatToIntBits(fFld));
        FuzzerUtils.out.println("Test0730.iArrFld = " + FuzzerUtils.checkSum(Test0730.iArrFld));
