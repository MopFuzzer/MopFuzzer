...
public class Test0699 {
    ...
    public static void vMeth2(int i12, long l1, boolean b) {
        ...
        for (f1 = 7; f1 < 181; f1++) {
            i12 *= (int) Test0699.instanceCount;
            switch ((int) (((f1 % 6) * 5) + 14)) {
                ...
                case 26:
                    i13 = i12;
                    i12 -= i12;
                    Test0699.instanceCount += (long) f1;
                    break;
                case 34:
                    for (i14 = 1; i14 < 9; ++i14) {
                        l1 &= i15;
                    ...
                    break;
                case 29:
                    iArr2[(int) (f1 + 1)] /= (int) (Test0699.instanceCount | 1);
                    break;
                case 43:
                    f2 = i13;
                    break;
                case 23:
                    f2 += (((f1 * i12) + i15) - Test0699.instanceCount);
                default:
    ...
    public static void vMeth1(int i8) {
        ...
        for (i9 = 8; i9 < 180; ++i9) {
            i11 = 1;
            while (++i11 < 9) {
                vMeth2(i8, Test0699.instanceCount, b1);
                for (l2 = 1; l2 < 1; l2++) {
                    i10 -= (int) f3;
                    i10 += (int) (l2 * l2);
                    dArr[(int) (l2 + 1)] -= i11;
    ...
    public static void vMeth(int i6, long l, int i7) {
        ...
        for (d1 = 5; d1 < 346; d1++) {
            ...
            for (i19 = 5; i19 > d1; i19--) {
                ...
                i18 += (((i19 * l) + Test0699.instanceCount) - i19);
                l3 = (long) d1;
                Test0699.instanceCount += (((i19 * i18) + i6) - Test0699.instanceCount);
                if (i6 != 0) {
    ...
    public void mainTest(String[] strArr3) {
        ...
        do {
            ...
            for (i3 = 3; i3 < 114; i3++) {
                ...
                i5 = 1;
                do {
                    vMeth(i2, Test0699.instanceCount, -28141);
                    by = (byte) f;
                    lArr2[i5 - 1] = FuzzerUtils.long1array(N, (long) 4L);
                    d2 -= Test0699.instanceCount;
                    i4 += i2;
                    f += (i5 + i2);
                    Test0699.instanceCount = i4;
                    i1 += (i5 | i2);
                } while (++i5 < 2);
            }
            for (i21 = i2; 114 > i21; ++i21) {
                for (i23 = 1; i23 < 1; ++i23) {
                    ...
                    fArr[i21 + 1] -= Test0699.instanceCount;
                    Test0699.instanceCount += (((i23 * f) + i24) - i24);
                    i22 += i23;
                    i4 >>>= (int) 4216326060L;
                }
                lArr2[i21 - 1][i2] -= i1;
                ...
                for (i25 = 1; 1 > i25; i25++) {
                    ...
                    fArr[i21] -= Test0699.instanceCount;
                    i26 = 32322;
                }
                i24 += (((i21 * i22) + i3) - i25);
            }
        ...
        FuzzerUtils.out.println("Test0699.instanceCount = " + Test0699.instanceCount);
