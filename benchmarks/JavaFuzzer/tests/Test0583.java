...
public class Test0583 {
    ...
    static {
        FuzzerUtils.init(Test0583.lArrFld, 1297908862498229807L);
        FuzzerUtils.init(Test0583.lArrFld1, -46720L);
    }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0583.instanceCount = (((-(++Test0583.instanceCount)) * (-i)) * (iMeth(i, i, i) - s1));
        for (long l1 : Test0583.lArrFld1) {
            for (i20 = 2; i20 < 63; i20++) {
                if (Test0583.bFld) {
                    ...
                    Test0583.instanceCount = 19014;
                    i -= (int) dFld;
                } else if (b1) {
                    Test0583.lArrFld[i20 + 1] = FuzzerUtils.long1array(N, (long) 5L);
                    i23 += (i20 * i20);
                    f3 += (((i20 * i20) + i20) - i21);
                    if (false) break;
                } else {
                    i -= by;
                    i21 = (int) f3;
                    Test0583.instanceCount += (long) f3;
                    i = s1;
                }
        ...
        FuzzerUtils.out.println("Test0583.instanceCount dFld Test0583.bFld = " + Test0583.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + (Test0583.bFld ? 1 : 0));
        FuzzerUtils.out.println("lFld Test0583.lArrFld Test0583.lArrFld1 = " + lFld + "," + FuzzerUtils.checkSum(Test0583.lArrFld)
                + "," + FuzzerUtils.checkSum(Test0583.lArrFld1));
