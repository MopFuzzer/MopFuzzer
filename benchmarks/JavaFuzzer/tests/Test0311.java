...
public class Test0311 {
    ...
    static {
        FuzzerUtils.init(Test0311.iArrFld, -236);
        FuzzerUtils.init(Test0311.lArrFld, -131L);
    }
    ...
    public static void vMeth1(int i8, int i9, int i10) {
        ...
        i13 = 1;
        do {
            Test0311.iArrFld[i13 - 1][i13] *= i9;
            Test0311.instanceCount -= Test0311.instanceCount;
            d -= i10;
            Test0311.iFld += (((i13 * Test0311.instanceCount) + i10) - Test0311.instanceCount);
            Test0311.lArrFld[i13 - 1] <<= 6;
        } while (++i13 < 322);
    ...
    public static void vMeth() {
        ...
        do {
            i4 += (123 + (i3 * i3));
            for (i5 = 1; i5 < 7; ++i5) {
                i6 = (int) (Test0311.instanceCount++);
                i7 = 1;
                while (++i7 < 2) {
                    Test0311.instanceCount += (i7 ^ Test0311.instanceCount);
                    f2 *= (Test0311.instanceCount++);
                    Test0311.instanceCount += (((i7 * i7) + Test0311.iFld) - f2);
                    Test0311.iArrFld = (Test0311.iArrFld = (Test0311.iArrFld = (Test0311.iArrFld = Test0311.iArrFld)));
                    b = b;
                    vMeth1(i7, i3, i4);
                    f2 = f2;
                    try {
                        i6 = (-1292364167 / i3);
                        i6 = (11 / i7);
                        i4 = (Test0311.iArrFld[i5][i5] % Test0311.iFld);
                    } catch (ArithmeticException a_e) {
                    }
                    i4 >>= i5;
                }
                Test0311.iArrFld[i3 - 1][i5] -= (int) 1.107800;
            }
        } while (++i3 < 226);
    ...
    public static int iMeth(int i2) {
        ...
        vMeth();
        Test0311.instanceCount -= Test0311.iFld;
        for (i14 = 3; i14 < 208; ++i14) {
            Test0311.iArrFld[i14][i14 + 1] >>= -66;
            for (i16 = 1; 8 > i16; ++i16) {
                d1 /= (i14 | 1);
                Test0311.instanceCount = 167;
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (f = 6; f < 158; f++) {
            ...
            do {
                ...
                by %= (byte) (((long) (f1 * iMeth(Test0311.iFld))) | 1);
                Test0311.instanceCount += (((i1 * f1) + Test0311.iFld) - Test0311.iFld);
                Test0311.instanceCount -= (long) f1;
                i = i;
                Test0311.lArrFld[i1] = Test0311.instanceCount;
                Test0311.iFld += (((i1 * Test0311.iFld) + i1) - f1);
                i += i1;
                Test0311.iFld >>= Test0311.iFld;
                i += (int) Test0311.instanceCount;
            } while (++i1 < 165);
            i += (int) f;
            Test0311.instanceCount += Test0311.instanceCount;
            ...
            do {
                i /= (int) (i1 | 1);
                dArr[(int) (f - 1)] *= Test0311.instanceCount;
            } while (++i18 < 165);
        ...
        FuzzerUtils.out.println("Test0311.instanceCount Test0311.iFld Test0311.sFld = " + Test0311.instanceCount + "," + Test0311.iFld +
                "," + Test0311.sFld);
        FuzzerUtils.out.println("Test0311.iArrFld Test0311.lArrFld = " + FuzzerUtils.checkSum(Test0311.iArrFld) + "," +
                FuzzerUtils.checkSum(Test0311.lArrFld));
