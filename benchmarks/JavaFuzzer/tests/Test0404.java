...
public class Test0404 {
    ...
    public static void vMeth2(int i10, float f, int i11) {
        ...
        while (++i12 < 193) {
            i11 += (i12 * i12);
            iArr[i12 + 1] *= (int) Test0404.instanceCount;
            i10 += (i12 * i12);
            d *= i11;
            for (f1 = 1; f1 < 8; f1 += 3) {
                i13 += (int) (((f1 * i13) + i10) - Test0404.instanceCount);
                i11 += (int) f1;
            }
            i11 += (int) Test0404.instanceCount;
            for (i14 = 1; 8 > i14; i14++) {
                i10 -= (int) f;
                Test0404.instanceCount /= (i12 | 1);
                Test0404.instanceCount = -15223;
                d = i14;
                bArr = bArr;
            }
        }
    ...
    public static void vMeth1(int i4, int i5) {
        ...
        for (i6 = 2; i6 < 178; i6++) {
            for (i8 = i6; i8 < 9; ++i8) {
                ...
                Test0404.instanceCount += (((i8 * Test0404.instanceCount) + i16) - i6);
                iArr1[i6 + 1] -= i4;
            }
            iArr1[i6 - 1] *= 3;
            try {
                        ...
                        while (++i20 < 1) {
                            ...
                            switch (((i18 % 6) * 5) + 33) {
                                ...
                                case 37:
                                    ...
                                    break;
                                case 43:
                                    Test0404.instanceCount += (-76 + (i20 * i20));
                                    break;
                                case 40:
                                    iArr2[i18 + 1] *= s;
                                    break;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i22 = 22; i22 < 390; ++i22) {
            ...
            do {
                i23 -= i24;
                by1 -= (byte) Test0404.instanceCount;
            } while (++i24 < 68);
            for (i25 = 4; i25 < 68; i25++) {
                for (i27 = 1; i27 < 2; i27++) {
                    ...
                    if (b1) {
                        ...
                        switch ((i27 % 2) + 99) {
                            case 99:
                                Test0404.instanceCount += (i27 - i27);
                                i21 += i27;
                                i26 = i27;
                                fArr[i27 - 1] = 77;
                                break;
                            case 100:
                                Test0404.instanceCount &= i27;
                                i23 |= by1;
                                iArr3[i25 + 1] += i27;
                            default:
                                i21 += (i27 + i22);
        ...
        FuzzerUtils.out.println("Test0404.instanceCount = " + Test0404.instanceCount);
