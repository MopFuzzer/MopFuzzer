...
public class Test0176 {
    ...
    public static byte byMeth(long l2, short s1, int i6) {
        ...
        l2 >>= (((90 * (i6 & i6)) + iMeth(i6, Test0176.fFld, i6)) * i6);
        Test0176.instanceCount = 43350;
        i6 = (int) Test0176.instanceCount;
        for (i16 = 6; i16 < 320; i16++) {
            switch (((i6 >>> 1) % 1) + 24) {
                case 24:
                    iArr2[i16] = (int) Test0176.instanceCount;
                    for (i18 = 1; i18 < 5; i18++) {
                        for (i20 = 1; i20 < 2; ++i20) {
                            try {
                                i21 = (i16 % i21);
                            ...
                            Test0176.byFld <<= (byte) 5;
                            Test0176.instanceCount *= i6;
                            Test0176.byFld = (byte) i16;
                            l2 *= i18;
                            Test0176.byFld = (byte) -79;
                        }
                        l2 = (long) Test0176.fFld;
                    }
            }
        }
    ...
    public static long lMeth(long l1, float f) {
        ...
        for (int i4 : iArr) {
            int i5 = 137;
            Test0176.instanceCount += (long) ((f--) * ((i3 - by) / ((-(-1477 / ((i3 + i3) | 1))) | 1)));
            i4 >>>= (int) l1;
            i3 = i5;
            i3 = ((++i5) - (-(-(i4++))));
            i3 = (int) ((iArr[(i3 >>> 1) % N] * byMeth(l1, (short) (6508), -165)) - Test0176.instanceCount);
            iArr[(i3 >>> 1) % N] = -6997;
            for (i22 = 1; 4 > i22; i22++) {
    ...
    public void mainTest(String[] strArr3) {
        ...
        do {
            l = 1;
            while (++l < 99) {
                Test0176.instanceCount = lMeth(l, Test0176.fFld);
            }
            ...
            for (i30 = 4; i30 < 99; ++i30) {
                iArr3[i30 + 1] <<= i;
                iArr3[i2] += i;
                Test0176.instanceCount = Test0176.byFld;
                s2 = (short) i31;
                fArr[i30 - 1] = i28;
                Test0176.fFld -= Test0176.byFld;
                i29 = s2;
                for (i32 = 1; 2 > i32; i32++) {
                    dArrFld[i2 + 1][i32] = d1;
                    s2 >>= (short) i31;
        ...
        FuzzerUtils.out.println("Test0176.instanceCount Test0176.fFld Test0176.byFld = " + Test0176.instanceCount + "," +
                Float.floatToIntBits(Test0176.fFld) + "," + Test0176.byFld);
