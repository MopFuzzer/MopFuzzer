...
public class Test0657 {
    ...
    public static void vMeth(int i) {
        ...
        vMeth1(sMeth(180, Test0657.instanceCount, 3087), Test0657.byFld, i);
        i %= (int) (i | 1);
        Test0657.instanceCount *= Test0657.instanceCount;
        vMeth_check_sum += i;
    }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0657.instanceCount *= (long) dFld;
        vMeth(i10);
        i10 -= Test0657.byFld;
        iArr2[(-5 >>> 1) % N] = 2;
        Test0657.fFld *= Test0657.instanceCount;
        switch ((((i10 >>> 1) % 6) * 5) + 118) {
            case 131:
                for (i11 = 7; i11 < 161; i11++) {
                    iArr2[i11] /= (int) 10.943F;
                    i12 += (((i11 * Test0657.byFld) + i12) - Test0657.fFld);
                    i13 = 1;
                    while (++i13 < 163) {
                        iArrFld = iArrFld;
                        Test0657.byFld = (byte) i11;
                        Test0657.fFld /= (Test0657.byFld | 1);
                    }
                ...
                if (true) {
                    for (i16 = 14; i16 < 308; ++i16) {
                        i10 = i16;
                        i15 -= (int) Test0657.fFld;
                        for (i18 = 3; i18 < 86; i18++) {
                            for (i20 = i16; i20 < 2; i20++) {
                                Test0657.instanceCount = i21;
                                Test0657.fFld -= i11;
                                i21 <<= (int) Test0657.instanceCount;
                                i12 = (int) 8540270465834237928L;
                            }
                        }
                    }
                } else {
                    i15 &= (int) Test0657.instanceCount;
                }
                break;
            case 120:
        ...
        FuzzerUtils.out.println("Test0657.instanceCount dFld Test0657.byFld = " + Test0657.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + Test0657.byFld);
        FuzzerUtils.out.println("Test0657.fFld sFld iArrFld = " + Float.floatToIntBits(Test0657.fFld) + "," + sFld + "," +
