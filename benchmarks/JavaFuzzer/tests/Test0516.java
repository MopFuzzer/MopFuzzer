...
public class Test0516 {
    ...
    static {
        FuzzerUtils.init(Test0516.iArrFld, 28767);
        FuzzerUtils.init(Test0516.byArrFld, (byte) -83);
    }
    ...
    public static short sMeth(int i5) {
        ...
        Test0516.iArrFld[(-37254 >>> 1) % N] = Test0516.byArrFld[(i5 >>> 1) % N];
        for (i6 = 1; 142 > i6; ++i6) {
            switch ((i6 % 7) + 27) {
                case 27:
                    vMeth();
                    i5 += (int) d;
                    i5 *= i7;
                    i7 += (((i6 * Test0516.instanceCount) + i6) - i7);
                    break;
                case 28:
                    Test0516.instanceCount -= (long) d;
                    break;
                case 29:
                    Test0516.instanceCount *= Test0516.instanceCount;
                    i5 += (i6 ^ i7);
                    Test0516.instanceCount *= i5;
                    break;
                case 30:
                    for (i15 = 1; i15 < 11; ++i15) {
                        Test0516.iArrFld[i15 - 1] |= i15;
                        i16 += (int) Test0516.instanceCount;
                        i16 *= i5;
                    }
                    break;
                case 31:
    ...
    public static int iMeth(int i1, int i2, long l) {
        ...
        for (i3 = 4; i3 < 365; ++i3) {
            Test0516.instanceCount = sMeth(i1);
            for (i17 = 1; i17 < 5; ++i17) {
                by1 <<= (byte) i1;
                i2 = i18;
    ...
    public void mainTest(String[] strArr1) {
        ...
        FuzzerUtils.out.println("Test0516.instanceCount Test0516.bFld Test0516.dFld = " + Test0516.instanceCount + "," + (Test0516.bFld ? 1
                : 0) + "," + Double.doubleToLongBits(Test0516.dFld));
        FuzzerUtils.out.println("Test0516.iArrFld Test0516.byArrFld = " + FuzzerUtils.checkSum(Test0516.iArrFld) + "," +
