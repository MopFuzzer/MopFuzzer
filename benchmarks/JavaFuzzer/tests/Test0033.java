...
public class Test0033 {
    ...
    static {
        FuzzerUtils.init(Test0033.iArrFld, -11);
    }
        ...
        do {
            ...
            for (i14 = 1; 5 > i14; ++i14) {
                ...
                for (i16 = 2; i16 > 1; --i16) {
                    ...
                    iArr[i14 + 1] >>= i14;
                    i15 += (i16 ^ i17);
                    l1 = Test0033.instanceCount;
                    i15 >>= i15;
                    Test0033.instanceCount += i16;
                }
            }
        } while (--d1 > 0);
    ...
    public static long lMeth(int i3, int i4, int i5) {
        ...
        for (i6 = 12; i6 < 207; i6++) {
            for (i8 = 1; i8 < 8; ++i8) {
                Test0033.instanceCount >>= (i4 ^= 1);
                for (i10 = 2; i10 > 1; i10 -= 2) {
                    b = ((--i9) != i9);
                    Test0033.instanceCount = (long) (((d - i8) - (-(i7 - -3971))) + ((225 + (Test0033.instanceCount++)) - (d -
                            i9)));
                    i9 += (i10 + Test0033.instanceCount);
                    i5 += (((i10 * by) + i11) - i4);
                    Test0033.instanceCount += ((iMeth(f2, i7, Test0033.instanceCount) - Test0033.instanceCount) % (i5 | 1));
                    Test0033.iArrFld[i6] = 3;
                }
                Test0033.instanceCount += (((i8 * i11) + Test0033.instanceCount) - i6);
                Test0033.instanceCount += i8;
                if (i10 != 0) {
                }
                i9 = by;
                i3 += (int) 3719027408L;
    ...
    public void vMeth(long l, int i2) {
        ...
        f -= (-((Test0033.instanceCount - i2) - lMeth(i2, i2, i2)));
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 2; i < 224; ++i) {
            vMeth(Test0033.instanceCount, i);
            for (f3 = 2; f3 < 113; f3++) {
                i18 += (int) (f3 + i1);
                i1 += -65;
                i18 -= i1;
                Test0033.instanceCount = i;
            }
        }
        for (i19 = 12; i19 < 192; i19++) {
            Test0033.iArrFld[i19] += i;
            for (i21 = 5; i21 < 139; i21++) {
                if (Test0033.bFld) continue;
                byArr = byArr;
                for (i23 = 1; i23 < 2; ++i23) {
                    d2 -= 6;
                    Test0033.instanceCount += (-22 + (i23 * i23));
                }
                Test0033.iArrFld[i21 + 1] |= 42;
            }
            i25 = 1;
            while (++i25 < 139) {
                Test0033.instanceCount >>= i23;
                Test0033.instanceCount += (1 + (i25 * i25));
            }
            for (i26 = 139; 8 < i26; --i26) {
                ...
                for (i28 = 2; 1 < i28; --i28) {
                    sArr[i28] += (short) Test0033.instanceCount;
                    i27 = i1;
                    Test0033.instanceCount = i24;
                }
                i22 = i29;
            }
            i20 -= i21;
        ...
        FuzzerUtils.out.println("Test0033.instanceCount Test0033.bFld byFld = " + Test0033.instanceCount + "," + (Test0033.bFld ? 1 :
                0) + "," + byFld);
        FuzzerUtils.out.println("Test0033.iArrFld = " + FuzzerUtils.checkSum(Test0033.iArrFld));
