    ...
    public static void vMeth2(long l, float f2, int i9) {
        ...
        for (i12 = 5; i12 < 245; i12++) {
            for (i14 = 1; 7 > i14; i14++) {
                i15 *= (int) 1.498F;
                i9 += (i14 - i15);
                i15 = (int) Test0458.instanceCount;
            }
            f2 = i14;
            for (i16 = 1; 7 > i16; i16++) {
                byte by1 = -3;
                i15 -= i15;
                s1 += (short) (((i16 * f2) + i17) - Test0458.instanceCount);
                if (i13 != 0) {
    ...
    public void vMeth() {
        ...
        for (i3 = 3; i3 < 122; i3++) {
            ...
            do {
                ...
                iArrFld[i3 + 1] += (int) (((i3 * i5) * (Test0458.instanceCount--)) | (long) (d - (i5 * i4)));
                i4 += (i5 | i4);
                for (i6 = 1; i6 < 3; i6++) {
                    switch ((((i6 * i4) >>> 1) % 6) + 100) {
                        ...
                        case 101:
                            ...
                            i4 += (((i6 * i5) + by) - Test0458.instanceCount);
                            break;
                        case 102:
                            vMeth1(f, i3);
                            d = Test0458.instanceCount;
                            break;
                        case 103:
                            i4 += i6;
                        case 104:
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i1 = 278; i1 > 13; --i1) {
            switch ((i1 % 9) + 54) {
                case 54:
                case 55:
                    i2 += (((i1 * Test0458.instanceCount) + Test0458.instanceCount) - s);
                    vMeth();
                    break;
                case 56:
                    if (Test0458.bFld) {
        ...
        FuzzerUtils.out.println("Test0458.instanceCount sFld Test0458.bFld = " + Test0458.instanceCount + "," + sFld + "," +
                (Test0458.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0458.dFld iArrFld byArrFld = " + Double.doubleToLongBits(Test0458.dFld) + "," +
