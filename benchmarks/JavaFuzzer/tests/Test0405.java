...
public class Test0405 {
    ...
    static {
        FuzzerUtils.init(Test0405.iArrFld, -186);
    }
    ...
    public static void vMeth2(long l1) {
        ...
        for (d1 = 1; d1 < 147; ++d1) {
            ...
            do {
                l1 -= i2;
                l1 = Test0405.instanceCount;
                l1 = 0;
            } while (++i3 < 11);
        }
        for (i4 = 2; 288 > i4; ++i4) {
            Test0405.instanceCount *= i3;
            i2 += (((i4 * Test0405.instanceCount) + i4) - Test0405.instanceCount);
        }
        i5 = i3;
        for (i6 = 4; i6 < 283; ++i6) {
            try {
    ...
    public static void vMeth1(float f1) {
        ...
        for (int i1 : Test0405.iArrFld) {
            Test0405.instanceCount -= (i1 + (i1 * (i1 = (int) Test0405.instanceCount)));
        }
        vMeth2(Test0405.instanceCount);
        i9 = 1;
        while (++i9 < 149) {
            i10 = 1;
            while (++i10 < 11) {
                ...
                switch (((i10 % 10) * 5) + 118) {
                    ...
                    case 145:
                    case 125:
                        Test0405.iArrFld[i10 + 1] += (int) Test0405.instanceCount;
                        break;
                    case 131:
                        Test0405.instanceCount = -132L;
                        break;
                    case 134:
                    case 159:
                        if (false) continue;
    ...
    public void vMeth() {
        ...
        Test0405.instanceCount -= (long) fArrFld[(-32837 >>> 1) % N];
        vMeth1(f2);
    ...
    public void mainTest(String[] strArr1) {
        ...
        if (bFld) {
            for (l = 256; 7 < l; l--) {
                bArr[(int) (l - 1)] = (((++iArr[(int) (l + 1)]) * (Test0405.instanceCount - i)) > ((l - i) *
                        (Test0405.instanceCount++)));
            }
        } else if (i > i) {
            f *= (i + ((--i) - (Test0405.instanceCount + i)));
            i = (int) (i = (int) (i += (int) (-(i + d))));
        } else {
            vMeth();
            for (i19 = 4; i19 < 127; ++i19) {
                for (i21 = 2; i21 < 204; i21++) {
                    i20 -= (int) Test0405.instanceCount;
                    if (true) break;
                    for (i23 = 1; i23 < 2; ++i23) {
                        i20 -= (int) l;
                        if (false) break;
                        i24 += (((i23 * f) + i24) - i);
                        Test0405.sFld >>>= (short) -9;
                        bFld = false;
                        Test0405.sFld *= (short) i19;
                        i22 = (int) Test0405.instanceCount;
                        i -= 86;
                        i = i24;
                    }
                }
        ...
        FuzzerUtils.out.println("Test0405.instanceCount bFld Test0405.dFld = " + Test0405.instanceCount + "," + (bFld ? 1 : 0) +
                "," + Double.doubleToLongBits(Test0405.dFld));
        FuzzerUtils.out.println("Test0405.sFld byFld fArrFld = " + Test0405.sFld + "," + byFld + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(fArrFld)));
        FuzzerUtils.out.println("Test0405.iArrFld dArrFld = " + FuzzerUtils.checkSum(Test0405.iArrFld) + "," +
