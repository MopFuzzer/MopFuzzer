...
public class Test0229 {
    ...
    static {
        FuzzerUtils.init(Test0229.iArrFld, 89);
    }
    ...
    public static float fMeth(int i2) {
        ...
        while (++i3 < 179) {
            i4 = 1;
            while ((i4 += 3) < 9) {
                Test0229.instanceCount = i4;
                i2 -= -73;
                s = (short) i3;
                Test0229.instanceCount = 15499;
                i2 = -11;
                Test0229.iArrFld[i3] &= i4;
            }
            if (i4 != 0) {
            }
        }
        ...
        for (l2 = 7; l2 < 148; l2++) {
            ...
            try {
                i7 = (-231 / i4);
                i7 = (Test0229.iArrFld[(int) (l2 - 1)] / Test0229.iArrFld[(int) (l2 + 1)]);
                i5 = (-239 / i2);
    ...
    public int iMeth(byte by, long l, int i1) {
        ...
        if (bFld) {
            ...
            for (d1 = 12; 237 > d1; ++d1) {
                Test0229.instanceCount >>>= i1;
                l -= (long) fFld;
            }
            Test0229.iArrFld[(iFld >>> 1) % N] = (int) l;
        } else {
            Test0229.iArrFld[(-118 >>> 1) % N] = i1;
        }
        Test0229.iArrFld[(i10 >>> 1) % N] += iFld;
        bFld = bFld;
        for (long l4 : lArr) {
            iFld = (int) l4;
            if (i1 != 0) {
            ...
            fFld = i1;
            Test0229.iArrFld[(i10 >>> 1) % N] = i1;
        }
        Test0229.iArrFld[(i10 >>> 1) % N] = (int) Test0229.instanceCount;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0229.iArrFld[(i >>> 1) % N] &= iMeth(byFld, Test0229.instanceCount, iFld);
        fFld -= 3L;
        l5 = 1;
        while (++l5 < 374) {
            for (i11 = 2; i11 < 67; ++i11) {
                Test0229.iArrFld[(int) (l5)] = (int) -105.52277;
                fFld *= i;
                switch (((i11 % 6) * 5) + 120) {
                    case 146:
                        switch ((int) (((l5 % 4) * 5) + 100)) {
                            ...
                            case 114:
                                ...
                                for (i13 = i11; i13 < 2; ++i13) {
                                    Test0229.iArrFld[(int) (l5 - 1)] = iFld;
                                    Test0229.iArrFld[i13] = i14;
                                    if (bFld) {
                                        i *= i14;
                                    } else if (bFld) {
                                        if (bFld) break;
                                    ...
                                    i14 += (int) fFld;
                                    iFld = i11;
                                    Test0229.iArrFld[(int) (l5 - 1)] >>>= i14;
                                    sArr[i11] <<= (short) i14;
                                    fArr1[i11] += i12;
                                    Test0229.iArrFld[(int) (l5 - 1)] *= -125;
                                }
                                break;
                            case 116:
                                for (i15 = 1; i15 < 2; i15++) {
                                    dArr[i11] -= iFld;
                                    Test0229.instanceCount += (i15 + byFld);
                                    if (false) break;
                                    if (bFld) continue;
                                    s1 *= (short) -4;
                                }
                                break;
                            case 117:
                                Test0229.instanceCount += (i11 + i11);
                                break;
                            default:
                                lArr1[i11 - 1] |= i;
                        }
                        break;
                    case 126:
                        s1 += (short) (((i11 * Test0229.instanceCount) + Test0229.instanceCount) - i14);
                    case 128:
                        i -= (int) l5;
                        break;
                    case 141:
                        ...
                        break;
                    case 127:
                        Test0229.instanceCount += (i11 | i13);
                        break;
                    case 124:
                        Test0229.instanceCount *= i11;
                    default:
                        i12 /= -23752;
                }
            }
        ...
        FuzzerUtils.out.println("Test0229.instanceCount iFld fFld = " + Test0229.instanceCount + "," + iFld + "," +
                Float.floatToIntBits(fFld));
        FuzzerUtils.out.println("byFld bFld Test0229.iArrFld = " + byFld + "," + (bFld ? 1 : 0) + "," +
                FuzzerUtils.checkSum(Test0229.iArrFld));
