...
public class Test0483 {
    ...
    static {
        FuzzerUtils.init(Test0483.iArrFld, -10);
    }
    ...
    public static int iMeth1() {
        ...
        for (i11 = 15; i11 < 283; i11++) {
            ...
            if (Test0483.bFld) {
                iArr1 = iArr1;
            } else if (Test0483.bFld) {
                for (i13 = 1; 6 > i13; ++i13) {
                    i12 = i11;
                    Test0483.instanceCount |= i12;
                    Test0483.instanceCount >>= i14;
                }
                for (i15 = 1; i15 < 6; i15++) {
                    i14 *= (int) Test0483.instanceCount;
                    f *= Test0483.instanceCount;
                }
                if (Test0483.bFld) {
                    iArr1[i11 + 1] *= (int) Test0483.instanceCount;
                    i16 -= -180;
                } else {
                    Test0483.instanceCount = i15;
                }
            } else if (Test0483.bFld) {
                iArr1[i11 - 1] ^= i17;
            }
        ...
        for (i5 = 14; i5 < 236; ++i5) {
            for (i7 = 1; i7 < 7; i7++) {
                for (i9 = 1; i9 < 2; i9++) {
                    ...
                    i3 += (((i9 * i6) + Test0483.instanceCount) - i6);
                    i3 += iMeth1();
                    i4 -= i18;
                }
                i18 *= i18;
                for (i19 = i5; 2 > i19; ++i19) {
                    i21 += (int) Test0483.fFld1;
                    d = i3;
                    i2 = -42117;
    ...
    public int iMeth(int i1) {
        ...
        i1 -= Math.max((int) ((i1 * fFld) * (Test0483.instanceCount + sFld)), (-(iArr[(i1 >>> 1) % N] += i1)) - i1);
        vMeth(i1, i1, i1);
        i22 = 384;
        while ((i22 -= 3) > 0) {
            by1 -= (byte) Test0483.instanceCount;
            ...
            do {
                ...
                switch (((i22 >>> 1) % 2) + 80) {
                    case 80:
                        i1 *= i1;
                        iArr[i22] *= 3;
                        i1 %= (int) (Test0483.instanceCount | 1);
                        break;
                    case 81:
                        i1 *= i23;
                        break;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (l = 5; 328 > l; ++l) {
            for (i25 = 2; 78 > i25; ++i25) {
                f1 = 1;
                do {
                    byFld += (byte) (((f1 * f1) + i24) - Test0483.instanceCount);
                    d2 += i25;
                    i = (int) l;
                    Test0483.instanceCount += (long) (f1 * f1);
                    iArr2[(int) (f1 - 1)] <<= i25;
                } while (++f1 < 2);
                i -= i;
            }
            i24 *= i;
            Test0483.instanceCount -= i25;
            i26 = (int) d2;
            i26 *= (int) l1;
        }
        for (i27 = 4; 321 > i27; i27++) {
            switch ((i27 % 9) + 21) {
                case 21:
                    ...
                    while (++i29 < 79) {
                        ...
                        for (i32 = i29; i32 < 1; ++i32) {
                            i28 = (int) Test0483.fFld1;
                            iArr2[i27 + 1] += (int) l1;
                            i33 -= (int) -8716308946542700246L;
                            i33 >>>= i28;
                            i24 = i25;
                            Test0483.fFld1 -= (float) d2;
                            Test0483.iArrFld = FuzzerUtils.int2array(N, (int) 6170);
                        }
                ...
                case 23:
                    ...
                    break;
                case 24:
                    bArrFld[i27 + 1] = Test0483.bFld;
                    break;
                case 25:
                    Test0483.instanceCount += i27;
                    break;
                case 26:
                    i28 += -42375;
                    break;
                ...
                case 29:
                    ...
                    break;
                default:
                    i31 += (i27 | Test0483.instanceCount);
            }
        }
        ...
        FuzzerUtils.out.println("Test0483.instanceCount fFld sFld = " + Test0483.instanceCount + "," +
                Float.floatToIntBits(fFld) + "," + sFld);
        FuzzerUtils.out.println("Test0483.bFld Test0483.fFld1 Test0483.fFld2 = " + (Test0483.bFld ? 1 : 0) + "," +
                Float.floatToIntBits(Test0483.fFld1) + "," + Float.floatToIntBits(Test0483.fFld2));
        FuzzerUtils.out.println("byFld Test0483.iArrFld bArrFld = " + byFld + "," + FuzzerUtils.checkSum(Test0483.iArrFld) +
