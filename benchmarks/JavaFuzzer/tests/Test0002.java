...
public class Test0002 {
    ...
    static {
        FuzzerUtils.init(Test0002.iArrFld, -11);
        FuzzerUtils.init(Test0002.dArrFld, -110.78501);
    }
    ...
    public static void vMeth2(int i5, int i6, short s) {
        ...
        for (i7 = 2; i7 < 148; ++i7) {
            ...
            lArr2 = lArr2;
            for (i9 = i7; 11 > i9; ++i9) {
                Test0002.iArrFld[i7 + 1] *= -226;
                lArr2[i7] = i6;
                Test0002.bFld = Test0002.bFld;
                Test0002.iArrFld[i7] = i9;
                i8 += (((i9 * i9) + i9) - i10);
                if (true) break;
                f1 += i8;
                for (d = 1; d < 1; d++) {
                    if (Test0002.bFld) continue;
                    Test0002.instanceCount += (long) d;
    ...
    public static void vMeth1() {
        ...
        for (i3 = 6; i3 < 316; i3++) {
            ...
            Test0002.iArrFld[i3] &= Math.min((int) ((Test0002.dFld - 20617) + Test0002.iArrFld[i3 + 1]), (i4--) + Test0002.iArrFld[i3 +
                    1]);
            Test0002.iArrFld[i3] = (int) ((i4 * l) + (lArr1[i3]--));
            vMeth2(16, i3, s1);
            l -= i4;
            l -= i3;
            d1 = 5;
            while ((d1 -= 3) > 0) {
                ...
                if (Test0002.bFld) {
                    ...
                    try {
                        i13 = (39924 % Test0002.iArrFld[(int) (d1 + 1)]);
                        i13 = (i3 % 1526949938);
                        i13 = (i3 % i13);
    ...
    public void vMeth(int i, int i1, int i2) {
        ...
        vMeth1();
        Test0002.dFld = -10;
        Test0002.iArrFld[(i1 >>> 1) % N] *= 27021;
        i2 = (int) 146L;
        i2 -= i1;
        for (i14 = 12; i14 < 216; ++i14) {
            dFld1 = 0.79964;
            Test0002.instanceCount &= iFld;
            if (i2 != 0) {
            ...
            while (++i16 < 8) {
                for (i17 = 1; 1 > i17; ++i17) {
                    Test0002.instanceCount += (i17 ^ i);
                    f2 -= sFld;
                    Test0002.dArrFld[i17] = i17;
                }
            }
        }
        vMeth_check_sum += i + i1 + i2 + i14 + i15 + Float.floatToIntBits(f2) + i16 + i17 + i18;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0002.instanceCount -= ((Test0002.instanceCount - (--Test0002.instanceCount)) + (sFld - (iFld * iFld)));
        fArr[(-153 >>> 1) % N] = iFld;
        lArr[(-11 >>> 1) % N] += Test0002.iArrFld[(iFld >>> 1) % N];
        vMeth(13, iFld, iFld);
        d2 = 1;
        while (++d2 < 125) {
            iFld -= iFld;
        ...
        switch ((((i19 >>> 1) % 8) * 5) + 73) {
            case 93:
                ...
                for (i21 = 10; 160 > i21; i21++) {
                    Test0002.iArrFld[i21 - 1] = i22;
                    i22 <<= (int) Test0002.instanceCount;
                    iFld += (-66 + (i21 * i21));
                    i22 += iFld;
                    if (true) continue;
                    l1 = 1;
                    do {
                        int i23 = -161;
                        Test0002.iArrFld[i21] = i23;
                        Test0002.instanceCount *= (long) f3;
                    } while (++l1 < 167);
                    i22 >>= (int) l2;
                    l2 = 13;
                    fArr[i21 - 1] /= (i21 | 1);
                ...
                switch (((i19 >>> 1) % 2) + 1) {
                    case 1:
                        i24 = 302;
                        while (--i24 > 0) {
                            f3 += (((i24 * i22) + i21) - Test0002.instanceCount);
                            f3 *= Test0002.instanceCount;
                        }
                        i22 -= i22;
                        Test0002.dArrFld[(i19 >>> 1) % N] += i19;
                        break;
                    case 2:
                        i20 += iFld;
                        break;
        ...
        FuzzerUtils.out.println("Test0002.instanceCount sFld iFld = " + Test0002.instanceCount + "," + sFld + "," + iFld);
        FuzzerUtils.out.println("Test0002.bFld Test0002.dFld dFld1 = " + (Test0002.bFld ? 1 : 0) + "," +
                Double.doubleToLongBits(Test0002.dFld) + "," + Double.doubleToLongBits(dFld1));
        FuzzerUtils.out.println("Test0002.iArrFld Test0002.dArrFld = " + FuzzerUtils.checkSum(Test0002.iArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0002.dArrFld)));
