...
public class Test0486 {
    ...
    static {
        FuzzerUtils.init(Test0486.sArrFld, (short) -29742);
        FuzzerUtils.init(Test0486.lArrFld, -3512689331150801882L);
        FuzzerUtils.init(Test0486.byArrFld, (byte) 36);
        FuzzerUtils.init(Test0486.iArrFld, 203);
    }
    ...
    public static float fMeth(int i9) {
        ...
        for (d = 297; d > 7; --d) {
            ...
            do {
                ...
                if (Test0486.bFld) {
                    i9 <<= i11;
                    iArr2[(int) (d)] ^= (int) Test0486.instanceCount;
                    for (i12 = i11; i12 < 1; ++i12) {
                        ...
                        if (Test0486.bFld) {
                            ...
                            i9 += i12;
                            lArr1[i11 + 1] = (long) f2;
                        } else if (Test0486.bFld) {
                            i9 *= (int) Test0486.instanceCount;
                        } else if (false) {
                            iArr2[(int) (d)] *= i13;
                        } else {
                            i13 /= (int) (i11 | 1);
    ...
    public static boolean bMeth(long l1) {
        ...
        for (i5 = 11; i5 < 229; i5++) {
            for (i7 = 1; i7 < 7; i7++) {
                iArr1[i7 - 1] = (int) (Math.abs(fMeth(i6)) - Test0486.sFld);
                iArr1[i5] += (int) f3;
                switch (((i5 % 8) * 5) + 123) {
                    case 162:
                        i6 += i8;
                        ...
                        break;
                    case 125:
                        Test0486.lArrFld[i5 - 1] += l1;
                        break;
                    case 151:
                        i8 -= (int) 3774790178L;
                        i6 -= (int) f3;
                        Test0486.instanceCount %= (i6 | 1);
                        l1 = by1;
                        break;
                    case 160:
                        Test0486.lArrFld[i7 - 1] = 3;
                        break;
                    case 143:
                        Test0486.lArrFld[i5] <<= i7;
                        i8 += (i7 - i6);
                        break;
                    case 134:
                        i8 *= i7;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0486.sArrFld[(i >>> 1) % N] >>= (short) (s - (i = (i - i)));
        vMeth(Test0486.instanceCount, false);
        for (f4 = 175; f4 > 1; f4--) {
            i15 = 1;
            do {
                i16 = 1;
            ...
            Test0486.instanceCount <<= -1682;
            f5 = (float) -89.24188;
            i += i14;
            i14 = (int) dFld;
        }
        i = i;
        Test0486.instanceCount += (long) dFld;
        for (i17 = 3; i17 < 150; ++i17) {
            f5 += i14;
            i14 >>= i15;
            i19 = 1;
            while (++i19 < 171) {
                Test0486.byArrFld[i19][i17] *= (byte) i17;
                by2 += (byte) -5;
                dFld /= (i14 | 1);
                Test0486.iArrFld = Test0486.iArrFld;
            }
            Test0486.instanceCount = (long) dFld;
            i = i18;
            Test0486.bFld = Test0486.bFld;
            dArr[i17 - 1] *= Test0486.fFld;
            i14 = (int) Test0486.instanceCount;
        ...
        FuzzerUtils.out.println("Test0486.instanceCount Test0486.bFld Test0486.sFld = " + Test0486.instanceCount + "," + (Test0486.bFld ? 1
                : 0) + "," + Test0486.sFld);
        FuzzerUtils.out.println("dFld Test0486.fFld Test0486.sArrFld = " + Double.doubleToLongBits(dFld) + "," +
                Float.floatToIntBits(Test0486.fFld) + "," + FuzzerUtils.checkSum(Test0486.sArrFld));
        FuzzerUtils.out.println("Test0486.lArrFld Test0486.byArrFld Test0486.iArrFld = " + FuzzerUtils.checkSum(Test0486.lArrFld) + ","
                + FuzzerUtils.checkSum(Test0486.byArrFld) + "," + FuzzerUtils.checkSum(Test0486.iArrFld));
