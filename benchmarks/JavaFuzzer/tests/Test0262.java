...
public class Test0262 {
    ...
    static {
        FuzzerUtils.init(Test0262.iArrFld, 41405);
        FuzzerUtils.init(Test0262.fArrFld, 46.207F);
    }
        ...
        for (i4 = 7; i4 < 248; i4++) {
            ...
            switch ((i4 % 6) + 9) {
                case 9:
                    ...
                    do {
                        i7 <<= -1;
                        f2 *= Test0262.instanceCount;
                        d *= i5;
                        for (i9 = 1; i9 < 1; i9++) {
                            Test0262.instanceCount = i10;
                            i10 = 8;
                        }
                    } while (++i8 < 7);
                case 10:
                    iArr1[i4] = i7;
                case 11:
                    Test0262.instanceCount += (i4 - Test0262.instanceCount);
                    break;
                case 12:
                    i7 += (i4 * i4);
                    break;
    ...
    public static int iMeth(int i1, float f1) {
        ...
        Test0262.instanceCount = (byMeth(i1, i1, f1) - Test0262.instanceCount);
        i12 = 1;
        do {
            i1 = i12;
            f1 -= Test0262.instanceCount;
            f1 += (i12 - f1);
        } while (++i12 < 142);
        i1 = -69;
        Test0262.iArrFld[(i12 >>> 1) % N] = (int) -31L;
        f1 *= i1;
        for (i13 = 3; i13 < 259; ++i13) {
            short s = 32079;
            s += (short) (((i13 * f1) + i13) - i13);
            d1 -= Test0262.instanceCount;
            i14 = i1;
            f3 = 6;
            do {
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (int smallinvoc = 0; smallinvoc < 470; smallinvoc++) vSmallMeth(f4, i16, Test0262.instanceCount);
        for (i17 = 6; i17 < 124; ++i17) {
            switch (((i18 >>> 1) % 1) + 10) {
                ...
                default:
                    ...
                    while (++i21 < 212) {
                        for (i22 = 1; 1 > i22; i22++) {
                            i16 = i23;
                            Test0262.instanceCount -= by1;
                        }
                        i16 >>>= -54;
                        Test0262.fArrFld[i21] -= by1;
                        i23 = (int) f4;
                    }
                    f4 = i23;
            }
            ...
            for (i24 = i17; i24 < 212; i24++) {
                i23 += i24;
                Test0262.iArrFld[i17 - 1] += (int) Test0262.instanceCount;
                i18 -= (int) Test0262.instanceCount;
                iFld %= (int) (i18 | 1);
                iFld += i23;
                switch ((i17 % 8) + 21) {
                    case 21:
                        f4 += Test0262.instanceCount;
                    case 22:
                        lArrFld[i17 - 1] += i19;
                        i16 = (int) Test0262.instanceCount;
                        break;
                    case 23:
                        dFld -= iFld;
                        break;
                    ...
                    case 25:
                        ...
                        break;
                    case 26:
                        Test0262.instanceCount += (i24 | Test0262.instanceCount);
                        break;
                    case 27:
                        f4 += i24;
                        break;
        ...
        FuzzerUtils.out.println("Test0262.instanceCount dFld iFld = " + Test0262.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + iFld);
        FuzzerUtils.out.println("Test0262.iArrFld Test0262.fArrFld lArrFld = " + FuzzerUtils.checkSum(Test0262.iArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0262.fArrFld)) + "," + FuzzerUtils.checkSum(lArrFld));
