...
public class Test0596 {
    ...
    static {
        FuzzerUtils.init(Test0596.fArrFld1, 0.815F);
    }
    ...
    public static void vMeth1(int i5) {
        ...
        for (i6 = 11; i6 < 372; ++i6) {
            for (i8 = 1; 5 > i8; ++i8) {
                ...
                switch ((i6 % 3) + 55) {
                    case 55:
                        iArr1[i8] = (int) Test0596.instanceCount;
                        break;
                    case 56:
                        i10 = 1;
                        do {
    ...
    public static int iMeth() {
        ...
        vMeth1(Test0596.iFld);
        switch (((Test0596.iFld >>> 1) % 10) + 111) {
            case 111:
                ...
                if (b) {
                    ...
                    for (i12 = 16; i12 < 318; i12++) {
                        i13 *= i11;
                        for (i14 = 1; i14 < 5; i14++) {
                            Test0596.instanceCount = (long) d;
                            Test0596.fArrFld1[i14][i14 - 1] += i14;
                            for (i16 = 1; i16 < 2; ++i16) {
                                iArr2[i12][i14 - 1] = (int) -2.4711;
                                Test0596.iFld += (-10 + (i16 * i16));
                                i15 = i15;
                            }
                        }
                    }
            ...
            case 112:
                Test0596.instanceCount = -2237;
                break;
            case 113:
                i13 -= (int) Test0596.lFld;
                break;
            case 114:
                Test0596.iFld = i13;
                break;
            ...
            case 118:
                ...
                break;
            case 119:
                Test0596.iFld *= (int) Test0596.lFld;
                break;
            case 120:
                Test0596.lFld = i14;
                break;
    ...
    public static void vMeth(long l, int i1, int i2) {
        ...
        iArr[(9 >>> 1) % N] -= (int) ((long) ((Test0596.instanceCount + i1) - (-7205885986972273451L * (f - i1))) << (i2 +
                (Test0596.iFld * l)));
        i2 = (int) (Test0596.instanceCount + (iArr[(70 >>> 1) % N]++));
        for (byte by : byArr) {
            i2 = i1;
            for (i3 = 1; i3 < 4; i3++) {
                s = (short) (((--i1) - iMeth()) + d1);
                ...
                Test0596.iFld = Test0596.iFld;
                Test0596.iFld = i1;
                f *= 210;
                iArr[i3] += (int) Test0596.instanceCount;
            }
        }
        i2 = (int) 50112L;
        i1 = i4;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i18 = 7; i18 < 384; ++i18) {
            ...
            for (i20 = 1; i20 < 67; i20++) {
                ...
                do {
                    i23 += (i22 | i);
                    dFld += Test0596.instanceCount;
                    s1 += (short) i;
                    Test0596.iFld += (((i22 * i21) + i) - i20);
                    i21 += -42;
                    i21 = -52018;
                ...
                i23 += (((i20 * i20) + Test0596.lFld) - i22);
                Test0596.instanceCount += -11;
                i21 ^= 13967;
                byArr2[i20] = (byte) 14;
            }
        ...
        FuzzerUtils.out.println("Test0596.instanceCount Test0596.iFld Test0596.lFld = " + Test0596.instanceCount + "," + Test0596.iFld +
                "," + Test0596.lFld);
        FuzzerUtils.out.println("dFld fArrFld dArrFld = " + Double.doubleToLongBits(dFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(fArrFld)) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(dArrFld)));
        FuzzerUtils.out.println("Test0596.fArrFld1 = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0596.fArrFld1)));
