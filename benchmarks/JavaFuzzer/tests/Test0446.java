...
public class Test0446 {
    ...
    static {
        FuzzerUtils.init(Test0446.fArrFld, 2.111F);
    }
    ...
    public static void vMeth(short s1, double d, int i8) {
        ...
        for (i9 = 4; i9 < 382; ++i9) {
            vSmallMeth(Test0446.instanceCount, i9);
            bArr[i9 + 1] = b1;
            for (i11 = 1; i11 < 4; ++i11) {
                Test0446.fArrFld[i9] -= (float) d;
                iArr2[i11] <<= s1;
                for (i13 = 1; i13 < 2; i13++) {
                    i10 >>= (int) l1;
                }
    ...
    public static int iMeth() {
        ...
        for (i2 = 15; i2 < 301; i2++) {
            i3 += i3;
            Test0446.instanceCount |= (i3--);
            i3 += i2;
            if (b = (((i2 + Test0446.instanceCount) * Test0446.instanceCount) != (s + (i1 = (int) Test0446.instanceCount))))
                continue;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (int smallinvoc = 0; smallinvoc < 827; smallinvoc++) vSmallMeth(iMeth() - Test0446.instanceCount, i19);
        i20 = 1;
        while (++i20 < 213) {
            switch (((i20 % 7) * 5) + 116) {
                case 125:
                ...
                case 147:
                    for (i21 = 4; 118 > i21; i21++) {
                        ...
                        do {
                            ...
                            i22 &= (int) Test0446.instanceCount;
                            iArr3 = iArr3;
                            Test0446.instanceCount += (i25 * Test0446.instanceCount);
                        } while (++i25 < 2);
                        i26 = 1;
                        do {
                            i22 = (int) -9L;
                            i19 += (((i26 * i19) + Test0446.instanceCount) - f1);
                            f1 += (((i26 * Test0446.instanceCount) + l2) - s2);
                            l2 >>>= i21;
                        } while (++i26 < 2);
                    }
                    i19 = i23;
        ...
        FuzzerUtils.out.println("Test0446.instanceCount dFld Test0446.fArrFld = " + Test0446.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0446.fArrFld)));
