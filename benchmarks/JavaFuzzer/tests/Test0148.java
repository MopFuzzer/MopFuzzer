...
public class Test0148 {
    ...
    static {
        FuzzerUtils.init(Test0148.iArrFld, 50765);
        FuzzerUtils.init(Test0148.bArrFld, true);
        FuzzerUtils.init(Test0148.dArrFld, 83.129948);
    }
                ...
                for (i14 = 1; 1 > i14; ++i14) {
                    ...
                    switch (((i14 % 4) * 5) + 59) {
                        ...
                        case 75:
                            ...
                            s -= (short) i9;
                            i11 -= i9;
                            Test0148.iArrFld[i10][i14] = (int) Test0148.fFld;
                            break;
                        case 61:
                            fArr[i12 - 1] = i13;
                            break;
                        case 60:
                            Test0148.bArrFld[i14 + 1][i14] = b;
                            break;
                        default:
                            Test0148.iArrFld[i14][i14 + 1] >>= i14;
                    }
                }
            }
        }
    ...
    public static int iMeth1(int i8) {
        ...
        d1 = 376;
        do {
            Test0148.instanceCount = (long) (fMeth(Test0148.instanceCount, Test0148.instanceCount, 40581) - i8);
            if (Test0148.bFld) {
                i16 = 1;
                while (++i16 < 4) {
                    if (Test0148.bFld) break;
                    Test0148.instanceCount -= i16;
                    i8 += (-132 + (i16 * i16));
                    for (i17 = 1; i17 < 1; ++i17) {
                        Test0148.dArrFld[i16 - 1] -= i18;
                        i18 = (int) 154L;
                        i18 += i17;
                    }
                    for (i19 = 1; 1 < i19; --i19) {
                        double d2 = -1.12282;
                        if (Test0148.bFld) continue;
                        Test0148.instanceCount = -3291004646L;
                        d2 = i18;
                    }
                }
            } else if (Test0148.bFld) {
                i20 = by;
            } else {
                if (Test0148.bFld) break;
            }
    ...
    public static int iMeth(long l, int i1, double d) {
        ...
        for (i2 = 24; 395 > i2; i2++) {
            for (i4 = 5; i4 > 1; i4 -= 3) {
                for (f = 5; f > 1; f--) {
                    i3 -= (int) (--Test0148.instanceCount);
                    l %= ((++Test0148.iArrFld[(int) (f)][i2]) | 1);
                    l = (i5++);
                    i7 >>= i3;
                    f1 += ((++i7) - (iMeth1(i3) * 10L));
                    i5 += i5;
            ...
            i6 = -99;
            Test0148.dArrFld[i2] *= Test0148.instanceCount;
            i3 -= i5;
            i5 += i5;
            i5 = (int) f;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0148.iArrFld[(i >>> 1) % N][(i >>> 1) % N] %= (int) (((iMeth(11L, i, d3) >>> Test0148.instanceCount) - i) | 1);
        Test0148.instanceCount -= (long) d3;
        d3 += 100.411F;
        Test0148.iArrFld[(5 >>> 1) % N] = Test0148.iArrFld[(i >>> 1) % N];
        for (i22 = 156; i22 > 3; i22 -= 2) {
            for (i24 = 7; 329 > i24; ++i24) {
                Test0148.instanceCount >>= 218;
            }
            Test0148.instanceCount |= -52763;
            i -= (int) Test0148.fFld;
            i <<= i;
            i25 %= (int) (i23 | 1);
            for (i26 = 5; i26 < 329; i26++) {
                ...
                while (--i29 > 0) {
                    ...
                    Test0148.fFld += 60275L;
                    Test0148.fFld += i29;
                }
                Test0148.iArrFld[i26 - 1][i26] >>>= 60;
            }
        }
        for (i30 = 15; i30 < 395; i30++) {
            lArr1[i30] = i31;
            for (i32 = 4; i32 < 66; i32++) {
                Test0148.instanceCount >>= i31;
                for (i34 = 1; i34 < 2; i34++) {
                    i31 += i29;
                    i23 += (int) Test0148.instanceCount;
                    lArr1 = lArr1;
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0148.iArrFld Test0148.bArrFld Test0148.dArrFld = " + FuzzerUtils.checkSum(Test0148.iArrFld) + ","
                + FuzzerUtils.checkSum(Test0148.bArrFld) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0148.dArrFld)));
