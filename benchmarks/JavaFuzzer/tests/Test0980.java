...
public class Test0980 {
    ...
    static {
        FuzzerUtils.init(Test0980.iArrFld1, -12);
    }
                ...
                case 2:
                    for (i10 = 1; i10 < 4; i10++) {
                        for (i12 = i10; i12 < 2; ++i12) {
                            ...
                            i7 += (i12 + f2);
                            i11 = i9;
                            i9 -= (int) Test0980.instanceCount;
                        }
                        for (i14 = 1; i14 < 2; i14 += 2) {
                            try {
                                Test0980.iArrFld1[i14 + 1] = (i14 / i13);
                                Test0980.iArrFld1[i10 + 1] = (i14 % 181);
                                i9 = (i14 % i10);
                            } catch (ArithmeticException a_e) {
                            }
                            f1 = Test0980.instanceCount;
                        }
                        i13 ^= (int) -52693L;
                    }
                    break;
    ...
    public static int iMeth(long l, int i6) {
        ...
        d -= d;
        if (b) {
            l = Test0980.instanceCount;
            for (byte by : byArr) {
                Test0980.iArrFld1 = Test0980.iArrFld1;
                i6 *= (int) f3;
                Test0980.instanceCount |= i6;
                for (i16 = 1; i16 < 4; ++i16) {
                    l *= -203;
                    switch (((i16 % 1) * 5) + 53) {
                        case 56:
                            for (i18 = 1; i18 < 2; i18++) {
                                i19 += by;
                                Test0980.iArrFld1[i16] += (int) -27.565F;
                            }
                            break;
                    }
                }
    ...
    public static void vMeth(int i2, int i3) {
        ...
        for (i4 = 13; i4 < 213; i4++) {
            iMeth(Test0980.instanceCount, i2);
            for (i20 = 1; 8 > i20; ++i20) {
                for (i22 = 1; 2 > i22; i22++) {
                    f4 += (((i22 * i21) + Test0980.instanceCount) - i4);
                    i3 *= i22;
                    Test0980.iArrFld1[i4] -= (int) Test0980.instanceCount;
                    switch ((i20 % 6) + 56) {
                        case 56:
                            switch ((i20 % 7) + 51) {
                                case 51:
                                ...
                                case 55:
                                    ...
                                    break;
                                case 56:
                                    Test0980.iArrFld1 = FuzzerUtils.int1array(N, (int) -204);
                                    break;
                                case 57:
                                    Test0980.instanceCount = 66L;
                                    break;
                                default:
                                    b1 = b1;
                            }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 6; 232 > i; i++) {
            i1 = (int) ((--f) * (-(i - Test0980.instanceCount)));
            Test0980.instanceCount += lArr[i];
        ...
        FuzzerUtils.out.println("iArrFld byArrFld Test0980.iArrFld1 = " + FuzzerUtils.checkSum(iArrFld) + "," +
                FuzzerUtils.checkSum(byArrFld) + "," + FuzzerUtils.checkSum(Test0980.iArrFld1));
