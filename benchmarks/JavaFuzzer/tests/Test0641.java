...
public class Test0641 {
    ...
    static {
        FuzzerUtils.init(Test0641.iArrFld1, 0);
        FuzzerUtils.init(Test0641.iArrFld2, 16826);
    }
    ...
    public static void vMeth1(int i5, int i6, double d) {
        ...
        dArr[(-11 >>> 1) % N] *= Test0641.instanceCount;
        i7 += (int) -3204385968590637497L;
        i5 = (int) Test0641.instanceCount;
        for (i8 = 318; 1 < i8; i8--) {
            i6 += (i8 + i9);
            for (i10 = 1; i10 < 5; i10++) {
                Test0641.instanceCount = 233;
            }
            Test0641.instanceCount /= (i5 | 1);
            i9 -= (int) f;
            i12 = 1;
            do {
                i13 = 1;
                while (++i13 < 1) {
                    boolean b = true;
                    Test0641.iArrFld1[i13][i12 - 1] = i6;
                    i9 += (i13 * i13);
                    if (b) break;
                    fArr[i12 + 1] -= i5;
                }
    ...
    public static void vMeth() {
        ...
        if (b1) {
            ...
            vMeth1(i4, i4, d1);
            i4 = i4;
            Test0641.iArrFld1[(i4 >>> 1) % N][(i4 >>> 1) % N] >>= i4;
        } else if (b1) {
            try {
                for (int i14 : Test0641.iArrFld2) {
                    d1 += i4;
                    if (b1) break;
                    switch (((i4 >>> 1) % 5) + 13) {
                        case 13:
            ...
            } catch (UserDefinedExceptionTest0641 exc2) {
                Test0641.instanceCount -= (long) f1;
            } finally {
                i18 += -175;
            }
        } else if (b1) {
            Test0641.iArrFld1[(i17 >>> 1) % N][(-3 >>> 1) % N] = (int) Test0641.instanceCount;
        } else {
            Test0641.instanceCount += Test0641.instanceCount;
        }
    ...
    public static long lMeth(byte by, int i1, long l) {
        ...
        for (i2 = 19; i2 < 331; ++i2) {
            vMeth();
            f2 += ((long) i2 ^ (long) i3);
            Test0641.instanceCount *= (long) f2;
            for (i20 = 1; i20 < 5; ++i20) {
                i21 = i1;
                Test0641.instanceCount -= (long) f2;
                for (i22 = 1; i22 < 2; ++i22) {
                    Test0641.iArrFld2[i20 + 1] -= i2;
                    i21 -= 146;
                    i1 <<= 27725;
                    i1 += (int) l;
                    i21 -= i20;
                    i23 += (i22 | i1);
                    Test0641.iArrFld1[i20 - 1][i2 + 1] = i22;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = 1;
        do {
            byArr[i - 1] |= (byte) ((iArrFld[i]--) - lMeth(Test0641.byFld, i, 11L));
            for (i24 = 3; i24 < 63; i24++) {
                for (i26 = 1; 2 > i26; i26++) {
                    i27 = (int) Test0641.instanceCount;
                    dArrFld[i24] *= Test0641.instanceCount;
                    byArr1[i24 - 1] ^= (byte) i24;
                    Test0641.instanceCount *= i26;
                    i25 += (((i26 * Test0641.instanceCount) + i27) - Test0641.instanceCount);
                    Test0641.instanceCount += (((i26 * i26) + i24) - Test0641.instanceCount);
                    i27 = i24;
                }
                try {
                    i28 = (-57 % i28);
            ...
            for (i29 = i; i29 < 63; ++i29) {
                ...
                i30 |= 251;
                iFld1 += i28;
                Test0641.instanceCount += i31;
                Test0641.byFld = (byte) 30244;
                i30 = i30;
            }
            if (b2) continue;
            i28 += (((i * i27) + iFld) - i30);
        } while (++i < 397);
        iArrFld[(i24 >>> 1) % N] *= (int) Test0641.instanceCount;
        Test0641.instanceCount += (long) f3;
        ...
        FuzzerUtils.out.println("Test0641.instanceCount Test0641.byFld iFld = " + Test0641.instanceCount + "," + Test0641.byFld + "," +
                iFld);
        FuzzerUtils.out.println("Test0641.dFld iFld1 iArrFld = " + Double.doubleToLongBits(Test0641.dFld) + "," + iFld1 + "," +
                FuzzerUtils.checkSum(iArrFld));
        FuzzerUtils.out.println("Test0641.iArrFld1 Test0641.iArrFld2 dArrFld = " + FuzzerUtils.checkSum(Test0641.iArrFld1) + "," +
                FuzzerUtils.checkSum(Test0641.iArrFld2) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(dArrFld)));
...
///////////////////////////////////////////////////////////////////////
class UserDefinedExceptionTest0641 extends RuntimeException {
    public int field;
}
