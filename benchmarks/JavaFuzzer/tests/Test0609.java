...
public class Test0609 {
    ...
    static {
        FuzzerUtils.init(Test0609.dArrFld, -2.104069);
    }
    ...
    public static void vMeth2() {
        ...
        for (i8 = 8; 133 > i8; i8++) {
            ...
            for (i10 = 1; i10 < 13; i10++) {
                ...
                for (i12 = 1; i12 < 2; i12++) {
                    f2 = i12;
                    Test0609.instanceCount -= -3070541138L;
                    d1 = i11;
                    if (b) continue;
                }
                dArr[i10] -= -7156;
                i14 += (i10 ^ Test0609.sFld);
                i9 += i9;
                i14 += (i10 | i11);
            }
        }
    ...
    public static void vMeth1() {
        ...
        for (i4 = 3; i4 < 137; i4 += 2) {
            i5 += (((i4 * f1) + by1) - i5);
            i5 = 149;
            i5 -= (int) ((-(by1 ^= (byte) -6836262926519812437L)) - ((i4 * i5) % ((Test0609.instanceCount +
                    Test0609.instanceCount) | 1)));
            Test0609.instanceCount += (i4 + i5);
        }
        i5 ^= (i5 = (++iArr[(i4 >>> 1) % N]));
        for (i6 = 8; i6 < 293; ++i6) {
            vMeth2();
            ...
            while ((i18 += 2) < 8) {
                ...
                switch ((((182 >>> 1) % 8) * 5) + 29) {
                        ...
                        for (i19 = 2; i19 > 1; --i19) {
                            ...
                            switch ((i16 % 2) + 79) {
                                ...
                                case 80:
                                    i3 += i19;
                                default:
                                    Test0609.sFld += (short) (-92L + (i19 * i19));
                                    i20 += i17;
                            }
                        }
                        break;
                    ...
                    case 47:
                        f3 -= i19;
                    case 31:
                        d2 *= Test0609.instanceCount;
                        break;
                    case 43:
                        i17 += (-2482 + (i18 * i18));
                        break;
                    case 50:
                        i3 <<= (int) Test0609.instanceCount;
                        break;
                    default:
                        i20 *= i18;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++d < 269) {
            ...
            do {
                for (i22 = 1; i22 < 1; ++i22) {
                    Test0609.instanceCount *= i22;
                    iArr3[(int) (d)] *= (int) f;
                    i1 -= (int) Test0609.instanceCount;
                    i1 <<= (int) l;
                }
                i23 += -7;
                f4 = l;
                for (i24 = 1; i24 < 1; ++i24) {
                    i25 ^= i1;
                    Test0609.sFld += (short) (206 + (i24 * i24));
                }
                Test0609.dArrFld[(int) (d + 1)] = 26050;
            } while (++i21 < 93);
            iArr3[(int) (d - 1)] -= (int) d;
            if (b2) {
        ...
        FuzzerUtils.out.println("Test0609.instanceCount Test0609.sFld Test0609.byFld = " + Test0609.instanceCount + "," + Test0609.sFld +
                "," + Test0609.byFld);
        FuzzerUtils.out.println("Test0609.dArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0609.dArrFld)));
