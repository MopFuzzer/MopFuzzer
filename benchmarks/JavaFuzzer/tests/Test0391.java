...
public class Test0391 {
    ...
    static {
        FuzzerUtils.init(Test0391.byArrFld, (byte) -81);
    }
    ...
    public static long lMeth(int i3) {
        ...
        if (b) {
            Test0391.instanceCount = lArr[(i3 >>> 1) % N];
            for (i4 = 14; i4 < 225; ++i4) {
                vMeth(i3, -13, d1);
                i5 += (i4 | i3);
                Test0391.byFld += (byte) i4;
            }
            i5 *= i4;
        } else {
            Test0391.byArrFld[(i4 >>> 1) % N] = (byte) i5;
            i3 = i3;
            for (i8 = 332; i8 > 3; --i8) {
                i5 += i3;
                switch (((i3 >>> 1) % 4) + 106) {
    ...
    public static int iMeth() {
        ...
        Test0391.byFld = (byte) (((i2 & i2) + lMeth(i2)) + i2);
        i12 = 275;
        do {
            i13 = 1;
            do {
            ...
            for (i14 = 1; i14 < 11; ++i14) {
                ...
                while (++l < 2) {
                    d2 = 16472;
                    iArr[i12][i14] = (int) Test0391.instanceCount;
                    i15 += (int) (l ^ i2);
                    iArr[i14][i14] = (int) l;
                    i2 += i12;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 9; i < 235; ++i) {
            ...
            switch ((i % 9) + 90) {
                ...
                case 93:
                    ...
                    break;
                case 94:
                    i18 += (int) Test0391.instanceCount;
                case 95:
                    i20 = i16;
                    break;
                case 96:
                ...
                case 98:
                    ...
                    break;
                default:
                    Test0391.instanceCount = -3118726262440682416L;
            }
        }
        ...
        FuzzerUtils.out.println("Test0391.instanceCount Test0391.byFld Test0391.sFld = " + Test0391.instanceCount + "," + Test0391.byFld +
                "," + Test0391.sFld);
        FuzzerUtils.out.println("Test0391.byArrFld iArrFld = " + FuzzerUtils.checkSum(Test0391.byArrFld) + "," +
