...
public class Test0122 {
    ...
    public static void vMeth1(boolean b, int i9, int i10) {
        ...
        for (l2 = 5; l2 < 262; ++l2) {
            ...
            i11 *= 28531;
            i10 += (int) l2;
            Test0122.instanceCount += i9;
            Test0122.byFld -= (byte) i9;
            i9 += (int) Test0122.dFld;
        }
        i12 = i11;
        b = b;
        for (i13 = 9; i13 < 175; i13++) {
            Test0122.instanceCount = i12;
            i10 -= i12;
            i9 += (i13 * i14);
            iArr1[i13 - 1] += i14;
        }
        ...
        for (i3 = 8; i3 < 284; ++i3) {
            for (i5 = i3; i5 < 6; ++i5) {
                for (i7 = 1; i7 < 1; i7++) {
                    ...
                    Test0122.instanceCount = (((++Test0122.instanceCount) + (Test0122.instanceCount - i6)) + (--i6));
                }
                vMeth1(false, i7, 0);
            }
            iArr[i3 - 1] -= Test0122.byFld;
        }
        i8 = 15014;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = (int) ((long) ((i + Test0122.byFld) + (s + Test0122.dFld)) & -12913);
        i1 = 1;
        do {
            for (int smallinvoc = 0; smallinvoc < 62; smallinvoc++) vSmallMeth(199, Test0122.instanceCount);
            for (i15 = 3; i15 < 201; i15++) {
                for (i17 = i1; i17 < 2; ++i17) {
                    lArrFld[i15 + 1][i1 + 1] *= i15;
                    i += (i17 - Test0122.instanceCount);
                    Test0122.fFld -= i18;
                    switch (((i15 % 2) * 5) + 2) {
                        case 9:
                            bFld = bFld;
                ...
                for (i23 = 1; i23 < 2; i23++) {
                    switch ((i21 % 7) + 102) {
                        ...
                        case 103:
                            ...
                            break;
                        case 104:
                            Test0122.instanceCount = i19;
                            i20 >>= (int) lFld;
                            break;
                        case 105:
                            i24 += (int) Test0122.dFld;
                        case 106:
                            Test0122.dFld += Test0122.byFld;
                            break;
                        case 107:
                            i16 = i22;
                            break;
        ...
        FuzzerUtils.out.println("Test0122.instanceCount Test0122.byFld Test0122.dFld = " + Test0122.instanceCount + "," + Test0122.byFld +
                "," + Double.doubleToLongBits(Test0122.dFld));
        FuzzerUtils.out.println("Test0122.fFld bFld Test0122.dFld1 = " + Float.floatToIntBits(Test0122.fFld) + "," + (bFld ? 1 : 0)
                + "," + Double.doubleToLongBits(Test0122.dFld1));
