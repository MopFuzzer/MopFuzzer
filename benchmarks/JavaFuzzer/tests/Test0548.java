...
public class Test0548 {
    ...
    static {
        FuzzerUtils.init(Test0548.iArrFld, 7);
    }
    ...
    public static void vMeth1() {
        ...
        for (i5 = 148; i5 > 2; i5--) {
            float f4 = 0.623F;
            boolean b1 = false;
            vMeth2(Test0548.instanceCount, i6, 0);
            if (b1) {
                f4 *= i5;
                i6 = (int) 1.57F;
                i6 = i6;
            ...
            Test0548.iArrFld = Test0548.iArrFld;
    ...
    public static void vMeth(int i3) {
        ...
        for (f1 = 7; f1 < 143; ++f1) {
            ...
            for (l2 = 1; l2 < 12; ++l2) {
                for (i19 = 1; i19 < 2; ++i19) {
                    Test0548.byFld += (byte) (((i19 * i19) + i19) - i4);
                    Test0548.instanceCount &= s1;
                    i20 += (i19 * Test0548.instanceCount);
                    i18 = i19;
                    Test0548.iArrFld = Test0548.iArrFld;
                    i3 += (((i19 * Test0548.instanceCount) + i18) - i3);
                    Test0548.instanceCount = (long) Test0548.dFld;
                    i20 -= i3;
                }
            }
            Test0548.instanceCount -= Test0548.instanceCount;
            Test0548.instanceCount += (long) f1;
            i3 += (int) f1;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (long l : lArrFld) {
            for (i1 = 1; i1 < 63; i1 += 2) {
                i2 = (int) l;
                i2 += i1;
                Test0548.iArrFld[i1 - 1] = (int) (((f + -1289646438L) + (-33013 + (--Test0548.instanceCount))) + ((i + l) * (i *
                        d)));
                vMeth(i1);
            }
            i += (int) Test0548.instanceCount;
            for (d2 = 2; d2 < 63; ++d2) {
                for (i22 = 1; i22 < 2; ++i22) {
                    f += i2;
                    i21 = i1;
                    Test0548.iArrFld[i22] += (int) l;
                    Test0548.iArrFld[i22] ^= i;
                    f += -15340L;
                    i23 += -4;
                    i21 -= i23;
                    Test0548.instanceCount -= i;
                    iArr[i22 + 1] = i23;
                    Test0548.byFld = (byte) Test0548.instanceCount;
                }
                if (Test0548.bFld) {
                    i2 = (int) f;
                    Test0548.dFld = -8L;
                ...
                Test0548.instanceCount -= (long) -4.686F;
                f += (float) d2;
            }
        ...
        FuzzerUtils.out.println("Test0548.instanceCount Test0548.dFld Test0548.byFld = " + Test0548.instanceCount + "," +
                Double.doubleToLongBits(Test0548.dFld) + "," + Test0548.byFld);
        FuzzerUtils.out.println("Test0548.bFld lArrFld Test0548.iArrFld = " + (Test0548.bFld ? 1 : 0) + "," +
                FuzzerUtils.checkSum(lArrFld) + "," + FuzzerUtils.checkSum(Test0548.iArrFld));
