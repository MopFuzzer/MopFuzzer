...
public class Test0251 {
    ...
    public static float fMeth() {
        ...
        Test0251.iFld1 += 1864;
        Test0251.iFld1 += Test0251.iFld1;
        Test0251.iFld1 = -26056;
        Test0251.iFld1 = (int) Test0251.fFld1;
        for (i9 = 24; 392 > i9; i9++) {
            by1 += (byte) 16;
            if (b2) break;
            i11 -= i12;
            ...
            b2 = b2;
            iArr1 = iArr1;
            Test0251.instanceCount -= Test0251.iFld1;
        }
        for (i13 = 15; 353 > i13; ++i13) {
            Test0251.fFld1 *= -3338;
            iArr1[i13 - 1] = Test0251.iFld1;
        }
    ...
    public static int iMeth(int i7, boolean b1, int i8) {
        ...
        f = 1;
        do {
            Test0251.iFld1 += (int) (f * f);
            iArr[(int) (f)] += (int) (Integer.reverseBytes(i8) * Test0251.instanceCount);
            Test0251.instanceCount += (long) (Test0251.iFld1 / ((long) (fMeth()) | 1));
            if (b1) continue;
            for (i15 = 1; 8 > i15; i15++) {
                if (b1) continue;
            }
        ...
        i8 *= i7;
        Test0251.iFld1 = (int) Test0251.lFld;
        i17 = 1;
        do {
            for (i18 = 1; 5 > i18; ++i18) {
                Test0251.lFld = 12;
    ...
    public static byte byMeth(int i4, long l) {
        ...
        for (i5 = 1; i5 < 136; i5++) {
            boolean b3 = true;
            if (true) {
                vSmallMeth(i5, (byte) ((--i4) * ((-iMeth(-56594, b3, 45896)) + Test0251.iFld1)), i5);
                for (i20 = 1; i20 < 12; ++i20) {
                    double d = 1.116925;
                    i4 ^= Test0251.iFld1;
                    l >>= i4;
                    Test0251.lFld = Test0251.instanceCount;
                    for (i22 = 1; i22 < 2; i22++) {
                        Test0251.lFld += (i22 | l);
                        i21 += (int) Test0251.lFld;
                    }
                    if (b3) break;
                    i4 -= i4;
                    d = l;
                    i21 += (i20 ^ (long) Test0251.fFld1);
                    i4 = i22;
                }
            } else {
                i23 += (i5 * i5);
    ...
    public void mainTest(String[] strArr1) {
        ...
        iFld >>= (int) ((162L - (110L - (iFld * Test0251.iFld1))) + iFld);
        b = (!(Test0251.instanceCount != (iFld - fFld)));
        for (i = 2; i < 261; ++i) {
            for (int smallinvoc = 0; smallinvoc < 62; smallinvoc++)
                vSmallMeth(++iFld, byMeth(iFld, Test0251.instanceCount), i);
                        ...
                        case 80:
                            switch ((((iFld >>> 1) % 7) * 5) + 35) {
                                case 54:
                                    ...
                                    Test0251.iFld1 <<= i25;
                                    if (b) {
                                        Test0251.iFld1 = (int) fFld;
                                        for (i28 = 1; 2 > i28; i28++) {
                                            lArrFld[i28][i] += i29;
                                            b = b;
                                            Test0251.fFld1 += (((i28 * Test0251.instanceCount) + Test0251.lFld) - i24);
                                            s = (short) i28;
                                            by2 += (byte) (i28 | i29);
                                            i29 += (i28 * i28);
                                            Test0251.iFld1 *= (int) Test0251.fFld1;
                                ...
                                case 45:
                                    ...
                                    break;
                                case 68:
                                    iFld -= (int) Test0251.lFld;
                                    break;
                                case 52:
                                    Test0251.instanceCount -= 1847;
                                    break;
                                case 38:
                                    iArrFld[i26 + 1] *= i28;
                                    break;
        ...
        FuzzerUtils.out.println("Test0251.instanceCount iFld Test0251.iFld1 = " + Test0251.instanceCount + "," + iFld + "," +
                Test0251.iFld1);
        FuzzerUtils.out.println("fFld Test0251.fFld1 Test0251.lFld = " + Float.floatToIntBits(fFld) + "," +
                Float.floatToIntBits(Test0251.fFld1) + "," + Test0251.lFld);
