...
public class Test0869 {
    ...
    static {
        FuzzerUtils.init(Test0869.iArrFld, 4);
    }
    ...
    public static void vMeth1(int i5, byte by1, short s) {
        ...
        Test0869.iArrFld[(i5 >>> 1) % N] -= ((-Math.max(247, i5)) + (by1 + (i5--)));
        for (i6 = 2; i6 < 142; ++i6) {
            vMeth2(Test0869.dFld);
            for (i13 = 1; 11 > i13; i13++) {
                i5 = i5;
                i5 = i5;
                Test0869.iArrFld[i6 - 1] |= i13;
                i5 *= by1;
                i5 += i13;
    ...
    public static void vMeth(int i, float f) {
        ...
        b = (((i != 61) || bArr[(i >>> 1) % N]) || ((Test0869.instanceCount + i) != (i - Test0869.instanceCount)));
        Test0869.iArrFld[(i >>> 1) % N] = by;
        for (i1 = 10; i1 < 291; i1++) {
            Test0869.instanceCount += (i1 | i2);
            f -= (float) ((Integer.reverseBytes(i) + (++Test0869.iArrFld[i1 - 1])) - (-(Test0869.iArrFld[i1 - 1] -=
                    (int) Test0869.dFld)));
            for (i3 = 6; i3 > i1; --i3) {
                vMeth1(i3, by, s2);
                for (i19 = 1; 1 > i19; ++i19) {
                    ...
                    try {
                        i20 = (i % -2072609723);
                        i2 = (i3 / i3);
                        i2 = (Test0869.iArrFld[i3 - 1] / 95);
                    } catch (ArithmeticException a_e) {
                    }
                    Test0869.instanceCount = i4;
                    i4 += 50;
                }
                by *= (byte) 13;
                i20 = (int) Test0869.instanceCount;
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(i21, -125.26F);
        Test0869.iArrFld[(i21 >>> 1) % N] ^= i21;
        i22 = 1;
        do {
            Test0869.iArrFld[i22 - 1] += i22;
            if (false) continue;
            for (i23 = i22; i23 < 101; ++i23) {
                long l = 3886520795L;
                i21 += (((i23 * i22) + Test0869.instanceCount) - Test0869.instanceCount);
                i24 += (int) (-50646L + (i23 * i23));
                i21 += (i23 * Test0869.instanceCount);
                i21 >>= i22;
                l = i22;
            }
            Test0869.instanceCount -= (long) Test0869.dFld;
            i24 -= (int) Test0869.dFld;
            for (i25 = 5; i25 < 101; i25++) {
                i21 += i25;
                byArr[i25] = (byte) i25;
                i27 *= (int) f2;
                Test0869.iArrFld = FuzzerUtils.int1array(N, (int) -124);
                Test0869.dFld *= f2;
                for (i28 = 1; i28 < 2; i28++) {
                    i29 |= Test0869.iFld;
                    i27 = 160;
                ...
                Test0869.iFld += i29;
                for (i30 = 1; i30 < 2; ++i30) {
                    s3 = (short) Test0869.instanceCount;
                    s3 -= (short) Test0869.iFld;
                    Test0869.iArrFld[i22 + 1] -= i29;
                    i27 += (i30 | i28);
                    f2 = i23;
                }
            }
        ...
        FuzzerUtils.out.println("Test0869.instanceCount Test0869.dFld Test0869.iFld = " + Test0869.instanceCount + "," +
                Double.doubleToLongBits(Test0869.dFld) + "," + Test0869.iFld);
        FuzzerUtils.out.println("Test0869.iArrFld = " + FuzzerUtils.checkSum(Test0869.iArrFld));
