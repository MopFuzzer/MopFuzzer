...
public class Test0638 {
    ...
    static {
        FuzzerUtils.init(Test0638.lArrFld, -4798890779776319710L);
        FuzzerUtils.init(Test0638.bArrFld, true);
    }
            ...
            for (f2 = 1; 8 > f2; f2 += 2) {
                for (i12 = 1; 3 > i12; ++i12) {
                    ...
                    switch ((i12 % 1) + 34) {
                        case 34:
                            fArr[i10] += -9;
                            Test0638.instanceCount = Test0638.sFld;
                            f1 = i9;
                            i11 += (((i12 * i11) + i13) - i11);
                            break;
                    }
    ...
    public static void vMeth1(int i7, int i8, long l3) {
        ...
        while (++l4 < 377) {
            float f4 = 122.881F;
            i7 += (-28871 + (l4 * l4));
            iArr1[(int) (l4 - 1)] = (int) Test0638.fFld;
            i7 += (int) l4;
            for (f3 = 1; f3 < 4; f3++) {
                i7 += i7;
                i7 += i8;
                l3 = i8;
                Test0638.lArrFld[(int) (f3 - 1)] *= i14;
                by = (byte) i8;
            }
            f4 *= Test0638.sFld;
            if (false) break;
            Test0638.lArrFld[(int) (l4)] &= i7;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(39517, 29292, Test0638.instanceCount);
        if (b2) {
            Test0638.instanceCount ^= i15;
            Test0638.fFld = Test0638.instanceCount;
            for (i16 = 3; i16 < 134; i16++) {
                ...
                for (i18 = 2; i18 < 191; i18++) {
                    Test0638.fFld -= Test0638.fFld;
                    i15 >>= 228;
                    Test0638.bArrFld[i18] = true;
                    i15 -= i18;
                    i15 = Test0638.sFld;
                    i17 = i18;
                    i19 = (int) Test0638.instanceCount;
                }
                Test0638.instanceCount += (13 + (i16 * i16));
                i17 = i18;
            }
        } else if (b3) {
            ...
            Test0638.instanceCount = i23;
        } else {
            i17 += (int) Test0638.instanceCount;
        }
        ...
        FuzzerUtils.out.println("Test0638.instanceCount Test0638.sFld Test0638.fFld = " + Test0638.instanceCount + "," + Test0638.sFld +
                "," + Float.floatToIntBits(Test0638.fFld));
        FuzzerUtils.out.println("Test0638.lArrFld Test0638.bArrFld = " + FuzzerUtils.checkSum(Test0638.lArrFld) + "," +
                FuzzerUtils.checkSum(Test0638.bArrFld));
