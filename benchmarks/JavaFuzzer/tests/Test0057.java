...
public class Test0057 {
        ...
        for (i8 = 176; 1 < i8; i8 -= 2) {
            ...
            for (i10 = 1; i10 < 18; ++i10) {
                ...
                for (i12 = i10; i12 < 2; i12++) {
                    i11 *= (int) Test0057.instanceCount;
                    try {
                        i7 = (i8 % i12);
                        i11 = (-29837 / i8);
                        i7 = (i7 % -39961);
                    ...
                    Test0057.instanceCount = i9;
                }
                byArr = byArr;
                i14 = 2;
                do {
                    i15 -= (int) Test0057.instanceCount;
                    i7 <<= (int) Test0057.instanceCount;
                } while ((i14 -= 3) > 0);
            }
        }
    ...
    public static void vMeth(int i, int i1, int i2) {
        ...
        for (f = 15; 345 > f; f++) {
            for (i4 = 5; i4 > 1; --i4) {
                vMeth1(231L, 176, f);
                i1 = (int) Test0057.instanceCount;
                f3 *= i;
                switch ((int) (((f % 1) * 5) + 24)) {
                    case 29:
                        for (d = 1; d < 2; ++d) {
                            i19 += (int) Test0057.instanceCount;
                            i3 += (int) d;
                        }
                        Test0057.instanceCount += (((i4 * i) + i5) - i1);
                        i1 += (i4 * i4);
                        i19 += (((i4 * i5) + i4) - i1);
                        break;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            for (i23 = i21; i23 < 101; i23++) {
                for (i25 = 1; i25 < 1; ++i25) {
                    Test0057.instanceCount = (long) f4;
                    i20 += i26;
                    iArr2[i21] = (int) Test0057.instanceCount;
                    Test0057.iFld >>= i21;
                    f4 += f4;
                    Test0057.instanceCount %= (Test0057.iFld | 1);
                    i24 = i20;
                    Test0057.instanceCount <<= i24;
                    Test0057.iFld >>= 27024;
                }
                for (i27 = 1; i27 < 1; i27++) {
                    f4 = Test0057.sFld;
                ...
                lArrFld[i23] = i20;
                iArr2[i23] = (int) Test0057.instanceCount;
                i24 &= i28;
                for (i29 = 1; i29 > 1; i29 -= 3) {
                    Test0057.instanceCount += (i29 * i29);
                    i26 <<= i27;
                }
        ...
        FuzzerUtils.out.println("Test0057.instanceCount Test0057.sFld Test0057.iFld = " + Test0057.instanceCount + "," + Test0057.sFld +
                "," + Test0057.iFld);
