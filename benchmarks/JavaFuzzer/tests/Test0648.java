...
public class Test0648 {
    ...
    static {
        FuzzerUtils.init(Test0648.iArrFld1, 7);
                        ...
                        switch ((i10 % 8) + 108) {
                            ...
                            case 109:
                                ...
                                for (l1 = 1; l1 < 4; l1++) {
                                    ...
                                    Test0648.instanceCount = 512430767L;
                                }
                                for (f = 4; f > 1; --f) {
                                    Test0648.instanceCount *= i16;
                            ...
                            case 112:
                            case 113:
                                Test0648.instanceCount += (i12 - i11);
                            case 114:
                                i14 = i8;
                                break;
                            case 115:
                    ...
                    if (b2) {
                        ...
                        switch (((i6 % 7) * 5) + 111) {
                            ...
                            case 140:
                                i18 += i18;
                            default:
                                Test0648.fFld += (float) d1;
                        }
                    } else if (b2) {
                        i21 |= -6;
                    } else if (true) {
                        Test0648.instanceCount -= i18;
    ...
    public static void vMeth(int i4, int i5) {
        ...
        vMeth1(-129L);
        Test0648.iArrFld1[(i4 >>> 1) % N] = i5;
        s1 = (short) i4;
        Test0648.fFld += Test0648.fFld;
        for (int i22 : Test0648.iArrFld1) {
            i4 -= by1;
        }
        Test0648.instanceCount = i4;
        Test0648.iArrFld1[(i5 >>> 1) % N] = 8;
        i23 = 1;
        do {
            for (i24 = 1; i24 < 9; ++i24) {
                b3 = b3;
            }
            i25 -= (int) Test0648.instanceCount;
            i25 *= i23;
            i5 -= i23;
            Test0648.lArrFld = Test0648.lArrFld;
        } while (++i23 < 183);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 5; i < 126; ++i) {
            ...
            for (i2 = 9; 207 > i2; i2 += 3) {
                ...
                i28 = 1;
                while (++i28 < 4) {
                    i3 += (((i28 * Test0648.instanceCount) + i) - i2);
                    iFld *= by2;
                    i27 += i1;
                }
                for (i29 = i; i29 < 4; ++i29) {
                    Test0648.instanceCount -= (long) Test0648.fFld;
                    i27 -= -164;
                }
                iFld -= i28;
                d2 += 46713;
                i30 = (int) Test0648.fFld;
            }
            i27 += (i | i1);
            iArr1 = iArr1;
            i3 = i;
        ...
        for (l2 = 212; l2 > 13; l2--) {
            for (i32 = (int) (l2); i32 < 126; i32++) {
                s >>= (short) i30;
                Test0648.iArrFld1[i32 - 1] -= -20611;
            }
            Test0648.instanceCount += (l2 - i33);
        }
        ...
        FuzzerUtils.out.println("Test0648.instanceCount iFld Test0648.fFld = " + Test0648.instanceCount + "," + iFld + "," +
                Float.floatToIntBits(Test0648.fFld));
        FuzzerUtils.out.println("iArrFld Test0648.iArrFld1 Test0648.lArrFld = " + FuzzerUtils.checkSum(iArrFld) + "," +
                FuzzerUtils.checkSum(Test0648.iArrFld1) + "," + FuzzerUtils.checkSum(Test0648.lArrFld));
