...
public class Test0309 {
    ...
    public static void vMeth1(double d1, double d2) {
        ...
        do {
            ...
            for (i9 = 1; i9 < 25; i9++) {
                i8 &= i8;
                Test0309.fFld -= Test0309.fFld;
                b = b;
                d2 -= 5L;
                i10 = (int) l;
                Test0309.instanceCount += by;
                i8 -= (int) Test0309.instanceCount;
            }
        } while ((l -= 2) > 0);
        ...
        try {
            ...
            for (i6 = 5; i6 < 308; i6++) {
                ...
                for (i11 = 5; i11 > i6; i11--) {
                    i12 = i6;
                    iArr2[i6 - 1] >>= (int) Test0309.instanceCount;
                    b1 = b1;
                    for (i13 = 1; i13 < 1; ++i13) {
                        if (false) continue;
                        try {
    ...
    public void mainTest(String[] strArr1) {
                    ...
                    case 27:
                        for (i3 = (int) (f); 2 > i3; i3++) {
                            switch ((((i3 * -213) >>> 1) % 3) + 20) {
                                case 20:
                                    lArr[i + 1] *= (long) (Test0309.instanceCount = (long) (Math.min(Test0309.instanceCount, -100701964L)
                                            - fMeth()));
                                        ...
                                        case 105:
                                            ...
                                            switch ((i % 5) + 106) {
                                                ...
                                                case 108:
                                                    ...
                                                    break;
                                                case 109:
                                                    Test0309.instanceCount -= -12;
                                                    break;
                                                case 110:
                                                default:
                                                    Test0309.instanceCount += (i3 + iFld);
                                            }
                                        case 106:
                                        case 107:
                                            iArr[i3] -= 23930;
        ...
        FuzzerUtils.out.println("Test0309.instanceCount iFld Test0309.fFld = " + Test0309.instanceCount + "," + iFld + "," +
                Float.floatToIntBits(Test0309.fFld));
