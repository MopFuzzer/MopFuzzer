...
public class Test0756 {
    ...
    public static float fMeth(int i2) {
        ...
        for (i3 = 3; i3 < 178; i3++) {
            switch (((i3 % 2) * 5) + 127) {
                case 133:
                    Test0756.fFld = i2;
                    fArr[i3] = Test0756.fFld;
                    break;
                case 134:
                    i4 *= Test0756.byFld;
                    i2 = (int) Test0756.instanceCount;
                    Test0756.sFld -= (short) 62L;
                    for (i5 = 1; 9 > i5; i5++) {
                        i2 *= Test0756.sFld;
                        i2 = i3;
                        d += i6;
                        i7 = 1;
                        do {
                            if (Test0756.bFld) continue;
                            i6 += (-41396 + (i7 * i7));
                            i2 += (((i7 * i2) + i2) - Test0756.fFld);
                        } while (++i7 < 2);
                    }
                    break;
            }
    ...
    public static void vMeth1() {
        ...
        do {
            iArr1[i8 + 1] <<= 61053;
            i1 += (((i8 * Test0756.instanceCount) + i8) - Test0756.fFld);
            Test0756.fFld += i8;
            iArr1[i8 + 1] = (int) d1;
            for (i9 = i8; i9 < 8; ++i9) {
                Test0756.instanceCount |= 122;
                try {
                    iArr1[i8 + 1] = (i8 / i9);
                    i10 = (31994 % iArr1[i9]);
                    i10 = (-50075 % i8);
    ...
    public static void vMeth(long l) {
        ...
        for (int i13 : iArr) {
            ...
            for (i16 = 1; 4 > i16; ++i16) {
                ...
                i15 *= (int) Test0756.instanceCount;
                l1 -= l;
            }
        }
        vMeth_check_sum += l + i + i14 + i15 + l1 + Double.doubleToLongBits(d2) + i16 + i17 +
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(Test0756.instanceCount);


        FuzzerUtils.out.println("Test0756.instanceCount Test0756.fFld Test0756.byFld = " + Test0756.instanceCount + "," +
                Float.floatToIntBits(Test0756.fFld) + "," + Test0756.byFld);
        FuzzerUtils.out.println("Test0756.sFld Test0756.bFld = " + Test0756.sFld + "," + (Test0756.bFld ? 1 : 0));
