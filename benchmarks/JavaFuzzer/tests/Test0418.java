...
public class Test0418 {
    ...
    static {
        FuzzerUtils.init(Test0418.fArrFld, 1.596F);
        FuzzerUtils.init(Test0418.bArrFld, false);
    }
    ...
    public static int iMeth(double d, int i2, double d1) {
        ...
        for (i3 = 3; i3 < 237; ++i3) {
            ...
            s += (short) (((i3 * i4) + i5) - i3);
            i6 += i3;
            Test0418.instanceCount = (long) (((f2 + i4) * fMeth(f2, i2, -10L)) - i5);
            iArr[i3] <<= i2;
        }
        iArr[(i2 >>> 1) % N] &= i5;
        for (i12 = 18; 344 > i12; i12++) {
            if (b1) {
                for (i14 = 1; i14 < 5; ++i14) {
                    i6 += (((i14 * f2) + f2) - Test0418.instanceCount);
                    i13 += (int) d1;
                }
                i13 -= -253;
            } else if (b1) {
    ...
    public static void vMeth(float f, float f1) {
        ...
        for (i = 8; i < 235; ++i) {
            Test0418.fArrFld[i + 1] += (((++i1) + (-(i1 * 28.55F))) / ((iMeth(d4, i1, 24.79978) + i1) | 1));
            i16 = 1;
            do {
                i1 += (int) f1;
                f -= f;
            ...
            while (--i17 > 0) {
                ...
                Test0418.instanceCount += (i17 | Test0418.instanceCount);
            }
        }
    ...
    public void mainTest(String[] strArr1) {
                ...
                for (i23 = 91; i23 > 1; i23--) {
                    ...
                    switch (((i19 >>> 1) % 1) + 106) {
                        case 106:
                            i19 *= (int) fFld;
                        default:
                            i20 -= (int) Test0418.instanceCount;
                            by1 *= (byte) i20;
                            fFld = 2824034042L;
                    }
                    i24 = i19;
        ...
        FuzzerUtils.out.println("Test0418.instanceCount fFld Test0418.sFld = " + Test0418.instanceCount + "," +
                Float.floatToIntBits(fFld) + "," + Test0418.sFld);
        FuzzerUtils.out.println("Test0418.dFld Test0418.fArrFld Test0418.bArrFld = " + Double.doubleToLongBits(Test0418.dFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0418.fArrFld)) + "," + FuzzerUtils.checkSum(Test0418.bArrFld));
