...
public class Test0215 {
            ...
            if (b) {
                ...
                while (++i5 < 6) {
                    ...
                    if (b) {
                        ...
                        do {
                            i3 -= i4;
                            i3 += (((i6 * i6) + i6) - Test0215.instanceCount);
    ...
    public static long lMeth(float f) {
        ...
        f += (float) dMeth();
        Test0215.instanceCount += i7;
        switch ((((i7 >>> 1) % 2) * 5) + 119) {
            case 127:
            case 125:
                f = Test0215.instanceCount;
                i7 *= i7;
                break;
        }
        for (i8 = 18; 311 > i8; ++i8) {
            ...
            Test0215.instanceCount += (long) 16.102F;
            i9 |= (int) Test0215.instanceCount;
            iArr1[i8 + 1] >>>= i10;
            Test0215.instanceCount += (-2 + (i8 * i8));
            for (i12 = 1; i12 < 6; ++i12) {
                try {
                    i11 = (i12 / iArr1[i8]);
                    i9 = (i11 / i13);
                ...
                Test0215.instanceCount += (141 + (i12 * i12));
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i14 = 13; 354 > i14; ++i14) {
            for (i16 = 2; i16 < 74; i16 += 2) {
                lArrFld[i14] >>= i14;
                f3 = l;
                i17 += (((i16 * Test0215.instanceCount) + f3) - i16);
                l = -13345;
                i17 += (i16 | Test0215.instanceCount);
            }
            i15 += (i14 * i14);
            for (i18 = 2; i18 < 74; ++i18) {
                i = (int) Test0215.instanceCount;
                for (i20 = 1; i20 < 2; i20++) {
                    i15 += s;
                    i17 -= -10;
                    i15 = i;
                    i += (((i20 * i19) + Test0215.instanceCount) - f3);
                    f3 += (i20 * i16);
                    d2 = Test0215.lFld;
                }
                Test0215.instanceCount -= i20;
                for (i22 = 1; i22 < 2; i22++) {
                    i21 = i19;
                    iArrFld[i22] >>= i23;
                    i23 <<= i;
        ...
        FuzzerUtils.out.println("Test0215.instanceCount Test0215.lFld iArrFld = " + Test0215.instanceCount + "," + Test0215.lFld + ","
