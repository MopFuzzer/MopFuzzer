...
public class Test0521 {
    ...
    static {
        FuzzerUtils.init(Test0521.lArrFld, -504191269126561288L);
    }
        ...
        for (i3 = 17; i3 < 308; i3++) {
            ...
            for (i5 = 1; 6 > i5; i5++) {
                for (i7 = 1; i7 < 2; i7++) {
                    ...
                    iArr[i3 - 1][i5] <<= i5;
                    i6 -= (int) d1;
                    Test0521.instanceCount += (((i7 * i5) + i6) - i5);
                }
                iArr[i5][i3 + 1] = (int) Test0521.instanceCount;
                Test0521.lArrFld[i5][i5] += i5;
                i6 = i4;
                i6 -= (int) -7L;
                Test0521.instanceCount += (56373 + (i5 * i5));
            }
        }
    ...
    public static int iMeth() {
        ...
        for (i9 = 3; i9 < 371; ++i9) {
            for (i11 = 1; 5 > i11; i11++) {
                iArr1[i9 - 1] = i9;
                s ^= (short) Test0521.instanceCount;
                iArr1 = iArr1;
            }
            try {
                iArr1[i9] = (i10 % 27677);
            ...
            i12 += (((i9 * Test0521.instanceCount) + s) - f);
            for (d2 = 1; d2 < 5; d2++) {
                for (i14 = 1; 2 > i14; i14 += 3) {
                    i15 += (i14 | Test0521.instanceCount);
                    i12 += i14;
                    i15 = (int) Test0521.instanceCount;
                    f -= i10;
                    f += (((i14 * Test0521.instanceCount) + Test0521.instanceCount) - f);
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
            ...
            for (i16 = 8; i16 < 159; i16++) {
                switch (((i % 8) * 5) + 22) {
                    case 59:
                        for (i18 = 2; i18 > 1; i18--) {
                            i19 = i;
                            i19 += (((i18 * Test0521.byFld) + Test0521.instanceCount) - i17);
                        }
                        break;
                    case 62:
                        Test0521.instanceCount += (i16 * i16);
                        fArr1[i16] += (float) d3;
                    case 40:
                        Test0521.lArrFld[(32 >>> 1) % N][i] = Test0521.instanceCount;
                        for (i20 = i; i20 < 2; ++i20) {
                            Test0521.instanceCount += (i20 * Test0521.instanceCount);
                            Test0521.instanceCount *= s1;
                            i17 = i;
                        }
                        i1 += (i16 | i21);
                    ...
                    case 29:
                        ...
                        i19 = i17;
                        f1 += (((i16 * i) + i18) - i);
                        Test0521.lArrFld[i][i16 - 1] += 55374;
                    case 60:
                        Test0521.instanceCount = i18;
                ...
                for (i22 = i16; i22 < 2; ++i22) {
                    Test0521.instanceCount *= (long) f1;
                }
                i19 += (((i16 * i19) + i22) - i16);
            }
        }
        ...
        FuzzerUtils.out.println("Test0521.instanceCount Test0521.byFld Test0521.bFld = " + Test0521.instanceCount + "," + Test0521.byFld +
                "," + (Test0521.bFld ? 1 : 0));
