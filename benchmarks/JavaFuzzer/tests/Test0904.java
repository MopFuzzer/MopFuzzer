...
public class Test0904 {
    ...
    public static void vMeth1(int i4, int i5) {
        ...
        for (i6 = 7; i6 < 264; ++i6) {
            s = (short) i4;
            Test0904.instanceCount -= i5;
        }
        i7 -= s;
        for (i8 = 205; i8 > 12; i8--) {
            i7 += (int) (-2.206F + (i8 * i8));
            iArr[i8 + 1] -= (int) Test0904.instanceCount;
            for (i10 = 1; i10 < 8; ++i10) {
                i5 = 4;
                i4 += (((i10 * i5) + i5) - i11);
                i12 = 1;
    ...
    public static void vMeth(int i2) {
        ...
        for (short s1 : sArr) {
            Test0904.instanceCount = i2;
            i2 = -105;
            i2 -= (int) Test0904.instanceCount;
        }
        i2 = i2;
        i2 >>= (int) Test0904.instanceCount;
    ...
    public void mainTest(String[] strArr1) {
                ...
                case 28:
                    for (i16 = 285; 5 < i16; --i16) {
                        ...
                        for (i18 = 1; i18 < 2; i18++) {
                            i17 -= i16;
                            s3 = (short) 4L;
                            Test0904.instanceCount += (i18 ^ i19);
                            i17 += i18;
                            i19 = (int) l1;
                            f3 -= 3;
                            byFld += (byte) (((i18 * f3) + f3) - i19);
                            l1 += (((i18 * i16) + i16) - Test0904.instanceCount);
                        }
                        l1 -= -10;
                        f3 = i17;
                        i19 = 240;
                    ...
                    switch (((i % 5) * 5) + 46) {
                        ...
                        case 62:
                            i19 += (((i * f3) + i) - l1);
                        case 54:
                            Test0904.instanceCount += (((i * Test0904.instanceCount) + l1) - byFld);
                    }
                    break;
                case 12:
                    dFld -= i16;
        ...
        FuzzerUtils.out.println("Test0904.instanceCount byFld dFld = " + Test0904.instanceCount + "," + byFld + "," +
