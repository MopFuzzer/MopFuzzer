...
public class Test0529 {
    ...
    public void vMeth1(float f2, int i7, boolean b) {
        ...
        do {
            ...
            if (b) {
                i7 += i7;
                Test0529.instanceCount = 28746;
                for (i9 = 1; i9 < 8; ++i9) {
                    i7 = (int) Test0529.lFld;
    ...
    public void vMeth(int i4) {
        ...
        for (i5 = 7; 128 > i5; ++i5) {
            boolean b1 = true;
            Test0529.lFld += Test0529.instanceCount;
            vMeth1(f3, i4, b1);
            for (f4 = 1; f4 < 13; ++f4) {
                i13 <<= (int) Test0529.lFld;
                Test0529.lFld += (4969 + (f4 * f4));
            ...
            Test0529.instanceCount = (long) -53.32226;
            ...
            switch ((int) ((f1 % 2) + 23)) {
                ...
                case 24:
                    for (i2 = 1; i2 < 5; i2 += 2) {
                        ...
                        vMeth(i1);
                        i1 += i1;
                        lArrFld[i2 - 1] += Test0529.lFld;
                        i1 += (int) Test0529.lFld;
                    }
                    for (i14 = 1; i14 < 5; i14++) {
                        by ^= (byte) Test0529.lFld;
    ...
    public void mainTest(String[] strArr1) {
            ...
            for (d1 = 5; d1 < 88; d1++) {
                ...
                for (i19 = 1; i19 < 2; i19++) {
                    ...
                    if (bFld) {
                        ...
                        i20 += (int) f;
                        sFld += (short) Test0529.instanceCount;
                    } else {
                        by1 <<= (byte) i21;
                    }
                    i += i19;
        ...
        FuzzerUtils.out.println("Test0529.instanceCount Test0529.lFld Test0529.fFld = " + Test0529.instanceCount + "," + Test0529.lFld +
