...
public class Test0100 {
    ...
    static {
        FuzzerUtils.init(Test0100.lArrFld, 173L);
        FuzzerUtils.init(Test0100.iArrFld, 24597);
    }
    ...
    public static void vMeth1(int i5, double d1, long l) {
        ...
        while (++f < 277) {
            ...
            do {
                f1 += (i6 + f1);
                Test0100.instanceCount = i6;
                i5 >>>= (int) l;
                i7 = 1;
                do {
                    Test0100.byFld %= (byte) -11L;
                    i5 += (int) l;
                    if (true) break;
                } while (++i7 < 1);
                f1 = i5;
    ...
    public static long lMeth() {
        ...
        for (i3 = 1; i3 < 287; i3++) {
            ...
            if (b) {
                ...
                for (i8 = 1; 6 > i8; i8++) {
                    for (f3 = 1; f3 < 2; ++f3) {
                        Test0100.instanceCount += (long) (((f3 * i4) + Test0100.instanceCount) - i4);
                        s += (short) Test0100.instanceCount;
                    }
                    for (i11 = 2; 1 < i11; --i11) {
                        i12 <<= (int) Test0100.instanceCount;
                        iArr2[i3 + 1] %= (int) (i10 | 1);
                        iArr2[i8] = (int) Test0100.instanceCount;
                    }
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(d3);
        for (f5 = 12; f5 < 281; f5++) {
            Test0100.lArrFld[(int) (f5)] += Test0100.instanceCount;
            for (i15 = 1; 93 > i15; ++i15) {
                try {
                    i16 = (i14 / -33078);
                    i14 = (i14 / 23305);
                    Test0100.iArrFld[(int) (f5 + 1)] = (-95 / i16);
                } catch (ArithmeticException a_e) {
                }
                Test0100.iArrFld = Test0100.iArrFld;
                i14 += i14;
                i16 += (((i15 * f5) + Test0100.byFld) - i16);
            }
            i14 = i16;
        }
        ...
        FuzzerUtils.out.println("Test0100.instanceCount Test0100.byFld bFld = " + Test0100.instanceCount + "," + Test0100.byFld + "," +
                (bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0100.lArrFld Test0100.iArrFld = " + FuzzerUtils.checkSum(Test0100.lArrFld) + "," +
                FuzzerUtils.checkSum(Test0100.iArrFld));
