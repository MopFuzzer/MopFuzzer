...
public class Test0463 {
    ...
    static {
        FuzzerUtils.init(Test0463.lArrFld, -3501304770271379911L);
    }
            ...
            switch (((-112 >>> 1) % 1) + 26) {
                case 26:
                    ...
                    do {
                        ...
                        iArr1 = iArr1;
                        i2 /= (int) -57698L;
                        i2 += (int) Test0463.instanceCount;
                    } while (--i5 > 0);
                    for (i6 = 7; i6 > 1; --i6) {
                        i7 += (((i6 * i7) + i3) - i7);
                        i7 = 62901;
                        i2 <<= i7;
                        lArr[i3] = (long) Test0463.dFld;
                        i7 += (int) -68.81457;
                    }
                    break;
                default:
                    Test0463.instanceCount -= by1;
            }
        }
    ...
    public static void vMeth(float f, long l, byte by) {
        ...
        i9 = 1;
        do {
            Test0463.dFld *= 2.209F;
            s -= (short) i8;
            Test0463.lArrFld[i9 - 1] += i9;
            sArr[i9] += (short) i8;
            Test0463.dFld = 3;
            s += (short) (((i9 * by) + i8) - i8);
            l1 = i8;
    ...
    public static float fMeth(int i1) {
        ...
        vMeth(f2, Test0463.instanceCount, by2);
        byArr[(13 >>> 1) % N] += (byte) i1;
        i1 = i1;
        for (i13 = 8; i13 < 274; i13++) {
            Test0463.dFld = Test0463.instanceCount;
            for (i15 = 1; i15 < 6; i15 += 2) {
                for (i17 = 1; 3 > i17; i17++) {
                    i16 = i16;
                    by2 *= (byte) i13;
                    Test0463.instanceCount += -43534;
                    Test0463.dFld -= by2;
                    switch (((i13 % 1) * 5) + 90) {
                        case 93:
                            Test0463.dFld *= i1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i += i;
        Test0463.instanceCount >>= (--iArr[(i >>> 1) % N]);
        Test0463.instanceCount -= (long) (fMeth(i) - i);
        for (long l2 : Test0463.lArrFld) {
                        ...
                        switch (((i23 >>> 1) % 7) + 61) {
                            ...
                            case 62:
                                if (bFld) {
                                    ...
                                    Test0463.instanceCount *= i22;
                                    i24 = by3;
                                    dArrFld[i23 + 1] = Test0463.dFld;
                                }
                                for (l4 = 1; l4 < 2; ++l4) {
                                    iArr[i23] += i24;
                                    i25 -= 115;
                            ...
                            case 66:
                                ...
                                break;
                            case 67:
                                Test0463.instanceCount += (((i23 * f3) + f3) - f3);
                                break;
                            default:
                                l3 += i19;
                        }
        ...
        FuzzerUtils.out.println("Test0463.instanceCount Test0463.dFld bFld = " + Test0463.instanceCount + "," +
                Double.doubleToLongBits(Test0463.dFld) + "," + (bFld ? 1 : 0));
        FuzzerUtils.out.println("iFld Test0463.lArrFld dArrFld = " + iFld + "," + FuzzerUtils.checkSum(Test0463.lArrFld) + ","
