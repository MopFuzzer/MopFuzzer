...
public class Test0883 {
    ...
    static {
        FuzzerUtils.init(Test0883.lArrFld, 9L);
        FuzzerUtils.init(Test0883.bArrFld, false);
    }
    ...
    public static void vMeth2(int i10) {
        ...
        for (i11 = 6; i11 < 327; i11++) {
            ...
            for (i13 = 1; i13 < 5; ++i13) {
                for (i15 = 1; 2 > i15; ++i15) {
                    i10 >>= (int) Test0883.instanceCount;
                    if (false) {
                        Test0883.instanceCount *= i11;
                        i16 += (168 + (i15 * i15));
                    } else if (b1) {
                        iArr2[i13 + 1] <<= i10;
                        i10 += (((i15 * i16) + Test0883.sFld) - i16);
                        Test0883.lArrFld[i11 - 1] = i11;
                    } else if (b1) {
                        try {
                ...
                while (++d1 < 2) {
                    ...
                    switch (((i18 % 7) * 5) + 2) {
                        case 9:
                            ...
                            i21 >>= i17;
                            f1 += (float) (((d1 * l1) + Test0883.sFld) - i21);
                            fArr1 = fArr1;
                            break;
                        case 7:
                            dArr[(i21 >>> 1) % N] = i22;
    ...
    public void vMeth(long l, int i4, int i5) {
        ...
        iArr1[(i4 >>> 1) % N] /= (int) ((i4 % ((++Test0883.instanceCount) | 1)) | 1);
        Test0883.sFld -= (short) (Short.reverseBytes((short) (i4 + Test0883.instanceCount)) /
                (Long.reverseBytes(Test0883.instanceCount + 236) | 1));
        i4 = (int) (-98 - f);
        for (i6 = 1; i6 < 223; i6++) {
            for (i8 = 1; i8 < 7; ++i8) {
                vMeth1(4L);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 388; i > 18; --i) {
            ...
            for (i2 = 1; i2 < 68; ++i2) {
                double d = -111.127545;
                i1 = (int) ((iArr[i - 1] + (5 * (iArr[i + 1]++))) - ((i + 23620) - (Test0883.instanceCount + i3)));
                ...
                for (i26 = 2; 1 < i26; i26--) {
                    ...
                    i3 += i26;
                    Test0883.bArrFld[i2 + 1] = false;
                    Test0883.fFld += (-1.758F + (i26 * i26));
                    b = b;
                    d -= i3;
                }
                if (b) break;
                Test0883.fFld = (float) d;
                for (i28 = 1; i28 < 2; i28++) {
                    i29 += i3;
                    i1 = (int) Test0883.instanceCount;
                }
            }
            Test0883.sFld = (short) i26;
            i1 += i29;
            fArr[i] *= i26;
            for (i30 = i; 68 > i30; i30++) {
                Test0883.instanceCount += i30;
                Test0883.instanceCount += (-13 + (i30 * i30));
                i31 += i30;
                for (d2 = 1; 1 > d2; ++d2) {
        ...
        FuzzerUtils.out.println("Test0883.instanceCount Test0883.sFld Test0883.fFld = " + Test0883.instanceCount + "," + Test0883.sFld +
                "," + Float.floatToIntBits(Test0883.fFld));
        FuzzerUtils.out.println("Test0883.lArrFld Test0883.bArrFld = " + FuzzerUtils.checkSum(Test0883.lArrFld) + "," +
                FuzzerUtils.checkSum(Test0883.bArrFld));
