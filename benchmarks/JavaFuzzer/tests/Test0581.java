...
public class Test0581 {
    ...
    static {
        FuzzerUtils.init(Test0581.dArrFld, 98.107371);
    }
    ...
    public static int iMeth1(int i7, int i8, int i9) {
        ...
        i10 = 1;
        while (++i10 < 217) {
            f += Test0581.instanceCount;
            i7 = (int) Test0581.instanceCount;
            i9 <<= i10;
            switch (((i10 % 4) * 5) + 26) {
                case 30:
                    iArr[i10] += i9;
                    i8 = i9;
                    i8 |= (int) Test0581.instanceCount;
                    break;
                case 40:
                    for (i11 = 1; 7 > i11; ++i11) {
                        b = b;
    ...
    public static void vMeth() {
        ...
        for (i5 = 3; 202 > i5; i5++) {
            ...
            for (i14 = 1; i14 < 8; ++i14) {
                ...
                for (i16 = 2; i16 > 1; --i16) {
                    s ^= (short) i14;
                    Test0581.instanceCount += (i16 ^ (long) f1);
                    d2 = d2;
    ...
    public static int iMeth(int i3, int i4) {
        ...
        i3 -= (int) ((0.121826 % (Long.reverseBytes(Test0581.instanceCount) | 1)) - (-201L - (d * i3)));
        vMeth();
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 3; i < 152; i++) {
            ...
            i2 = 1;
            while (++i2 < 168) {
                Test0581.instanceCount = ((-iMeth(i, i)) - -31702);
            }
            Test0581.dArrFld[i + 1] += i;
            by1 *= (byte) Test0581.instanceCount;
            iArrFld[i - 1] >>= (int) Test0581.instanceCount;
            if (b1) continue;
            if (b1) {
                for (i18 = 9; i18 < 168; i18++) {
                    ...
                    while (++i20 < 2) {
                        f2 *= i19;
                        iArrFld[i] <<= (int) Test0581.instanceCount;
                        Test0581.sFld += (short) (-47164 + (i20 * i20));
                        fArr[i18] = i1;
                        i1 += i20;
                        switch ((i20 % 2) + 114) {
                            case 114:
                                lArr[i18 + 1] = -14;
                                dFld = -1.516F;
                                i19 += (((i20 * i19) + i20) - Test0581.instanceCount);
                                if (b1) break;
                                break;
                            case 115:
                                Test0581.instanceCount -= Test0581.instanceCount;
                        ...
                        Test0581.sFld = (short) -20.28F;
                        if (b1) continue;
                        i1 = (int) Test0581.instanceCount;
                        b1 = b1;
                    }
                    dFld = i18;
                    f2 -= i1;
        ...
        FuzzerUtils.out.println("Test0581.instanceCount Test0581.sFld dFld = " + Test0581.instanceCount + "," + Test0581.sFld + "," +
                Double.doubleToLongBits(dFld));
        FuzzerUtils.out.println("iArrFld Test0581.dArrFld = " + FuzzerUtils.checkSum(iArrFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0581.dArrFld)));
