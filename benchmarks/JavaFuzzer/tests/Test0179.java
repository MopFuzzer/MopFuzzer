...
public class Test0179 {
            ...
            switch ((((i3 >>> 1) % 3) * 5) + 16) {
                case 31:
                    ...
                    do {
                        ...
                        for (l = 1; 5 > l; ++l) {
                            i4 /= (int) ((long) (f) | 1);
                            Test0179.instanceCount = 137;
                            i4 += (int) (14L + (l * l));
                        }
                        Test0179.instanceCount += (((i10 * i11) + i3) - i3);
                    } while ((i10 += 3) < 5);
                    bArr[i3] = b1;
                    break;
                case 27:
    ...
    public static long lMeth() {
        ...
        for (i1 = 4; 146 > i1; ++i1) {
            ...
            i2 *= (int) d2;
            Test0179.instanceCount += (-191 + (i1 * i1));
            iArr1[i1 + 1] -= (int) Test0179.instanceCount;
            for (i12 = 1; i12 < 11; ++i12) {
                ...
                for (i14 = 1; 2 > i14; i14++) {
                    i13 += (int) Test0179.instanceCount;
                    Test0179.instanceCount += i14;
                    Test0179.fFld += (float) d2;
                    i13 = i12;
                }
                if (b2) continue;
            }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = i;
        i <<= i;
        bArr1[(-133 >>> 1) % N] = Test0179.bFld;
        by1 -= (byte) i16;
        Test0179.instanceCount <<= i16;
        i *= (int) 25512L;
        i = i16;
        if (true) {
            Test0179.instanceCount -= i16;
            for (i17 = 3; i17 < 142; ++i17) {
                ...
                for (i21 = 6; i21 < 180; i21++) {
                    ...
                    for (i23 = 1; 2 > i23; i23++) {
                        Test0179.instanceCount -= -28231;
                    }
                    d3 += i21;
                    i18 -= i21;
                }
            }
        } else if (Test0179.bFld) {
            i = (int) Test0179.instanceCount;
        } else {
            i22 = i23;
        }
        ...
        FuzzerUtils.out.println("Test0179.instanceCount Test0179.fFld Test0179.bFld = " + Test0179.instanceCount + "," +
                Float.floatToIntBits(Test0179.fFld) + "," + (Test0179.bFld ? 1 : 0));
