...
public class Test0768 {
    ...
    static {
        FuzzerUtils.init(Test0768.iArrFld, -219);
        FuzzerUtils.init(Test0768.lArrFld, 13L);
    }
    ...
    public static void vMeth1(int i8, int i9, int i10) {
        ...
        for (f1 = 1; f1 < 382; ++f1) {
            for (d = 1; d < 4; ++d) {
                s <<= (short) i10;
                Test0768.lArrFld[(int) (f1 - 1)] += 49;
                i12 -= i10;
                dArr[(int) (d + 1)] *= i10;
                s -= (short) i8;
                if (b) break;
                Test0768.iArrFld[(int) (d)] *= (int) d;
            }
            d1 += i11;
            iArr = iArr;
            i11 -= (int) 1.59712;
        }
        i11 /= (int) (Test0768.instanceCount | 1);
        lArr = lArr;
    ...
    public static void vMeth(int i3, float f, int i4) {
        ...
        for (int i5 : Test0768.iArrFld) {
            for (i6 = 1; i6 < 4; i6 += 3) {
                vMeth1(i5, i4, -98);
                for (i13 = 1; i13 < 4; ++i13) {
                    Test0768.instanceCount += -174;
                    f = f;
                }
                i4 += (int) 2.546F;
                by = (byte) 46534;
                Test0768.instanceCount += i6;
                i15 = 1;
                while (++i15 < 4) {
                    Test0768.iArrFld[i6] = i4;
                    d2 -= i13;
                    i14 += i15;
                    f -= i13;
                    i5 -= i7;
    ...
    public static float fMeth(int i1, long l, int i2) {
        ...
        while (--l2 > 0) {
            ...
            for (i16 = (int) (l2); 5 > i16; i16++) {
                fArr[(int) (l2 + 1)] += (float) Test0768.dFld;
                i1 += i2;
                i2 += (i16 * i16);
                f2 += (i16 * i16);
                if (i16 != 0) {
                }
                f2 = Test0768.instanceCount;
            }
        }
        i18 = 296;
        while (--i18 > 0) {
            boolean b1 = true;
            Test0768.byFld += (byte) (i18 * i18);
            Test0768.iArrFld = FuzzerUtils.int1array(N, (int) -3);
            i2 >>= 0;
            if (b1) continue;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        switch (((i20 >>> 1) % 9) + 3) {
            case 3:
                ...
                for (i23 = 3; i23 < 175; ++i23) {
                    for (i25 = 7; i25 < 146; i25++) {
                        for (d3 = 1; d3 < 2; d3++) {
                            Test0768.iArrFld = Test0768.iArrFld;
                            fFld = Test0768.instanceCount;
                            Test0768.instanceCount *= i25;
                            Test0768.iArrFld[i25 + 1] -= i28;
                            switch (((i19 >>> 1) % 8) + 74) {
                                case 74:
                                    Test0768.instanceCount &= i28;
                                    switch (((i19 >>> 1) % 1) + 44) {
                                        case 44:
                                            Test0768.instanceCount >>= 97;
                                            fFld = -89;
                                            Test0768.iArrFld[i25] *= Test0768.byFld;
                                            i29 += sFld;
                                    }
                                    break;
                                case 75:
                                    Test0768.lArrFld[i23] >>>= i28;
                                    Test0768.instanceCount += i21;
                                    Test0768.instanceCount = i21;
                                case 76:
                                case 77:
                                    fFld += (float) (d3 * i25);
            ...
            case 6:
                ...
                break;
            case 7:
                Test0768.iArrFld[(i23 >>> 1) % N] -= i23;
                break;
            case 8:
                Test0768.byFld += (byte) fFld;
                break;
            case 9:
                Test0768.byFld = (byte) i26;
            case 10:
                i19 -= sFld;
                break;
            case 11:
        ...
        FuzzerUtils.out.println("Test0768.instanceCount Test0768.dFld Test0768.byFld = " + Test0768.instanceCount + "," +
                Double.doubleToLongBits(Test0768.dFld) + "," + Test0768.byFld);
        FuzzerUtils.out.println("fFld sFld Test0768.bFld = " + Float.floatToIntBits(fFld) + "," + sFld + "," + (Test0768.bFld ?
                1 : 0));
        FuzzerUtils.out.println("Test0768.iArrFld Test0768.lArrFld = " + FuzzerUtils.checkSum(Test0768.iArrFld) + "," +
                FuzzerUtils.checkSum(Test0768.lArrFld));
