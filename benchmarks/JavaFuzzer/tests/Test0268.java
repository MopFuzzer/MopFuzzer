...
public class Test0268 {
    ...
    static {
        FuzzerUtils.init(Test0268.iArrFld, 114);
    }
                ...
                switch ((((i6 >>> 1) % 2) * 5) + 52) {
                    case 62:
                        ...
                        switch ((int) ((l1 % 8) + 89)) {
                            case 89:
                                i8 += (int) l1;
                                Test0268.iArrFld[i5 - 1] = s1;
                                i6 *= -74;
                                i6 += (51214 + (l1 * l1));
                            case 90:
                                lArr[i5 + 1][(i6 >>> 1) % N] = i6;
                                if (Test0268.bFld) continue;
                                Test0268.iArrFld[i5 + 1] >>= i8;
                                byArr[(int) (l1 + 1)] *= (byte) Test0268.instanceCount;
                                break;
                            case 91:
                                f2 -= i6;
                                Test0268.instanceCount = i6;
                                break;
                            case 92:
                                lArr[i5 + 1][(int) (l1)] >>= -7826;
                            case 93:
                                i8 = (int) Test0268.instanceCount;
                                break;
                            case 94:
                                Test0268.instanceCount >>= i5;
                                break;
                            case 95:
                            case 96:
                                Test0268.iArrFld[(int) (l1 - 1)] = (int) Test0268.instanceCount;
                                break;
                            default:
                                Test0268.instanceCount >>>= i5;
                        }
    ...
    public static void vMeth(long l) {
        ...
        i4 += (int) (((i4 / (i4 | 1)) / (((long) (l * d)) | 1)) - ((Test0268.instanceCount + i4) + (i4 %= (int) 2733679434L)));
        i4 = (int) f1;
    ...
    public static int iMeth() {
        ...
        for (d3 = 5; d3 < 194; d3++) {
            for (i13 = 1; i13 < 8; i13++) {
                for (i15 = 2; i15 > 1; i15--) {
                    f3 *= Test0268.instanceCount;
                    fArr1[i15 + 1] += f3;
                    try {
                        Test0268.iArrFld[(int) (d3 - 1)] = (i15 / -40640);
                        i14 = (i16 % Test0268.iArrFld[i13]);
                        i11 = (10 / i3);
                    } catch (ArithmeticException a_e) {
                    }
                    i11 >>>= (int) Test0268.instanceCount;
                    Test0268.instanceCount &= i16;
                    Test0268.instanceCount -= i11;
                    Test0268.iArrFld = Test0268.iArrFld;
                    Test0268.instanceCount = (long) 68.861F;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (f = 12; f < 273; ++f) {
            i2 = 96;
            while (--i2 > 0) {
                Test0268.instanceCount = (iMeth() - 7);
                try {
                    i1 = (i1 / -35874);
                    i1 = (89 % Test0268.iArrFld[(int) (f - 1)]);
                    Test0268.iArrFld[i2] = (i1 % 112);
                } catch (ArithmeticException a_e) {
                }
                for (i17 = 1; i17 > 1; i17 -= 2) {
                    Test0268.iArrFld[(int) (f)] <<= i1;
                    f4 -= -5;
                    i -= -104;
                    Test0268.instanceCount -= (long) dFld;
        ...
        FuzzerUtils.out.println("Test0268.instanceCount Test0268.bFld dFld = " + Test0268.instanceCount + "," + (Test0268.bFld ? 1 : 0)
                + "," + Double.doubleToLongBits(dFld));
        FuzzerUtils.out.println("Test0268.iFld byFld Test0268.iArrFld = " + Test0268.iFld + "," + byFld + "," +
