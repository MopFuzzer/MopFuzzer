...
public class Test0551 {
    ...
    public static void vMeth2() {
        ...
        for (i8 = 7; i8 < 176; i8 += 3) {
            ...
            for (i10 = 1; i10 < 27; i10++) {
                ...
                lArr[i10] -= Test0551.instanceCount;
                Test0551.instanceCount -= 176;
                i9 %= (int) (i11 | 1);
                switch ((i8 % 2) + 48) {
                    case 48:
                        for (i12 = 1; i12 < 2; ++i12) {
    ...
    public static void vMeth1(long l, int i3) {
        ...
        for (i4 = 3; i4 < 129; i4 += 2) {
            for (i6 = i4; i6 < 24; i6++) {
                boolean b = false;
                l = (8L - (i7 += (int) (Test0551.instanceCount + 64733L)));
                if (b = b) continue;
                vMeth2();
                i3 >>= i6;
                i7 += (i6 - l);
    ...
    public static void vMeth(int i1, int i2) {
        ...
        vMeth1(Test0551.instanceCount, i1);
        i1 += i2;
        for (i14 = 2; i14 < 133; i14++) {
            ...
            f1 += (float) -1.118913;
            iArr1[i14 - 1] |= i14;
            Test0551.instanceCount += (i14 | i1);
        }
        Test0551.instanceCount -= Test0551.instanceCount;
        i2 <<= (int) Test0551.instanceCount;
        b1 = b1;
        i15 -= i14;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i18 = 1;
        do {
            Test0551.iFld += (((i18 * i) + i) - i);
        } while (++i18 < 269);
        for (i19 = 13; i19 < 256; ++i19) {
            for (i21 = 2; i21 < 103; i21++) {
                i22 += (i21 + Test0551.iFld);
                s1 <<= (short) i18;
                iArr2 = iArr2;
                i22 += (int) Test0551.instanceCount;
                if (b2) continue;
                b2 = b2;
                sArr[i19] -= (short) Test0551.instanceCount;
                iArr2[i21 - 1][i19] += 30370;
                i23 = 2;
                do {
                    lArrFld[i21] = Test0551.instanceCount;
                    d3 *= d3;
                    i22 = i;
                    d3 -= i22;
                    i20 >>>= (int) Test0551.instanceCount;
                    if (b2) {
                        Test0551.instanceCount = Test0551.iFld;
                        fArr1[i19] = (float) d3;
                        fArr1[i19 + 1] = Test0551.instanceCount;
                    } else if (true) {
                        lFld -= lFld;
                        s1 -= (short) i20;
                        lArrFld[i19 + 1] >>= i;
        ...
        FuzzerUtils.out.println("Test0551.instanceCount Test0551.iFld lFld = " + Test0551.instanceCount + "," + Test0551.iFld + "," +
                lFld);
