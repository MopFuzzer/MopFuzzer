...
public class Test0999 {
    ...
    static {
        FuzzerUtils.init(Test0999.lArrFld, -3L);
        FuzzerUtils.init(Test0999.dArrFld, -49.113005);
    }
    ...
    public static long lMeth(short s1, int i8, long l) {
        ...
        i9 = 292;
        do {
            vMeth1(Test0999.instanceCount);
            i8 >>= by;
        } while (--i9 > 0);
        f1 = 1;
        do {
            i8 += (int) ((long) f1 | i8);
            i8 += (int) (((f1 * i8) + i8) - Test0999.instanceCount);
            i8 += i9;
            i8 = i9;
            Test0999.instanceCount += (long) (-1.678F + (f1 * f1));
            for (i18 = 1; i18 < 5; ++i18) {
                f2 = l;
                if (false) continue;
                by -= (byte) i18;
    ...
    public static void vMeth(double d, short s) {
        ...
        for (i6 = 10; 336 > i6; i6++) {
            iArr1[i6 - 1] += (int) lMeth(s, i6, Test0999.instanceCount);
            switch ((i6 % 7) + 56) {
                case 56:
                    for (i20 = 1; i20 < 5; i20++) {
                    ...
                    while (--i22 > 0) {
                        ...
                        for (i23 = i22; i23 < 1; i23 += 3) {
                            Test0999.instanceCount = i24;
                        }
                        i7 = (int) Test0999.instanceCount;
                        if (true) continue;
                        fArr1[i22 + 1] *= i24;
                        f3 *= 137;
                        i7 = i20;
                ...
                case 58:
                    ...
                    break;
                case 59:
                    i24 = (int) Test0999.instanceCount;
                    break;
                case 60:
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i4 = 9; i4 < 192; ++i4) {
            iArr[i4] += (int) (Test0999.dFld -= ((i + -38687) >> i5));
            vMeth(Test0999.dFld, sFld);
        }
        for (i25 = 6; i25 < 134; i25++) {
            for (i27 = 12; i27 < 196; i27++) {
                for (i29 = 2; i29 > 1; i29--) {
                    if (Test0999.bFld) break;
                    i28 = (int) Test0999.instanceCount;
                    Test0999.instanceCount = i30;
                    Test0999.dFld = by1;
                    i28 *= (int) Test0999.instanceCount;
                    i1 >>>= i3;
                    i1 += (int) Test0999.instanceCount;
                }
                i28 *= (int) Test0999.instanceCount;
                ...
                if (b) {
                    for (i31 = 1; i31 < 2; ++i31) {
                        ...
                        switch (((i >>> 1) % 10) + 113) {
                            ...
                            case 120:
                                Test0999.dArrFld = Test0999.dArrFld;
                            case 121:
                                Test0999.instanceCount = i30;
                                break;
                            case 122:
        ...
        FuzzerUtils.out.println("Test0999.instanceCount Test0999.bFld Test0999.dFld = " + Test0999.instanceCount + "," + (Test0999.bFld ? 1
                : 0) + "," + Double.doubleToLongBits(Test0999.dFld));
        FuzzerUtils.out.println("sFld lFld Test0999.lArrFld = " + sFld + "," + lFld + "," +
                FuzzerUtils.checkSum(Test0999.lArrFld));
        FuzzerUtils.out.println("Test0999.dArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0999.dArrFld)));
