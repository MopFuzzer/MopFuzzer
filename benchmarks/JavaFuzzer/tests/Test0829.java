...
public class Test0829 {
    ...
    static {
        FuzzerUtils.init(Test0829.iArrFld1, 3);
    }
        ...
        for (int i8 : iArr1) {
            for (d2 = 1; 4 > d2; ++d2) {
                for (i10 = (int) (d2); 2 > i10; i10++) {
                    float f = 63.600F;
                    f *= Test0829.instanceCount;
                    if (b2) break;
                }
                i9 += (int) Test0829.instanceCount;
                i7 -= i9;
                try {
                    i11 = (57035 % i8);
                    i9 = (iArr1[(int) (d2)] % i8);
            ...
            Test0829.instanceCount <<= i10;
        }
        Test0829.instanceCount = -245;
    ...
    public static void vMeth1(int i5, boolean b1, int i6) {
        ...
        Test0829.instanceCount = (i5 * Integer.reverseBytes((int) (Test0829.fFld * d1)));
        lArr1[(165 >>> 1) % N][(i6 >>> 1) % N] -= iMeth(-103);
        f1 = 1;
        do {
            Test0829.byFld *= (byte) Test0829.fFld;
            i5 *= i5;
            i6 = i5;
            Test0829.iArrFld1[(int) (f1 - 1)] -= i6;
            i5 >>= i5;
            for (i12 = 10; i12 > f1; --i12) {
                Test0829.iArrFld1[i12 + 1] >>= i6;
                i5 *= i5;
                for (i14 = 1; i14 < 1; i14++) {
                    short s = -18721;
                    Test0829.byFld += (byte) -48L;
                    s -= (short) Test0829.instanceCount;
                    i13 += (i14 * i14);
                }
            }
        } while (++f1 < 151);
    ...
    public static void vMeth(long l, int i2) {
        ...
        Test0829.fFld -= (float) (d *= ((-(i2 - -15351)) * i2));
        i2 -= (int) ((Test0829.fFld - Test0829.fFld) + (i2 * (++i2)));
        i3 = 1;
        do {
            Test0829.instanceCount <<= (long) (((i2 -= -50522) - (dArr[i3 - 1]--)) - (Test0829.fFld *= (i3 + i4)));
            if (b) {
                Test0829.fFld += (lArr[(i3 >>> 1) % N][i3] - (i4++));
                Test0829.fFld *= fArr[i3 + 1];
                iArr[i3 - 1] = (i4--);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 15; i < 350; ++i) {
            Test0829.instanceCount += i;
            i1 = (++i1);
            iArrFld[i - 1] = (--i1);
        }
        vMeth(Test0829.instanceCount, i1);
        i1 *= (int) Test0829.fFld;

        FuzzerUtils.out.println("i i1 = " + i + "," + i1);

        FuzzerUtils.out.println("Test0829.instanceCount Test0829.fFld Test0829.byFld = " + Test0829.instanceCount + "," +
                Float.floatToIntBits(Test0829.fFld) + "," + Test0829.byFld);
        FuzzerUtils.out.println("iArrFld Test0829.iArrFld1 = " + FuzzerUtils.checkSum(iArrFld) + "," +
                FuzzerUtils.checkSum(Test0829.iArrFld1));
