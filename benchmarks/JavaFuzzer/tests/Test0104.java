...
public class Test0104 {
    ...
    public static void vMeth(int i3, short s1, double d) {
        ...
        while (++i4 < 292) {
            for (f = 1; f < 6; f++) {
                i3 = 204;
                vMeth1(Test0104.instanceCount, i4, i3);
                i5 += (int) (((f * i5) + Test0104.instanceCount) - i3);
                lArr[i4] += i4;
                Test0104.fFld -= i4;
                try {
                    iArr[i4 - 1] = (i4 % i3);
            ...
            if (b) {
                ...
                Test0104.instanceCount += i3;
                dArr[i4 - 1][i4 + 1] *= 167;
                i3 <<= (int) Test0104.instanceCount;
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 124; i > 3; i -= 2) {
            i1 = -14;
            Test0104.instanceCount <<= (s * Math.min(-119 + (7 + iMeth(-91L)), -10));
            for (i11 = i; 192 > i11; ++i11) {
                for (i13 = 1; i13 < 2; ++i13) {
                    fArr[i11 - 1] -= 159;
                    i12 += (int) Test0104.instanceCount;
                    i12 += (i13 | Test0104.instanceCount);
                }
                i14 += (i11 - i12);
                iArr2[i] ^= i14;
                iArr2[i11 + 1] = 38533;
                Test0104.byFld -= (byte) i;
                for (i15 = 1; i15 < 2; ++i15) {
                    Test0104.instanceCount -= i;
                    switch ((((i13 >>> 1) % 2) * 5) + 89) {
                        case 91:
                            switch (((i11 >>> 1) % 10) + 97) {
                                case 97:
                                    i1 %= (int) (i16 | 1);
                                    Test0104.instanceCount <<= Test0104.byFld;
                                    break;
                                case 98:
                                    b2 = b2;
                                    i12 += i15;
                                ...
                                case 100:
                                    Test0104.fFld = i15;
                                    iArr2[i + 1] &= (int) Test0104.instanceCount;
                        ...
                        case 95:
                            ...
                            break;
                        default:
                            i16 += (((i15 * i) + i1) - Test0104.instanceCount);
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0104.instanceCount Test0104.fFld Test0104.byFld = " + Test0104.instanceCount + "," +
                Float.floatToIntBits(Test0104.fFld) + "," + Test0104.byFld);
