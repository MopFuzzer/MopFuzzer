...
public class Test0733 {
    ...
    public static void vMeth1(float f2) {
        ...
        do {
            ...
            for (i8 = 1; i8 < 7; ++i8) {
                ...
                for (i10 = 1; i10 < 2; i10++) {
                    iArr1[i8 - 1] >>>= i11;
                    i9 += (i10 ^ Test0733.byFld);
                    switch (((Test0733.iFld >>> 1) % 2) + 17) {
                        case 17:
                            Test0733.instanceCount += (((i10 * i11) + i9) - Test0733.instanceCount);
                            if (i11 != 0) {
                                vMeth1_check_sum += Float.floatToIntBits(f2) + i7 + s + i8 + i9 + i10 + i11 + i12 +
                                        FuzzerUtils.checkSum(iArr1);
                                return;
                            }
                            Test0733.instanceCount = i8;
                            i11 = (int) Test0733.instanceCount;
                            break;
                        case 18:
                            i11 = i12;
                    }
    ...
    public static void vMeth(float f1, long l, long l1) {
        ...
        for (i13 = 2; i13 < 288; i13 += 2) {
            ...
            i15 = 1;
            do {
                Test0733.iFld -= Test0733.byFld;
                i16 = 1;
                do {
                    Test0733.iFld <<= Test0733.iFld;
                    Test0733.iFld = (int) l1;
                    i14 += (int) l;
                    switch ((i13 % 2) + 43) {
                        case 43:
                            l = i16;
    ...
    public static double dMeth() {
        ...
        for (i3 = 7; i3 < 283; i3++) {
            for (i5 = 6; i5 > 1; i5--) {
                ...
                i6 += (((i5 * f) + Test0733.instanceCount) - i6);
                vMeth(f, 5326654142196372576L, Test0733.instanceCount);
                lArr[i3 - 1] <<= i5;
                for (i17 = 1; 2 > i17; i17++) {
                    d = i17;
                }
                lArr[i5 + 1] -= s1;
                Test0733.instanceCount = i17;
                Test0733.byFld *= (byte) i17;
                for (i19 = i5; 2 > i19; ++i19) {
                    if (b1) {
                        f += (((i19 * Test0733.instanceCount) + Test0733.instanceCount) - i20);
                    } else {
                        f = 11;
                    }
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i -= (iArr[(-222 >>> 1) % N]--);
        dFld += (iArr[(i >>> 1) % N]--);
        Test0733.instanceCount += (iArr[(i >>> 1) % N] + (i += iArr[(i >>> 1) % N]));
        for (i1 = 5; i1 < 387; ++i1) {
            i = (int) (dMeth() - i2);
        }
        if (Test0733.bFld) {
            for (int i21 : iArr) {
                ...
                for (i22 = 2; i22 < 63; ++i22) {
                    for (i24 = 1; i24 < 2; i24 += 2) {
                        ...
                        Test0733.iFld *= i25;
                        fArr1[i22] += 9;
                        Test0733.iFld += (1 + (i24 * i24));
                    }
                    i21 -= (int) 4088650566L;
                    Test0733.instanceCount >>= i;
                    try {
                        iArr[i22] = (i22 / iArr[i22 + 1]);
                        i21 = (Test0733.iFld % -29801);
                        i = (Test0733.iFld % 21652);
                    } catch (ArithmeticException a_e) {
                    }
                    i >>= Test0733.byFld;
                    for (f3 = 1; f3 < 2; ++f3) {
                        Test0733.instanceCount *= (long) f3;
                        if (Test0733.bFld) break;
                        Test0733.byFld += (byte) -59L;
                        Test0733.instanceCount -= i2;
                        switch ((((i21 >>> 1) % 2) * 5) + 12) {
                            case 19:
                                lArr1[i22][i22 - 1] >>= i24;
                                Test0733.instanceCount *= (long) dFld;
                                i21 = i26;
                                break;
                            case 15:
                                lArr1[(int) (f3 - 1)][i22] -= Test0733.byFld;
                                break;
                        }
                    }
                }
        ...
        FuzzerUtils.out.println("Test0733.instanceCount dFld Test0733.iFld = " + Test0733.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + Test0733.iFld);
        FuzzerUtils.out.println("Test0733.byFld Test0733.bFld = " + Test0733.byFld + "," + (Test0733.bFld ? 1 : 0));
