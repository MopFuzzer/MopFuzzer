...
public class Test0914 {
    ...
    static {
        FuzzerUtils.init(Test0914.iArrFld, 5);
        FuzzerUtils.init(Test0914.fArrFld, 1.287F);
    }
    ...
    public static int iMeth() {
        ...
        while (++i11 < 126) {
            i12 = 10;
            i12 += (i11 | Test0914.sFld);
            for (f1 = 1; 12 > f1; ++f1) {
                i13 = 94;
                Test0914.instanceCount += (long) (f1 * f1);
                i13 += (int) f1;
                for (i14 = i11; i14 < 2; i14++) {
                    i15 = i11;
                    i15 = -125;
                    Test0914.instanceCount += (((i14 * i12) + Test0914.instanceCount) - f1);
                    f2 *= i14;
                    f2 = i14;
                    try {
    ...
    public static void vMeth1(int i2, double d, long l1) {
        ...
        for (i3 = 5; i3 < 167; ++i3) {
            for (i5 = i3; i5 < 10; ++i5) {
                for (i7 = i3; i7 < 1; ++i7) {
                    Test0914.instanceCount = i4;
                    i4 += (int) l1;
                }
                l1 = 43089;
                i8 = i7;
                i8 -= (int) (i3 * (i2 = (int) (Test0914.instanceCount * 26)));
                i6 = (int) ((143 << (--i4)) * (iArr[i3 + 1] -= (int) (Test0914.instanceCount++)));
            }
            for (i9 = 1; i9 < 10; i9++) {
                if (Test0914.bFld) {
                    lArr[i3 - 1] = iMeth();
    ...
    public static void vMeth(int i, long l, int i1) {
        ...
        for (i16 = 20; 354 > i16; i16++) {
            for (d2 = i16; d2 < 5; d2++) {
                i17 += (int) ((long) d2 ^ i17);
                Test0914.instanceCount += (long) (d2 + i1);
                Test0914.iArrFld[(int) (d2)] += (int) Test0914.fFld;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i22 >>= (int) Test0914.instanceCount;
        Test0914.fArrFld = Test0914.fArrFld;
        for (i23 = 2; 267 > i23; i23++) {
            Test0914.instanceCount = i23;
            for (i25 = 3; i25 < 95; ++i25) {
                ...
                for (i27 = i25; i27 < 2; ++i27) {
                    ...
                    switch ((i23 % 2) + 86) {
                        ...
                        case 87:
                            i22 ^= i28;
                            Test0914.instanceCount += (i27 * i22);
                            i26 = (int) Test0914.instanceCount;
                            break;
                        default:
                            Test0914.fFld -= 4457383867707081160L;
                            i26 += (i27 * by2);
                            Test0914.iArrFld[i25 - 1] = i23;
                    }
                    Test0914.fArrFld[i23] = i23;
                    Test0914.instanceCount -= i25;
                    i24 = by2;
                    if (Test0914.bFld) break;
                    Test0914.instanceCount = i27;
                    i24 = i22;
                    i28 &= (int) Test0914.instanceCount;
                }
            }
            switch (((6 >>> 1) % 6) + 113) {
                case 113:
                    if (Test0914.bFld) {
                        for (i29 = 95; i29 > i23; i29--) {
                            i28 = i27;
                            Test0914.iArrFld[i29] = i26;
                        }
                    }
                    break;
                case 114:
                    i30 -= (int) Test0914.fFld;
                case 115:
                    i22 -= (int) Test0914.fFld;
                case 116:
                    Test0914.sFld += (short) (i23 - by3);
                case 117:
                    i30 += (((i23 * i22) + i28) - Test0914.fFld);
                    break;
                case 118:
        ...
        FuzzerUtils.out.println("Test0914.instanceCount Test0914.sFld Test0914.bFld = " + Test0914.instanceCount + "," + Test0914.sFld +
                "," + (Test0914.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0914.fFld Test0914.iArrFld Test0914.fArrFld = " + Float.floatToIntBits(Test0914.fFld) + "," +
                FuzzerUtils.checkSum(Test0914.iArrFld) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0914.fArrFld)));
