...
public class Test0214 {
    ...
    static {
        FuzzerUtils.init(Test0214.iArrFld, 9);
        FuzzerUtils.init(Test0214.fArrFld, 1.174F);
    }
    ...
    public static void vMeth1(int i4, int i5, double d1) {
        ...
        for (i6 = 1; i6 < 249; ++i6) {
            for (i8 = i6; 7 > i8; i8++) {
                s *= (short) 69;
                f2 *= -27.1021F;
                f2 += (((i8 * by) + Test0214.instanceCount) - i8);
                if (i7 != 0) {
                ...
                switch (((17168 >>> 1) % 1) + 52) {
                    case 52:
                        i4 += (int) Test0214.instanceCount;
                        i7 = (int) 1.339F;
                        break;
                }
                Test0214.iArrFld[(i8 >>> 1) % N] >>= (int) Test0214.instanceCount;
            }
            for (i10 = 1; i10 < 7; ++i10) {
                i9 += (i10 ^ i9);
                i7 = i5;
                i5 += i10;
                Test0214.iArrFld[i10] |= (int) Test0214.instanceCount;
            }
        }
    ...
    public static void vMeth(float f1, int i3) {
        ...
        i3 = (int) ((lMeth(Test0214.instanceCount) * s1) - i3);
        Test0214.instanceCount = -21219;
        for (i13 = 383; i13 > 20; i13 -= 3) {
            i3 += i13;
            i15 = 1;
            do {
                Test0214.fArrFld[i13 + 1] -= 39693;
                i3 *= i14;
                i14 += (i15 * i14);
                i3 += i15;
                ...
                switch (((i13 % 4) * 5) + 109) {
                    case 114:
                        i14 = i3;
                        i14 = -13;
                        i14 >>= (int) Test0214.instanceCount;
                        lArr[i13] += i15;
                        break;
                    case 124:
                        i14 += (i15 * i15);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 1; 188 > i; i += 3) {
            ...
            Test0214.iArrFld[i - 1] = (int) Test0214.instanceCount;
            for (d = i; 308 > d; ++d) {
                vMeth(-1.974F, 250);
                i2 -= i2;
                bArr = bArr;
                f = Test0214.instanceCount;
            }
            by2 -= (byte) i;
            Test0214.instanceCount -= -6;
            Test0214.iArrFld[i + 1] -= i;
        }
        for (i16 = 13; i16 < 367; i16 += 2) {
            i17 += i16;
            Test0214.instanceCount = 51;
            l1 = 1;
            do {
                lArr1 = lArr1;
                for (i18 = 1; 4 > i18; ++i18) {
                ...
                for (i20 = 4; i20 > 1; --i20) {
                    i19 |= i20;
                    i1 += (((i20 * Test0214.instanceCount) + i16) - by2);
                    i2 += (i20 + l1);
                    b = b;
                    if (b) continue;
                    i2 >>= i20;
                ...
                Test0214.instanceCount = i20;
                Test0214.iArrFld[i16 + 1] *= 2;
            } while ((l1 += 3) < 142);
        }
        ...
        FuzzerUtils.out.println("Test0214.instanceCount Test0214.iArrFld Test0214.fArrFld = " + Test0214.instanceCount + "," +
                FuzzerUtils.checkSum(Test0214.iArrFld) + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0214.fArrFld)));
