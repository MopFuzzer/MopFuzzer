...
public class Test0111 {
    ...
    public static void vMeth1(float f1, int i11) {
        ...
        if (b) {
            for (i14 = 7; i14 < 325; i14++) {
                Test0111.instanceCount = (long) f1;
                i16 = 1;
                while (++i16 < 5) {
                    s1 = (short) f1;
                    for (i17 = 1; i17 > 1; --i17) {
                        Test0111.instanceCount <<= i14;
                        if (i16 != 0) {
    ...
    public static int iMeth(int i9, int i10) {
        ...
        for (i19 = 10; 328 > i19; ++i19) {
            ...
            f2 -= i19;
            f2 *= i19;
            iArr2[i19 - 1][i19 - 1] += (int) Test0111.instanceCount;
        }
        i21 = 1;
        while (++i21 < 359) {
            for (i22 = 1; 5 > i22; ++i22) {
    ...
    public static void vMeth(int i2) {
        ...
        for (i4 = 2; i4 < 172; i4++) {
            for (i6 = 1; 9 > i6; i6 += 3) {
                ...
                switch (((i4 >>> 1) % 5) + 121) {
                    case 121:
                        s &= (short) Test0111.instanceCount;
                        i5 += i6;
                        i2 -= by;
                        break;
                    case 122:
                    ...
                    case 124:
                        ...
                        break;
                    case 125:
                        iArr1[i4 + 1] <<= (int) Test0111.instanceCount;
                        break;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (l = 12; l < 385; ++l) {
            ...
            i = i24;
            Test0111.instanceCount += i24;
            iArr[(int) (l + 1)] = i;
            i += (int) (l + Test0111.instanceCount);
        }
        d1 += -14;
        i = 90;
        Test0111.instanceCount += by1;
        Test0111.instanceCount *= (long) d1;
        i26 = 1;
        while (++i26 < 294) {
            fArr[i26 - 1] -= l;
            i += i26;
            Test0111.instanceCount <<= 35673;
            i25 += i26;
            i27 = 1;
            do {
                Test0111.instanceCount += by1;
        ...
        FuzzerUtils.out.println("Test0111.instanceCount fFld bFld = " + Test0111.instanceCount + "," +
