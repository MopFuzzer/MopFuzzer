...
public class Test0687 {
    ...
    static {
        FuzzerUtils.init(Test0687.iArrFld, -5509);
    }
    ...
    public static void vMeth(int i13) {
        ...
        do {
            ...
            if (false) {
                ...
                f1 -= Test0687.instanceCount;
                byArr = byArr;
            } else {
                i13 += i14;
            }
            if (b) {
                Test0687.sFld = (short) Test0687.instanceCount;
                switch (((i14 % 4) * 5) + 40) {
                    case 53:
                        i13 += (int) Test0687.instanceCount;
                        b = b;
                        break;
                    case 46:
                        d1 -= Test0687.instanceCount;
                        break;
                    case 49:
                        if (i13 != 0) {
    ...
    public static int iMeth(int i11, int i12) {
        ...
        for (i15 = 7; i15 < 289; ++i15) {
            i12 *= i15;
            i11 = (int) Test0687.instanceCount;
            f2 -= i12;
            sArr[i15 + 1] = (short) f2;
        }
    ...
    public static long lMeth(int i5, long l) {
        ...
        for (f = 280; f > 4; f--) {
            for (i7 = 1; i7 < 6; i7++) {
                Test0687.iArrFld[i7] -= (int) lArr[(int) (f + 1)];
                i8 = i6;
                for (i9 = i7; i9 < 2; ++i9) {
                    Test0687.sFld += (short) (((i9 * i9) + i5) - i9);
                    d = iMeth(i10, i7);
                    i10 += i7;
                    ...
                    switch (((i7 % 8) * 5) + 19) {
                        case 56:
                            l *= -109;
                            Test0687.instanceCount = i7;
                            f3 += i9;
                        case 53:
                            Test0687.instanceCount *= 0;
                            break;
                        case 46:
                            i22 = i9;
                        case 29:
                            Test0687.iArrFld[(int) (f)] -= (int) l;
                        case 27:
                            i6 += (i9 + i6);
                            break;
                        case 51:
    ...
    public void mainTest(String[] strArr1) {
            ...
            try {
                for (i = 4; i < (276 + 400); i++) {
                    switch (((i % 6) * 5) + 47) {
                        case 49:
                            for (i2 = 2 - 400; i2 < 63; ++i2) {
                                for (int smallinvoc = 0; smallinvoc < 1; smallinvoc++)
                                    vSmallMeth((int) (dFld - (lMeth(i2,
                                            3911849215168766385L) * f4)));
                            }
                            Test0687.iArrFld[i] = i1;
                            i3 += i;
                            break;
                        case 57:
                            i1 += i;
                        ...
                        case 65:
                            Test0687.instanceCount = i3;
                            dFld = i1;
                            Test0687.instanceCount *= (long) f4;
                            for (i23 = i; i23 < (63 + 400); i23++) {
                                Test0687.iArrFld[i23 + 1] >>= i24;
                                i24 += (i23 * i23);
                                i1 += (i23 + i2);
                                i3 &= i23;
                                if (bFld) break;
                        ...
                        case 64:
                            for (i25 = 63; i25 > i; --i25) {
                                i26 += i1;
                                i26 += (((i25 * Test0687.instanceCount) + Test0687.instanceCount) - Test0687.instanceCount);
                                i1 = i3;
                                i3 += i1;
                            }
                            break;
                        ...
                        case 77:
                            switch ((i % 6) + 8) {
                                case 8:
                                    ...
                                    break;
                                case 9:
                                    Test0687.instanceCount = (long) 1.96739;
                                    break;
                                case 10:
                                    bFld = bFld;
                                case 11:
        ...
        FuzzerUtils.out.println("Test0687.instanceCount dFld Test0687.sFld = " + Test0687.instanceCount + "," +
                Double.doubleToLongBits(dFld) + "," + Test0687.sFld);
        FuzzerUtils.out.println("bFld Test0687.iArrFld lArrFld = " + (bFld ? 1 : 0) + "," +
                FuzzerUtils.checkSum(Test0687.iArrFld) + "," + FuzzerUtils.checkSum(lArrFld));
