...
public class Test0020 {
    ...
    static {
        FuzzerUtils.init(Test0020.iArrFld, 10);
    ...
    public static double dMeth() {
        ...
        vMeth1(16, Test0020.instanceCount);
        i5 <<= (int) Test0020.instanceCount;
        f *= i5;
        i5 = s1;
        f += i5;
    ...
    public static void vMeth(int i, short s, int i1) {
        ...
        for (i2 = 7; i2 < 370; ++i2) {
            ...
            i3 *= (int) Math.max(i3 - s, Test0020.instanceCount);
            dMeth();
            switch ((i2 % 3) + 109) {
                case 109:
                ...
                case 111:
                    ...
                    if (b) {
                        i3 += (i2 | by);
                        Test0020.instanceCount += (i2 * i2);
                        i += (((i2 * Test0020.instanceCount) + f1) - i1);
                    } else {
                        Test0020.iArrFld[i2][i2 + 1] = (int) Test0020.instanceCount;
                    }
                    break;
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i7 = 1;
        do {
            i6 += (((i7 * Test0020.instanceCount) + Test0020.instanceCount) - i7);
            b1 = false;
            fArr[i7 - 1] -= i6;
            i6 += i7;
            for (i8 = 121; i8 > i7; --i8) {
            ...
            while (++i10 < 121) {
                ...
                switch (((i7 >>> 1) % 1) + 50) {
                    case 50:
                        Test0020.instanceCount += i10;
                        break;
                }
            }
            Test0020.instanceCount *= (long) d;
            Test0020.instanceCount += i9;
            i9 = i7;
        } while (++i7 < 208);
        i9 = -19194;
        for (int i13 : iArr) {
            i12 -= (int) Test0020.instanceCount;
            Test0020.bArrFld[(i12 >>> 1) % N] = false;
            s2 *= (short) Test0020.instanceCount;
            switch ((((i7 >>> 1) % 8) * 5) + 51) {
                case 56:
                    for (i14 = 63; i14 > 2; --i14) {
                        for (f2 = 1; f2 < 2; ++f2) {
                            i11 += (int) 68.400F;
                            d *= 57229;
                            Test0020.iArrFld[i14][(int) (f2)] &= -12;
                            Test0020.fFld *= i9;
                        }
                    }
                    break;
                case 59:
                    d -= Test0020.instanceCount;
                case 69:
                    iArr[(-55590 >>> 1) % N] *= -9119;
                    break;
                case 88:
                ...
                case 74:
                    ...
                    break;
                case 54:
                    lArr1[(i12 >>> 1) % N] *= Test0020.instanceCount;
                case 62:
                    Test0020.instanceCount -= -1074391040L;
                case 80:
                    s2 = (short) -40449;
                default:
                    i11 = 9437;
        ...
        FuzzerUtils.out.println("Test0020.instanceCount Test0020.fFld Test0020.iArrFld = " + Test0020.instanceCount + "," +
                Float.floatToIntBits(Test0020.fFld) + "," + FuzzerUtils.checkSum(Test0020.iArrFld));
        FuzzerUtils.out.println("Test0020.bArrFld = " + FuzzerUtils.checkSum(Test0020.bArrFld));
