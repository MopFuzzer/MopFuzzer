...
public class Test0212 {
    ...
    static {
        FuzzerUtils.init(Test0212.iArrFld, -13);
        FuzzerUtils.init(Test0212.byArrFld, (byte) -120);
    }
    ...
    public static void vMeth1(int i3, int i4, long l) {
        ...
        for (i9 = 1; 205 > i9; ++i9) {
            ...
            do {
                ...
                for (i13 = 1; 1 > i13; ++i13) {
                    i3 += i13;
                    Test0212.iArrFld[i9] += (int) -56.405F;
                    i14 = i4;
                }
                i15 = 1;
                while (++i15 < 1) {
    ...
    public static void vMeth(int i) {
        ...
        for (i1 = 12; i1 < 259; i1++) {
            i += (int) ((fArr[i1 - 1] + (++i)) / (((52031 % ((Test0212.instanceCount % (i1 | 1)) | 1)) +
                    Long.reverseBytes(Test0212.instanceCount)) | 1));
            vMeth1(i1, i, Test0212.instanceCount);
            i16 = 1;
            do {
                byte by1 = 56;
                i += i1;
                Test0212.instanceCount = i;
                by1 <<= (byte) s1;
                for (i17 = 1; i17 < 1; i17++) {
                    dArr = dArr;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(iFld);
        Test0212.byArrFld[(iFld >>> 1) % N] *= (byte) Test0212.instanceCount;
        for (i20 = 276; i20 > 2; i20 -= 3) {
            for (i22 = 16; i22 < 275; i22++) {
                Test0212.instanceCount -= iFld;
                for (i24 = 1; i24 < 2; ++i24) {
                    double d = 1.27936;
                    i25 -= s2;
                    i21 -= i24;
                    d -= 2;
                    f += (-11 + (i24 * i24));
                    i25 += (int) Test0212.instanceCount;
                    Test0212.instanceCount = i25;
                }
                Test0212.iArrFld[i20 + 1] += iFld;
                ...
                switch (((i20 % 5) * 5) + 72) {
                    ...
                    case 91:
                        ...
                        break;
                    case 82:
                        Test0212.instanceCount <<= Test0212.iFld2;
                        break;
                    default:
                        try {
                            i28 = (i27 % i27);
        ...
        FuzzerUtils.out.println("Test0212.instanceCount iFld Test0212.iFld1 = " + Test0212.instanceCount + "," + iFld + "," +
                Test0212.iFld1);
        FuzzerUtils.out.println("Test0212.iFld2 Test0212.iArrFld Test0212.byArrFld = " + Test0212.iFld2 + "," +
                FuzzerUtils.checkSum(Test0212.iArrFld) + "," + FuzzerUtils.checkSum(Test0212.byArrFld));
