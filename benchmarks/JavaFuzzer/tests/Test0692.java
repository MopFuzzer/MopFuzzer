...
public class Test0692 {
    ...
    static {
        FuzzerUtils.init(Test0692.iArrFld, 33);
        FuzzerUtils.init(Test0692.fArrFld, 0.715F);
    }
    ...
    public static int iMeth(float f, int i3, double d) {
        ...
        for (i10 = 11; i10 < 215; ++i10) {
            ...
            d += f;
            i9 %= (int) (i8 | 1);
            Test0692.instanceCount += (i10 | l);
            for (i12 = 1; i12 < 8; i12++) {
                try {
                    Test0692.iArrFld[i10 - 1] = (-172076531 % i8);
                    Test0692.iArrFld[i10 + 1] = (-597926485 % i9);
                    i9 = (48530 % i8);
    ...
    public static float fMeth() {
        ...
        Test0692.iArrFld[(i15 >>> 1) % N] <<= i2;
        for (i16 = 14; i16 < 297; i16 += 3) {
            i17 %= (int) (Test0692.instanceCount | 1);
    ...
    public void mainTest(String[] strArr1) {
        ...
        by = (byte) ((i - (Test0692.instanceCount--)) - (i + i));
        Test0692.instanceCount -= (long) (-(fMeth() - Test0692.instanceCount));
        dArr[(i >>> 1) % N][(i >>> 1) % N] += Test0692.instanceCount;
        Test0692.fArrFld[(i >>> 1) % N] += Test0692.instanceCount;
        i <<= i;
        Test0692.instanceCount >>= i;
        sArr[(i >>> 1) % N] = (short) i;
        for (i18 = 12; i18 < 353; i18++) {
            Test0692.instanceCount >>= i18;
            for (i20 = 3; i20 < 74; ++i20) {
                for (i22 = 1; i22 < 2; i22++) {
                    Test0692.instanceCount *= Test0692.byFld;
                    sFld += (short) (52885 + (i22 * i22));
                    i19 >>>= (int) Test0692.instanceCount;
                    by <<= (byte) Test0692.instanceCount;
                    Test0692.fArrFld[i18] = Test0692.lFld;
                    i23 = i20;
                    try {
                        i19 = (i23 / i19);
                        i = (-39574 % i20);
                    ...
                    if (b2) {
                        ...
                        Test0692.iArrFld[i18 + 1] = i20;
                        i19 += (int) (-169L + (i22 * i22));
                    } else {
                        if (b2) {
                            i23 = i;
                        } else {
                            Test0692.iArrFld[i22] -= (int) Test0692.instanceCount;
                        }
                        Test0692.lFld = -4;
                        i >>= i19;
                    }
        ...
        FuzzerUtils.out.println("Test0692.instanceCount Test0692.dFld Test0692.byFld = " + Test0692.instanceCount + "," +
                Double.doubleToLongBits(Test0692.dFld) + "," + Test0692.byFld);
        FuzzerUtils.out.println("sFld Test0692.lFld Test0692.iArrFld = " + sFld + "," + Test0692.lFld + "," +
                FuzzerUtils.checkSum(Test0692.iArrFld));
        FuzzerUtils.out.println("Test0692.fArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0692.fArrFld)));
