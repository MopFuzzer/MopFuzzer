...
public class Test0561 {
    ...
    static {
        FuzzerUtils.init(Test0561.iArrFld, 135);
    }
    ...
    public static long lMeth1() {
        ...
        for (i9 = 2; i9 < 315; i9++) {
            for (i11 = 1; i11 < 5; i11 += 2) {
                Test0561.iArrFld = Test0561.iArrFld;
                if (b) continue;
                for (i13 = 1; 3 > i13; ++i13) {
                    i14 >>>= (int) Test0561.instanceCount;
                    Test0561.dFld *= i11;
                    lArr1[i13 + 1][i9] -= 20907;
                }
                Test0561.instanceCount += (((i11 * i9) + f1) - i13);
            }
            i10 += i9;
            if (true) continue;
            for (i15 = 1; i15 < 5; i15++) {
                i17 += (((i15 * Test0561.instanceCount) + Test0561.instanceCount) - Test0561.instanceCount);
                i17 += (((i15 * i14) + i15) - Test0561.instanceCount);
            }
            Test0561.iArrFld[i9 + 1] *= (int) Test0561.instanceCount;
        }
    ...
    public static void vMeth(int i2) {
        ...
        Test0561.sFld = (short) (-Test0561.instanceCount);
        i3 = 1;
        while (++i3 < 281) {
            for (i4 = 1; i4 < 6; ++i4) {
                for (i6 = 1; 2 > i6; i6 += 2) {
                    ...
                    Test0561.iArrFld[i3 - 1] = (int) (((-(i2 += i7)) + (l3 + by)) * (-(i7 + d)));
                    i7 += i8;
                    l3 <<= (--i5);
                }
                Test0561.sFld = (short) (i3 - (i2 / (i7 | 1)));
                i8 = (int) ((Math.min(i6, i5) + (Test0561.instanceCount % ((long) (f) | 1))) + lMeth1());
                Test0561.instanceCount += -114;
            }
        }
    ...
    public static long lMeth(long l, long l1, int i1) {
        ...
        for (d1 = 4; 173 > d1; d1++) {
            bArr[(int) (d1 + 1)][(int) (d1)] = Test0561.bFld;
            f2 *= -48946;
            i19 %= (int) (i20 | 1);
            for (i21 = 1; 9 > i21; i21++) {
                lArr2[i21] = Test0561.instanceCount;
                l1 >>= Test0561.instanceCount;
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = (int) (-((13 - (26580 - lMeth(Test0561.instanceCount, Test0561.instanceCount, i))) - i));
        lArr3[(i >>> 1) % N] = i;

        FuzzerUtils.out.println("i lArr3 = " + i + "," + FuzzerUtils.checkSum(lArr3));

        FuzzerUtils.out.println("Test0561.instanceCount Test0561.sFld Test0561.dFld = " + Test0561.instanceCount + "," + Test0561.sFld +
                "," + Double.doubleToLongBits(Test0561.dFld));
        FuzzerUtils.out.println("Test0561.bFld Test0561.iArrFld = " + (Test0561.bFld ? 1 : 0) + "," +
                FuzzerUtils.checkSum(Test0561.iArrFld));
