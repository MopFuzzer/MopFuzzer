...
public class Test0398 {
                ...
                if (b) {
                    ...
                    for (i16 = i13; i16 < 1; ++i16) {
                        switch ((i11 % 7) + 36) {
                            ...
                            case 37:
                                i15 >>= 8831;
                                i9 -= (int) Test0398.instanceCount;
                            case 38:
                                i12 = i10;
                                Test0398.instanceCount += (i16 * i16);
                                break;
                            case 39:
                            case 40:
                                i10 *= 3;
    ...
    public static int iMeth(int i5) {
        ...
        i5 *= (++i5);
        lMeth(-25L, i5, Test0398.dFld);
        for (i20 = 8; i20 < 172; i20++) {
            if (false) {
                Test0398.byFld = (byte) i20;
                i21 -= (int) Test0398.dFld;
            } else if (b1) {
                i5 = i21;
                Test0398.instanceCount = 0;
                i5 += i20;
            } else if (b1) {
                i21 += (int) Test0398.instanceCount;
                i21 = (int) Test0398.instanceCount;
                for (i22 = 1; i22 < 10; i22++) {
                    i24 = 1;
                    do {
                        Test0398.instanceCount += (-13 + (i24 * i24));
                        bArr[i20][i22] = b1;
                    } while (++i24 < 2);
                }
            } else {
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 9; i < 288; i++) {
            ...
            for (i2 = i; i2 < 90; i2++) {
                for (f = 1; f < 1; f++) {
                    iArr[i - 1] += (iArr[i2 - 1] + (Test0398.byFld + i4));
                    i4 = (int) Test0398.instanceCount;
                    if ((((f - i3) * Math.min(i4, i3)) - (++iArr[i])) != (((-201 + Float.intBitsToFloat(i2)) +
                            (-62.1730 - (i1 + i1))) - (Test0398.sFld *= (short) (d--)))) {
                        i1 = (int) (d++);
                        try {
                            i3 = (i1 / i2);
                            i3 = (i / 61);
                        ...
                        i4 = iMeth(i);
                        Test0398.byFld += (byte) (f + Test0398.instanceCount);
                        f2 = i4;
                    }
                    lArr1 = lArr1;
                }
        ...
        iArr[(216 >>> 1) % N] <<= Test0398.byFld1;
        switch ((((i3 >>> 1) % 10) * 5) + 97) {
            case 120:
                iArr[(i >>> 1) % N] = i3;
                i3 += i2;
                Test0398.instanceCount += i;
                for (i25 = 6; i25 < 177; ++i25) {
                    ...
                    for (i27 = 8; i27 < 147; i27++) {
                        i1 = i2;
                        Test0398.instanceCount += (long) d;
                        i3 <<= (int) Test0398.instanceCount;
                    }
                    Test0398.instanceCount = 128;
                }
                break;
            case 103:
                Test0398.instanceCount = i25;
                break;
            case 136:
                iArr3 = iArr3;
            case 125:
                i28 = (int) Test0398.dFld;
                break;
            case 145:
                i4 ^= Test0398.sFld;
                break;
            ...
            case 137:
                ...
                break;
            case 141:
                i28 = (int) Test0398.instanceCount;
                break;
            case 112:
        ...
        FuzzerUtils.out.println("Test0398.instanceCount Test0398.byFld Test0398.sFld = " + Test0398.instanceCount + "," + Test0398.byFld +
                "," + Test0398.sFld);
        FuzzerUtils.out.println("Test0398.dFld Test0398.byFld1 fArrFld = " + Double.doubleToLongBits(Test0398.dFld) + "," +
                Test0398.byFld1 + "," + Double.doubleToLongBits(FuzzerUtils.checkSum(fArrFld)));
