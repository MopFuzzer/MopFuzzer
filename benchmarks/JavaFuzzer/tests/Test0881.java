...
public class Test0881 {
    ...
    static {
        FuzzerUtils.init(Test0881.iArrFld, -49207);
    }
    ...
    public static void vMeth2(short s, long l1) {
        ...
        for (i6 = 9; 389 > i6; i6++) {
            Test0881.instanceCount *= by1;
            s += (short) (((i6 * i7) + i7) - f2);
            for (i8 = 1; i8 < 4; ++i8) {
                i7 += i8;
                Test0881.instanceCount -= i9;
        ...
        switch ((((iArr[(i3 >>> 1) % N]--) >>> 1) % 9) + 99) {
            ...
            case 101:
                ...
                do {
                    ...
                    for (i4 = 1; i4 < 8; i4++) {
                        short s1 = 14407;
                        vMeth2(s1, Test0881.instanceCount);
                        i3 = (int) Test0881.instanceCount;
                        iArr[(int) (f1)] = (int) Test0881.instanceCount;
                        iArr[i4] = (int) l;
                    }
                    i2 -= i4;
                    i5 += (int) (f1 - l);
                    Test0881.instanceCount += (long) (1.686F + (f1 * f1));
                } while (++f1 < 207);
            case 102:
                iArr[(i3 >>> 1) % N] -= 104;
                break;
    ...
    public static void vMeth(int i1) {
        ...
        vMeth1(i1, i1, Test0881.instanceCount);
        Test0881.fFld -= 243;
        i1 -= (int) d1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = (int) (--d);
        vMeth(i);
        i <<= (int) Test0881.instanceCount;
        Test0881.instanceCount /= (Test0881.iFld | 1);
        lArr = lArr;
        for (i10 = 11; i10 < 375; ++i10) {
            for (i12 = 1; i12 < 69; ++i12) {
                Test0881.fFld = i11;
                i11 = i11;
                Test0881.fFld = (float) 0.108011;
                Test0881.iFld = i13;
            }
            Test0881.instanceCount = Test0881.instanceCount;
            i += (((i10 * i10) + s2) - i13);
            Test0881.instanceCount = Test0881.instanceCount;
            Test0881.instanceCount *= i10;
            Test0881.instanceCount *= (long) Test0881.fFld;
            Test0881.iFld >>= i;
            for (i15 = 1; i15 < 69; ++i15) {
                fArr[i15 - 1] *= Test0881.fFld;
            }
            iArr2[i10 - 1] = i10;
        }
        ...
        try {
            for (l2 = 383 + 400; l2 > 2; l2--) {
                Test0881.instanceCount += (-43693L + (l2 * l2));
                Test0881.instanceCount += l2;
                Test0881.instanceCount += i18;
                Test0881.iFld += (int) (((l2 * i) + i13) - i13);
                if (Test0881.bFld) break;
                iArr2[(int) (l2 + 1)] *= i17;
            }
        } catch (ArrayIndexOutOfBoundsException exc1) {
            Test0881.iArrFld[(i16 >>> 1) % N] &= (int) l2;
        }
        ...
        FuzzerUtils.out.println("Test0881.instanceCount Test0881.fFld Test0881.iFld = " + Test0881.instanceCount + "," +
                Float.floatToIntBits(Test0881.fFld) + "," + Test0881.iFld);
        FuzzerUtils.out.println("Test0881.bFld Test0881.iArrFld = " + (Test0881.bFld ? 1 : 0) + "," +
