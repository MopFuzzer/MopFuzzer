...
public class Test0433 {
        ...
        for (int i11 : iArr) {
            ...
            do {
                ...
                for (i13 = i12; i13 < 1; ++i13) {
                    if (b1) break;
                    i14 <<= Test0433.sFld;
                    Test0433.instanceCount = i12;
                    Test0433.instanceCount = -19;
                }
                for (f = 1; 1 < f; f -= 2) {
                    switch ((((-58995 >>> 1) % 10) * 5) + 93) {
                        ...
                        case 100:
                            b1 = b1;
                            i14 = (int) Test0433.instanceCount;
                            break;
                        case 96:
                            if (b1) continue;
                            break;
    ...
    public static long lMeth(int i5, int i6, short s) {
        ...
        i6 += (int) (~((i5 + Test0433.instanceCount) - (Test0433.instanceCount - Test0433.instanceCount)));
        i7 = 1;
        do {
            for (i8 = 4; i8 > i7; --i8) {
                i5 -= ((i6--) + (--i9));
            ...
            for (i16 = 1; i16 < 4; i16++) {
                iArr1 = iArr1;
                Test0433.instanceCount += -29;
                i6 += (((i16 * i8) + Test0433.fFld) - Test0433.instanceCount);
                i5 = i7;
                for (i18 = 1; i18 < 2; i18++) {
                    i6 -= (int) -52.542F;
                    i19 <<= i6;
    ...
    public static void vSmallMeth() {
        ...
        b = b;
        Test0433.fFld = ((Test0433.fFld++) * lMeth(i20, i20, (short) (5921)));
    ...
    public void mainTest(String[] strArr1) {
                                ...
                                switch ((i22 % 1) + 105) {
                                    case 105:
                                        for (i25 = 1; i25 < 1; i25++) {
                                            ...
                                            i = i2;
                                            i2 *= i2;
                                            Test0433.fFld = Test0433.sFld;
                                        }
                                    default:
                                        i += (i24 - Test0433.instanceCount);
                                }
                            } while (++i24 < 148);
                            break;
                        case 77:
                            ...
                            break;
                        case 78:
                            Test0433.instanceCount += (-1 + (i22 * i22));
                            break;
                        case 79:
                            iArr2[i22] >>= (int) Test0433.instanceCount;
                        case 80:
                            i2 *= -106;
                            break;
                        case 81:
                            Test0433.instanceCount ^= i25;
                            break;
                        default:
                            Test0433.instanceCount -= i;
                    }
                    break;
                case 106:
                    i21 = i24;
        ...
        FuzzerUtils.out.println("Test0433.instanceCount Test0433.fFld Test0433.sFld = " + Test0433.instanceCount + "," +
                Float.floatToIntBits(Test0433.fFld) + "," + Test0433.sFld);
