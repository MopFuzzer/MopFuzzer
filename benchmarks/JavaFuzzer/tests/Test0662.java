...
public class Test0662 {
    ...
    static {
        FuzzerUtils.init(Test0662.fArrFld, 0.981F);
        FuzzerUtils.init(Test0662.lArrFld, 31408L);
    }
    ...
    public static void vMeth2(int i10) {
        ...
        for (i11 = 6; i11 < 233; ++i11) {
            ...
            for (i15 = 1; 7 > i15; i15++) {
                ...
                Test0662.lArrFld[i11 - 1] -= 41779;
                for (i19 = 1; 2 > i19; i19++) {
                    f3 -= (float) Test0662.dFld;
                    f3 = i12;
                    i16 = (int) Test0662.instanceCount;
                }
            }
        }
    ...
    public static void vMeth1(int i9, float f2) {
        ...
        vMeth2(-98);
        Test0662.instanceCount += i9;
        Test0662.instanceCount ^= i9;
        for (i21 = 15; 317 > i21; ++i21) {
            iArr[i21] *= s1;
            i9 += (i21 - Test0662.instanceCount);
            if (b1) {
                for (i23 = 1; i23 < 5; i23++) {
                    iArr[i23 + 1] = -2159;
                }
                ...
                by += (byte) (i21 * i23);
                Test0662.lArrFld[i21 + 1] = Test0662.instanceCount;
                for (i25 = 5; i25 > 1; i25--) {
                    f2 *= f2;
                    Test0662.lArrFld[i21] = -3214;
                    i22 += (((i25 * i9) + i26) - s1);
                }
    ...
    public void vMeth(int i3) {
        ...
        for (i4 = 3; i4 < 154; i4++) {
            ...
            for (i6 = 1; i6 < 10; i6 += 3) {
                for (f1 = 1; f1 < 4; f1++) {
                    vMeth1(i7, fFld);
                    s = (short) Test0662.instanceCount;
                    Test0662.dFld = i27;
                    Test0662.instanceCount = (long) fFld;
                    iArrFld[(int) (f1 + 1)] *= i3;
                }
                i7 += (int) Test0662.instanceCount;
                i3 += (((i6 * f1) + Test0662.instanceCount) - i4);
                Test0662.instanceCount += i3;
            }
        }
        for (i28 = 7; 224 > i28; ++i28) {
            Test0662.instanceCount += i8;
            Test0662.lArrFld[i28 + 1] >>>= i6;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            for (i1 = 4; i1 < 134; ++i1) {
                dArr[i + 1][i1] -= i;
                i2 += (i1 * i1);
                Test0662.fArrFld[i1 - 1] %= (Test0662.lArrFld[i1 + 1] | 1);
            }
            vMeth(i1);
            i2 = i;
            i2 += i2;
            ...
            if (true) {
                if (b2) continue;
                iArrFld[i] = (int) Test0662.instanceCount;
            } else {
                i2 = i;
                i2 += i2;
                iArrFld[i] -= (int) Test0662.instanceCount;
        ...
        for (d = 16; d < 363; ++d) {
            ...
            for (f4 = 73; 3 < f4; f4--) {
                i34 -= (int) Test0662.dFld;
                i33 += (int) f4;
                Test0662.lArrFld[(int) (d - 1)] = i34;
                f *= 37066;
                Test0662.instanceCount = i2;
            }
        }
        ...
        FuzzerUtils.out.println("Test0662.instanceCount fFld Test0662.dFld = " + Test0662.instanceCount + "," +
                Float.floatToIntBits(fFld) + "," + Double.doubleToLongBits(Test0662.dFld));
        FuzzerUtils.out.println("Test0662.fArrFld Test0662.lArrFld iArrFld = " +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0662.fArrFld)) + "," + FuzzerUtils.checkSum(Test0662.lArrFld) +
