...
public class Test0441 {
    ...
    public static void vMeth1() {
        ...
        for (i3 = 7; i3 < 193; i3 += 3) {
            Test0441.instanceCount += (((i3 * Test0441.byFld) + i3) - Test0441.instanceCount);
            iArr[i3][i3] <<= i3;
            for (l = 1; 25 > l; l++) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = 1;
        while (++i < 313) {
            i1 = (int) ((iMeth((short) (7453), Test0441.byFld, i1) / -104) + Test0441.instanceCount);
        }
        d1 = 1;
        do {
            for (i18 = 3; i18 < 180; ++i18) {
                ...
                i21 = i18;
                iArrFld[(int) (d1 + 1)] = Test0441.byFld;
                if (b2) continue;
                i19 = i;
                if (b2) {
                    i19 = i18;
                    i21 |= i22;
                    i21 = (int) Test0441.instanceCount;
                    for (i23 = 1; i23 < 2; i23++) {
                        Test0441.instanceCount = i21;
                        i22 = (int) Test0441.instanceCount;
                        i22 += i22;
        ...
        FuzzerUtils.out.println("Test0441.instanceCount Test0441.byFld Test0441.fFld = " + Test0441.instanceCount + "," + Test0441.byFld +
                "," + Float.floatToIntBits(Test0441.fFld));
