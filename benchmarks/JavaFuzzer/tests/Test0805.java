...
public class Test0805 {
    ...
    static {
        FuzzerUtils.init(Test0805.fArrFld, 107.175F);
        FuzzerUtils.init(Test0805.bArrFld, true);
    }
    ...
    public static void vMeth1(int i9, int i10) {
        ...
        Test0805.fArrFld[(i10 >>> 1) % N] += -60081;
        Test0805.instanceCount |= i9;
        for (l1 = 20; l1 < 350; ++l1) {
            i12 = 1;
            while (++i12 < 5) {
                Test0805.instanceCount >>>= i12;
                i9 -= 13;
                i9 = i11;
                l2 = 1;
                while (++l2 < 1) {
    ...
    public static int iMeth() {
        ...
        vMeth1(i13, -8);
        iArr[(i13 >>> 1) % N] = Test0805.byFld;
        i13 *= i13;
        iArr[(i13 >>> 1) % N] *= (int) f3;
        Test0805.instanceCount += (long) f3;
        f3 = i13;
        i13 >>= (int) Test0805.instanceCount;
        Test0805.instanceCount = Test0805.instanceCount;
        i14 = 1;
        do {
            i13 += i14;
            f4 = 1;
    ...
    public void vMeth(int i3) {
        ...
        for (i4 = 4; 334 > i4; i4 += 3) {
            Test0805.instanceCount = (long) (((Test0805.instanceCount + Test0805.instanceCount) - Test0805.instanceCount) * ((f1 - i3) +
                    i3));
            i5 |= i5;
            for (i6 = 1; i6 < 14; ++i6) {
                for (l = 2; 1 < l; --l) {
                    Test0805.instanceCount += l;
                    switch ((i4 % 1) + 74) {
                        case 74:
                    }
                        ...
                        case 41:
                            switch ((i8 >>> 1) % 3) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    Test0805.instanceCount = (long) f1;
                                    i3 >>= (int) Test0805.instanceCount;
                                    break;
                                case 2:
                                    i7 *= i8;
                                    break;
    ...
    public void mainTest(String[] strArr1) {
        ...
        if (b2) {
            for (l3 = 7; l3 < 270; ++l3) {
                for (d2 = l3; d2 < 96; ++d2) {
                    ...
                    i17 += i18;
                    Test0805.instanceCount -= 24;
                    i16 = i18;
                    for (i20 = 1; i20 < 1; i20 += 3) {
                        switch ((int) ((d2 % 9) + 101)) {
                            case 101:
                                i17 -= i1;
                                Test0805.bArrFld[(int) (l3)] = b2;
                                i16 += i2;
                                break;
                            case 102:
                                try {
                                ...
                                switch ((((i17 >>> 1) % 2) * 5) + 69) {
                                    case 77:
                                        if (false) continue;
                                        i16 = (int) Test0805.instanceCount;
                                        lArr[i20 + 1] += iFld;
                                        break;
                                    case 71:
                                        f = l3;
                                ...
                                break;
                            case 103:
                                Test0805.instanceCount += (((i20 * f) + i17) - iFld);
                                break;
                            case 104:
                                i2 += iFld;
                                break;
                            ...
                            case 108:
                                Test0805.dFld += iFld;
                            case 109:
                                lArr[i20] += Test0805.instanceCount;
                        }
                    }
                }
            }
        ...
        FuzzerUtils.out.println("Test0805.instanceCount Test0805.byFld Test0805.dFld = " + Test0805.instanceCount + "," + Test0805.byFld +
                "," + Double.doubleToLongBits(Test0805.dFld));
        FuzzerUtils.out.println("iFld Test0805.fArrFld Test0805.bArrFld = " + iFld + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0805.fArrFld)) + "," + FuzzerUtils.checkSum(Test0805.bArrFld));
