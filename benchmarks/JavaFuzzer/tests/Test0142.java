...
public class Test0142 {
    ...
    static {
        FuzzerUtils.init(Test0142.bArrFld, true);
        FuzzerUtils.init(Test0142.iArrFld, -250);
    }
    ...
    public static void vMeth2(int i2) {
        ...
        for (i3 = 152; i3 > 3; i3--) {
            d *= Test0142.instanceCount;
            for (i5 = i3; i5 < 11; ++i5) {
                for (i7 = 1; i7 > 1; i7--) {
                    i2 += (i7 * i6);
                }
                iArr = FuzzerUtils.int1array(N, (int) 6);
                f = Test0142.instanceCount;
            }
            Test0142.instanceCount = i2;
            dArr[i3 + 1][(i7 >>> 1) % N] = i4;
            switch (((i3 % 1) * 5) + 15) {
                case 17:
                    for (i9 = 1; i9 < 11; ++i9) {
                        i8 = by;
                        Test0142.instanceCount >>= i3;
                        Test0142.instanceCount = i5;
                    }
                default:
                    i8 += (((i3 * l) + f) - Test0142.instanceCount);
            }
        }
                ...
                switch ((i % 5) + 117) {
                    case 117:
                        for (i13 = i; i13 < 2; i13++) {
                            switch (((i11 % 3) * 5) + 69) {
                                case 72:
                                    Test0142.byFld *= (byte) d1;
                                    f1 = Test0142.instanceCount;
                                    if (b) break;
                                    break;
                                case 74:
                                    i1 += (i13 * i13);
            ...
            switch (((i16 % 3) * 5) + 36) {
                case 45:
                    ...
                    do {
                        ...
                        i19 = 1;
                        while (++i19 < 1) {
                            Test0142.instanceCount <<= i16;
                            if (b1) break;
                            Test0142.byFld += (byte) (i19 * Test0142.instanceCount);
                        }
                        i17 = i16;
                        lArr1[i16 - 1] = -110;
                        i17 = i18;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i20 = 218; 13 < i20; --i20) {
            Test0142.instanceCount += i20;
            for (i22 = 122; i20 < i22; i22 -= 2) {
                i23 = i20;
                iArr3[i22 - 1][i20] = (int) Test0142.instanceCount;
            }
        }
        Test0142.instanceCount = i22;
        ...
        for (d2 = 12; d2 < 250; d2++) {
            ...
            for (i25 = 3; i25 < 106; ++i25) {
                ...
                d3 = 1;
                do {
                    Test0142.instanceCount += (long) (((d3 * Test0142.instanceCount) + i26) - i24);
                    i26 = i24;
                    i21 >>= (int) Test0142.instanceCount;
                    i24 += (int) d3;
                    if (false) continue;
                    i26 = i21;
                    i26 -= i21;
                } while (++d3 < 2);
                Test0142.instanceCount += (i25 | i24);
                iArr3[i25 - 1][(int) (d2 - 1)] -= (int) Test0142.instanceCount;
                if (true) {
                    Test0142.iArrFld[i25][i25] = i24;
                    fArr[i25 + 1] *= i25;
                    i23 = (int) Test0142.instanceCount;
                } else if (bFld) {
                    i23 = i22;
                    s1 &= (short) i24;
                } else if (true) {
        ...
        FuzzerUtils.out.println("Test0142.instanceCount Test0142.byFld bFld = " + Test0142.instanceCount + "," + Test0142.byFld + "," +
                (bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0142.bArrFld Test0142.iArrFld = " + FuzzerUtils.checkSum(Test0142.bArrFld) + "," +
                FuzzerUtils.checkSum(Test0142.iArrFld));
