...
public class Test0191 {
    ...
    static {
        FuzzerUtils.init(Test0191.iArrFld, 7);
    }
    ...
    public static long lMeth1(int i6, int i7) {
        ...
        for (i8 = 202; i8 > 2; --i8) {
            ...
            if (b) continue;
            if (b) {
                i9 += (((i8 * i6) + i8) - Test0191.instanceCount);
                i7 = -22101;
            } else if (b) {
                d -= i8;
                if (i6 != 0) {
            ...
            i9 -= (int) Test0191.instanceCount;
            Test0191.instanceCount = -95;
            i10 = 1;
            while (++i10 < 8) {
                s += (short) (-86 + (i10 * i10));
                Test0191.instanceCount += (long) -1.38984;
                i6 += i10;
            }
        }
    ...
    public long lMeth(int i2, long l) {
        ...
        for (l3 = 14; l3 < 317; l3++) {
            ...
            Test0191.dFld *= i12;
            i2 -= i13;
            Test0191.instanceCount += (((l3 * i12) + i2) - i13);
            i12 += (int) l3;
        }
        for (int i14 : Test0191.iArrFld) {
            fFld %= (0 | 1);
            for (i15 = 1; 4 > i15; ++i15) {
                short s1 = 11865;
                Test0191.instanceCount += (i15 * i15);
                if (b1) {
                    fArr1[i15] += s1;
                    Test0191.iArrFld[i15 - 1] >>= i12;
                } else {
                    l = i13;
                }
            }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 11; i < 203; i++) {
            fArr[i][i - 1] = (float) (lMeth(i1, Test0191.instanceCount) + Test0191.dFld);
            Test0191.instanceCount = (long) Test0191.dFld;
            lArr3[i + 1] = Test0191.instanceCount;
            Test0191.iArrFld[i - 1] += i;
            for (i17 = 2; i17 < 131; i17++) {
                f = 1;
                do {
                    lArr3[i17 + 1] >>>= -26;
                    Test0191.iArrFld[i17] -= i;
                    Test0191.iArrFld[i - 1] = (int) Test0191.instanceCount;
                    if (b2) continue;
                    i18 = i1;
                    i18 -= i18;
                    i18 = s2;
                ...
                i1 = i18;
                Test0191.iArrFld[(-51174 >>> 1) % N] = (int) Test0191.instanceCount;
                i18 = i18;
                Test0191.instanceCount = (long) fFld;
                for (i19 = 1; 2 > i19; i19++) {
                    Test0191.iArrFld[i17 + 1] *= i;
                    i1 = -11;
                    Test0191.instanceCount += Test0191.instanceCount;
                    if (b2) continue;
                    fFld -= fFld;
        ...
        FuzzerUtils.out.println("Test0191.instanceCount fFld Test0191.dFld = " + Test0191.instanceCount + "," +
                Float.floatToIntBits(fFld) + "," + Double.doubleToLongBits(Test0191.dFld));
        FuzzerUtils.out.println("Test0191.iArrFld bArrFld = " + FuzzerUtils.checkSum(Test0191.iArrFld) + "," +
