...
public class Test0502 {
    ...
    static {
        FuzzerUtils.init(Test0502.iArrFld, 1);
    }
    ...
    public static int iMeth1(int i4, int i5, int i6) {
        ...
        for (i7 = 1; i7 < 243; i7++) {
            Test0502.iArrFld[i7 + 1] = i7;
            Test0502.iArrFld[i7] += i8;
        }
        i4 = (int) f1;
        b = b;
        s -= (short) i4;
        for (i9 = 8; 190 > i9; i9++) {
            ...
            for (i12 = 9; i12 > 1; i12 -= 2) {
                ...
                i8 = s;
                i6 += s;
                i10 += (i12 + Test0502.instanceCount);
            }
        }
    ...
    public static long lMeth(long l, float f) {
        ...
        Test0502.iArrFld[(i3 >>> 1) % N] = (((-(i3 - i3)) * (i3 / (i3 | 1))) + iMeth1(i3, i3, i3));
        for (i14 = 8; i14 < 236; i14++) {
            i16 = 1;
            do {
                try {
                    i3 = (Test0502.iArrFld[(3816 >>> 1) % N] % -1777849188);
                    i17 = (86 / Test0502.iArrFld[i14]);
                    i3 = (267769163 % i14);
                } catch (ArithmeticException a_e) {
                }
            } while (++i16 < 7);
            i15 += (((i14 * f) + Test0502.instanceCount) - Test0502.instanceCount);
    ...
    public static int iMeth(int i2) {
        ...
        Test0502.iArrFld[(-225 >>> 1) % N] *= (int) lMeth(-196L, -1.429F);
        Test0502.instanceCount = (long) Test0502.fFld;
        i2 += i2;
        Test0502.fFld = -6368;
        i2 += (int) -1.128078;
        long meth_res = i2;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 208; i > 12; i--) {
            Test0502.iArrFld = (Test0502.iArrFld = (Test0502.iArrFld = (Test0502.iArrFld = Test0502.iArrFld)));
            i1 = iMeth(i);
            i1 += (i * i);
            for (i21 = 8; i21 < 128; ++i21) {
                Test0502.fFld *= 119;
                if (Test0502.bFld) continue;
                Test0502.fFld += (((i21 * Test0502.fFld) + i22) - i21);
                i1 = (int) Test0502.instanceCount;
                ...
                for (i23 = 1; 2 > i23; i23++) {
                    try {
                        i1 = (i23 % i);
                        i24 = (i22 % 57061);
                        i22 = (i23 / Test0502.iArrFld[i23 - 1]);
                    } catch (ArithmeticException a_e) {
                    }
                    lArr[i23] -= -118;
                    i22 -= (int) 207L;
                ...
                for (i25 = 1; i25 < 2; ++i25) {
                    lArr[i21] = (long) Test0502.fFld;
                }
                Test0502.instanceCount -= Test0502.instanceCount;
                i26 -= (int) Test0502.fFld;
            }
        }
        for (i27 = 138; i27 > 1; i27--) {
            i28 *= (int) Test0502.fFld;
        ...
        FuzzerUtils.out.println("Test0502.instanceCount Test0502.fFld Test0502.bFld = " + Test0502.instanceCount + "," +
                Float.floatToIntBits(Test0502.fFld) + "," + (Test0502.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0502.iArrFld = " + FuzzerUtils.checkSum(Test0502.iArrFld));
