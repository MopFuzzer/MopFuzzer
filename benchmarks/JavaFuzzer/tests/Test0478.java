...
public class Test0478 {
    ...
    public static void vMeth1() {
        ...
        i6 = (int) ((i6 -= (int) (i6 * Test0478.instanceCount)) + (++i6));
        i6 *= (int) (Test0478.instanceCount++);
        vMeth2();
        for (long l3 : lArr) {
            iArr2[(i6 >>> 1) % N] *= (int) l3;
            i6 += (int) d1;
            ...
            switch (((i6 >>> 1) % 2) + 74) {
                case 74:
                    d1 -= -864;
                    d1 -= Test0478.instanceCount;
                    break;
                case 75:
                    i11 = 1;
                    do {
                        iArr2 = FuzzerUtils.int1array(N, (int) -7590);
                        Test0478.byFld1 <<= (byte) i6;
                    } while (++i11 < 4);
                default:
            }
        }
    ...
    public void vMeth(long l1, long l2, int i5) {
        ...
        vMeth1();
        lArr1[(-4 >>> 1) % N] -= i5;
        l2 = (long) Test0478.fFld;
        Test0478.fFld -= i5;
        Test0478.fFld += Test0478.fFld;
        l1 = i5;
    ...
    public void mainTest(String[] strArr1) {
        ...
        iArr[(-183 >>> 1) % N] = (int) (((i - Test0478.instanceCount) - Test0478.instanceCount) | i);
        i = (int) (sFld + ((-i) - (Test0478.instanceCount - i)));
        for (i1 = 22; 376 > i1; ++i1) {
            if ((((i2--) + Long.reverseBytes(Test0478.instanceCount)) + iMeth(134 - i1)) >= (i2 - (byFld + (i2 -
                    Test0478.instanceCount)))) continue;
            vMeth(Test0478.instanceCount, Test0478.instanceCount, -11);
            i18 = 1;
            while (++i18 < 71) {
                i += (int) Test0478.instanceCount;
                Test0478.instanceCount ^= i;
                Test0478.byFld1 = (byte) i18;
                if (Test0478.bFld) break;
                for (i19 = i1; 1 > i19; i19++) {
                    iArr[i1] = -124;
                    sFld += (short) i19;
                    i2 = (int) Test0478.instanceCount;
                    Test0478.instanceCount += i;
                }
                Test0478.instanceCount = i1;
            }
            Test0478.byFld1 *= (byte) Test0478.fFld;
            d2 *= 101;
            i2 = i20;
            iArr[i1 - 1] += i1;
            i20 += (i1 | i2);
        ...
        FuzzerUtils.out.println("Test0478.instanceCount sFld Test0478.fFld = " + Test0478.instanceCount + "," + sFld + "," +
                Float.floatToIntBits(Test0478.fFld));
        FuzzerUtils.out.println("byFld Test0478.bFld Test0478.byFld1 = " + byFld + "," + (Test0478.bFld ? 1 : 0) + "," +
                Test0478.byFld1);
