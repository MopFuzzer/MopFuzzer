...
public class Test0237 {
    ...
    public static void vMeth(double d, int i3, int i4) {
        ...
        Test0237.instanceCount >>= Math.max(i3, -i4);
    ...
    public static void vMeth1(int i12, double d4) {
        ...
        iArr1[(i12 >>> 1) % N] = Test0237.byFld;
        i13 = 1;
        while (++i13 < 127) {
            iArr1[i13] *= 245;
            s1 += (short) (i13 | Test0237.instanceCount);
            i12 = i13;
            i12 <<= i12;
            s1 = (short) 60;
            i12 = (int) Test0237.instanceCount;
            i12 += (-148 + (i13 * i13));
        }
        lArr1[(i13 >>> 1) % N] -= i12;
        iArr1[(i13 >>> 1) % N] = i13;
        ...
        i12 = Test0237.byFld;
        Test0237.instanceCount += (long) f4;
    ...
    public static int iMeth1(int i9, int i10, float f2) {
        ...
        for (f3 = 10; f3 < 223; ++f3) {
            vMeth1(i11, d5);
            Test0237.byFld = (byte) 11640;
            i11 += i9;
        }
        Test0237.instanceCount -= i11;
        i14 = 1;
        do {
            for (i15 = 1; i15 < 5; ++i15) {
                iArr2[i14] += (int) d5;
    ...
    public int iMeth(int i6, float f1, int i7) {
        ...
        Test0237.instanceCount = (long) ((Math.max(i7, i7) * (i6 = (int) 1.659F)) - ((i8 >> i6) - Math.min(i6, i7)));
        d3 += (-((f1++) * Integer.reverseBytes(i6)));
        vMeth((i7 | (Test0237.instanceCount - i6)) - ((i8 + f1) - (i8 - i7)), (int) (iMeth1(i6, i8, f1) *
                Test0237.instanceCount), 8);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 5; i < 361; i++) {
            for (l = 71; l > 1; l -= 3) {
                double d2 = 0.45675;
                vMeth(Math.abs(l - (iArrFld[i + 1]++)), (int) (((i2 = i1) + (Test0237.instanceCount * i2)) - ((s - i1) -
                        iArrFld[i + 1])), i2);
                for (d1 = 1; d1 < 4; d1++) {
                    i5 = (int) (--lArr[(int) (l - 1)]);
                    i1 = (int) (--Test0237.instanceCount);
                }
                if (b) {
                    if (b = ((iArrFld[i + 1]--) != iArrFld[(int) (l - 1)])) {
                        iArrFld[(int) (l)] = (int) l;
                        i2 = (int) ((f++) + (Math.max(i2, i2) + d1));
                        d2 -= (((Test0237.instanceCount = i5) * 11599L) + (f++));
                        bArr[(int) (l - 1)] = (b = ((-2.330F - (iArrFld[(int) (l - 1)]++)) != (Test0237.instanceCount =
                                (long) d1)));
                    } else {
                        i2 += (-iMeth(i5, f, i));
                        for (i20 = 1; i20 < 4; ++i20) {
                    ...
                    i2 >>= i5;
                    for (i22 = 1; i22 < 4; i22++) {
                        iArrFld[i + 1] += (int) Test0237.instanceCount;
                        i23 += i23;
                        iArrFld[i22 - 1] -= i;
                        i23 += i22;
                        try {
                    ...
                    for (i24 = 1; i24 < 4; ++i24) {
                        iArrFld[i] *= (int) Test0237.instanceCount;
                        d2 = -74;
                    }
                }
            }
        ...
        FuzzerUtils.out.println("Test0237.instanceCount Test0237.byFld iArrFld = " + Test0237.instanceCount + "," + Test0237.byFld +
