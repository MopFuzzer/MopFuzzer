...
public class Test0498 {
    ...
    public static int iMeth(int i5) {
        ...
        i6 = 1;
        while (++i6 < 221) {
            i5 += (i6 | Test0498.instanceCount);
            for (i7 = 7; i7 > 1; --i7) {
                i8 = i5;
                f -= -81;
                Test0498.bFld = Test0498.bFld;
                bArr[i6] = Test0498.bFld;
                for (i9 = i7; 2 > i9; i9++) {
                    f += Test0498.instanceCount;
                    f += (((i9 * Test0498.instanceCount) + i6) - i7);
                    i5 += i5;
                    i8 = i10;
                    bArr[i7 + 1] = Test0498.bFld;
                    i8 /= (int) ((long) (f) | 1);
                    i5 &= (int) Test0498.instanceCount;
                }
            }
        }
    ...
    public static long lMeth(double d, int i4) {
        ...
        i4 += iMeth(i4);
        i4 *= i4;
        i4 %= (int) (Test0498.instanceCount | 1);
        for (i11 = 9; 234 > i11; ++i11) {
            i4 >>= i4;
            for (i13 = 1; i13 < 7; i13++) {
                i4 = (int) Test0498.instanceCount;
                switch (((i13 % 4) * 5) + 64) {
                    case 72:
                        i12 += (int) (7L + (i13 * i13));
                        f1 = 2;
    ...
    public static void vMeth(int i1, int i2, int i3) {
        ...
        lArr[(i1 >>> 1) % N] >>>= Test0498.instanceCount;
        lMeth(d1, i3);
        Test0498.fFld -= i3;
        i2 = -209;
        i1 -= i1;
            ...
            switch (((i15 % 5) * 5) + 55) {
                case 69:
                    for (d2 = i15; d2 < 5; d2++) {
                        iArr[i15 + 1] ^= i15;
                        i16 = i3;
                        Test0498.instanceCount -= (long) Test0498.fFld;
                    }
                    break;
                case 67:
                    i18 |= s;
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            for (f3 = 1; f3 < 116; f3++) {
                ...
                do {
                    ...
                    Test0498.instanceCount >>>= i21;
                    Test0498.instanceCount += (((i21 * Test0498.iFld) + Test0498.instanceCount) - i19);
                    Test0498.fFld *= Test0498.instanceCount;
                    i20 += 148;
                    iArr1[i - 1] = i20;
                    iArr1[(int) (f3 + 1)] *= i;
                } while (++i21 < 2);
                switch ((int) ((f3 % 2) + 16)) {
                    case 16:
                        Test0498.iFld >>= (int) Test0498.instanceCount;
                        s1 ^= (short) 1;
                        Test0498.instanceCount = Test0498.iFld;
                        i19 += (int) f3;
                    case 17:
                        for (i22 = 1; i22 < 2; i22++) {
                            lArr1[i22] ^= by;
                            iArr1[i + 1] = (int) Test0498.instanceCount;
                            lArr1 = lArr1;
                            i20 = i20;
                            Test0498.bFld = Test0498.bFld;
                            Test0498.iFld *= 9;
                            i19 <<= i20;
                            i20 *= i20;
                            Test0498.instanceCount = i20;
                        }
                        Test0498.instanceCount *= (long) f3;
                        break;
                    default:
                        i19 = i21;
                }
        ...
        FuzzerUtils.out.println("Test0498.instanceCount Test0498.bFld Test0498.fFld = " + Test0498.instanceCount + "," + (Test0498.bFld ? 1
                : 0) + "," + Float.floatToIntBits(Test0498.fFld));
        FuzzerUtils.out.println("Test0498.iFld = " + Test0498.iFld);
