...
public class Test0937 {
    ...
    public static int iMeth(long l1) {
        ...
        for (i2 = 1; i2 < 179; i2++) {
            ...
            if (b) continue;
            for (i4 = 9; i2 < i4; i4 -= 2) {
                Test0937.instanceCount = 2395886317L;
                for (i6 = 1; 1 > i6; ++i6) {
                    Test0937.dFld -= Test0937.instanceCount;
                    i7 = i3;
                    l1 ^= l1;
                    l1 = i5;
    ...
    public static void vMeth(long l) {
        ...
        Test0937.instanceCount = ((iMeth(Test0937.instanceCount) * i8) - 251);
        for (d = 9; d < 170; ++d) {
            short s1 = -23736;
            s1 <<= (short) i8;
            iArr[(int) (d - 1)] -= i10;
        ...
        for (f1 = 391; f1 > 23; --f1) {
            switch ((int) (((f1 % 8) * 5) + 8)) {
                ...
                case 47:
                    i11 >>>= i10;
                    Test0937.instanceCount >>= s2;
                case 10:
                    Test0937.instanceCount = i9;
                    f2 += (f1 + f2);
                case 9:
                    fArr[(int) (f1)] = Test0937.instanceCount;
                    i11 = i10;
                    break;
                case 39:
                    l *= -26;
    ...
    public void mainTest(String[] strArr3) {
        ...
        for (int smallinvoc = 0; smallinvoc < 379; smallinvoc++) vSmallMeth(Test0937.sFld, i12);
            ...
            switch ((i15 % 7) + 105) {
                ...
                case 108:
                    for (i19 = 2; i19 < 131; i19++) {
                        Test0937.instanceCount += i19;
                        if (Test0937.bFld) break;
                        Test0937.instanceCount -= (long) f3;
                    }
                    for (i21 = i15; i21 < 131; i21++) {
                        Test0937.dFld += 63531;
                        i12 = i21;
                        i14 += (((i21 * Test0937.instanceCount) + i13) - i14);
                    }
                    break;
                case 109:
                    i16 += (i15 * i15);
        ...
        FuzzerUtils.out.println("Test0937.instanceCount Test0937.dFld Test0937.sFld = " + Test0937.instanceCount + "," +
                Double.doubleToLongBits(Test0937.dFld) + "," + Test0937.sFld);
        FuzzerUtils.out.println("Test0937.bFld = " + (Test0937.bFld ? 1 : 0));
