...
public class Test0670 {
    ...
    static {
        FuzzerUtils.init(Test0670.sArrFld, (short) -23675);
        FuzzerUtils.init(Test0670.iArrFld, -218);
    }
    ...
    public static void vMeth2(int i3) {
        ...
        for (i4 = 302; 8 < i4; i4--) {
            ...
            f2 = i3;
            lArr[i4 + 1] = 161;
            Test0670.sFld = (short) Test0670.dFld;
            d1 = 1;
            do {
                b = b;
                try {
                ...
                switch ((i4 % 2) + 10) {
                    case 10:
                        i6 = 1;
                        do {
                            iArr[(int) (d1)] = (int) Test0670.instanceCount;
    ...
    public static void vMeth1(double d, int i2, float f1) {
        ...
        for (d2 = 24; d2 < 392; ++d2) {
            ...
            for (i8 = 1; i8 < 5; i8++) {
                ...
                i7 = (int) -2.994F;
                Test0670.sArrFld = Test0670.sArrFld;
                by1 += (byte) (i8 | i12);
                Test0670.iArrFld[(int) (d2 - 1)] = i8;
                for (i13 = 1; i13 < 2; i13++) {
                    if (Test0670.bFld) break;
                    Test0670.instanceCount += i13;
                }
                f1 += (-7 + (i8 * i8));
            }
        }
    ...
    public static void vMeth(int i, float f, int i1) {
        ...
        vMeth1(Test0670.dFld, i1, f);
        dArr = dArr;
        Test0670.bFld = Test0670.bFld;
        l1 = 1;
        do {
            lArr1[(int) (l1)] = i1;
            i1 = i1;
            Test0670.instanceCount += (60 + (l1 * l1));
            by2 -= (byte) Test0670.instanceCount;
            Test0670.iArrFld = FuzzerUtils.int1array(N, (int) 27736);
            i1 -= i1;
            if (Test0670.bFld) break;
        } while (++l1 < 198);
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(13, f3, i15);
        Test0670.sFld += (short) Test0670.dFld;
        fArr1[(i15 >>> 1) % N] = Test0670.instanceCount;
        lArr2 = lArr2;
        Test0670.iArrFld[(-62 >>> 1) % N] = i15;
        i15 = i15;
        Test0670.instanceCount /= (i15 | 1);
        f3 = -1;
        Test0670.instanceCount |= i15;
        lArr2[(8 >>> 1) % N] = i15;
        ...
        FuzzerUtils.out.println("Test0670.bFld Test0670.sArrFld Test0670.iArrFld = " + (Test0670.bFld ? 1 : 0) + "," +
                FuzzerUtils.checkSum(Test0670.sArrFld) + "," + FuzzerUtils.checkSum(Test0670.iArrFld));
