...
public class Test0554 {
    ...
    static {
        FuzzerUtils.init(Test0554.iArrFld, -10);
        FuzzerUtils.init(Test0554.iArrFld1, -29662);
    }
    ...
    public static void vMeth1() {
        ...
        Test0554.instanceCount = i4;
        for (i5 = 8; i5 < 297; i5++) {
            i6 += i5;
            i6 >>= i5;
            Test0554.instanceCount -= i6;
        }
        i4 = (int) Test0554.fFld;
        for (i7 = 10; i7 < 314; ++i7) {
            i6 += (((i7 * i8) + i7) - i4);
            i6 *= (int) Test0554.instanceCount;
            i6 -= i7;
            i6 *= i6;
        }
        i9 = 1;
        ...
        for (i11 = 9; i11 < 251; i11++) {
            switch (((i11 % 5) * 5) + 68) {
                case 90:
                    ...
                    for (i13 = 1; i13 < 7; i13++) {
                        d += 3825725595L;
                        i14 |= (int) Test0554.instanceCount;
                        try {
                            i14 = (-1458801465 % i11);
                            i12 = (i12 % i3);
                            i14 = (i11 / 25725);
                        ...
                        Test0554.fFld += i13;
                        i14 = i16;
                        Test0554.iArrFld[i11] = (int) Test0554.instanceCount;
                    }
                    break;
                case 93:
    ...
    public static int iMeth(int i2) {
        ...
        for (i17 = 6; i17 < 268; ++i17) {
            i2 = i18;
            i18 *= (int) Test0554.instanceCount;
            fArr1[i17 + 1][i17] -= i17;
            for (i19 = i17; i19 < 6; i19++) {
                i20 *= by1;
                for (i21 = 1; i21 < 1; i21++) {
                    i18 += (int) -34.577F;
                    Test0554.instanceCount *= i2;
                    Test0554.fFld = -206L;
                    i20 = -204;
                    if (b) continue;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        while ((i23 += 2) < 251) {
            ...
            try {
                i1 = (i / i23);
                Test0554.iArrFld1[i23 + 1] = (1395293331 / i24);
                Test0554.iFld = (Test0554.iArrFld1[i23 - 1] / Test0554.iArrFld[i23]);
            } catch (ArithmeticException a_e) {
            }
        ...
        FuzzerUtils.out.println("Test0554.instanceCount Test0554.fFld dFld = " + Test0554.instanceCount + "," +
                Float.floatToIntBits(Test0554.fFld) + "," + Double.doubleToLongBits(dFld));
        FuzzerUtils.out.println("Test0554.iFld byArrFld Test0554.iArrFld = " + Test0554.iFld + "," + FuzzerUtils.checkSum(byArrFld)
                + "," + FuzzerUtils.checkSum(Test0554.iArrFld));
        FuzzerUtils.out.println("Test0554.iArrFld1 = " + FuzzerUtils.checkSum(Test0554.iArrFld1));
