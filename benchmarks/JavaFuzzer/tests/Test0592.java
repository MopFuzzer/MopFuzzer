...
public class Test0592 {
    ...
    public static void vMeth1(long l2) {
        ...
        for (l3 = 11; l3 < 322; l3++) {
            if (b) {
                ...
                f1 *= i4;
                f1 += f1;
                Test0592.iFld += (int) l3;
                Test0592.iFld *= i4;
            } else {
                d = l3;
            }
            if (b) continue;
            Test0592.instanceCount *= i4;
            if (b) continue;
            for (i5 = 1; i5 < 5; i5++) {
                i7 += (i5 | i5);
    ...
    public static int iMeth(int i, int i1) {
        ...
        for (f = 10; f < 308; ++f) {
            switch (((i >>> 1) % 9) + 15) {
                case 15:
                    vMeth(-29701, Test0592.instanceCount, Test0592.instanceCount);
                    iArr1[(int) (f)] += (int) Test0592.instanceCount;
                    switch ((int) ((f % 10) + 91)) {
                        case 91:
                            for (i8 = 1; i8 < 6; i8++) {
                                for (i10 = 1; i10 < 2; i10++) {
                        ...
                        case 95:
                            ...
                            break;
                        case 96:
                            Test0592.iFld %= (int) (Test0592.iFld | 1);
                            break;
                        case 97:
                            dArr[(int) (f - 1)] = i1;
                            break;
                        case 98:
                            Test0592.instanceCount += s;
                        case 99:
                            if (i2 != 0) {
                            }
                            break;
                        case 100:
                            f2 += Test0592.instanceCount;
                            break;
                        default:
                            i1 -= i2;
                    }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test0592.iFld *= iMeth(102, Test0592.iFld);
        if (b1) {
            iArrFld[(Test0592.iFld >>> 1) % N] = Test0592.iFld;
            Test0592.fFld -= Test0592.iFld;
            ...
            for (i12 = 11; i12 < 242; ++i12) {
                ...
                i13 += i12;
                i13 += (i12 * i12);
                Test0592.iFld += (-20084 + (i12 * i12));
                Test0592.iFld ^= (int) Test0592.instanceCount;
                try {
                    iArrFld[i12 + 1] = (161 / i12);
                    Test0592.iFld = (i12 / i12);
                    iArrFld[i12 - 1] = (i12 / Test0592.iFld);
                } catch (ArithmeticException a_e) {
                }
            }
            i13 = i12;
                    ...
                    if (b1) {
                        ...
                        switch (((58335 >>> 1) % 5) + 108) {
                            case 108:
                                ...
                                i15 *= i14;
                                Test0592.instanceCount += i12;
                                break;
                            case 109:
                                Test0592.iFld1 -= i17;
                            case 110:
                                Test0592.byFld = (byte) -38078;
                                break;
                            case 111:
                            case 112:
                                Test0592.fFld = i17;
        ...
        FuzzerUtils.out.println("Test0592.instanceCount Test0592.iFld Test0592.fFld = " + Test0592.instanceCount + "," + Test0592.iFld +
                "," + Float.floatToIntBits(Test0592.fFld));
        FuzzerUtils.out.println("dFld Test0592.iFld1 Test0592.byFld = " + Double.doubleToLongBits(dFld) + "," + Test0592.iFld1 +
                "," + Test0592.byFld);
