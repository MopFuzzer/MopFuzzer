...
public class Test0361 {
    ...
    static {
        FuzzerUtils.init(Test0361.iArrFld, 153);
        FuzzerUtils.init(Test0361.lArrFld, -151L);
    }
        ...
        for (i7 = 3; i7 < 194; i7++) {
            for (i9 = 8; i9 > 1; i9 -= 2) {
                ...
                while (++f1 < 3) {
                    i6 *= i5;
                    i5 = i10;
                    Test0361.iArrFld[i9 - 1] -= (int) Test0361.instanceCount;
            ...
            i11 = 1;
            do {
                Test0361.instanceCount = i7;
                for (i12 = 1; i12 > 1; --i12) {
                    Test0361.iArrFld[i7] >>= -68;
                    Test0361.instanceCount = i9;
                }
            } while (++i11 < 8);
        }
    ...
    public static int iMeth1(long l1, double d) {
        ...
        for (i = 7; i < 355; ++i) {
            for (i2 = 5; i2 > 1; --i2) {
                i4 = 1;
                while (++i4 < 2) {
                    b = (b = (Test0361.iArrFld[i2 - 1] != iMeth2(i3, f2, i1)));
                    i1 *= (int) f2;
                    lArr[i4] >>= i2;
                    switch ((((i1 >>> 1) % 9) * 5) + 50) {
                        case 75:
                            Test0361.instanceCount += (long) 28.124205;
                            b = b;
                            break;
                        case 83:
                            i3 += (i4 * i3);
    ...
    public static int iMeth(long l) {
        ...
        for (i15 = 21; i15 < 370; ++i15) {
            ...
            for (i17 = 1; i17 < 5; ++i17) {
                ...
                i18 *= i17;
                for (i19 = 1; i19 < 2; ++i19) {
                    Test0361.iArrFld[i17] ^= i18;
                    f3 *= i18;
                    l += by;
                    Test0361.instanceCount += -2095259713L;
    ...
    public void mainTest(String[] strArr1) {
        ...
        if (Test0361.bFld) {
            ...
            while ((i22 -= 2) > 0) {
                i23 = 239;
                do {
                    Test0361.instanceCount += (-49948 + (i23 * i23));
                    d2 = -3.31F;
                    Test0361.lArrFld[i22][i22 + 1] -= i21;
                    Test0361.instanceCount >>= s;
                    Test0361.instanceCount = i21;
                    Test0361.instanceCount += (i23 * Test0361.instanceCount);
                } while (--i23 > 0);
                ...
                for (i24 = i22; i24 < 239; ++i24) {
                    try {
                        i25 = (-32901 % i22);
                        i25 = (-428560300 % i25);
                        Test0361.iArrFld[i24] = (i22 % 43311);
                    } catch (ArithmeticException a_e) {
                    }
                    if (false) continue;
                    f4 = i23;
                    bArr[i22 - 1] = Test0361.bFld;
                }
                try {
                    i25 = (-24644 / Test0361.iArrFld[i22 + 1]);
                    i25 = (-26886 / i22);
                    i21 = (i23 / i23);
                } catch (ArithmeticException a_e) {
                }
        ...
        FuzzerUtils.out.println("Test0361.instanceCount Test0361.bFld Test0361.iArrFld = " + Test0361.instanceCount + "," + (Test0361.bFld
                ? 1 : 0) + "," + FuzzerUtils.checkSum(Test0361.iArrFld));
        FuzzerUtils.out.println("Test0361.lArrFld = " + FuzzerUtils.checkSum(Test0361.lArrFld));
