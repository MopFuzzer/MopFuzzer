...
public class Test0655 {
    ...
    public static void vMeth(float f, long l) {
        ...
        for (i12 = 3; i12 < 164; i12 += 3) {
            ...
            i13 *= (int) Test0655.instanceCount;
            if (b2) break;
        }
        for (i14 = 6; i14 < 233; ++i14) {
            Test0655.byFld += (byte) i13;
            if (b2) {
                i13 = Test0655.byFld;
                i13 = i13;
                f += (i14 * i14);
                ...
                iArr2[i14][i14 - 1] >>>= i11;
                i11 += (((i14 * Test0655.instanceCount) + l) - i11);
            }
        }
        vMeth_check_sum += Float.floatToIntBits(f) + l + i11 + i12 + i13 + (b2 ? 1 : 0) + i14 + i15 +
                FuzzerUtils.checkSum(iArr2);
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = 1;
        do {
            Test0655.instanceCount = ((++Test0655.instanceCount) - i);
            vMeth(0.986F, -18284L);
            i16 += (((i * Test0655.instanceCount) + i16) - f3);
            i16 = i16;
            for (d2 = 4; d2 < 65; d2++) {
                i16 /= -36716;
                for (i18 = 1; i18 < 2; i18++) {
                    switch ((i18 % 7) + 106) {
                        case 106:
                            i19 -= (int) Test0655.instanceCount;
                            break;
                        case 107:
                        case 108:
                            Test0655.instanceCount = Test0655.instanceCount;
                            Test0655.instanceCount += (i18 * i18);
                            f3 = Test0655.instanceCount;
                            i16 -= -12;
                            break;
                        case 109:
                            f3 = i;
                            ...
                            switch (((i18 % 2) * 5) + 49) {
                                case 52:
                                    ...
                                    switch (((i18 % 4) * 5) + 102) {
                                        ...
                                        default:
                                            i17 += i18;
                                            Test0655.instanceCount += (i18 - i17);
                                    }
                                    i17 = (int) Test0655.instanceCount;
                                    i17 |= (int) Test0655.instanceCount;
                                    break;
                                case 58:
                                    Test0655.instanceCount += i18;
                                    Test0655.instanceCount = Test0655.byFld;
                                default:
                                    i17 *= i16;
                            }
                            break;
                        case 111:
                            i19 += (((i18 * Test0655.instanceCount) + Test0655.instanceCount) - i19);
                        case 112:
                            i17 += (((i18 * i19) + f3) - Test0655.instanceCount);
                            break;
                        default:
                            i17 -= (int) f3;
                    }
        ...
        FuzzerUtils.out.println("Test0655.instanceCount Test0655.byFld = " + Test0655.instanceCount + "," + Test0655.byFld);
