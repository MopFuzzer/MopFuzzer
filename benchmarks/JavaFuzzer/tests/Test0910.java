...
public class Test0910 {
            ...
            for (i6 = 361; 1 < i6; --i6) {
                for (i8 = 1; i8 < 5; i8++) {
                    ...
                    for (i10 = 1; 2 > i10; ++i10) {
                        Test0910.iFld = -33051;
                        Test0910.iFld *= i4;
                        Test0910.iFld += (i10 * i10);
                    }
                    lArr[i6] = i8;
                    iArr1[i6] -= i7;
                }
                Test0910.iFld += -62;
                Test0910.instanceCount = i7;
            }
        } else if (b) {
            i7 = i7;
        } else if (b) {
            i11 |= (int) Test0910.instanceCount;
        } else {
            f1 += 7;
        }
    ...
    public static short sMeth(int i2) {
        ...
        d += (((--Test0910.iFld) + 2247) + (Math.abs(Test0910.iFld) << (i2 * i2)));
        by = (byte) (((-13 << Test0910.iFld) + (68 - i2)) + iArr[(Test0910.iFld >>> 1) % N]);
        for (d1 = 18; d1 < 397; d1++) {
            vMeth(13, false, -124);
        }
        i2 = i3;
    ...
    public int iMeth() {
        ...
        Test0910.iFld ^= (sMeth(Test0910.iFld) >> -33098);
        for (i12 = 1; i12 < 146; ++i12) {
            ...
            do {
                for (i15 = 1; i15 < 1; i15++) {
                    ...
                    d2 += i16;
                    f2 = (float) d2;
                    Test0910.instanceCount = i16;
                    i16 -= i12;
                    i13 *= -4026;
                    Test0910.instanceCount <<= by1;
                }
                i13 = i16;
                Test0910.instanceCount = (long) d2;
                if (i15 != 0) {
                }
            } while (++i14 < 11);
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            do {
                ...
                i18 = 1;
                do {
                    Test0910.instanceCount += (i18 - f);
                    Test0910.iFld += (i18 ^ i1);
                    iArrFld[i18 - 1] ^= i;
                    Test0910.dFld *= Test0910.iFld;
                    Test0910.instanceCount *= (long) Test0910.dFld;
                    i >>= Test0910.iFld;
                    Test0910.instanceCount >>= i17;
                } while (++i18 < 1);
            } while (++i17 < 72);
            i &= i1;
            for (i19 = 4; i19 < 72; i19++) {
                f += (((i19 * Test0910.instanceCount) + Test0910.iFld) - s);
                for (i21 = 1; i21 < 2; i21++) {
                    i22 = i21;
                    by2 -= (byte) i17;
                    i22 -= i21;
                    ...
                    lArr1[i1 - 1] = (long) f;
                    i = Test0910.iFld;
                    i22 -= (int) Test0910.instanceCount;
                    if (b1) break;
                }
        ...
        FuzzerUtils.out.println("Test0910.instanceCount Test0910.iFld Test0910.dFld = " + Test0910.instanceCount + "," + Test0910.iFld +
                "," + Double.doubleToLongBits(Test0910.dFld));
