...
public class Test0322 {
    ...
    static {
        FuzzerUtils.init(Test0322.iArrFld, -13);
        FuzzerUtils.init(Test0322.iArrFld1, 11);
    }
    ...
    public static void vMeth1() {
        ...
        for (i2 = 15; i2 < 384; ++i2) {
            ...
            i10 += (((i2 * Test0322.fFld) + i10) - i2);
        }
        for (l = 19; 395 > l; ++l) {
            Test0322.iArrFld = Test0322.iArrFld;
            Test0322.iArrFld[(int) (l)] >>= i10;
        }
        for (i12 = 21; 381 > i12; ++i12) {
            if (b) {
                for (i14 = 1; i14 < 5; i14++) {
                    byte by = 88;
                    try {
                        i11 = (Test0322.iArrFld[i12] % 533722756);
                        i15 = (i2 / -1688672269);
                        i11 = (i3 / -19280);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 8; 208 > i; i++) {
            ...
            double d1 = 1.73788;
            vMeth();
            Test0322.sFld = Test0322.sFld;
            i1 += i;
            i1 += (((i * i) + i24) - i);
            Test0322.iArrFld1[i + 1] += i1;
            i24 = i1;
            Test0322.instanceCount += (long) d1;
            i1 = (int) Test0322.fFld;
            Test0322.instanceCount = -8408L;
        }
        lArr2 = lArr2;
        Test0322.instanceCount = by1;
        fArr[(i1 >>> 1) % N] += 2318970584L;
        for (double d2 : dArrFld) {
            Test0322.instanceCount = i1;
            Test0322.iArrFld1[(i1 >>> 1) % N] = (int) Test0322.fFld;
            for (i25 = 1; i25 < 63; ++i25) {
                i1 -= i26;
                i26 = i;
                if (Test0322.bFld) continue;
                i26 -= (int) Test0322.instanceCount;
                i1 = i26;
            }
            Test0322.fFld = i26;
            i1 = (int) -13L;
            Test0322.iArrFld[(i >>> 1) % N] -= i;
            dArrFld[(i1 >>> 1) % N] += i;
            Test0322.fFld += Test0322.instanceCount;
            Test0322.fFld = i1;
            i1 *= 18299;
        }
        Test0322.fFld += i26;
        ...
        FuzzerUtils.out.println("Test0322.instanceCount Test0322.fFld Test0322.bFld = " + Test0322.instanceCount + "," +
                Float.floatToIntBits(Test0322.fFld) + "," + (Test0322.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0322.sFld Test0322.iArrFld Test0322.iArrFld1 = " + Test0322.sFld + "," +
                FuzzerUtils.checkSum(Test0322.iArrFld) + "," + FuzzerUtils.checkSum(Test0322.iArrFld1));
