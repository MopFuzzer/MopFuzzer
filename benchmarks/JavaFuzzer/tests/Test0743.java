...
public class Test0743 {
    ...
    static {
        FuzzerUtils.init(Test0743.dArrFld, 2.85032);
    }
    ...
    public static void vMeth1(int i13, int i14) {
        ...
        for (i16 = 13; i16 < 250; i16++) {
            ...
            for (i18 = 1; i18 < 7; i18++) {
                ...
                i19 += (int) Test0743.instanceCount;
            }
        }
    ...
    public void vMeth() {
        ...
        iArrFld[(i8 >>> 1) % N] ^= i8;
        i8 -= (int) (((i8 + Test0743.instanceCount) + (i8 - i8)) * 11);
        i8 ^= 22;
        if (true) {
            i9 = 1;
            while (++i9 < 156) {
                if (Test0743.fFld >= 5) continue;
                Test0743.fFld *= i9;
                i10 += (int) ((lArr[i9] >>= (6 - (++by1))) + ((by1 | 4) * (i10 * Test0743.instanceCount)));
                i8 += (int) (i8 >>> (long) ((Test0743.fFld - Test0743.instanceCount) % ((Test0743.instanceCount + i8) | 1)));
                for (i11 = 1; i11 < 10; ++i11) {
                    if ((Test0743.dFld * (-Math.max(38968, i10))) != (--i10)) break;
                }
                vMeth1(-62521, i10);
                by1 *= (byte) -70;
                i8 -= 16;
                Test0743.instanceCount += (i9 * i9);
            }
        } else {
            Test0743.fFld += 53;
        }
        ...
        for (i4 = 5; i4 < 134; i4++) {
            ...
            for (i6 = 1; i6 < 12; ++i6) {
                ...
                for (i22 = 1; i22 < 2; i22++) {
                    ...
                    iArr[i4 - 1] <<= i5;
                    sFld = (short) i22;
                    i23 = (int) Test0743.instanceCount;
                }
            }
            Test0743.dFld *= i7;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 10; i < 207; i++) {
            ...
            for (i2 = 6; i2 < 127; i2++) {
                ...
                i3 += (15681 + (i2 * i2));
                i1 += (i2 - i1);
                Test0743.instanceCount = i;
                i1 -= (int) Test0743.instanceCount;
            }
            i1 += i2;
            i24 = 1;
            while (++i24 < 127) {
                switch ((i % 10) + 126) {
                    case 126:
                        ...
                        break;
                    case 127:
                        Test0743.instanceCount += (i24 + Test0743.fFld);
                    case 128:
                        i1 |= i3;
                        i3 += i3;
                        Test0743.instanceCount = -7460;
                        Test0743.fFld = Test0743.instanceCount;
                        break;
                    case 129:
                        for (i25 = 1; i25 < 1; i25++) {
                    ...
                    case 131:
                        for (i27 = 1; i27 < 1; i27++) {
                            i26 = (int) Test0743.instanceCount;
                            Test0743.dArrFld[i24] -= Test0743.instanceCount;
                        }
                        break;
                    case 132:
                        Test0743.instanceCount -= (long) Test0743.fFld;
                        break;
                    case 133:
                        Test0743.instanceCount += i25;
                        break;
                    case 134:
                        byArr[i - 1] = (byte) i1;
                        break;
        ...
        FuzzerUtils.out.println("Test0743.instanceCount Test0743.fFld Test0743.dFld = " + Test0743.instanceCount + "," +
                Float.floatToIntBits(Test0743.fFld) + "," + Double.doubleToLongBits(Test0743.dFld));
        ...
        FuzzerUtils.out.println("Test0743.dArrFld = " + Double.doubleToLongBits(FuzzerUtils.checkSum(Test0743.dArrFld)));
