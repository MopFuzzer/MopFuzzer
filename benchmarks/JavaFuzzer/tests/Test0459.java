...
public class Test0459 {
    ...
    static {
        FuzzerUtils.init(Test0459.lArrFld, -9L);
        FuzzerUtils.init(Test0459.lArrFld1, -181L);
    }
            ...
            for (i10 = 1; 5 > i10; i10++) {
                ...
                switch (((93 >>> 1) % 4) + 115) {
                    case 115:
                        ...
                        break;
                    case 116:
                        i11 += (int) Test0459.instanceCount;
                        break;
                    case 117:
                        iArr2[i8 + 1] -= i8;
                        iArr3[i10] >>= s;
    ...
    public static int iMeth(float f1, int i7) {
        ...
        i7 += Short.reverseBytes((short) ((iArr1[(i7 >>> 1) % N] &= (int) Test0459.instanceCount) * lMeth1(-60189L)));
        d2 *= i7;
        i7 = 31837;
        iArr1[(i7 >>> 1) % N] = (int) Test0459.instanceCount;
        for (int i12 : iArr1) {
            i12 += 224;
            Test0459.instanceCount ^= 167;
            switch ((((i7 >>> 1) % 1) * 5) + 23) {
                case 28:
                    i7 &= i12;
                    i12 += i7;
    ...
    public static long lMeth(double d) {
        ...
        do {
            i6 <<= 8;
            Test0459.lArrFld = Test0459.lArrFld1;
        } while (++i16 < 132);
        Test0459.sFld &= (short) i16;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 10; i < 358; i++) {
            ...
            i2 = 1;
            while (++i2 < 72) {
                i1 = (int) (-((i - Test0459.byFld) - (i1 + f)));
                i3 += (((i2 * Test0459.instanceCount) + i1) - i1);
                i3 += i2;
                switch ((i % 2) + 63) {
                    case 63:
                        ...
                        if (Test0459.bFld) {
                            ...
                            for (d3 = 1; d3 < 1; d3++) {
                                ...
                                i17 += i17;
                                dFld %= (i1 | 1);
                                Test0459.instanceCount >>= i1;
                                Test0459.instanceCount += (long) ((long) d3 ^ i3);
                                i3 += (int) (((d3 * Test0459.instanceCount) + i1) - Test0459.instanceCount);
                                i1 += i;
                                Test0459.instanceCount += (long) d3;
                            }
                        } else if (Test0459.bFld) {
                            if (false) break;
                        }
                        Test0459.lArrFld[i + 1] = i2;
                        break;
                    case 64:
                        Test0459.iFld &= (int) Test0459.instanceCount;
                        break;
                    default:
                        f += (i2 * i2);
                        Test0459.sFld -= (short) i1;
                        iArr[i2 - 1] -= (int) f;
        ...
        FuzzerUtils.out.println("Test0459.instanceCount Test0459.byFld Test0459.bFld = " + Test0459.instanceCount + "," + Test0459.byFld +
                "," + (Test0459.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test0459.sFld dFld Test0459.iFld = " + Test0459.sFld + "," + Double.doubleToLongBits(dFld) + "," +
                Test0459.iFld);
        FuzzerUtils.out.println("Test0459.lArrFld Test0459.lArrFld1 = " + FuzzerUtils.checkSum(Test0459.lArrFld) + "," +
                FuzzerUtils.checkSum(Test0459.lArrFld1));
