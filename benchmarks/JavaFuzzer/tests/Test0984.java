...
public class Test0984 {
    ...
    static {
        FuzzerUtils.init(Test0984.iArrFld, 68);
    }
    ...
    public static void vMeth1(int i7, float f2) {
        ...
        for (i8 = 13; 255 > i8; i8++) {
            ...
            for (d = 1; 7 > d; ++d) {
                i9 -= i10;
                Test0984.instanceCount = i8;
                if (Test0984.bFld) continue;
                i11 = 1;
                do {
                    s = (short) -12;
                    Test0984.instanceCount -= i11;
                    Test0984.instanceCount = (long) d;
                    Test0984.instanceCount = Test0984.instanceCount;
                } while (++i11 < 2);
                i10 = i9;
                i7 |= i8;
                Test0984.instanceCount >>>= i10;
            }
            i9 += (i8 ^ (long) f2);
        }
    ...
    public static void vMeth(int i4, int i5, int i6) {
        ...
        vMeth1(-10, f3);
        bArr[(i4 >>> 1) % N] = Test0984.bFld;
        i12 = 377;
        do {
            if (b) continue;
            i5 *= (int) Test0984.instanceCount;
        } while ((i12 -= 2) > 0);
        Test0984.instanceCount += Test0984.instanceCount;
    ...
    public int iMeth(long l1, float f1, int i3) {
        ...
        i3 = (--Test0984.iArrFld[(i3 >>> 1) % N]);
        i3 >>= (int) (Test0984.instanceCount + Integer.reverseBytes(i3++));
        vMeth(i3, i3, i3);
        f1 = s1;
        i3 += i3;
        for (i19 = 4; i19 < 139; ++i19) {
            for (i21 = 12; i21 > 1; i21--) {
                i20 -= -136;
                f1 = Test0984.instanceCount;
                i22 += (i21 * i21);
                i3 = (int) -2.1002F;
                lArr[i19 + 1][i21 + 1] = i22;
                for (i23 = 1; i23 < 2; ++i23) {
                    Test0984.iArrFld[i21] += (int) dFld;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 9; 259 > i; i++) {
            for (l = i; l < 101; l += 2) {
                f += Test0984.iArrFld[i + 1];
                i2 += (int) f;
                i1 = ((i1++) * (--i2));
            }
            i2 += (4 + (i * i));
            i1 -= iMeth(Test0984.instanceCount, f, i2);
        }
        for (i25 = 371; 1 < i25; --i25) {
            for (i27 = 3; i27 < 68; ++i27) {
                i28 = i26;
                Test0984.iArrFld = Test0984.iArrFld;
            }
            i29 = 1;
            while (++i29 < 68) {
                i2 += (i29 * i29);
                i1 -= i29;
                if (Test0984.bFld) continue;
                Test0984.instanceCount *= (long) dFld;
                i26 >>>= i;
                i2 <<= i26;
                i26 += by;
            }
            for (i30 = 2; i30 < 68; i30++) {
                i2 >>= i;
                i28 += (int) f;
                Test0984.iArrFld = FuzzerUtils.int1array(N, (int) 6);
            }
            i2 += (i25 * i28);
            i26 = (int) Test0984.instanceCount;
            Test0984.instanceCount += (long) 1.125F;
            i2 = -1;
        }
        i28 = i1;
        Test0984.iArrFld = Test0984.iArrFld;
        ...
        FuzzerUtils.out.println("Test0984.instanceCount Test0984.bFld dFld = " + Test0984.instanceCount + "," + (Test0984.bFld ? 1 : 0)
                + "," + Double.doubleToLongBits(dFld));
        FuzzerUtils.out.println("Test0984.iArrFld = " + FuzzerUtils.checkSum(Test0984.iArrFld));
