...
public class Test0802 {
    ...
    static {
        FuzzerUtils.init(Test0802.iArrFld, 5);
        FuzzerUtils.init(Test0802.lArrFld, 190L);
    }
                ...
                switch (((i4 >>> 1) % 2) + 122) {
                    ...
                    default:
                        for (d2 = 355; d2 > 19; d2 -= 3) {
                            by += (byte) (-218 + (d2 * d2));
                            i5 = (int) Test0802.instanceCount;
                            Test0802.instanceCount -= i5;
                            Test0802.instanceCount = -12;
                            i4 = 118;
                        }
                }
            } else if (b) {
    ...
    public static int iMeth1(long l1) {
        ...
        for (int i3 : Test0802.iArrFld) {
            float f1 = -1.786F;
            vMeth1(f1, 11);
            Test0802.instanceCount = i3;
            if (b1) {
                i3 -= (int) f1;
                for (i7 = 1; 4 > i7; i7++) {
                    d3 %= (Test0802.instanceCount | 1);
                    for (i9 = 2; 1 < i9; i9--) {
                        i8 %= (int) (Test0802.instanceCount | 1);
                    }
                        ...
                        switch ((i11 % 1) + 117) {
                            case 117:
                                switch ((i7 % 8) + 110) {
                                    ...
                                    case 113:
                                        try {
                                            Test0802.iArrFld[i7 - 1] = (i11 % -45039);
                                            i10 = (i8 % 1319348710);
                                            i3 = (-115 / i12);
    ...
    public static void vMeth() {
        ...
        for (l = 17; 353 > l; l++) {
            i2 = i2;
            Test0802.iArrFld[(int) (l + 1)] -= (int) ((i2 *= (i2 + i2)) * (iMeth1(l) * l));
            i2 += (int) (l * s1);
            try {
                i13 = (653587973 / i2);
                i13 = (-19940 / Test0802.iArrFld[(int) (l + 1)]);
                Test0802.iArrFld[(int) (l - 1)] = (-1711764463 % i2);
            } catch (ArithmeticException a_e) {
            }
            switch (((i13 >>> 1) % 2) + 49) {
                case 49:
                    for (i14 = 1; i14 < 5; i14++) {
                        ...
                        do {
                            f2 = s1;
                            Test0802.instanceCount += l2;
                        } while ((l2 += 2) < 2);
                        Test0802.lArrFld[(int) (l - 1)] >>= -2;
                        Test0802.instanceCount = l2;
                        Test0802.iArrFld[(int) (l + 1)] = i13;
                        i2 = i14;
                    }
                    break;
                case 50:
    ...
    public void mainTest(String[] strArr1) {
        ...
        iMeth(i1);
        fArr[(i1 >>> 1) % N] -= (Test0802.instanceCount - Math.max(Test0802.iArrFld[(i1 >>> 1) % N], i1 - i1));
        vMeth();
        i1 -= i1;
        i16 = 1;
        do {
            Test0802.instanceCount += (i16 * i16);
        } while (++i16 < 199);
        b2 = b2;
        b2 = b2;
        for (int i17 : Test0802.iArrFld) {
            i1 |= i17;
            for (i18 = 1; i18 < 63; ++i18) {
                Test0802.instanceCount += i18;
            }
            Test0802.instanceCount *= i18;
            i20 = 1;
            do {
                ...
                Test0802.iArrFld[i20 - 1] += i19;
                for (i22 = 1; i22 < 1; i22++) {
                    Test0802.instanceCount += (((i22 * i17) + f3) - i19);
                    Test0802.lArrFld[i20] >>= i18;
                    i23 += i17;
                    Test0802.iArrFld[i20] = (int) Test0802.instanceCount;
                    i19 *= (int) Test0802.instanceCount;
                    i23 <<= 3;
                }
                i19 += i20;
                i23 -= 179;
        ...
        FuzzerUtils.out.println("Test0802.instanceCount Test0802.iArrFld Test0802.lArrFld = " + Test0802.instanceCount + "," +
                FuzzerUtils.checkSum(Test0802.iArrFld) + "," + FuzzerUtils.checkSum(Test0802.lArrFld));
