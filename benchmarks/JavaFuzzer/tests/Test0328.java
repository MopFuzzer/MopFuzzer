...
public class Test0328 {
    ...
    static {
        FuzzerUtils.init(Test0328.iArrFld, 3);
        FuzzerUtils.init(Test0328.fArrFld, -114.771F);
        FuzzerUtils.init(Test0328.dArrFld, -2.125015);
    }
    ...
    public static void vMeth1(int i3, int i4) {
        ...
        for (i5 = 7; i5 < 287; ++i5) {
            i3 += (int) Test0328.instanceCount;
            for (i7 = 1; i7 < 6; i7 += 3) {
                iArr = (iArr = iArr);
                for (i9 = 1; i9 < 6; ++i9) {
                    if (b = (((long) (Test0328.dFld + 19970) ^ by) == ((i5 + i10) * lMeth(i4, Test0328.instanceCount))))
                        break;
                    Test0328.instanceCount >>= i6;
                    f1 = f1;
                    Test0328.instanceCount += (i9 + i9);
                    by = (byte) i3;
                }
                i3 += (i7 - f1);
            }
    ...
    public static void vMeth(double d, int i2) {
        ...
        for (double d1 : dArr) {
            ...
            for (i22 = 4; i22 > 1; i22 -= 3) {
                ...
                b2 = false;
                i2 = (int) -60L;
                Test0328.iArrFld[i22 + 1] >>= -14;
                Test0328.instanceCount = i23;
                i2 >>>= i23;
                i2 += i22;
            }
            d1 -= 10L;
            i23 = (int) Test0328.instanceCount;
            i25 = 1;
            do {
                i2 += (i25 - f2);
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++i1 < 351) {
            ...
            for (i26 = i1; i26 < 72; i26++) {
                ...
                for (l1 = 1; l1 < 1; l1 += 2) {
                    ...
                    Test0328.dFld = Test0328.instanceCount;
                    Test0328.instanceCount += l1;
                    if (b3) continue;
                    lArr1[(int) (l1)] *= 21;
                    switch (((i26 % 5) * 5) + 80) {
                        case 101:
                        ...
                        case 93:
                            i28 ^= 16208;
                            Test0328.instanceCount += (((l1 * i1) + i27) - i28);
                            sFld *= (short) i;
                        case 92:
                            Test0328.instanceCount += Test0328.instanceCount;
                            Test0328.fArrFld[(int) (l1)] = i27;
                            break;
                        case 91:
                            i28 += (int) l1;
                        ...
                        case 97:
                            ...
                            i27 ^= i27;
                            i28 >>>= i27;
                            Test0328.iArrFld[(int) (l1 - 1)] = (int) Test0328.instanceCount;
                        default:
                            Test0328.dArrFld[i26] = i27;
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test0328.instanceCount Test0328.dFld sFld = " + Test0328.instanceCount + "," +
                Double.doubleToLongBits(Test0328.dFld) + "," + sFld);
        FuzzerUtils.out.println("Test0328.iArrFld Test0328.fArrFld Test0328.dArrFld = " + FuzzerUtils.checkSum(Test0328.iArrFld) + ","
