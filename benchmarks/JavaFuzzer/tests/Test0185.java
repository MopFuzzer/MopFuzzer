...
public class Test0185 {
    ...
    static {
        FuzzerUtils.init(Test0185.dArrFld, -1.120931);
        FuzzerUtils.init(Test0185.iArrFld1, -1);
    }
    ...
    public static void vMeth2(int i6, int i7, short s) {
        ...
        for (i8 = 13; 246 > i8; ++i8) {
            f *= i9;
            Test0185.instanceCount += (((i8 * by) + i6) - Test0185.instanceCount);
            i9 += (((i8 * f) + i6) - Test0185.instanceCount);
            i7 = (int) f;
            i9 += i9;
            Test0185.instanceCount += (i8 + i8);
            iArr[i8 + 1] = i8;
            by = (byte) i7;
            f1 += i9;
        }
    ...
    public static void vMeth1(int i5, long l) {
        ...
        for (i12 = 16; i12 < 310; ++i12) {
            ...
            if (b1) {
                ...
                if (b1) break;
                i13 = i12;
                Test0185.byFld += (byte) -3000883593L;
            } else {
                f2 += (137 + (i12 * i12));
    ...
    public static void vMeth(int i, int i1, int i2) {
        ...
        for (i3 = 9; i3 < 304; i3++) {
            vMeth1(i, Test0185.instanceCount);
            for (d1 = 6; d1 > 1; --d1) {
                boolean b2 = false;
                Test0185.dArrFld[(i4 >>> 1) % N] -= -14;
                i14 *= i14;
                b2 = false;
                i <<= 175;
                switch ((int) ((d1 % 8) + 122)) {
                    case 122:
                        ...
                        break;
                    case 123:
                        Test0185.instanceCount = i1;
                        for (i15 = 1; i15 < 2; ++i15) {
                            f3 += i1;
                            i2 += (i15 + i1);
                            if (b2) continue;
                            Test0185.byFld *= (byte) -11;
                        }
                        break;
                    case 124:
                    case 125:
                    ...
                    case 128:
                        ...
                        break;
                    case 129:
                        s2 = (short) Test0185.instanceCount;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        dFld = -19606;
        iFld <<= Test0185.byFld;
        Test0185.instanceCount = (long) f4;
        for (i20 = 4; i20 < 245; ++i20) {
            i21 *= (int) l2;
            if (b3) continue;
            for (i22 = 1; i22 < 104; i22++) {
                iFld = (int) Test0185.instanceCount;
                iArrFld = Test0185.iArrFld1;
                iFld = (int) -61.61895;
                f4 = Test0185.byFld;
                switch ((i20 % 5) + 72) {
                    case 72:
        ...
        FuzzerUtils.out.println("Test0185.instanceCount Test0185.byFld iFld = " + Test0185.instanceCount + "," + Test0185.byFld + "," +
                iFld);
        FuzzerUtils.out.println("dFld Test0185.dArrFld iArrFld = " + Double.doubleToLongBits(dFld) + "," +
                Double.doubleToLongBits(FuzzerUtils.checkSum(Test0185.dArrFld)) + "," + FuzzerUtils.checkSum(iArrFld));
        FuzzerUtils.out.println("Test0185.iArrFld1 = " + FuzzerUtils.checkSum(Test0185.iArrFld1));
