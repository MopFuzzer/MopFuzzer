...
public class Test0683 {
    ...
    static {
        FuzzerUtils.init(Test0683.iArrFld, -185);
    }
    ...
    public static void vMeth1(double d1, int i8) {
        ...
        do {
            ...
            for (i10 = 1; i10 < 6; ++i10) {
                ...
                i8 += (((i10 * by) + i8) - i10);
                d1 += i10;
                Test0683.instanceCount -= -223;
                i8 = (int) Test0683.instanceCount;
                switch ((i10 % 4) + 55) {
                    case 55:
                        i12 = 1;
                        while (++i12 < 2) {
    ...
    public static int iMeth(float f) {
        ...
        for (i6 = 6; i6 < 262; i6++) {
            ...
            for (i13 = 1; i13 < 6; ++i13) {
                ...
                Test0683.instanceCount += (i13 ^ i15);
                i16 = i16;
                iArr1[(i14 >>> 1) % N] = 35560;
                by1 *= (byte) i13;
            }
        ...
        for (i4 = 6; i4 < 143; i4++) {
            ...
            if (Test0683.bFld) {
                ...
                for (i17 = 1; i17 < 11; ++i17) {
                    Test0683.iArrFld[i4 - 1] += i4;
                    Test0683.fFld -= Test0683.instanceCount;
                    Test0683.iArrFld[i17] = (int) Test0683.instanceCount;
                }
            } else {
                for (i19 = 1; i19 < 11; i19++) {
                    switch ((i4 % 2) + 113) {
                        case 113:
                            Test0683.iArrFld[i4] *= i5;
                            Test0683.dFld *= i3;
                            Test0683.iArrFld[i19] *= i4;
                            break;
                        case 114:
                            i18 >>= i18;
                        default:
    ...
    public void mainTest(String[] strArr1) {
                ...
                switch (((i >>> 1) % 1) + 85) {
                    case 85:
                        for (i21 = 12; 393 > i21; ++i21) {
                            Test0683.fFld -= Test0683.fFld;
                            for (i23 = 2; i23 < 66; ++i23) {
                                Test0683.iArrFld[i23] -= (int) -106.748F;
                            }
                            i2 += (((i21 * i) + i2) - i1);
                            i24 -= i23;
                            i24 = i22;
                            Test0683.sFld += (short) i21;
                        }
                        Test0683.instanceCount <<= i;
                        i24 = byFld;
                        break;
                }
                for (l = 5; l < 139; ++l) {
        ...
        FuzzerUtils.out.println("Test0683.instanceCount Test0683.bFld Test0683.fFld = " + Test0683.instanceCount + "," + (Test0683.bFld ? 1
                : 0) + "," + Float.floatToIntBits(Test0683.fFld));
        FuzzerUtils.out.println("Test0683.dFld Test0683.sFld byFld = " + Double.doubleToLongBits(Test0683.dFld) + "," + Test0683.sFld +
                "," + byFld);
        FuzzerUtils.out.println("Test0683.iArrFld = " + FuzzerUtils.checkSum(Test0683.iArrFld));
