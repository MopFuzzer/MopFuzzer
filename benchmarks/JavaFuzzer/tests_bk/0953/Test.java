...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 1.759F);
        FuzzerUtils.init(Test.iArrFld, -33437);
    }
    ...
    public static int iMeth1(float f2) {
        ...
        int i3=-112, i4=58704, i5=-75, i6=-11, i7=131, i8=159, i9=-44217, i10=-17326, iArr[]=new int[N];
        byte byArr[][]=new byte[N][N];

        FuzzerUtils.init(byArr, (byte)-99);
        FuzzerUtils.init(iArr, -251);

        byArr[(i3 >>> 1) % N][(41801 >>> 1) % N] = (byte)Test.instanceCount;
        i3 *= (int)-5L;
        i4 = 175;
        do {
            i5 = 1;
    ...
    public static void vMeth(int i2, float f1) {
        ...
        int i11=6144, i12=-41302, i13=-54073, i14=0, i15=2, i16=-179, i17=-13, iArr1[]=new int[N];
        boolean b=true;
            ...
            do {
                for (i21 = 1; 1 < i21; --i21) {
                    ...
                    try {
                        i22 = (i1 % i21);
                        i22 = (i22 / -2);
                        i19 = (Test.iArrFld[i20] / i18);
                    } catch (ArithmeticException a_e) {}
                    i22 += (((i21 * i22) + Test.instanceCount) - i21);
                }
            } while (++i20 < 12);
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        boolean b1=false;
        long l1=6L, lArr2[]=new long[N];

        FuzzerUtils.init(lArr2, 6065283545316357798L);

        f -= (-((i + i) - (Test.fArrFld[(-11 >>> 1) % N][(i >>> 1) % N]--)));
        ...
        for (i27 = 9; 173 > i27; i27++) {
            ...
            for (i29 = 9; i29 < 153; i29++) {
                ...
                i31 = 1;
                while (++i31 < 2) {
                    Test.fArrFld[i29][i27] = 11;
                    i30 = i30;
                    lArr2[i31] = Test.instanceCount;
                    Test.iArrFld[i29] *= byFld;
