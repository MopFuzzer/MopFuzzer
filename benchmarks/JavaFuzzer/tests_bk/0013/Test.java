...
public class Test {
    ...
    public static long lMeth() {
        ...
        int i14=-8, i15=49966, i16=11, i17=212, i18=-195, i19=-29415, i20=-40691, i21=-2, iArr1[]=new int[N];
        boolean b1=true;
    ...
    public static short sMeth(boolean b, int i5) {
        ...
        int i6=-137, i22=64454, i23=-167, iArr[]=new int[N];
        double d1=-72.12719;
        ...
        i6 = 342;
        while ((i6 -= 3) > 0) {
            iArr[i6] >>= (int)Math.max(Math.abs(lMeth()), Test.instanceCount);
            i5 *= (int)d1;
            Test.fFld += i6;
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d=0.95298, dArr[]=new double[N];
        ...
        for (d = 8; d < 217; d++) {
            for (i1 = 120; i1 > 1; --i1) {
                byte by=91;
                Test.sFld = (short)(((i - 5263252511589145987L) + (i2 - i)) - lArr[(int)(d - 1)]);
                by = (byte)251;
                by += (byte)(--i2);
                Test.fFld += (++Test.instanceCount);
                iArrFld[i1] = (int)((byArr[i1 + 1] * (Test.instanceCount + i2)) * ((-Math.abs(i)) - Test.fFld));
                for (i3 = 1; i3 < 2; i3++) {
                    Test.instanceCount >>= byArr[i1];
                    i2 += (i3 - by);
                    i2 += (i3 ^ (long)Test.fFld);
                    i2 += i3;
                    Test.instanceCount -= (((i1 - -4444449843545932726L) - (i3 * Test.instanceCount)) *
                        (Test.instanceCount + Math.min(i, -22)));
                    by ^= (byte)(-((Test.instanceCount * Test.sFld) - Test.instanceCount));
                    i2 = (int)(((Test.instanceCount - Test.instanceCount) / (sMeth(Test.bFld, 179) | 1)) / -53);
                    Test.fFld -= i2;
