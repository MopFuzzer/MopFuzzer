...
public class Test {
    ...
    public static long lMeth() {
        ...
        Test.iArrFld[(i2 >>> 1) % N] += (int)((Test.instanceCount *= (by * i2)) + (-96 >>> i2));
        long meth_res = i2 + by;
    ...
    public static void vMeth1(int i7, short s, long l1) {
        ...
        for (int i8 : Test.iArrFld) {
            Test.iArrFld[(i8 >>> 1) % N] = Test.iFld;
            i8 >>= i8;
            for (i9 = 1; i9 < 4; ++i9) {
                Test.instanceCount += (((i9 * i8) + f) - i8);
                f += i9;
                Test.iFld = -31952;
                i8 *= i10;
                for (i11 = 1; i11 < 2; i11++) {
    ...
    public static void vMeth() {
        ...
        vMeth1(Test.iFld1, (short)(-27817), Test.instanceCount);
        i13 = 1;
        while (++i13 < 292) {
            for (i14 = 1; 6 > i14; ++i14) {
                Test.iFld -= i14;
                Test.iFld1 += (-13 + (i14 * i14));
                Test.iFld = (int)f1;
                Test.iArrFld[i13 + 1] += (int)-4273387758L;
                if (i14 != 0) {
    ...
    public static byte byMeth(long l, int i3) {
        ...
        Test.iArrFld[(57123 >>> 1) % N] -= Test.iFld1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 11; i < 314; i++) {
            sArrFld[i] *= (short)((lMeth() >> byMeth(Test.instanceCount, i1)) + 3422593509L);
            i18 = 83;
            do {
                ...
                for (i19 = i; i19 < 1; i19++) {
                    Test.byFld = (byte)Test.instanceCount;
                    try {
                        i20 = (Test.iArrFld[i - 1] / Test.iFld1);
                        Test.iFld1 = (-65186 / i18);
                        Test.iArrFld[i - 1] = (Test.iFld / 10956);
                ...
                do {
                    ...
                    case 124:
                        try {
                            Test.iArrFld[i] = (i19 / -520692332);
                            Test.iFld1 = (i21 / Test.iFld1);
                            i1 = (Test.iFld % -24529);
                        } catch (ArithmeticException a_e) {}
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.bFld = " + Test.instanceCount + "," + Test.iFld +
            "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test.iFld1 Test.byFld fFld = " + Test.iFld1 + "," + Test.byFld + "," +
            Float.floatToIntBits(fFld));
        FuzzerUtils.out.println("Test.dFld sArrFld Test.iArrFld = " + Double.doubleToLongBits(Test.dFld) + "," +
