...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 1.309F);
        FuzzerUtils.init(Test.dArrFld, -88.32310);
    }
    ...
    public static void vMeth2(long l1) {
        ...
        int i1=66, i2=11365, i3=-5, i4=16692, iArr[]=new int[N];
    ...
    public static void vMeth1() {
        ...
        Test.iFld += Test.iFld;
        Test.iFld >>>= Test.sFld;
        Test.fArrFld[(-46746 >>> 1) % N][(Test.iFld >>> 1) % N] += Test.sFld;
        f = Test.instanceCount;
        Test.iFld = Test.iFld;
        Test.byFld *= (byte)2.118632;
        by = (byte)Test.iFld;
    ...
    public static void vMeth(long l, int i) {
        ...
        double d=-1.29608;
        int i5=-204, i6=60738, i7=50873, i8=-179, i9=-57749, i10=102, i11=-9390, i12=-9, i13=11593, iArr2[]=new int[N];
        float f1=20.1013F;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (d1 = 268; d1 > 1; d1--) {
            ...
            for (f2 = 4; f2 < 94; f2++) {
                ...
                case 63:
                    for (i17 = 1; i17 < 2; i17++) {
                        ...
                        Test.fArrFld[(int)(f2 - 1)][(int)(f2)] *= f2;
            ...
            for (i19 = (int)(d1); i19 < 94; i19++) {
                i21 = 1;
                while (++i21 < 1) {
                    Test.instanceCount += (((i21 * i16) + i19) - f2);
                    i14 += (i21 * i21);
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.sFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.sFld);
        FuzzerUtils.out.println("Test.byFld Test.dFld bFld = " + Test.byFld + "," + Double.doubleToLongBits(Test.dFld)
            + "," + (bFld ? 1 : 0));
