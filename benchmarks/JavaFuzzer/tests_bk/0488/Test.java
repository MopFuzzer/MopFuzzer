...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 33.370F);
    ...
    public static void vMeth1(int i3) {
        ...
        double d=-124.24082;
        int i4=-211, i5=45349, i6=12, iArr[]=new int[N];
        byte by1=-69;
        boolean b=true;
    ...
    public static void vMeth(byte by, long l) {
        ...
        int i7=-175, i8=-63517, i9=-146, i10=223, i11=-59312, i12=-5, iArr1[]=new int[N];
        ...
        for (i10 = 10; 213 > i10; ++i10) {
            ...
            do {
                ...
                Test.instanceCount += (27482 + (i12 * i12));
    ...
    public static float fMeth(int i) {
        ...
        int i1=-118, i2=-18143, i13=-175, i14=-2, i15=27308, iArr2[]=new int[N];
        ...
        for (i1 = 7; 246 > i1; i1++) {
            i = (int)lArr[i1];
            vMeth((byte)(20), Test.instanceCount);
            for (f1 = 1; f1 < 7; f1++) {
                i13 += (int)(((f1 * i2) + i13) - Test.instanceCount);
                for (i14 = 1; 2 > i14; i14++) {
                    if (b1) continue;
                    f2 = i13;
                ...
                i <<= -14;
                i2 += (int)(((f1 * f1) + Test.byFld) - Test.sFld);
                Test.instanceCount += (long)(((f1 * i15) + i2) - Test.byFld);
                i2 += (int)(((f1 * Test.instanceCount) + i13) - Test.instanceCount);
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i16=-24059, i17=-13, i18=-14, i19=-13014, i20=-13, i21=7, i22=9, i23=0, i24=110, i25=-61, iArr3[]=new
            int[N];
        float f3=-1.57F;
        double d1=-1.42385;
        boolean b2=true;
        ...
        Test.instanceCount -= (long)(((--Test.sFld) - Long.reverseBytes(-229L)) + (-fMeth(iFld)));
        for (i16 = 6; i16 < 332; ++i16) {
            Test.sFld += (short)(((i16 * f3) + Test.instanceCount) - iFld);
            try {
                i17 = (iFld / i17);
                i17 = (iFld % 157);
                i17 = (-35298 % Test.iArrFld[i16]);
            ...
            for (i18 = 2; i18 < 77; i18++) {
                ...
                for (i24 = 1; i24 < 2; ++i24) {
                    ...
                    case 108:
                        ...
                        break;
                    case 109:
                        i25 += (((i24 * i23) + Test.instanceCount) - i20);
                        break;
                    case 110:
                        Test.sFld = (short)i22;
                    }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.sFld Test.byFld = " + Test.instanceCount + "," + Test.sFld +
            "," + Test.byFld);
        FuzzerUtils.out.println("iFld Test.fArrFld Test.iArrFld = " + iFld + "," +
