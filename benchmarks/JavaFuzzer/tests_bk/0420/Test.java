    ...
    public static long lMeth(int i, double d) {
        ...
        for (i9 = 7; i9 < 147; i9++) {
            ...
            for (i12 = 1; i12 < 11; ++i12) {
                ...
                i13 /= (int)(s | 1);
                i10 = i10;
                Test.instanceCount >>= -1333713056L;
                i14 += (i12 * i12);
                if (b1) continue;
            }
        }
                    ...
                    case 0:
                        ...
                        for (f5 = 1; f5 < 3; f5++) {
                            ...
                            case 129:
                                ...
                                Test.iArrFld[(int)(f5 + 1)] += i16;
                                Test.instanceCount *= Test.instanceCount;
                            case 127:
                                Test.iArrFld[(int)(f5 + 1)] = (int)d3;
                                Test.iArrFld[(int)(f5 + 1)] %= (int)((long)(d3) | 1);
                                i15 <<= i17;
                                break;
                            case 119:
