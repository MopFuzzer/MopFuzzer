...
public class Test {
    ...
    public static void vMeth1() {
        ...
        int i4=50702, i5=-29108, i8=-15741, i9=179, iArr1[]=new int[N];
        float f=36.642F;
        ...
        for (i4 = 13; i4 < 394; i4++) {
            ...
            if (((long)(Float.intBitsToFloat(12) + (i5 + i5)) >> ((i5 << 144) - i4)) <= ((i5 * byMeth(Test.sFld, 49029,
                i4)) + i4)) continue;
    ...
    public static void vMeth() {
        ...
        int i2=-35017, i3=-159, i10=35097, i11=-12, i12=14, i13=3, i14=41, iArr2[]=new int[N];
        double d1=-18.122931;
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            for (d4 = 1; d4 < 91; ++d4) {
                ...
                iFld = i1;
                Test.instanceCount += (long)(((d4 * Test.sFld) + i1) - i);
                for (l = 1; l < 2; ++l) {
                    fFld += (((l * Test.byFld) + iFld) - i1);
                    lArr2[i + 1] = 0;
                }
                Test.instanceCount += (long)(((d4 * iFld) + Test.byFld) - i16);
            }
            if (bFld) {
                for (f2 = 3; f2 < 91; ++f2) {
                    i16 = i15;
                }
                Test.instanceCount += (((i * i18) + i18) - i16);
                Test.lFld += (i - Test.byFld);
                i15 = i;
            } else {
                i17 = i17;
            }
        ...
        FuzzerUtils.out.println("Test.instanceCount iFld Test.byFld = " + Test.instanceCount + "," + iFld + "," +
            Test.byFld);
        FuzzerUtils.out.println("Test.sFld bFld fFld = " + Test.sFld + "," + (bFld ? 1 : 0) + "," +
