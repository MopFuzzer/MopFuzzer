...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.dArrFld, -88.18953);
    }
    ...
    public static void vMeth2(int i4, int i5, int i6) {
        ...
        int i7=-186, i9=-44, i10=-195, iArr1[]=new int[N];
        float f=-2.789F;
        short s=-8178;
        double d1=2.188;
    ...
    public static void vMeth1(int i, int i1) {
        ...
        int i2=-50, i3=-65011, i11=-5, iArr[][]=new int[N][N];
        short s1=-32733;
        byte by=-29;
    ...
    public static void vMeth(double d) {
        ...
        vMeth1(i12, i12);
        Test.dArrFld = FuzzerUtils.double1array(N, (double)14.96326);
        i13 = 1;
        do {
            i14 = 1;
            do {
    ...
    public void mainTest(String[] strArr1) {
        ...
        long l1=4L;
        int i21=0, i22=13, i23=2, i24=0, i25=190, i26=61, iArr2[]=new int[N];
        byte by1=-41;
            ...
            for (l1 = 22; l1 < 366; l1++) {
                ...
                for (i22 = (int)(l1); i22 < 73; ++i22) {
                    ...
                    case 28:
                        ...
                        break;
                    case 29:
                        i23 += (((i22 * Test.fFld) + Test.fFld) - i21);
                        Test.fFld *= i22;
                ...
                case 2:
                    Test.fFld += i24;
                    Test.sFld += (short)(((l1 * i22) + i24) - i21);
                    for (i25 = 1; i25 < 73; ++i25) {
                        switch ((int)((l1 % 9) + 123)) {
                        case 123:
                            Test.instanceCount = (long)-1.68F;
                            i26 = i23;
                            Test.bFld = Test.bFld;
                            Test.fFld = i21;
                            break;
        ...
        FuzzerUtils.out.println("Test.sFld dFld Test.dArrFld = " + Test.sFld + "," + Double.doubleToLongBits(dFld) +
