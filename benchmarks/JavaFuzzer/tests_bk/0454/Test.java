...
public class Test {
    ...
    public static void vMeth(int i8, int i9, int i10) {
        ...
        for (i11 = 13; i11 < 342; ++i11) {
            ...
            for (i13 = 1; i13 < 5; i13++) {
                ...
                i14 = i14;
                i16 += (((i13 * i11) + i14) - i18);
                f2 += (((i13 * i11) + Test.instanceCount) - i17);
            }
            d = i16;
        }
    ...
    public static int iMeth(int i5, int i6) {
        ...
        float f=2.48F, fArr[]=new float[N];
        ...
        f = i6;
        Test.instanceCount = (((i6 - i6) - Test.iArrFld[(i5 >>> 1) % N]) - iMeth1(i5));
        for (i23 = 8; 371 > i23; i23 += 3) {
            switch (((i23 % 9) * 5) + 64) {
            case 100:
                fArr[i23 - 1] -= (float)Test.dFld;
                i6 = (int)Test.instanceCount;
                Test.instanceCount += (long)22.876F;
                break;
            case 109:
                f += (((i23 * i5) + f) - i5);
                break;
            case 106:
                ...
                case 119:
                    ...
                    case 2:
                        ...
                        Test.dFld += i24;
                        f -= Test.sFld;
                        f += (((i23 * Test.instanceCount) + Test.instanceCount) - i6);
                    case 3:
                        lArr[i23 - 1] = i23;
                        break;
                    case 4:
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (int i : Test.iArrFld) {
            for (i1 = 63; i1 > 1; --i1) {
                i2 <<= (by++);
                for (i3 = 1; i3 < 2; ++i3) {
                    Test.instanceCount = iMeth(i4, i4);
                    i2 = i3;
                    lArr1[(-194 >>> 1) % N] += 1;
                }
                Test.iArrFld[i1] -= i;
            ...
            for (i26 = 1; i26 < 63; i26++) {
                for (i28 = i26; 2 > i28; i28++) {
                    ...
                    if (b2) {
                        i2 = i1;
                        i4 += i28;
                        dArr[i28 + 1] *= Test.instanceCount;
                        i4 += (((i28 * i) + i) - Test.iFld1);
                    }
                    i2 += i28;
                }
            }
