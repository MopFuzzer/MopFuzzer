...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.dArrFld, -2.42961);
    }
        ...
        for (i7 = 4; i7 < 128; i7++) {
            ...
            do {
                ...
                case 123:
                    ...
                    break;
                case 124:
                    i8 += (((i9 * Test.iFld) + i9) - Test.instanceCount);
                    break;
                case 125:
                    lArr[i7 - 1][i9] &= i9;
                    break;
                ...
                case 153:
                    try {
                        i8 = (i5 % -28840);
                        i6 = (i9 / 47103);
                        Test.iArrFld[i7 + 1] = (Test.iArrFld[i7] % Test.iArrFld[i7]);
                ...
                case 157:
                    ...
                    break;
                case 158:
                    Test.iArrFld[i9 - 1] += (int)Test.dFld;
                    break;
                case 159:
                    if (Test.bFld) continue;
                    break;
                ...
                case 171:
                    try {
                        i6 = (i9 / i5);
                        Test.iArrFld[i7] = (i10 % Test.iArrFld[i9]);
                        Test.iFld = (Test.iArrFld[i7] / i6);
                    } catch (ArithmeticException a_e) {}
                case 172:
                    if (false) continue;
                    break;
    ...
    public static void vMeth() {
        ...
        if (true) {
            d = ((9 + Integer.reverseBytes(Test.iFld)) - ((d - i1) + (i1 - -13903)));
            vMeth1();
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            s = (short)Test.iFld;
            Test.instanceCount += (long)((long)f | Test.iFld);
            i = 1;
            while (++i < 131) {
                vMeth();
                switch ((i % 9) + 25) {
                case 25:
                    ...
                    while (++i21 < 1) {
                        switch ((int)((f % 2) + 69)) {
                        case 69:
                            Test.iFld1 += (i21 + Test.lFld);
                            Test.lFld += (i21 | Test.instanceCount);
                        case 70:
                            Test.iFld1 *= i21;
                            Test.iFld += (i21 * i21);
                        default:
                            Test.iFld1 += (((i21 * i) + Test.lFld) - Test.lFld);
                            Test.iFld += (((i21 * i) + Test.iFld) - Test.lFld);
                        }
                    }
                    for (i22 = 1; 1 > i22; i22++) {
                        Test.lFld <<= i23;
                    }
                    Test.dArrFld[(int)(f)] += Test.dFld;
                    break;
                case 26:
                    Test.iFld += (((i * i21) + Test.iFld) - i24);
                    break;
                case 27:
                    switch (((i % 3) * 5) + 10) {
                    case 21:
        ...
        FuzzerUtils.out.println("Test.bFld Test.sFld Test.lFld = " + (Test.bFld ? 1 : 0) + "," + Test.sFld + "," +
            Test.lFld);
        FuzzerUtils.out.println("Test.iFld1 dFld1 Test.iArrFld = " + Test.iFld1 + "," + Double.doubleToLongBits(dFld1)
