...
public class Test {
    ...
    public static void vMeth() {
        ...
        Test.instanceCount = (long)((Math.abs(-48.386F) + (Test.instanceCount--)) + (Test.fFld++));
    ...
    public static int iMeth1(long l, int i1) {
        ...
        int i2=-12, i3=-19447, i4=28718, i5=14, iArr[]=new int[N];
        long l1=58116L, lArr1[][]=new long[N][N];
        byte by1=87;
    ...
    public static int iMeth(double d) {
        ...
        vMeth();
        Test.instanceCount = (long)(++dArr[(i >>> 1) % N]);
        dArr[(i >>> 1) % N] += (by -= (byte)195);
        i <<= ((++i) / ((i--) | 1));
        vMeth();
        i -= iMeth1(Test.instanceCount, i);
        if (b) {
            for (i6 = 376; i6 > 15; --i6) {
                d = -85;
                switch ((i6 % 2) + 122) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d1=1.31573;
        int i12=144, i13=-14, i14=96, i15=-57464, i16=-51, i17=-2, i18=-13, iArr1[]=new int[N];
        short s=12612;

        FuzzerUtils.init(iArr1, 6852);

        Test.instanceCount += (iMeth(d1) - iFld);
