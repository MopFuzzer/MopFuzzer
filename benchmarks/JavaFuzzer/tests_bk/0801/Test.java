...
public class Test {
    ...
    public static byte byMeth(long l1) {
        ...
        Test.iFld = (int)(((Test.instanceCount + d) - Test.iArrFld1[(Test.iFld >>> 1) % N][(Test.iFld >>> 1) % N]) +
            dMeth(56741));
        for (i5 = 12; 241 > i5; ++i5) {
            Test.iFld += (int)f1;
            i6 = 48486;
            ...
            case 4:
                ...
                break;
            case 7:
                Test.iArrFld1[i5 - 1] = FuzzerUtils.int1array(N, (int)115);
                break;
            case 39:
            case 27:
                Test.iFld -= 15512;
            ...
            case 37:
                try {
                    i10 = (135 / i10);
                    i6 = (181 / i8);
                    i6 = (i9 % Test.iArrFld1[i5][i5]);
                } catch (ArithmeticException a_e) {}
                break;
            case 43:
                Test.iArrFld1[i5 + 1][i5 - 1] >>= (int)Test.instanceCount;
                break;
            case 22:
    ...
    public void vMeth(int i2) {
        ...
        long l2=-45008L, lArr[]=new long[N];
        boolean b=true;

        FuzzerUtils.init(lArr, -63820L);

        iArrFld[(i2 >>> 1) % N] >>>= (int)((i2 >>>= (-(i2 * i2))) + ((i2 + 0.110529) - (i2 / (Test.instanceCount |
            1))));
        Test.instanceCount = (long)((--i2) * ((f + 11) + (i3 >> Test.iFld)));
        ...
        for (i11 = 6; i11 < 136; ++i11) {
            for (l2 = 1; l2 < 12; l2 += 2) {
                ...
                switch ((int)((l2 % 10) + 45)) {
                case 45:
                    Test.iArrFld1[(int)(l2)][(int)(l2 + 1)] = i3;
                    i13 *= i12;
                    for (i14 = 1; i14 < 3; ++i14) {
                ...
                case 49:
                    i2 *= iFld1;
                case 50:
                    Test.iArrFld1[i11 - 1] = Test.iArrFld1[i11 - 1];
                case 51:
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-30313, i1=-36912, i16=29912, i17=8, i18=2, i19=59923, i20=-11, iArr[]=new int[N];
        byte by=13;
        long l=100L;
        float f2=-1.162F;
        ...
        for (i = 13; i < 372; i++) {
            ...
            for (i16 = 70; 2 < i16; i16 -= 3) {
                ...
                for (i18 = 4; i18 > i; i18--) {
                    ...
                    case 127:
                        Test.bFld = Test.bFld;
                        Test.instanceCount += (((i18 * l) + i1) - iFld2);
                        break;
                    case 128:
                        Test.iFld += i18;
                        break;
                    case 129:
                        Test.iArrFld1[i16] = iArr;
                    case 130:
                        i1 *= (int)-4106323369L;
                    }
                }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.byFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.byFld);
        FuzzerUtils.out.println("iFld1 sFld Test.bFld = " + iFld1 + "," + sFld + "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("iFld2 iArrFld Test.iArrFld1 = " + iFld2 + "," + FuzzerUtils.checkSum(iArrFld) + "," +
