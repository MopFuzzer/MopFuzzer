...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 37.382F);
    ...
    public static void vMeth2(long l1, int i11) {
        ...
        float f1=2.181F;
        int i12=-4530, i13=-64745, i14=-44640, iArr1[]=new int[N];
    ...
    public static void vMeth1(long l) {
        ...
        int i5=-11, i6=60368, i7=-60991, i8=-3, i9=27248, i10=42570, iArr[]=new int[N];
        float f=126.334F;
        byte by=-43;
        double d=-29.88929;
        boolean b=false;
        ...
        try {
            if (b) {
                for (i5 = 15; i5 < 277; i5++) {
                    ...
                    f = (Float.intBitsToFloat(by + 165) - ((-i6) + (i5 - Test.instanceCount)));
                    Test.instanceCount = (long)((iArr[i5 - 1] >>= (Test.sFld * Test.sFld)) - Test.fArrFld[i5 - 1]);
                    for (i7 = 1; i7 < 6; ++i7) {
                        for (i9 = 1; 2 > i9; ++i9) {
                            lArr[i9 - 1] >>= i7;
                            i8 &= (int)((++d) + (d++));
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++i < 303) {
            ...
            for (i22 = i; i22 < 83; ++i22) {
                ...
                default:
                    i23 += (i22 + i22);
                    i24 >>>= i27;
                    switch ((((Test.iFld >>> 1) % 5) * 5) + 78) {
                    case 101:
                        for (f2 = 1; f2 < 1; f2++) {
                            Test.fFld += (f2 * Test.byFld);
                    ...
                    case 80:
                        ...
                        break;
                    case 86:
                        Test.iArrFld[i - 1] <<= (int)-62805L;
                        break;
                    case 83:
                        bArrFld[i22 - 1] = b1;
                        break;
                    default:
                        Test.fFld -= (float)-105.110189;
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test.fArrFld Test.iArrFld bArrFld = " +
