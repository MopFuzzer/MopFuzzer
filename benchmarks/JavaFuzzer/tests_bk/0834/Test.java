...
public class Test {
    ...
    public static int iMeth(int i9, int i10) {
        ...
        int i11=42, i12=-155, i13=-4, i14=6, i15=-4, i16=95, i17=27288, iArr[]=new int[N];
        float f1=-64.370F;
        double d1=107.32277;
        byte by1=-102;
        ...
        for (i13 = 4; i13 < 226; i13++) {
            for (i15 = 1; i15 < 7; i15++) {
                for (d1 = 2; d1 > 1; --d1) {
                    Test.instanceCount += (long)(((d1 * i13) + i10) - by1);
                }
                i16 = i16;
                i9 += (int)-9L;
            }
    ...
    public static void vMeth1(int i7, int i8, long l2) {
        ...
        float f2=67.379F, fArr[]=new float[N];
        double d2=-99.47281;
    ...
    public static void vMeth(long l1, int i3, byte by) {
        ...
        short s=-18108;
        int i4=-23554, i5=-60124, i6=-96, i21=169, iArr1[]=new int[N];
        ...
        s >>= (short)(((10L + (--Test.instanceCount)) + i4) / (((long)(1357L - (f + Test.instanceCount))) | 1));
        for (i5 = 8; i5 < 139; i5++) {
            vMeth1(Test.iFld, i5, l1);
            l1 += (i5 + i4);
            if (Test.bFld) break;
            Test.sFld += (short)i5;
            f += (129 + (i5 * i5));
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=28342, i1=28888, i2=63388, i22=95, i23=49, i24=6448, i25=0, i26=-2, i27=-112, i28=14159, i29=60584,
            i30=5667, i31=-10, i32=-202, iArr2[]=new int[N];
        double d=12.22119;
        float f4=6.828F;
        ...
        for (i = 4; i < 144; i++) {
            ...
            l <<= (-i);
            for (d = 3; d < 179; d++) {
                vMeth(Test.instanceCount, i1, Test.byFld);
            }
            sArr[i] = (short)i22;
            Test.iFld = i22;
            i2 += (61049 + (i * i));
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.sFld Test.iFld = " + Test.instanceCount + "," + Test.sFld +
            "," + Test.iFld);
        FuzzerUtils.out.println("Test.bFld Test.byFld lArrFld = " + (Test.bFld ? 1 : 0) + "," + Test.byFld + "," +
