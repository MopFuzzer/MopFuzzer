...
public class Test {
    ...
    public static int iMeth1(long l2, int i7) {
        ...
        i8 = 1;
        do {
            Test.instanceCount += (((i8 * i8) + i8) - i7);
        } while ((i8 += 2) < 350);
    ...
    public static int iMeth(float f, double d) {
        ...
        double d1=0.99747, dArr[]=new double[N];
        byte by1=23;
        ...
        switch ((((i6++) >>> 1) % 3) + 104) {
        case 104:
            i6 = iMeth1(Test.instanceCount, i6);
            break;
        case 105:
            for (i9 = 8; 297 > i9; ++i9) {
                dArr[i9 + 1] -= i6;
                for (d1 = 1; d1 < 6; d1++) {
                    ...
                    case 125:
                        i11 = i10;
                        Test.iArrFld[(int)(d1 + 1)] = i6;
                        lArr[(int)(d1 + 1)] += Test.iFld;
                        break;
                    case 126:
                        i10 &= i10;
                        break;
                    ...
                    case 129:
                        ...
                        break;
                    case 130:
                        Test.instanceCount = -15010;
                        break;
                    case 131:
                        Test.iArrFld[(int)(d1 - 1)] -= (int)-91L;
                        break;
                    case 132:
                        f += i10;
                        break;
    ...
    public long lMeth(int i3, short s, boolean b) {
        ...
        int i4=-1, i13=0, i14=-14, iArr[][]=new int[N][N];
        float f1=15.668F, fArr[]=new float[N];
        ...
        i4 = 1;
        while (++i4 < 301) {
            vMeth1((Math.min(i3, i4) + iMeth(f1, Test.dFld)) - Test.instanceCount, Test.instanceCount, i3);
            i13 = 5;
            while ((i13 -= 2) > 0) {
                long l4=107L;
                ...
                Test.dFld1 += -5529787657974256173L;
                i14 = 1;
                do {
                    byte by2=-54;
                    by2 = (byte)i4;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f2=0.867F, f3=90.895F, fArr1[][]=new float[N][N];
        ...
        for (i1 = 10; i1 < 331; ++i1) {
            ...
            while (++i15 < 78) {
                ...
                while (--i16 > 0) {
                    ...
                    case 16:
                        i2 = Test.iFld;
                        i2 += (((i16 * Test.iFld) + i2) - i1);
                        Test.instanceCount += (((i16 * f2) + i15) - i15);
                        Test.iArrFld[i1] = -137;
                        break;
                    case 30:
                        Test.iFld = (int)4117723034L;
                        f2 -= sFld;
                        if (bFld) break;
                        break;
                    case 3:
                        i2 -= i2;
                        i2 += (((i16 * f2) + Test.iFld) - i16);
                    ...
                    case 14:
                        dArr1[i1 + 1] *= Test.iFld;
                        break;
                    default:
                        Test.iArrFld[i1] *= (int)-69L;
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test.dFld1 bFld sFld = " + Double.doubleToLongBits(Test.dFld1) + "," + (bFld ? 1 : 0)
            + "," + sFld);
