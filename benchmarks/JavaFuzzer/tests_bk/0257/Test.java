...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.dArrFld, -49.39989);
    ...
    public static int iMeth(int i4) {
        ...
        int i5=-52, i6=105, i7=-27592, i8=-62257, i9=-12, i10=-11, i11=59122, i12=-13, iArr[][]=new int[N][N];
        float f1=1.83F, fArr[]=new float[N];
        double d1=127.97240;
        ...
        Test.iArrFld[(i4 >>> 1) % N][(i4 >>> 1) % N] &= -8;
        Test.instanceCount >>= i7;
        for (i8 = 9; i8 < 148; ++i8) {
            i6 = i9;
            i10 = 1;
            while (++i10 < 11) {
                Test.instanceCount = (long)-2.5981;
            }
    ...
    public static void vMeth(long l, float f) {
        ...
        long l1=-42158L, lArr[][]=new long[N][N];
        ...
        for (l1 = 9; l1 < 190; ++l1) {
            ...
            i3 *= (int)(Test.dArrFld[(int)(l1)] * iMeth(i3));
            f += l1;
            i3 = s;
            if (b) break;
            Test.byFld = (byte)i3;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f3=-13.230F, f4=89.187F, fArr1[]=new float[N];
        ...
        for (i1 = 10; i1 < 245; ++i1) {
            vMeth(Test.instanceCount, f3);
            Test.instanceCount *= (long)-1.29469;
            for (i15 = i1; 107 > i15; ++i15) {
                if (false) break;
                d3 = i1;
                Test.dArrFld[i1 + 1] = 70;
                switch ((((i15 >>> 1) % 9) * 5) + 78) {
                case 87:
                    i16 += (int)f3;
                    i16 += (i15 ^ (long)f3);
                ...
                case 112:
                    ...
                    break;
                case 80:
                    Test.iArrFld[i1 - 1][i15] = (int)Test.instanceCount;
                    l2 = 1;
                    do {
