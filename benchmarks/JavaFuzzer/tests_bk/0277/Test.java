...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -5895);
    }
    ...
    public static long lMeth1() {
        ...
        double d3=19.12238;
        int i4=-215, i5=32011, i6=68, i7=171, i8=3, iArr[]=new int[N];
        byte by=-97;
        boolean b=true;
    ...
    public void vMeth() {
        ...
        double d2=-46.25451;
        int i1=-144, i2=-5, i3=47, i10=-11, i11=4530, i12=-101, i13=6, iArr1[]=new int[N];
        boolean b1=true;
        ...
        for (d2 = 5; d2 < 254; d2++) {
            ...
            i3 %= (int)37.46709;
            Test.instanceCount += (-164 + (d2 * d2));
            for (i10 = 1; i10 < 7; ++i10) {
                iArr1[(i2 >>> 1) % N] ^= i1;
                i3 += i10;
            }
            for (i12 = 1; 7 > i12; ++i12) {
                byArr[(int)(d2)][i12] = (byte)Test.instanceCount;
                b1 = b1;
                if (b1) break;
            }
        }
    ...
    public long lMeth(double d1) {
        ...
        i14 = 170;
        do {
            Test.iArrFld[i14] >>>= -50187;
            switch (((i14 % 3) * 5) + 73) {
            case 76:
                iFld -= (int)6L;
                Test.fFld -= 3917721943L;
                for (i15 = 1; i15 < 9; ++i15) {
                    iFld += (((i15 * i15) + Test.instanceCount) - i16);
                    d1 = 7;
                    d1 *= i15;
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d4=124.67540, dArr[]=new double[N];
        boolean b3=false;
        byte by1=-64, byArr1[]=new byte[N];
