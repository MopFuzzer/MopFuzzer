...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -56543L);
    ...
    public static int iMeth1(int i5) {
        ...
        int i6=-179, i7=188, i9=-59956, i10=-46133, i11=1, i12=-237, iArr[]=new int[N];
        short s=-14656;
        byte by=49;
    ...
    public static int iMeth(long l) {
        ...
        int i3=-57, i4=168, i13=0, i14=1, iArr1[]=new int[N];
        long l1=-5639400420747917142L;
        short s1=19150;
        float f3=-44.870F, f4=-55.979F, fArr[]=new float[N];
        boolean b=false;
        ...
        for (f4 = 14; f4 < 259; ++f4) {
            ...
            case 20:
                if (b) break;
                iArr1[(int)(f4 + 1)] = (int)Test.instanceCount;
                if (b) {
                    i14 = 1;
                    do {
                        i13 += (i14 * i14);
    ...
    public static long lMeth() {
        ...
        int i=130, i1=84, i2=41985, i15=12005, i16=9, iArr2[][]=new int[N][N];
        float f=-109.357F;
        byte by1=123;
        boolean b1=true;
        double d=117.128383, dArr[][]=new double[N][N];
        ...
        for (i = 3; i < 165; ++i) {
            i2 = 1;
            do {
                i1 += (int)((f--) + (iMeth(Test.instanceCount) - i));
                i1 = -179;
            } while (++i2 < 10);
            by1 += (byte)i;
    ...
    public void mainTest(String[] strArr1) {
        ...
        boolean b2=true;
        float f6=-94.656F;
        double d1=35.107900, dArr1[]=new double[N];
        int i18=160, i19=-23166, i20=-137, i21=-597, i22=0, i23=-57889, i24=62131, iArr3[]=new int[N];
        ...
        for (int i17 : iArr3) {
                ...
                for (d1 = 1; d1 < 63; d1++) {
                    ...
                    case 106:
                        ...
                        case 113:
                            ...
                            i18 += (int)(d1 - Test.instanceCount);
                            Test.instanceCount += (49805 + (d1 * d1));
                            break;
                        case 114:
                            i17 += i18;
                            for (i23 = 1; i23 < 2; i23++) {
                    ...
                    case 107:
                        ...
                        break;
                    case 108:
                        Test.instanceCount += (long)(d1 + i21);
                        break;
                    }
                }
                break;
            ...
            case 123:
                ...
                break;
            case 146:
                Test.instanceCount += 52581L;
            case 128:
                Test.byArrFld[(i21 >>> 1) % N][(i24 >>> 1) % N] += (byte)i24;
                break;
            }
        }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.lArrFld Test.byArrFld = " + Test.instanceCount + "," +
