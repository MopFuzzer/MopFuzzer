...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.dArrFld, -33.119388);
    }
    ...
    public static int iMeth(int i5, int i6, boolean b) {
        ...
        Test.instanceCount += (long)123.551F;
    ...
    public static long lMeth(int i2) {
        ...
        boolean b1=true;
        float f=-1.694F;
        double d1=-82.128622, dArr[][]=new double[N][N];
        ...
        do {
            i4 = 4;
            while (--i4 > 0) {
                if (Test.instanceCount > (iMeth(i4, i3, b1) - -142)) continue;
    ...
    public static void vMeth(int i, int i1) {
        ...
        double d=-2.130095;
        int i9=243, i10=12, i11=-116, i12=-201, i13=-41061, iArr[]=new int[N];
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i14=-50322, i15=60, i17=-7, i18=-49867, i19=6, i20=53421, i21=-6, i22=34862, iArr1[]=new int[N],
            iArr2[]=new int[N];
        double d2=-85.30205;
        ...
        do {
            ...
            Test.dArrFld[i15][i15 + 1] = Test.instanceCount;
            i14 += (int)Test.instanceCount;
        ...
        for (int i16 : iArr1) {
            for (i17 = 3; i17 < 63; ++i17) {
                i18 *= -61;
                Test.instanceCount += (((i17 * Test.instanceCount) + i15) - Test.instanceCount);
                i14 %= (int)-73.46445;
                i18 += i17;
                i18 += (i17 ^ i17);
            }
            ...
            for (i19 = 3; i19 < 63; ++i19) {
                ...
                if (bFld) {
                    ...
                    case 20:
                        for (i21 = 1; i21 < 2; i21++) {
                            i14 = i15;
                            Test.instanceCount += (-24660 + (i21 * i21));
                            iArr1[i19] = i22;
        ...
        FuzzerUtils.out.println("bFld Test.dArrFld lArrFld = " + (bFld ? 1 : 0) + "," +
