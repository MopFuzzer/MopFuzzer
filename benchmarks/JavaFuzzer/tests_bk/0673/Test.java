...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, -14.184F);
    }
    ...
    public static void vMeth1(int i7) {
        ...
        int i8=110, i9=8, i10=-126, i11=-3973, i12=20389, i13=231, iArr[]=new int[N];
        float f2=-97.928F;
        byte by=-49;
    ...
    public static void vMeth(long l1, int i6) {
        ...
        int i14=37344, i15=-21373, i16=3, i17=32132, i18=-10, iArr1[]=new int[N];
    ...
    public static int iMeth(float f1) {
        ...
        long l=-48130L, l3=164L, lArr[]=new long[N];
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (f = 1; 130 > f; ++f) {
            Test.instanceCount += (long)(((f * i) + i) - i);
            for (i1 = 5; i1 < 194; ++i1) {
                short s=-23499;
                Test.instanceCount = (++i);
                Test.iFld += (((i1 * s) + s) - Test.instanceCount);
                i -= (int)(((++i2) - i2) + ((Test.instanceCount + -77) * (Test.fArrFld[(int)(f - 1)]--)));
                i = (int)((Math.abs(-56844) * (Test.instanceCount - f)) * iMeth(f3));
                switch (((i22 >>> 1) % 9) + 94) {
                case 94:
                    switch (((i1 >>> 1) % 1) + 2) {
                    case 2:
                    ...
                    default:
                        for (i23 = i1; i23 < 2; i23++) {
                            boolean b1=true;
                            i22 *= (int)Test.lFld;
                            i2 += (((i23 * f3) + i22) - Test.instanceCount);
                            switch (((i1 >>> 1) % 2) + 71) {
                            case 71:
                                Test.lFld >>= Test.lFld;
                                lArr1 = lArr1;
                            ...
                            case 72:
                                ...
                                break;
                            default:
                                Test.instanceCount += (((i23 * i23) + Test.iFld1) - Test.instanceCount);
                            }
                            Test.dFld *= Test.iFld1;
                            iArrFld[i23] = Test.sFld;
        ...
        FuzzerUtils.out.println("Test.sFld Test.lFld Test.iFld1 = " + Test.sFld + "," + Test.lFld + "," + Test.iFld1);
