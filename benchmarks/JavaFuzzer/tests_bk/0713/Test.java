...
public class Test {
    ...
    public static float fMeth(byte by, long l) {
        ...
        int i6=23527, i7=-230, i8=-244, i9=1, i10=92, i11=27129, iArr[]=new int[N];
        double d=-37.58862;
        float f1=-88.825F, fArr[]=new float[N];
    ...
    public static void vMeth(int i3, int i4, int i5) {
        ...
        long l1=-15617L, lArr[][]=new long[N][N];
        ...
        fMeth(Test.byFld, Test.instanceCount);
        for (l1 = 133; l1 > 6; --l1) {
            boolean b=false;
            i5 -= (int)d1;
            if (b) break;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=40, i17=179, i18=-38546, i19=-56612, i20=-46262, i21=-23313, i22=-45554, i23=-177, iArr1[]=new int[N];
        float f=2.493F;
        double d2=0.5245, d3=0.76537, dArr[][]=new double[N][N];

        FuzzerUtils.init(iArr1, 13135);
        FuzzerUtils.init(dArr, -58.46176);

        Test.instanceCount = (long)((i--) - (f = iMeth()));
            ...
            case 67:
                ...
                for (i22 = 2; i22 < 67; i22 += 3) {
                    ...
                    case 98:
                        ...
                        break;
                    case 97:
                        i18 += (((i22 * i19) + i) - Test.instanceCount);
                        b2 = b2;
                        i23 = (int)d2;
                        break;
                    case 83:
                        Test.iFld += (i22 * Test.iFld1);
                        break;
                    case 85:
                        iArr1[i22 - 1] = i18;
                        break;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.sFld Test.byFld = " + Test.instanceCount + "," + Test.sFld +
            "," + Test.byFld);
        FuzzerUtils.out.println("fFld Test.iFld Test.iFld1 = " + Float.floatToIntBits(fFld) + "," + Test.iFld + "," +
            Test.iFld1);
