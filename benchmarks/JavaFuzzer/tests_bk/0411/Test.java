...
public class Test {
        ...
        for (i5 = 353; i5 > 2; --i5) {
            for (i7 = 1; i7 < 5; i7++) {
                ...
                while (++i9 < 2) {
                    ...
                    Test.iArrFld[i5] = (int)l1;
                    if (true) {
                        Test.iArrFld[i7 + 1] += (int)l1;
                        d2 /= (i6 | 1);
                    } else if (b) {
                        if (b) break;
                    } else if (b) {
        ...
        for (i10 = 18; i10 < 334; ++i10) {
            ...
            while (++i12 < 5) {
                ...
                do {
                    lArr1[i10] += by;
                    i11 = 198;
                    Test.instanceCount -= -39807;
                    Test.instanceCount = Test.instanceCount;
                    Test.instanceCount = i12;
                    i11 = (int)Test.instanceCount;
                    f -= i12;
                    i11 += (((i13 * i12) + Test.instanceCount) - i10);
    ...
    public static int iMeth(int i1, int i2, double d) {
        ...
        double d3=23.29246, dArr[]=new double[N];
        byte by1=-126;
        short s=13472;
        boolean b1=false;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test.instanceCount -= (long)60.106416;
            ...
            while (++i21 < 147) {
                ...
                case 7:
                    ...
                    for (i23 = 1; i23 < 1; i23++) {
                        ...
                        try {
                            i20 = (128 / i19);
                            i24 = (-22547 / Test.iArrFld[i23 + 1]);
                            Test.iArrFld[(i >>> 1) % N] = (40945 % i21);
