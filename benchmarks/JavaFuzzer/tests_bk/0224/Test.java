...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -5646374591172523820L);
        FuzzerUtils.init(Test.iArrFld1, -146);
        FuzzerUtils.init(Test.fArrFld1, -21.461F);
    }
    ...
    public static short sMeth(long l1, int i10, long l2) {
        ...
        i11 = 228;
        do {
            Test.lArrFld = FuzzerUtils.long2array(N, (long)-102L);
            i10 += (int)d;
            i10 = i11;
            for (i12 = i11; i12 < 7; i12++) {
                Test.iArrFld1[i12][i12 - 1] |= i10;
                for (i14 = 1; i14 < 1; ++i14) {
                    i15 += i11;
                    Test.fArrFld1[i12 + 1] -= -43933;
                }
                l1 = i15;
                Test.fArrFld1[i12] += l2;
            }
    ...
    public static void vMeth1(int i9) {
        ...
        int i17=-8, i18=63343, i19=-57636, i20=13, iArr[]=new int[N];
        byte by=0;
        ...
        iArr[(i9 >>> 1) % N] = sMeth(Test.instanceCount, i9, Test.instanceCount);
        for (i17 = 11; 212 > i17; ++i17) {
            ...
            case 118:
                iArr[i17] = i17;
                Test.iArrFld1[i17 + 1][i17 + 1] += (int)Test.fFld;
                break;
            case 119:
                by += (byte)(i17 * i17);
                d1 -= i17;
    ...
    public void mainTest(String[] strArr1) {
        ...
        FuzzerUtils.out.println("fArrFld iArrFld Test.lArrFld = " +
            Double.doubleToLongBits(FuzzerUtils.checkSum(fArrFld)) + "," + FuzzerUtils.checkSum(iArrFld) + "," +
            FuzzerUtils.checkSum(Test.lArrFld));
        FuzzerUtils.out.println("Test.iArrFld1 Test.fArrFld1 sArrFld = " + FuzzerUtils.checkSum(Test.iArrFld1) + "," +
            Double.doubleToLongBits(FuzzerUtils.checkSum(Test.fArrFld1)) + "," + FuzzerUtils.checkSum(sArrFld));
