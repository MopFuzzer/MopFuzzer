...
public class Test {
    ...
    public static void vMeth3(long l1, int i3, int i4) {
        ...
        int i5=-4, i6=41, i7=59776, i8=-65505, i9=5, i10=7996, iArr1[]=new int[N];
    ...
    public void vMeth2(int i1) {
        ...
        i2 = 1;
        do {
            vMeth3(Test.instanceCount, i2, Test.iFld);
            for (i11 = 1; i11 < 5; i11++) {
                lArr = lArr;
            }
            ...
            case 61:
            case 62:
                i16 += (((i2 * Test.instanceCount) + i1) - i2);
            case 63:
                iFld1 *= i1;
                break;
            default:
    ...
    public void vMeth(long l, int i) {
        ...
        int i17=-5, i18=-4, i19=-23191, i20=0, i21=-24094, i22=-198, iArr[][]=new int[N][N];
        double d4=3.76792;

        FuzzerUtils.init(iArr, -14895);

        iArr[(i >>> 1) % N][(-51652 >>> 1) % N] = (int)Test.instanceCount;
        vMeth1();
        vMeth2(Test.iFld);
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i23=124, i24=-38693, i25=-5, i26=-152, i27=47200, i28=-173, i29=-8, iArr2[]=new int[N], iArr3[][]=new
            int[N][N];
        float f1=0.860F;
        short s=-13867;
        byte by=57;
                    ...
                    case 87:
                        if (b2) {
                            ...
                            case 129:
                                ...
                                break;
                            case 128:
                                iArr3[i25 - 1][i25] -= (int)Test.instanceCount;
                                Test.iFld += (int)Test.instanceCount;
                            case 123:
                                s += (short)(((i27 * Test.iFld) + i23) - Test.byFld);
                                f1 *= i23;
                                break;
                            case 127:
                                s += (short)i27;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.byFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.byFld);
        FuzzerUtils.out.println("iFld1 Test.bArrFld = " + iFld1 + "," + FuzzerUtils.checkSum(Test.bArrFld));
