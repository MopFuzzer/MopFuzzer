...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, 40867);
    }
    ...
    public static int iMeth(int i2, int i3, float f1) {
        ...
        int i4=-5, i5=2, i6=14, i9=8, i10=-84, i11=-4, iArr[]=new int[N];
        double d=-44.75496;
        byte by=84;
        short s=9738;
    ...
    public static void vMeth(int i, boolean b) {
        ...
        double d2=1.128433, dArr[]=new double[N];
        ...
        Test.iArrFld[(-170 >>> 1) % N][(i >>> 1) % N] = i1;
        switch (((i1 >>> 1) % 6) + 11) {
        case 11:
            Test.iArrFld[(i >>> 1) % N][(i1 >>> 1) % N] *= 19116;
    ...
    public void mainTest(String[] strArr1) {
        ...
        long l2=-1433027526594564777L, lArr1[]=new long[N];
        ...
        while (++l2 < 281) {
            ...
            Test.iArrFld[(int)(l2 - 1)][(int)(l2)] -= i20;
            if (b1) continue;
            i23 = i21;
            Test.iArrFld[(int)(l2 - 1)][(int)(l2 + 1)] = i22;
        }
        iFld = (int)l2;
        lArr1[(i20 >>> 1) % N] = l2;
        i24 = 1;
        do {
            ...
            do {
                ...
                try {
                    i23 = (58329 / Test.iArrFld[i25][i24]);
                    i21 = (-82 % iFld);
                    i19 = (i18 / 110);
                } catch (ArithmeticException a_e) {}
