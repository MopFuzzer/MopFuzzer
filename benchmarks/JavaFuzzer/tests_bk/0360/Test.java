...
public class Test {
    ...
    public static long lMeth1(int i8, int i9) {
        ...
        int i10=-60780, i11=33334, i12=-12, iArr[]=new int[N];
            ...
            default:
                ...
                if (true) {
                    ...
                    do {
                        f2 = 1;
                        do {
                            Test.iArrFld[(i9 >>> 1) % N][i12 + 1] = -93;
                            i11 = (int)Test.instanceCount;
                            Test.instanceCount += (long)(((f2 * i8) + i12) - i12);
                        } while (++f2 < 1);
                    } while (++i12 < 7);
                } else {
                    i8 += i10;
        ...
        for (l2 = 10; 369 > l2; l2++) {
            ...
            case 65:
                ...
                for (i13 = (int)(l2); i13 < 5; ++i13) {
                    i14 = i13;
                    i7 = i6;
                    Test.iArrFld[i13 - 1][i13] <<= -190;
                    i7 = (int)-3711089863L;
                    try {
                        i6 = (i14 % i7);
                        i7 = (i7 % Test.iArrFld[(i13 >>> 1) % N][(int)(l2 + 1)]);
                        i6 = (i14 % i7);
    ...
    public void vMeth(int i2, boolean b, long l) {
        ...
        for (i3 = 13; i3 < 382; ++i3) {
            float f4=5.425F;
            vMeth1(sFld - lMeth(Test.dFld, i2), f4, i4);
            for (i15 = 5; 1 < i15; i15 -= 3) {
                i4 -= (int)Test.instanceCount;
                i17 = 1;
                do {
                    i2 = (int)Test.instanceCount;
                    Test.instanceCount += (((i17 * f4) + l) - Test.byFld);
                    if (i3 != 0) {
                ...
                for (i18 = 1; i18 < 5; i18++) {
                    Test.iArrFld[i18] = Test.iArrFld[i15 + 1];
                    if (i4 != 0) {
                        vMeth_check_sum += i2 + (b ? 1 : 0) + l + i3 + i4 + i15 + i16 + i17 + i18 + i19;
                        return;
                    }
    ...
    public void mainTest(String[] strArr1) {
        ...
        long l3=-8666442547813178499L, lArr[]=new long[N];
        boolean b1=true;
        ...
        for (i = 14; i < 254; ++i) {
            vMeth(i, false, Test.instanceCount);
            for (i20 = i; i20 < 105; ++i20) {
                ...
                for (i22 = 1; i22 < 1; ++i22) {
                    ...
                    case 63:
                        Test.byFld *= (byte)i1;
                        Test.iArrFld[i20][i22 - 1] = 47806;
                        i1 = i21;
                        i23 += (((i22 * i21) + Test.instanceCount) - Test.instanceCount);
                    case 64:
                        Test.dFld -= i23;
                        Test.iArrFld[i20 + 1][i22] = i23;
                        l3 += (long)Test.fFld;
                    case 65:
                        sFld <<= (short)i20;
                        if (b1) break;
