...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, 27673);
        FuzzerUtils.init(Test.fArrFld, 63.36F);
    }
    ...
    public static void vMeth2(int i2, int i3, int i4) {
        ...
        i3 = (int)-113.107321;
        for (i5 = 7; i5 < 394; i5++) {
            i4 += (((i5 * Test.instanceCount) + Test.instanceCount) - f1);
            i3 = i3;
            for (i7 = 1; i7 < 4; i7++) {
                f1 += (i7 * i8);
                Test.iArrFld[i7 + 1] -= 13060;
    ...
    public static void vMeth1(double d1) {
        ...
        int i1=-210, i11=-186, i12=59422, i13=-9, i14=-11, i15=-232, iArr[]=new int[N];
        float f=-18.772F;
        boolean b=false;
        ...
        iArr[(i1 >>> 1) % N] = (int)(Test.instanceCount *= (long)f);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i24 = 2; i24 < 245; ++i24) {
            ...
            f3 -= i25;
            i23 += (((i24 * i24) + Test.instanceCount) - Test.instanceCount);
        ...
        for (i26 = 4; i26 < 145; ++i26) {
            ...
            while (++i28 < 178) {
                ...
                i25 += (i28 ^ i24);
                lArrFld[i28] = i28;
                Test.fArrFld[i28 + 1] += i27;
                try {
                    i27 = (i27 % Test.iArrFld[i28]);
                    i25 = (i26 % 1730758232);
                    Test.iArrFld[i26] = (i27 % 1203292445);
                } catch (ArithmeticException a_e) {}
            }
            dArrFld[i26] = i28;
            Test.instanceCount *= i25;
            ...
            case 57:
                try {
                    i30 = (110 / i27);
                    Test.iArrFld[i26] = (Test.iArrFld[i26] % 19212);
                    i31 = (-72 % i28);
                } catch (ArithmeticException a_e) {}
            case 51:
                i30 += i26;
            case 60:
                Test.instanceCount += (i26 ^ (long)f3);
            case 77:
                f3 -= -9;
                break;
            }
