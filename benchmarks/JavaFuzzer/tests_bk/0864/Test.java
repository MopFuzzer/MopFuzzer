...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.dArrFld, 0.26190);
        FuzzerUtils.init(Test.dArrFld1, 49.123765);
    }
    ...
    public static void vSmallMeth() {
        ...
        i2 -= (int)(f + (-56898L + (Test.instanceCount--)));
    ...
    public static void vMeth(float f2) {
        ...
        fArr[(i6 >>> 1) % N] *= (i6 + (f2 - (i6 + Test.sFld1)));
        ...
        Test.dArrFld = Test.dArrFld1;
        for (i15 = 6; i15 < 162; i15++) {
            fArr[i15] = (float)Test.dFld;
            lArr1[i15 + 1] = i6;
            i8 = i8;
    ...
    public void mainTest(String[] strArr1) {
        ...
        byte by=78;
        float f1=0.996F, fArr1[][]=new float[N][N];
        long l1=121L, lArr[][]=new long[N][N];
        ...
        vSmallMeth();
        for (i3 = 12; i3 < 370; i3++) {
            i1 += (((i3 * Test.instanceCount) + i) - by);
            iArrFld[i3 + 1] -= 32611;
        }
        vSmallMeth();
        iArrFld[(i3 >>> 1) % N] += (int)(((Test.instanceCount - Test.dFld) + iArrFld[(i >>> 1) % N]) * ((i1 -
            Test.instanceCount) ^ -31614));
        vSmallMeth();
        f1 = ((iMeth(i4) * Test.instanceCount) + iFld);
        i17 = 1;
        do {
                ...
                case 29:
                    for (i20 = 1; i20 < 2; i20++) {
                        ...
                        case 97:
                            ...
                            break;
                        case 92:
                            fArr1[i18 - 1][i18 - 1] -= Test.instanceCount;
                            break;
                        }
                    }
                    break;
                case 26:
                    f1 += (i18 * Test.instanceCount);
                    break;
                default:
                    i22 ^= (int)-2974284064L;
                }
        ...
        FuzzerUtils.out.println("Test.dFld Test.sFld1 Test.bFld = " + Double.doubleToLongBits(Test.dFld) + "," +
            Test.sFld1 + "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("iArrFld Test.dArrFld Test.dArrFld1 = " + FuzzerUtils.checkSum(iArrFld) + "," +
