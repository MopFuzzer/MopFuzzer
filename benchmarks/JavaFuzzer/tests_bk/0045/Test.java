...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, 6233637623494058649L);
        FuzzerUtils.init(Test.iArrFld, 4146);
    }
    ...
    public static void vMeth1() {
        ...
        int i3=-8328, i4=-2, i5=-46498, i6=-11, iArr1[]=new int[N];
    ...
    public static int iMeth(int i2) {
        ...
        long l2=-180L;
        boolean b1=false;
        double d2=-63.125231, dArr[]=new double[N];
        ...
        for (double d : dArr) {
            f -= ((long)((i2 - d) + (-125L + (i2--))) | (long)(Test.instanceCount * (d - i2)));
            vMeth1();
            Test.iArrFld[(i2 >>> 1) % N] = (int)Test.instanceCount;
            i2 *= (int)l2;
            b1 = b1;
            for (d2 = 1; d2 < 4; ++d2) {
                Test.iArrFld[(int)(d2 - 1)] = (int)-86.75283;
                for (i8 = 1; i8 < 2; i8++) {
                    by += (byte)(((i8 * l2) + i7) - i9);
                    if (b1) {
                        l2 += (-2 + (i8 * i8));
                        Test.instanceCount <<= -7229579028563312346L;
                        i7 >>= i2;
                    } else {
                        i7 += i8;
                    }
    ...
    public static void vMeth(int i1, boolean b) {
        ...
        double d3=63.76896;
        int i10=11, i11=-13, i12=-1457, iArr[]=new int[N];
        float f2=0.724F;
        short s1=16823;

        FuzzerUtils.init(iArr, -10);

        iArr[(i1 >>> 1) % N] = (int)(Math.min((int)(Test.instanceCount - i1), iMeth(Test.iFld)) + Test.instanceCount);
        i1 = -38101;
        d3 = 1;
        while (++d3 < 201) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f3=-43.447F;
        short s2=-12893;
        double d4=-2.70783, dArr1[]=new double[N];
        ...
        for (i17 = 7; i17 < 166; i17++) {
            ...
            for (d4 = 158; d4 > 9; d4 -= 2) {
                Test.iArrFld = FuzzerUtils.int1array(N, (int)48925);
            }
            switch ((i17 % 1) + 26) {
            case 26:
                i20 = 1;
