...
public class Test {
    ...
    public static void vMeth1(int i10) {
        ...
        byte by1=-89;
        long l1=2587121707L, lArr[]=new long[N];
        short s1=-8456;
        ...
        for (i11 = 6; 139 > i11; ++i11) {
            ...
            Test.byArrFld[i11 - 1] -= (byte)-18043;
            Test.bFld = Test.bFld;
            i10 = (int)5L;
            by1 = (byte)-14784;
            i10 += i10;
            ...
            for (l1 = i11; l1 < 12; ++l1) {
                switch ((int)((l1 % 9) + 29)) {
                case 29:
                    Test.iArrFld[(int)(l1 + 1)] = (int)-39342L;
                    i12 = (int)l1;
                    Test.iFld += (int)(((l1 * i10) + Test.fFld) - Test.iFld);
                case 30:
                    lArr[i11] ^= Test.instanceCount;
                    break;
                case 31:
                    Test.instanceCount += (((l1 * s1) + i10) - i13);
                    break;
                case 32:
                    by1 = (byte)i10;
                    break;
                ...
                case 37:
                    ...
                    break;
                default:
                    i10 += (int)(((l1 * Test.fFld) + by1) - Test.instanceCount);
                }
            }
        }
    ...
    public static int iMeth(int i6) {
        ...
        i6 = i6;
        for (i7 = 7; i7 < 152; i7++) {
            i8 >>= (int)(((i6 + i6) + Test.instanceCount) * ((Test.iFld = (int)Test.instanceCount) - Test.iArrFld[i7]));
            for (d = 1; d < 11; ++d) {
                vMeth1(Test.iFld);
                i9 += (int)d;
                switch (((i7 % 2) * 5) + 7) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        vMeth(Test.fFld, -1366576615L, Test.iFld);
                        ...
                        if (true) {
                            ...
                            do {
                                ...
                                case 35:
                                    ...
                                    Test.iArrFld[(int)(f1 + 1)] = (int)Test.fFld;
                                    break;
                                case 44:
                                    Test.byArrFld = FuzzerUtils.byte1array(N, (byte)-67);
                                    d1 += -44885;
                                ...
                                case 51:
                                    ...
                                    break;
                                case 48:
                                    Test.instanceCount += (long)(((f1 * i18) + i18) - i21);
                                    if (false) continue;
                                    d1 += Test.instanceCount;
                                case 37:
                                case 63:
                                    by2 += (byte)(f1 + Test.instanceCount);
                                    break;
                                }
                            } while ((f1 += 2) < 1);
                        } else {
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.bFld = " + Test.instanceCount + "," + Test.iFld +
            "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test.fFld Test.iArrFld Test.byArrFld = " + Float.floatToIntBits(Test.fFld) + "," +
