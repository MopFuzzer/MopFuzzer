...
public class Test {
    ...
    public static void vMeth2(float f) {
        ...
        int i5=-1, i6=194, i7=137, i8=0, iArr[]=new int[N];
        boolean b1=false;
        ...
        while (++i5 < 130) {
            ...
            for (i7 = i5; i7 < 12; ++i7) {
                ...
                case 3:
                    ...
                    i6 += (((i7 * i6) + Test.instanceCount) - i8);
                    if (b1) continue;
                    break;
                case 4:
                    lArr1[i7 - 1] -= i7;
    ...
    public static void vMeth1(boolean b) {
        ...
        float f1=2.818F;
        long l=37956L, lArr[]=new long[N];
        int i9=-9, iArr1[]=new int[N];
        byte by=0;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=59572, i1=1, i2=52694, i3=-41864, i13=60010, i14=27208, iArr2[]=new int[N];
        float f3=-50.832F, fArr1[][]=new float[N][N];
        ...
        FuzzerUtils.out.println("Test.bFld dArrFld = " + (Test.bFld ? 1 : 0) + "," +
