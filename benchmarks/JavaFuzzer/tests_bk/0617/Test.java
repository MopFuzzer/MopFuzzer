...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.fArrFld, 0.231F);
    }
    ...
    public static int iMeth(float f, float f1, int i1) {
        ...
        long l1=4158445062L, lArr1[]=new long[N];
        ...
        vMeth1(i1);
        Test.instanceCount -= (long)125.794F;
        for (l1 = 6; 392 > l1; ++l1) {
            lArr1[(int)(l1 + 1)] += (long)Test.dFld;
        }
        for (i9 = 1; i9 < 126; i9++) {
            for (i11 = 1; i11 < 13; ++i11) {
                for (f3 = 1; f3 < 2; f3 += 2) {
                    ...
                    s1 = (short)l1;
                    try {
                        Test.iArrFld[(int)(f3)] = (-416763678 / i13);
                        i10 = (i9 / 30);
                        Test.iArrFld[i11] = (i12 / i10);
    ...
    public static void vMeth(long l) {
        ...
        Test.iArrFld[(i >>> 1) % N] = Math.min(iMeth(f4, f4, 54189), i);
        i14 = 1;
        do {
            switch ((i14 * 5) + 70) {
            case 383:
            ...
            case 208:
            case 276:
                Test.iArrFld[i14 + 1] = -177;
                break;
            case 78:
                Test.instanceCount -= 67;
                break;
            case 122:
                Test.fArrFld[i14] -= i17;
                break;
            case 279:
                i17 -= 225;
                break;
            ...
            do {
                ...
                if (b2) {
                    for (i21 = 1; i21 < 191; i21++) {
                        ...
                        iFld1 = i23;
                        i24 += (((i21 * i24) + Test.instanceCount) - i24);
                    }
                    iFld -= (int)Test.instanceCount;
                    i22 = i24;
                }
