...
public class Test {
    ...
    public static void vMeth1(int i3, int i4, int i5) {
        ...
        float f=-2.256F;
        int i13=-47297, i14=64047, i15=-22958, i16=10987, i17=-166, i18=-31750, i19=663, i20=-18, iArr[]=new int[N];
        long l=308699980L, lArr[][]=new long[N][N];
        double d1=19.39229;
        boolean b1=false;
                ...
                case 86:
                    ...
                    case 79:
                        for (i17 = 1; i17 < 8; i17++) {
                            for (i19 = 2; i19 > 1; i19--) {
                                iArr[i13] += i18;
                                i20 += (((i19 * Test.instanceCount) + i13) - f);
                            }
                        }
                        break;
                    case 80:
    ...
    public static void vMeth(int i1, int i2) {
        ...
        double d2=-84.101837, dArr[]=new double[N];
        long l1=7364724406072230891L, lArr1[]=new long[N];
        float f1=-109.810F, fArr1[]=new float[N];
        ...
        do {
            ...
            do {
                ...
                for (l1 = 1; 1 < l1; l1--) {
                    f1 += i23;
                    Test.instanceCount *= (long)-105.115489;
                }
                switch (((-1 >>> 1) % 8) + 55) {
                case 55:
                    i2 += i22;
                ...
                case 56:
                    lArr1[i21 - 1] -= (long)d2;
                case 57:
                    f1 += (((i22 * i21) + Test.instanceCount) - l1);
                case 58:
                    f1 -= (float)25.44745;
                    break;
                case 59:
                    Test.instanceCount += (((i22 * i21) + i23) - i1);
                    break;
                case 60:
                    dArr[i21] += -12455;
                    break;
                case 61:
                    Test.instanceCount = 42562;
                case 62:
                    i23 &= (int)-30480L;
                    break;
                default:
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++i < 186) {
            ...
            for (i24 = 4; i24 < 135; i24++) {
                ...
                i27 += (i24 ^ i24);
                Test.instanceCount += (((i24 * Test.instanceCount) + Test.byFld) - i);
            }
            d3 += 8;
            i27 += i25;
