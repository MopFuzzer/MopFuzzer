...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld1, -117);
        FuzzerUtils.init(Test.iArrFld2, -110);
    }
        ...
        if (b) {
            ...
            for (i11 = 8; 253 > i11; i11++) {
                for (i13 = 1; i13 < 7; ++i13) {
                    ...
                    Test.iArrFld1[i11] += -127;
                    i12 = s;
                    Test.iArrFld1[i13 - 1] |= 29;
    ...
    public static long lMeth(float f, double d1, int i1) {
        ...
        for (i2 = 17; 367 > i2; i2++) {
            for (i4 = 1; i4 < 5; i4++) {
                ...
                try {
                    Test.iFld = (i1 % -13755);
                    Test.iArrFld1[i2 - 1] = (i2 / -22);
                    i3 = (-785183485 / Test.iArrFld1[i4]);
                } catch (ArithmeticException a_e) {}
                for (i6 = 1; i6 < 2; i6++) {
                    i5 = iMeth(i4, i6, i7);
                    lArr1[i6 - 1] += i4;
                    s1 += (short)i1;
                    Test.iArrFld2[i4 + 1] = (int)-1.1952;
                    Test.iFld += (((i6 * i16) + i5) - i7);
                    Test.instanceCount += (i6 * Test.byFld);
                    Test.instanceCount += (i6 | Test.instanceCount);
                }
                i1 += (((i4 * i7) + i5) - Test.instanceCount);
    ...
    public static void vSmallMeth(int i) {
        ...
        Test.dFld -= ((lMeth(f1, Test.dFld, i) + Test.instanceCount) - Test.instanceCount);
        i = i;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (int smallinvoc=0; smallinvoc<906; smallinvoc++) vSmallMeth(Test.iFld);
        b2 = b2;
        Test.iFld -= i17;
        Test.dFld = i17;
        i17 >>>= -46;
        for (i18 = 9; i18 < 158; i18++) {
            ...
            for (i22 = 168; i22 > 4; --i22) {
                ...
                Test.iFld += (i22 * i22);
                Test.iArrFld2[i22 + 1] = i18;
                Test.instanceCount += (((i22 * i20) + i17) - Test.byFld);
            }
            for (f3 = 4; f3 < 168; f3++) {
                Test.instanceCount = Test.instanceCount;
                Test.byFld &= (byte)i24;
                Test.iArrFld1[(int)(f3)] += s2;
                i23 >>= -6;
            }
        }
        ...
        FuzzerUtils.out.println("Test.byFld iArrFld Test.iArrFld1 = " + Test.byFld + "," +
