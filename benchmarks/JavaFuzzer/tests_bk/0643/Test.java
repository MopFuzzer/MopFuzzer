...
public class Test {
    ...
    public float fMeth(int i, boolean b, int i1) {
        ...
        i1 *= (int)(Test.instanceCount + Math.max(i1++, Test.iFld++));
    ...
    public static long lMeth1() {
        ...
        int i10=-7697, i11=-233, i12=-14452, i13=-12, i14=-6, iArr1[]=new int[N];
        double d1=-2.69197;
        ...
        for (int i9 : iArr1) {
            ...
            i9 >>= (int)-423984446L;
            for (i11 = 1; i11 < 4; ++i11) {
                Test.instanceCount += (((i11 * Test.fFld1) + i11) - i9);
                Test.sFld -= (short)Test.fFld1;
                Test.instanceCount -= i9;
                if (Test.bFld) continue;
                for (i13 = 2; i13 > 1; i13--) {
                    Test.iFld += (((i13 * i11) + i13) - i10);
                    d1 *= Test.iFld;
                    Test.iFld += (int)d1;
                }
    ...
    public static long lMeth() {
        ...
        int i8=-14, i15=-10, i16=-37722, i17=4, i18=-222, iArr2[]=new int[N];
        ...
        Test.sFld >>= (short)((++dArr[(Test.iFld >>> 1) % N]) + Test.iFld);
        i8 = 1;
        do {
            lMeth1();
            Test.iFld += i8;
    ...
    public static void vMeth(double d, int i2, long l) {
        ...
        int i3=52961, i4=-12, i5=-20615, i6=-225, i7=-44668, iArr[]=new int[N];

        FuzzerUtils.init(iArr, 7201);

        for (l1 = 8; 244 > l1; l1++) {
            for (i4 = 1; i4 < 7; i4++) {
                i5 = (Test.iFld + (iArr[i4]++));
                switch ((((i5++) >>> 1) % 8) + 63) {
                case 63:
                    for (i6 = i4; i6 < 2; i6++) {
                        l >>= (long)(i2 -= (int)(++Test.fFld1));
                        l = i3;
                        if ((lMeth() - Test.iFld) >= Test.iFld) continue;
                ...
                case 65:
                    ...
                    break;
                case 66:
                    Test.fFld1 += 2025014060L;
                case 67:
                    Test.instanceCount *= -7235;
                    break;
                case 68:
                    iArr[i4] = i5;
                    break;
                ...
                case 70:
                    ...
                    break;
                default:
                    Test.iFld += (((i4 * i7) + Test.instanceCount) - i2);
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test.iFld = (int)fMeth(Test.iFld - (iArrFld[(37819 >>> 1) % N]++), Test.bFld = (fFld <= by),
            (int)(Test.instanceCount - (-(Test.instanceCount - Test.iFld))));
        Test.iFld = (int)Test.instanceCount;
        vMeth(d2, Test.iFld, Test.instanceCount);
        Test.iFld -= (int)fFld;
        for (i19 = 13; i19 < 393; ++i19) {
            ...
            for (i21 = 66; i21 > 2; i21--) {
                ...
                i28 += (i21 ^ Test.instanceCount);
                try {
                    i26 = (i19 / iArrFld[i19 + 1]);
                    Test.iFld = (Test.iFld % iArrFld[i21]);
                    Test.iFld = (-233 / i24);
                } catch (ArithmeticException a_e) {}
                Test.sFld += (short)(i21 * fFld);
            }
            f = 1;
            while (++f < 66) {
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.bFld = " + Test.instanceCount + "," + Test.iFld +
            "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("fFld Test.fFld1 Test.sFld = " + Float.floatToIntBits(fFld) + "," +
            Float.floatToIntBits(Test.fFld1) + "," + Test.sFld);
        FuzzerUtils.out.println("Test.byFld iFld1 iArrFld = " + Test.byFld + "," + iFld1 + "," +
