...
public class Test {
    ...
    public static int iMeth(int i4, int i5, int i6) {
        ...
        vMeth1((short)(-12895), Test.instanceCount);
        for (i8 = 22; i8 < 371; ++i8) {
            for (i10 = 1; i10 < 5; i10++) {
            ...
            i5 += (((i8 * Test.instanceCount) + i12) - i4);
            if (b) break;
            dArr = dArr;
            i5 += (i8 * i8);
        }
    ...
    public static void vMeth(long l1) {
        ...
        int i3=-40317, i13=-41704, i14=2, i15=0, i16=3837, i17=88, i18=51890, i19=0, i20=-154, iArr1[][]=new int[N][N];
        double d=-2.20226;
        float f3=-35.679F;
    ...
    public void mainTest(String[] strArr3) {
        ...
        int i1=-248, i2=34199, i21=8, i22=46252, i23=0, i24=-57, i25=14, i26=-197, i27=6, i28=130, iArr2[]=new int[N];
        long l=-4031909755381746189L, lArr1[]=new long[N];
        float f=0.882F;
        double d1=-2.23713;
        byte by1=29;
        boolean b1=false;
        ...
        FuzzerUtils.out.println("Test.instanceCount dArrFld = " + Test.instanceCount + "," +
