...
public class Test {
    ...
    public int iMeth1(float f) {
        ...
        case 18:
            for (i12 = 333; i12 > 12; i12--) {
                ...
                d1 -= 204L;
                i13 = 45066;
                Test.instanceCount += (248L + (i12 * i12));
            }
        }
    ...
    public int iMeth(int i, double d, int i1) {
        ...
        Test.fFld += ((iArrFld[(i >>> 1) % N] -= (++i)) + Math.min(i1 + iFld, iFld));
    ...
    public void mainTest(String[] strArr1) {
        ...
        short s1=-20413;
        float f1=32.965F, fArr[]=new float[N];
        byte by2=-40;
        ...
        iFld -= (int)(fArr[(0 >>> 1) % N]--);
        Test.instanceCount += ((iFld - iMeth(27409, dFld, iFld)) - 11);
        for (i17 = 2; i17 < 123; i17 += 2) {
            for (i19 = 1; i19 < i17; i19++) {
                ...
                for (i21 = 1; i21 < 2; ++i21) {
                    ...
                    i22 += (((i21 * i18) + Test.fFld) - Test.instanceCount);
                    iArrFld[i21] = iFld;
                    iFld -= s1;
                    try {
