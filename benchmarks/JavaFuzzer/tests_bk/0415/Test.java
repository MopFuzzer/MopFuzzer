...
public class Test {
    ...
    public static double dMeth(int i7, long l1, boolean b1) {
        ...
        double d1=-2.6835;
        int i8=-34003, i9=3, i10=5, i11=-4, iArr1[]=new int[N];
        float f2=-2.971F, fArr[]=new float[N];
    ...
    public static void vMeth(double d) {
        ...
        int i1=59285, i2=-48002, i3=-8, i4=-46631, i15=-75, i16=154, i17=-6, iArr[][]=new int[N][N];
        float f1=121.783F;
        ...
        for (i1 = 9; i1 < 223; i1 += 2) {
            ...
            do {
                ...
                Test.instanceCount = ((++i2) - iArr[i1 - 1][i3]);
            } while (++i3 < 15);
            vMeth1(-55749, Test.instanceCount, i2);
            if (i1 != 0) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=205, i18=-100, i19=97, i20=44367, i21=-5, i22=-34532, i23=-214, iArr2[]=new int[N];
        float f=80.739F;
        double d3=0.3411, dArr[][]=new double[N][N];
        byte by=34;
