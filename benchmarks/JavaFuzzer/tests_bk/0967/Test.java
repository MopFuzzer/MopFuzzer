...
public class Test {
    ...
    public static void vMeth2() {
        ...
        for (i8 = 4; i8 < 218; i8++) {
            Test.instanceCount += (59103 + (i8 * i8));
            for (i10 = 1; i10 < 8; i10 += 3) {
                Test.instanceCount += Test.sFld;
                Test.instanceCount += (19749 + (i10 * i10));
                if (b) break;
                for (i12 = 1; i12 < 4; ++i12) {
                    i7 >>= i13;
    ...
    public static void vMeth1(int i4) {
        ...
        double d=-61.98932;
        int i5=0, i14=147, i15=11, i16=-233, iArr[]=new int[N];
        ...
        for (d = 8; d < 355; d += 2) {
            ...
            for (i14 = 1; 9 > i14; i14++) {
                ...
                do {
                    i15 = 45206;
                    i4 += i16;
                    i5 += (((i16 * Test.instanceCount) + Test.instanceCount) - i14);
                    fArr = fArr;
                    byArr[(int)(d)] += (byte)-9;
    ...
    public static void vMeth(byte by, float f1, float f2) {
        ...
        int i17=-4013, i18=10, i19=-18021, i20=-2, i21=31673, i22=-10818, iArr1[]=new int[N];
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f=2.618F;
        short s=14854, sArr1[]=new short[N];
        byte by1=100;
        ...
        i = (int)(f + (i + (i * Test.instanceCount)));
        for (long l : lArr) {
            i1 = 1;
            do {
                i = Math.abs(-9937);
                ...
                for (i2 = 1; i2 < 1; i2++) {
                    ...
                    case 57:
                        try {
                            Test.iFld = (iArrFld[i1][i1 - 1] % i);
                            Test.iFld = (Test.iFld % 15886);
                            i3 = (i / -3084);
