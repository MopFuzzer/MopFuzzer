...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -5265);
    }
    ...
    public static int iMeth(int i4, int i5) {
        ...
        i5 *= (int)lMeth(Test.instanceCount, Test.instanceCount, Test.instanceCount);
        long meth_res = i4 + i5;
    ...
    public static void vMeth(double d1, float f1) {
        ...
        float f2=-2.160F, fArr[][]=new float[N][N];
        ...
        for (f2 = 10; f2 < 294; f2++) {
            Test.instanceCount += (iMeth(i3, Test.iFld1) + i2);
            Test.iFld1 += (int)(f2 * f2);
            fArr[(int)(f2 - 1)][(int)(f2 + 1)] *= Test.instanceCount;
            for (i12 = 1; i12 < 6; i12++) {
                for (i14 = 1; 2 > i14; i14++) {
                    i13 = i14;
                    i2 += (i14 * i14);
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=30411, i16=128, i17=8588, i18=35513, i19=-76, i20=169, i21=-7, i22=9863, i23=36232, iArr[][]=new
            int[N][N];
        ...
        switch ((((((int)(Test.instanceCount * -1143874108L)) >>> 1) % 10) * 5) + 31) {
        case 69:
            i = 1;
            do {
                iFld = (int)((++Test.instanceCount) * iFld);
                iFld >>= i;
            } while (++i < 317);
        ...
        case 72:
            for (f3 = 2; f3 < 366; f3 += 2) {
                ...
                while (++i20 < 138) {
                    ...
                    f = -17980;
                    Test.iFld1 += (((i20 * i20) + Test.instanceCount) - f);
                    i22 += i20;
                    iFld += (((i20 * i16) + Test.instanceCount) - i22);
                    if (Test.bFld) break;
                }
                i23 = 1;
                while (++i23 < 138) {
                    i16 += Test.iFld1;
                    Test.instanceCount += (long)(0.200F + (i23 * i23));
                }
            }
            break;
        case 47:
        ...
        FuzzerUtils.out.println("Test.instanceCount iFld Test.iFld1 = " + Test.instanceCount + "," + iFld + "," +
            Test.iFld1);
        FuzzerUtils.out.println("Test.bFld Test.iFld2 Test.iArrFld = " + (Test.bFld ? 1 : 0) + "," + Test.iFld2 + "," +
