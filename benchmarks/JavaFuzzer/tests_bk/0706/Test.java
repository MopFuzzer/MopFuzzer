...
public class Test {
    ...
    public static float fMeth(float f1, int i5) {
        ...
        int i6=-117, i7=-13, i8=36393, iArr[]=new int[N];
    ...
    public static void vMeth1() {
        ...
        int i=173, i1=69, i2=-56569, i3=-166, i4=194, iArr1[]=new int[N];
        float f2=-1.888F;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f4=0.258F;
        int i17=12, i18=19, i19=-8, i20=-113, i21=39909, i22=44479, i23=2745, i24=-14, i25=-46623, i26=50894, i27=-238,
            iArr2[]=new int[N];
        boolean b1=false;
        ...
        for (i17 = 7; i17 < 361; ++i17) {
            ...
            for (i19 = 71; i19 > 3; --i19) {
                i20 += (((i19 * f4) + Test.instanceCount) - Test.iFld);
            }
            if (b1) {
                if (b1) continue;
                ...
                for (i21 = 3; i21 < 71; i21++) {
                    ...
                    Test.instanceCount += (long)(0.617F + (i21 * i21));
                }
            }
        }
        iArr2[(i23 >>> 1) % N] -= i22;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.iFld1 = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.iFld1);
        FuzzerUtils.out.println("Test.byFld sArrFld = " + Test.byFld + "," + FuzzerUtils.checkSum(sArrFld));
