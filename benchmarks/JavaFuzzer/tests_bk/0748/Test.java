...
public class Test {
    ...
    public static double dMeth(int i5, int i6) {
        ...
        for (l1 = 146; l1 > 2; l1--) {
            ...
            lArr1[(int)(l1 + 1)] *= (long)Test.dFld1;
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-233, i1=185, i2=47344, i3=-38, i4=-64096, iArr[]=new int[N];
            ...
            for (i1 = 1; i1 < 65; i1++) {
                for (i3 = i; 2 > i3; i3++) {
                    ...
                    case 12:
                        Test.fFld = i3;
                        Test.instanceCount *= Test.instanceCount;
                        i4 += (((i3 * i4) + Test.fFld) - i);
                        break;
                    case 32:
                        if (bFld) {
                            i2 += (i3 ^ i1);
                            fArr[i] = (float)Test.dFld1;
                        }
                        i2 = i2;
                        break;
                    default:
        ...
        FuzzerUtils.out.println("lFld Test.fFld bFld = " + lFld + "," + Float.floatToIntBits(Test.fFld) + "," + (bFld ?
            1 : 0));
