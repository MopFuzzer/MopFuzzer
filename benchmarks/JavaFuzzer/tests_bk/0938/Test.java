...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)19300);
    }
    ...
    public static void vMeth2(int i5, int i6, int i7) {
        ...
        int i8=-51099, i9=228, i10=-310, i11=-191, iArr[]=new int[N], iArr1[]=new int[N];
        boolean b=true;
        float f2=-76.927F;
        byte by=61;
    ...
    public static void vMeth1() {
        ...
        sArr[(i12 >>> 1) % N] >>= (short)Test.instanceCount;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test.sArrFld[(i1 >>> 1) % N] *= (short)1.919F;
        ...
        FuzzerUtils.out.println("Test.sArrFld fArrFld iArrFld = " + FuzzerUtils.checkSum(Test.sArrFld) + "," +
