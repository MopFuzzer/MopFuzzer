...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -859670490L);
    }
        ...
        do {
            ...
            case 120:
                if (b) {
                    i5 *= i3;
                    i5 -= i4;
                    i3 += (((i6 * i5) + Test.instanceCount) - Test.instanceCount);
    ...
    public static void vMeth(int i2) {
        ...
        Test.lArrFld[(i2 >>> 1) % N] += (-(i2 + sMeth(i2)));
        for (i9 = 2; i9 < 154; ++i9) {
            i10 -= i2;
            i10 += (i9 * i9);
            i10 *= s1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (l2 = 18; l2 < 318; l2++) {
            ...
            for (l3 = 3; l3 < 84; l3++) {
                ...
                for (i17 = 2; i17 > 1; --i17) {
                    short s2=-15148;
                    iArrFld[(int)(l2 + 1)] = (int)Test.fFld;
                    i14 += s2;
                    i15 += (((i17 * i15) + i15) - i14);
            ...
            for (i19 = 5; 84 > i19; i19++) {
                for (f = 1; f < 2; f++) {
                    ...
                    case 46:
                        Test.fFld -= Test.instanceCount;
                        Test.instanceCount = -12425;
                        dArr[(int)(l2)] += Test.byFld;
                        break;
                    case 48:
                        Test.fFld += f;
                    case 40:
        ...
        FuzzerUtils.out.println("Test.sFld Test.byFld Test.lFld = " + Test.sFld + "," + Test.byFld + "," + Test.lFld);
