...
public class Test {
        ...
        while (++i4 < 309) {
            ...
            case 29:
                ...
                case 28:
                    d = -46.78569;
                default:
                    Test.instanceCount += (((i4 * i6) + i8) - Test.instanceCount);
                }
                break;
            case 30:
                i8 += (((i4 * i4) + Test.instanceCount) - Test.instanceCount);
                break;
            case 22:
                i6 -= i7;
                break;
    ...
    public static void vMeth1(int i, int i1) {
        ...
        i2 = 1;
        while (++i2 < 256) {
            lArr[i2][i2 - 1] *= ((++Test.instanceCount) - ((--i1) + (i * 54342)));
            vMeth2(i2);
        }
        Test.fFld -= i1;
    ...
    public void vMeth() {
        ...
        Test.iFld = (int)(((Test.instanceCount++) + (-(Test.instanceCount++))) - f);
        vMeth1(Test.iFld, Test.iFld);
        Test.iArrFld = Test.iArrFld;
        Test.iArrFld[(Test.iFld >>> 1) % N] >>= 240;
        for (i9 = 2; i9 < 244; ++i9) {
            for (i11 = 1; i11 < 7; i11++) {
