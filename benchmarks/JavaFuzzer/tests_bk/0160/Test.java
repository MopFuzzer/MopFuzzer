...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -13789);
    }
    ...
    public static void vMeth() {
        ...
        for (i1 = 7; i1 < 391; i1++) {
            for (i3 = 4; i3 > 1; i3 -= 2) {
                float f3=-2.171F;
                i2 += (int)(d++);
                s += (short)(((11611 * iMeth1(f3, b1, f3)) * Test.instanceCount) / (i1 | 1));
                by = (byte)i2;
            }
            i4 += (((i1 * i1) + i2) - Test.fFld);
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i24=-57265, i26=8, i27=43487, i28=241, iArr[][]=new int[N][N];
                    ...
                    while (--i28 > 0) {
                        ...
                        case 79:
                            ...
                            case 137:
                                ...
                                break;
                            case 129:
                                Test.fFld -= -3465129414254479881L;
                                break;
                            case 132:
                                iArr[i24 - 1][i26] = -213;
                                i27 += i24;
                        ...
                        case 86:
                            ...
                            break;
                        case 87:
                            Test.iArrFld[i26 + 1] <<= (int)Test.lFld;
                            break;
                        case 88:
                            b3 = false;
                            break;
        ...
        FuzzerUtils.out.println("Test.lFld Test.dFld byFld = " + Test.lFld + "," + Double.doubleToLongBits(Test.dFld) +
            "," + byFld);
