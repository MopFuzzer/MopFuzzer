...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, 7117L);
    }
    ...
    public static void vMeth(int i7, int i8, int i9) {
        ...
        double d=2.58214;
        float f1=1.482F, fArr[]=new float[N];
    ...
    public static int iMeth(int i5, int i6, long l) {
        ...
        int i14=-1, i15=-206, i16=58849, i17=-7, i18=-8, iArr[]=new int[N];
        double d1=54.91902;
        float f2=103.209F, fArr1[]=new float[N];
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-10, i1=-58, i2=31941, i19=15609, i20=4, i21=-49286, i22=-16575, i23=-26666, iArr1[]=new int[N];
        float f3=-67.68F;
        double d2=-2.95151, dArr[]=new double[N];
        ...
        for (i = 14; i < 277; i++) {
            ...
            do {
                byte by=-80;
                for (int smallinvoc=0; smallinvoc<1; smallinvoc++) vSmallMeth((int)(((i2 + i2) + (-9.902F - i2)) -
                    (iMeth(i, i1, -4489551902436592735L) + 5)), i2, f3);
                Test.instanceCount = -4500;
                try {
                    i1 = (i1 % i2);
                    i1 = (i2 % 15878);
                    i1 = (-14621 / i1);
            ...
            for (d2 = 96; d2 > 5; d2--) {
                ...
                case 122:
                    ...
                    break;
                case 106:
                    Test.lArrFld[(int)(d2 + 1)] = Test.sFld;
                    break;
                case 116:
