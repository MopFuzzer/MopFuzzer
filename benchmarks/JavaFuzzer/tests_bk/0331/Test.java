...
public class Test {
    ...
    public static void vMeth() {
        ...
        int i7=-230, i8=88, i9=-12, i10=-218, i11=-29, i18=-26107, iArr[]=new int[N];
        double d1=-2.56965;
        float f2=2.597F;
        long l=-2100890582L;
            ...
            for (i21 = 1; i21 < 5; ++i21) {
                ...
                if (b1) {
                    for (i23 = 1; i23 < 2; ++i23) {
                        i20 -= -12;
                        i6 = 14;
                        Test.instanceCount += (-43357L + (i23 * i23));
                        i6 = i21;
                    }
                } else if (b1) {
                    f3 = f3;
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            i1 += i1;
            fFld *= (((30L + (i + Test.sFld)) + (--i1)) * (i * (fFld + Test.instanceCount)));
            i1 += ((i1 - i) * Test.sFld);
            for (i2 = 4; i2 < 70; ++i2) {
                for (i4 = i2; i4 < 2; ++i4) {
                    ...
                    case 31:
                        ...
                        case 110:
                            try {
                                i5 = (-28 / i3);
                                i5 = (Test.iArrFld[i] / i5);
                                i3 = (i / i4);
                            } catch (ArithmeticException a_e) {}
                            fFld += i5;
                            try {
                                i3 = (i4 / -14986);
                                Test.iArrFld[i4] = (i2 / -765835009);
                                i5 = (i3 / Test.iArrFld[i4]);
                            } catch (ArithmeticException a_e) {}
