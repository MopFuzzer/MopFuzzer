...
public class Test {
    ...
    public static void vMeth1(float f2, int i6, long l) {
        ...
        float f3=43.882F;
        byte by1=22;
        int i7=-41325, i8=11, i9=25367, i10=8, i11=-5, i12=229, iArr1[]=new int[N];
        short s=-21253;
    ...
    public static double dMeth(byte by, int i4, int i5) {
        ...
        for (i13 = 10; i13 < 262; i13++) {
            for (i15 = 1; i15 < 6; ++i15) {
                ...
                i5 += (((i15 * i17) + i18) - Test.instanceCount);
                for (i19 = 1; i19 < 2; i19++) {
                    f4 += i18;
                    i5 += i16;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-219, i27=-76, i28=-16916, i29=-53883, i30=6, i31=-21, i32=0, i33=0, i34=-5, i35=6, iArr[][]=new
            int[N][N];
        ...
        Test.instanceCount &= (long)((Math.min(i, i) + i) * f);
        f1 = 1;
        do {
            ...
            for (i27 = 12; i27 < 193; i27 += 3) {
                Test.instanceCount += (((i27 * i28) + by3) - i27);
            }
        } while ((f1 += 2) < 260);
