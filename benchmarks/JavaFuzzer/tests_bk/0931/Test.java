...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -28022);
    }
    ...
    public static void vMeth1(long l1, long l2) {
        ...
        int i7=-132, i8=226, i9=-4, i10=178, i11=-231, iArr[]=new int[N];
        double d=-89.5402;
        boolean b1=false;
    ...
    public static void vMeth(int i4, long l) {
        ...
        for (i14 = 19; i14 < 370; ++i14) {
            ...
            try {
                i15 = (i4 % Test.iArrFld[i14 - 1]);
                i4 = (i15 % -237);
                i15 = (Test.iArrFld[i14] / Test.iArrFld[i14]);
            } catch (ArithmeticException a_e) {}
            if (b2) {
                Test.iArrFld[i14 - 1] -= -244;
                if (i4 != 0) {
    ...
    public void mainTest(String[] strArr1) {
            ...
            do {
                ...
                case 86:
                    ...
                    while (++i23 < 1) {
                        ...
                        i3 += (((i23 * i1) + i1) - Test.instanceCount);
        ...
        FuzzerUtils.out.println("Test.dFld bFld lFld = " + Double.doubleToLongBits(Test.dFld) + "," + (bFld ? 1 : 0) +
            "," + lFld);
