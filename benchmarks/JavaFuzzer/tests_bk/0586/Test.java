...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.lArrFld1, 7L);
    }
    ...
    public static int iMeth(int i4, float f1) {
        ...
        short s=-2835;
        int i5=-214, i6=-34688, i7=43275, i8=103, i9=226, iArr[]=new int[N], iArr1[][]=new int[N][N];
        float f2=-9.558F;
    ...
    public static void vMeth(int i3) {
        ...
        int i10=227, i11=-33631, i12=200, i13=18874, i14=102, i15=-160, i16=-32929, iArr2[]=new int[N];
        byte by=68;
        ...
        fArr[(-32 >>> 1) % N] = (Test.instanceCount -= iMeth(i3, Test.fFld));
        for (i10 = 24; 392 > i10; i10++) {
            for (i12 = 5; i10 < i12; i12--) {
                i11 = 39;
                Test.lArrFld1[i12 + 1] = 3;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=22792, i1=13, i18=14, i19=26532, i20=6164, i21=-13360, iArr3[]=new int[N];
        double d=0.46830, d1=-1.18001;
        byte by1=85;

        FuzzerUtils.init(iArr3, -58630);

        Test.instanceCount = (long)((Math.abs(i) - (Test.instanceCount + d)) * ((i + Test.instanceCount) - d));
        for (d1 = 10; d1 < 207; d1++) {
            ...
            case 33:
                ...
                if (b1) {
                    ...
                    for (i18 = 3; i18 < 63; ++i18) {
                        for (i20 = 1; i20 < 2; i20++) {
                            i1 += (((i20 * Test.instanceCount) + i17) - i);
                            switch (((i20 % 10) * 5) + 41) {
                            case 76:
                                Test.fFld = i1;
                                break;
