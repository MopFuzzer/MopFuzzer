...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -35538);
        FuzzerUtils.init(Test.fArrFld, 0.470F);
    }
    ...
    public static void vMeth() {
        ...
        double d=0.117766, dArr[]=new double[N];
        ...
        i2 &= i2;
        dArr[(i2 >>> 1) % N] += Math.abs((int)((--Test.instanceCount) + (Test.instanceCount - Test.byFld)));
        i2 = i2;
        for (i3 = 159; 6 < i3; --i3) {
            Test.iArrFld[i3] -= (int)(Test.iArrFld[i3 - 1] + -1.133F);
            i2 += (int)(i2 + (Test.iArrFld[i3 + 1] * (Test.instanceCount - i4)));
    ...
    public static int iMeth() {
        ...
        float f=0.740F, fArr2[]=new float[N];
        byte by=-122;
        short s=-2228;

        FuzzerUtils.init(fArr2, 0.249F);

        Test.dFld += Test.iArrFld[(i >>> 1) % N];
        i += (int)(((Test.instanceCount - f) - (i1 >>> by)) - (~(i1 + i1)));
        vMeth();
        ...
        for (i15 = 15; 259 > i15; ++i15) {
            for (i17 = 1; i17 < 7; i17++) {
                for (i19 = 1; 2 > i19; i19 += 2) {
                    ...
                    try {
                        i20 = (-1177746741 % i1);
                        Test.iArrFld[i19 + 1] = (i16 / i19);
                        i1 = (-23300 / i15);
                    } catch (ArithmeticException a_e) {}
                    s -= (short)Test.instanceCount;
                    Test.iArrFld[i15] -= i20;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i21 = 12; i21 < 236; ++i21) {
            ...
            for (i23 = 7; i23 < 112; i23++) {
                Test.iArrFld = FuzzerUtils.int1array(N, (int)-231);
                Test.iArrFld[i23] <<= (int)-8397626779875455734L;
                try {
                    i22 = (iFld / i22);
                    i22 = (iFld / i21);
                    i24 = (Test.iArrFld[i21 + 1] % -389249540);
                } catch (ArithmeticException a_e) {}
            }
        }
