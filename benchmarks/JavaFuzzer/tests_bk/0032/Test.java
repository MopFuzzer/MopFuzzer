...
public class Test {
        ...
        case 50:
            for (i3 = 5; i3 < 393; i3 += 2) {
                ...
                case 70:
                    ...
                    break;
                case 71:
                    Test.byArrFld[i3] += (byte)Test.instanceCount;
                    break;
                case 72:
        ...
        do {
            ...
            if (Test.bFld) {
                for (i7 = 6; i7 > 1; --i7) {
                    ...
                    case 120:
                        try {
                            Test.iArrFld[i7 + 1][i1 + 1] = (i1 % i10);
                            Test.iArrFld[i1 - 1][i1 + 1] = (i7 / 47842);
                            i8 = (Test.iArrFld[i1 - 1][i7] / -5179);
                        } catch (ArithmeticException a_e) {}
                        break;
                    case 121:
                        Test.iArrFld[i7 - 1][i1 + 1] = (int)l;
                        break;
                    case 122:
                        i10 -= i8;
                        break;
    ...
    public static void vMeth(byte by) {
        ...
        vMeth1(Test.instanceCount, i11, 2.113029);
        Test.sFld += (short)99.677F;
        Test.lArrFld[(i11 >>> 1) % N] -= Test.instanceCount;
        i11 += (int)Test.instanceCount;
        for (i12 = 5; i12 < 329; ++i12) {
            for (i14 = 1; i14 < 5; ++i14) {
                Test.iArrFld[i14][i14] = i14;
                for (i16 = 1; i16 < 2; ++i16) {
                    i15 <<= -2;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test.byFld = (byte)Math.abs(Test.instanceCount);
        vMeth(Test.byFld);
        Test.lArrFld[(i19 >>> 1) % N] = Test.instanceCount;
        for (d4 = 12; 213 > d4; ++d4) {
            Test.sFld += (short)8155771902413320791L;
            i20 = i20;
            i20 >>= 233;
        ...
        for (i21 = 7; i21 < 304; ++i21) {
            ...
            for (i23 = 2; 85 > i23; i23 += 3) {
                ...
                Test.dFld *= i24;
                try {
                    Test.iArrFld[i21 + 1][i21 - 1] = (21 / i20);
                    i20 = (-760327763 / Test.iArrFld[i21 + 1][i21 + 1]);
                    i24 = (i20 % i25);
                } catch (ArithmeticException a_e) {}
                i24 -= i22;
                for (i26 = 1; i26 < 4; ++i26) {
                    i22 = (int)Test.instanceCount;
                    sArr[i21 - 1] >>>= Test.sFld;
                }
                i20 += i19;
                i24 = 217;
            }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.byFld Test.bFld = " + Test.instanceCount + "," + Test.byFld +
            "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test.sFld Test.dFld Test.byArrFld = " + Test.sFld + "," +
