...
public class Test {
    ...
    public static void vMeth1(int i3, int i4) {
        ...
        int i5=-188, i6=-56578, i7=6, i8=-14, i9=-76, i10=2908, i13=-6182, iArr[]=new int[N];
        short s=13877;
        float f=0.9F;
        byte by=25;
        double d=-115.15361, dArr[][]=new double[N][N];
        boolean b=false;
        ...
        for (i5 = 16; i5 < 384; i5++) {
            ...
            case 48:
                Test.instanceCount *= Test.instanceCount;
            case 49:
                Test.instanceCount += (((i5 * Test.instanceCount) + i9) - i3);
                break;
            case 50:
                Test.iFld |= i4;
            case 51:
            ...
            case 92:
                iArr[i5 + 1] *= (int)Test.instanceCount;
            case 93:
                dArr[i5 - 1][i5 + 1] -= Test.instanceCount;
                break;
            case 94:
                by *= (byte)88;
            case 95:
    ...
    public static int iMeth() {
        ...
        double d1=-2.13740, dArr1[]=new double[N];
        int i15=91, i16=-55189, iArr1[]=new int[N];
        boolean b1=true;
        ...
        for (int i14 : iArr1) {
            ...
            for (i15 = 1; i15 < 4; i15++) {
                ...
                if (b1) break;
                iArr1[i15 - 1] -= (int)d1;
                Test.instanceCount += 45719;
                s1 -= (short)i14;
                b1 = b1;
                try {
                    i16 = (i16 / i14);
                    Test.iFld = (i16 % -96);
                    i14 = (iArr1[i15 + 1] % Test.iFld);
    ...
    public void vMeth(int i1, long l) {
        ...
        int i2=-10, i17=-26592, i18=-5, i19=-8, i20=2, i21=37473, iArr2[]=new int[N];
        float f1=36.720F;
        boolean b2=true;
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            do {
                for (i23 = 1; i23 < 1; i23 += 3) {
                    ...
                    Test.iFld += (i23 - f2);
                    try {
                        Test.iFld = (i / -1353931754);
                        iArrFld[i][i - 1] = (i % Test.iFld);
                        iArrFld[i23 + 1][i - 1] = (166564632 % i);
                    } catch (ArithmeticException a_e) {}
                    i24 += (int)Test.instanceCount;
                    i24 = i22;
                    i24 >>= 2;
                    iArrFld[i22 + 1][i23 + 1] = Test.iFld;
                    switch (((i % 10) * 5) + 21) {
                    case 62:
                        Test.iFld += (-23 + (i23 * i23));
                    case 23:
                        Test.iFld = (int)f2;
                        i24 *= i23;
                    ...
                    case 71:
                        ...
                        break;
                    case 68:
                        Test.instanceCount <<= -40529;
                        break;
                    case 22:
                        Test.iFld *= 149;
                        break;
                    default:
                        Test.iFld += (((i23 * i23) + i23) - i);
                    }
                }
            } while (--i22 > 0);
        } while (--i > 0);
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld sFld = " + Test.instanceCount + "," + Test.iFld + "," +
            sFld);
        FuzzerUtils.out.println("Test.dFld byFld Test.bFld = " + Double.doubleToLongBits(Test.dFld) + "," + byFld + ","
            + (Test.bFld ? 1 : 0));
