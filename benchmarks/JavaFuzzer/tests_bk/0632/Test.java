...
public class Test {
    ...
    public static void vMeth1(int i4) {
        ...
        boolean b2=false;
        float f3=-68.777F, fArr[]=new float[N];

        FuzzerUtils.init(fArr, 0.634F);

        Test.iArrFld[(i4 >>> 1) % N] -= (int)lMeth();
        fArr = fArr;
        i8 = (int)Test.instanceCount;
        Test.iArrFld[(i8 >>> 1) % N] -= i9;
        fArr[(Test.iFld >>> 1) % N] = i4;
        for (int i10 : Test.iArrFld) {
            for (d = 1; d < 4; d++) {
                ...
                case 59:
                    ...
                    break;
                case 60:
                    i9 += (int)((long)d ^ Test.instanceCount);
                case 61:
                    for (i12 = 2; i12 > 1; --i12) {
                        f3 = Test.instanceCount;
                        Test.iArrFld[(int)(d)] = 32978;
                        Test.iFld += (((i12 * i12) + f3) - Test.instanceCount);
                    }
                    break;
                }
            }
    ...
    public static void vMeth(int i3) {
        ...
        int i14=143, i15=167, iArr[]=new int[N];
        short s=19670;
        ...
        f = 1;
        do {
            i3 += (int)(Test.instanceCount + ((i3 - i3) + (i3 - i3)));
            b = (b = (bArr[(int)(f + 1)] ^ b));
            i3 += (int)f;
            Test.instanceCount += (long)(i3 - ((f - -13043) - Test.instanceCount));
            f1 *= iArr[(int)(f)];
            vMeth1(Test.iFld);
            for (i14 = 1; i14 < 5; ++i14) {
                try {
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++i18 < 136) {
            ...
            for (i19 = i18; i19 < 184; i19++) {
                ...
                case 59:
                    try {
                        Test.iArrFld[i19] = (i19 / 1191321622);
                        i20 = (133 / i1);
                        i1 = (i20 / Test.iArrFld[i18]);
                    } catch (ArithmeticException a_e) {}
                    break;
                case 60:
