...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.lArrFld, 3533246830913377699L);
    }
    ...
    public static int iMeth1(double d1, float f) {
        ...
        for (f1 = 15; 285 > f1; f1++) {
            ...
            Test.iArrFld[(int)(f1 + 1)] -= Test.byFld;
        }
    ...
    public static int iMeth(int i3, double d) {
        ...
        for (i4 = 6; i4 < 347; i4++) {
            ...
            i3 = 5;
            try {
                Test.iArrFld[i4 - 1] = (i4 % 784445752);
                i3 = (i4 / i3);
                Test.iFld = (Test.iFld % -26913);
            } catch (ArithmeticException a_e) {}
    ...
    public static void vMeth(int i) {
        ...
        int i1=41710, i2=-236, i13=11247, i14=13, i15=0, i16=162, iArr[]=new int[N];
        byte by=-15;
        float f3=49.546F;
        double d2=-1.21537;
        boolean b=false;
        ...
        for (i1 = 3; 376 > i1; ++i1) {
            ...
            case 97:
                i2 = iArr[i1 + 1];
                if (b) {
                    by >>= (byte)(iMeth(i1, 1.104574) * Test.instanceCount);
                    for (i13 = 1; i13 < 5; i13++) {
                        if (b) {
                            for (i15 = 1; 2 > i15; i15++) {
