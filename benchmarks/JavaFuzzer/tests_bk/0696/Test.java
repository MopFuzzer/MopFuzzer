...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.iArrFld1, -47025);
    }
    ...
    public static void vMeth1(long l2) {
        ...
        int i8=5, i9=63987, i10=43510, i11=-109, i12=-52712, i13=-2, iArr[]=new int[N];
        double d=1.38284;
        byte by=112;
        float f=80.405F;
        boolean b=false;
        ...
        for (i8 = 327; i8 > 2; i8 -= 3) {
            lArr[i8] >>= l2;
            i9 += (int)52870L;
            Test.sFld -= (short)-4082537588992825735L;
            Test.sFld = (short)224;
    ...
    public static void vMeth(int i3, long l1, int i4) {
        ...
        int i5=48363, i6=-8, i7=9673, i14=60542, i15=13, i16=-19958, i17=-34931, iArr1[]=new int[N];
        short s=-32351, sArr[]=new short[N];
        ...
        i3 ^= i4;
        for (i5 = 395; i5 > 1; --i5) {
            i3 += (((i5 * Test.instanceCount) + s) - i6);
            Test.instanceCount += (-6256168374914346839L + (++Test.instanceCount));
            i7 = 1;
            while (++i7 < 4) {
                l1 <<= (i4++);
            }
    ...
    public static int iMeth(long l) {
        ...
        while ((i -= 2) > 0) {
            for (i1 = 1; i1 < 21; i1++) {
                ...
                i2 += (i1 * i1);
                Test.lFld >>= -6300843998461327517L;
            }
        }
        Test.iArrFld[(-59911 >>> 1) % N][(i19 >>> 1) % N] = Test.byFld;
    ...
    public void mainTest(String[] strArr1) {
        ...
        dFld = iMeth(Test.lFld);
        iFld = iFld;
        Test.fFld = iFld;
        if (false) {
            Test.iArrFld[(iFld >>> 1) % N][(-13454 >>> 1) % N] <<= (int)Test.lFld;
            iFld = iFld;
        }
        dArr1[(iFld >>> 1) % N] = Test.fFld;
        iFld >>>= iFld;
        dFld = iFld;
        iFld >>= Test.sFld;
        for (int i20 : Test.iArrFld1) {
            try {
                iFld = (Test.iArrFld[(i20 >>> 1) % N][(i20 >>> 1) % N] / i20);
                iFld = (iFld % 1451008051);
                i20 = (i20 / iFld);
            } catch (ArithmeticException a_e) {}
            i20 = iFld;
            Test.iArrFld1[(6 >>> 1) % N] = iFld;
            i20 = Test.sFld;
        ...
        FuzzerUtils.out.println("Test.byFld Test.lFld iFld = " + Test.byFld + "," + Test.lFld + "," + iFld);
