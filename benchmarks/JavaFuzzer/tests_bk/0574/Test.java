...
public class Test {
        ...
        for (d1 = 353; d1 > 12; d1 -= 3) {
            ...
            for (i10 = 1; i10 < 14; i10++) {
                ...
                for (i12 = 1; 2 > i12; i12 += 2) {
                    ...
                    case 108:
                        by += (byte)(i12 + i13);
                        Test.fFld += (((i12 * Test.fFld) + Test.instanceCount) - i1);
                    case 109:
                        i1 += i12;
                        Test.iArrFld[i12 - 1] = Test.iArrFld[i12];
                        break;
                    case 110:
                        Test.instanceCount += (((i12 * Test.instanceCount) + i12) - i1);
                        break;
                    case 111:
                        Test.instanceCount += (((i12 * Test.instanceCount) + i8) - i8);
                        break;
                    case 112:
    ...
    public static void vMeth(double d, int i) {
        ...
        int i14=24615, i15=14932, i16=205, i17=-201, i18=13, i19=-240, iArr[]=new int[N];
        ...
        for (i14 = 1; i14 < 342; ++i14) {
            for (i16 = 1; 5 > i16; ++i16) {
                ...
                i17 += i14;
                i += (i16 * Test.instanceCount);
                i -= i16;
                for (i18 = 1; i18 < 2; i18++) {
                    Test.instanceCount += (((i18 * i14) + i18) - i);
                    Test.instanceCount += (165L + (i18 * i18));
                    i17 *= i18;
                    Test.iArrFld[i18 + 1][(159 >>> 1) % N] += i18;
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            ...
            i24 = 1;
            do {
                Test.iArrFld[i23 - 1][i24 + 1] += i22;
                i20 += i24;
                Test.fFld += ((long)i24 ^ (long)i21);
                for (l1 = 1; l1 > 1; --l1) {
        ...
        for (i26 = 4; i26 < 232; i26++) {
            ...
            Test.iArrFld[i26 - 1][i26] -= (int)Test.fFld;
