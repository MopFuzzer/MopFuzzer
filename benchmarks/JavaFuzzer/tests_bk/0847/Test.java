...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.dArrFld, 1.53196);
    }
    ...
    public static void vMeth1(long l, int i5) {
        ...
        Test.instanceCount -= -5606495443288404158L;
            ...
            case 124:
                ...
                while ((i7 += 3) < 4) {
                    ...
                    while (--i8 > 0) {
                        ...
                        i6 += (-61406 + (i8 * i8));
                        f *= i8;
                        Test.instanceCount >>= 5594105322978972480L;
                    }
                    i5 += i6;
                    i5 >>= i5;
                }
    ...
    public static void vMeth(int i3, int i4) {
        ...
        int i9=-7, i10=3, i11=0, i12=-11, i13=63406, iArr[]=new int[N];
        boolean b=false;
        short s=-15182;
        byte by=38;
        ...
        for (i14 = 18; i14 < 383; i14++) {
            ...
            case 111:
                ...
                for (i16 = 5; i16 > 1; --i16) {
                    for (i18 = 1; i18 < 2; i18++) {
                        Test.fFld += (i18 - i17);
                        i15 += (((i18 * i15) + Test.instanceCount) - i18);
                        s1 += (short)(i18 + i19);
                        i17 += (i18 * i18);
