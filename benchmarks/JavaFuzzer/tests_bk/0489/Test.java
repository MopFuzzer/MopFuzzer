...
public class Test {
    ...
    public static void vMeth2(int i7) {
        ...
        double d2=0.6659;
        float f1=48.149F, fArr[]=new float[N];
    ...
    public static void vMeth1(int i2) {
        ...
        short s1=29160, s2=-23703, sArr1[][]=new short[N][N];
        double d1=-126.82532;
        long l=-114L;
        ...
        for (i3 = 6; i3 < 172; i3++) {
            for (i5 = 1; i5 < 10; ++i5) {
                try {
                    i6 = (i3 % Test.iArrFld[i5 - 1]);
                    Test.iArrFld[i3] = (i2 % i3);
                    i2 = (-370009917 % i4);
                } catch (ArithmeticException a_e) {}
                i6 *= (int)(s1 ^= (short)(Math.sqrt(d1) * i2));
                Test.byFld <<= (byte)((--Test.instanceCount) - ((Test.instanceCount + i4) - Float.intBitsToFloat(i5)));
                i2 += (i5 | i5);
                i2 += i2;
                d1 = (sArr1[i5][i3]++);
                d1 += i6;
                Test.instanceCount += (-4965949938442315407L + (i5 * i5));
            }
            l <<= Test.iArrFld[i3 + 1];
            vMeth2(i3);
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=4;
        double d=2.79980, dArr[]=new double[N];
        ...
        for (short s : sArr) {
            try {
                Test.iArrFld[(i >>> 1) % N] = (-1775 % Test.iArrFld[(i >>> 1) % N]);
                i = (26746 % i);
                i = (880376200 % i);
            } catch (ArithmeticException a_e) {}
            i >>>= (i++);
            ...
            try {
                Test.iArrFld[(i >>> 1) % N] = (-45127 / i);
                i = (0 / i);
                Test.iArrFld[(i >>> 1) % N] = (i % -42167);
            } catch (ArithmeticException a_e) {}
            dArr[(i >>> 1) % N] *= d;
            vMeth();
            Test.iFld = i;
