...
public class Test {
    ...
    public static void vMeth(double d, int i) {
        ...
        b = bMeth((int)((Test.iArrFld[(i >>> 1) % N]--) - Long.reverseBytes(Test.instanceCount)));
            ...
            case 83:
                for (i8 = i6; i8 < 5; ++i8) {
                    ...
                    case 3:
                        ...
                        Test.iArrFld[i6 + 1] += (int)-3450270674L;
                        i5 = i8;
                        i10 = 1;
                        while (++i10 < 1) {
                            Test.instanceCount = (long)1.630F;
    ...
    public void mainTest(String[] strArr1) {
        ...
        byte by=70;
        float f1=0.608F, fArr[]=new float[N];
        boolean b1=false;
                ...
                for (i11 = 6; i11 < 108; i11++) {
                    ...
                    case 72:
                        ...
                        for (i13 = 2; 1 < i13; i13 -= 3) {
                            ...
                            f1 -= -13;
                            i12 = i11;
                            Test.iArrFld[i13 + 1] -= (int)d1;
                            i14 += (((i13 * i12) + i3) - i3);
                            f1 += -7;
                        }
                        Test.iArrFld[i11] = (int)-78.47F;
                        break;
                    case 58:
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.sFld Test.iArrFld = " + Test.instanceCount + "," + Test.sFld +
