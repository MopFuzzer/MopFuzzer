...
public class Test {
    ...
    public static void vMeth1() {
        ...
        Test.instanceCount = (long)(((i4++) + (i4 - d1)) - Test.iArrFld[(i4 >>> 1) % N]);
    ...
    public static long lMeth(int i5) {
        ...
        vMeth2(f1, Test.instanceCount, i5);
        for (i17 = 8; i17 < 258; ++i17) {
            for (i19 = 1; i19 < 7; i19++) {
                i18 -= (int)f1;
                i18 = i5;
                Test.instanceCount <<= 2311538589766362090L;
                Test.instanceCount = Test.instanceCount;
                i5 += (int)Test.instanceCount;
                i18 += (i19 ^ Test.instanceCount);
                i20 = (int)f1;
                try {
                    i18 = (i18 / Test.iArrFld[i17 + 1]);
                    i5 = (i19 % -1562108408);
                    i20 = (i20 % i5);
    ...
    public void vMeth(long l) {
        ...
        int i2=5, i3=132, i23=-386, i24=-1, iArr[]=new int[N];
        short s=8981;
        byte by1=-27;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f2=70.122F, fArr1[]=new float[N];
        ...
        for (i = 15; i < 286; ++i) {
            ...
            for (i26 = 93; i26 > 2; --i26) {
                ...
                case 84:
                    f2 *= i28;
                    i27 += (((i26 * i28) + i1) - Test.instanceCount);
                    i27 += -28506;
                    bArr1[i26 + 1] = true;
                    break;
                case 85:
                    i28 += i26;
                    Test.instanceCount += (long)-2.477F;
                    i1 <<= (int)Test.instanceCount;
                    i1 = (int)f2;
                    break;
                }
                fArr1[i26 + 1] *= Test.instanceCount;
                s2 += (short)d2;
                iFld += i27;
        ...
        FuzzerUtils.out.println("Test.instanceCount iFld Test.iArrFld = " + Test.instanceCount + "," + iFld + "," +
