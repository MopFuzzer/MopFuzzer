...
public class Test {
    ...
    public static int iMeth1(float f1) {
        ...
        int i4=-213, i5=6, i6=-37245, i7=-140, i8=45400, iArr1[]=new int[N];
        short s1=19864;
        double d2=0.89469;
    ...
    public static void vMeth(long l1, int i2, long l2) {
        ...
        double d1=77.86406;
        int i3=13, i10=10, i11=35, i12=-24737, iArr[]=new int[N];
        short s=15178;
        byte by=114;
        ...
        for (d1 = 6; d1 < 221; d1++) {
            ...
            s += (short)(((i2 - Test.fFld) - (Test.instanceCount += i3)) - ((--lArr[(int)(d1 + 1)]) + (i3 - l1)));
            iArr[(int)(d1 + 1)] |= iMeth1(Test.fFld);
            switch ((int)((d1 % 1) + 80)) {
            case 80:
                try {
                    i2 = (-33 / i2);
    ...
    public static int iMeth(float f, int i1, long l) {
        ...
        int i13=70, i14=-8692, i15=14, i16=-6795, i17=-8016, i18=-9, iArr2[]=new int[N];
        boolean b=true;

        FuzzerUtils.init(iArr2, -14);

        vMeth(Test.instanceCount, i1, 4157298658L);
        i1 = i1;
        l -= i1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d=11.41736;
        int i=-52116, i19=0, i20=240, i21=254, i22=245, i23=-1, i24=209, iArr3[]=new int[N];
        short s2=-27622;
        ...
        for (d = 3; d < 161; ++d) {
            i += iMeth(Test.fFld, i, Test.instanceCount);
            byFld -= (byte)i;
            ...
            while (++i22 < 159) {
                ...
                switch (((i22 % 4) * 5) + 14) {
                case 20:
                    i += (((i22 * Test.instanceCount) + i21) - Test.instanceCount);
                case 19:
                    i = i21;
                    break;
                case 26:
