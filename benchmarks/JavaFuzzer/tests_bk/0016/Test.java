...
public class Test {
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=47455, i1=193, i2=-63606, i3=3813, i13=8, iArr[]=new int[N];
        boolean b2=true;
        float f3=2.782F, fArr[]=new float[N];
        double d2=-103.88525;
        ...
        for (i = 14; 304 > i; ++i) {
            for (i2 = 87; i < i2; --i2) {
                vMeth(b2);
                for (f3 = 1; f3 < 1; f3++) {
                    Test.instanceCount -= (long)101.87476;
                    bArrFld[i + 1] = false;
                    iFld1 = -15635;
                    switch ((((i3 >>> 1) % 7) * 5) + 67) {
                    case 82:
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.byFld Test.iFld = " + Test.instanceCount + "," + Test.byFld +
            "," + Test.iFld);
        FuzzerUtils.out.println("Test.fFld iFld1 sFld = " + Float.floatToIntBits(Test.fFld) + "," + iFld1 + "," + sFld);
