...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -2005190906927398604L);
        FuzzerUtils.init(Test.iArrFld, -141);
        FuzzerUtils.init(Test.dArrFld, -125.12507);
        FuzzerUtils.init(Test.fArrFld, 1.533F);
    }
    ...
    public static int iMeth1() {
        ...
        Test.instanceCount = (Test.lArrFld[(Test.iFld >>> 1) % N] = Test.instanceCount);
        vMeth();
        ...
        Test.iArrFld[(i16 >>> 1) % N] -= (int)-58.1014F;
        i16 = by1;
    ...
    public static int iMeth(int i) {
        ...
        for (i1 = 16; i1 < 350; i1++) {
            ...
            for (i3 = 1; i3 < 5; ++i3) {
                ...
                case 115:
                    iMeth1();
                    i += (((i3 * Test.instanceCount) + Test.fFld) - i19);
                    Test.iFld += (((i3 * s) + i4) - Test.instanceCount);
                    break;
                case 146:
                    Test.fFld /= 29;
                    fArr[i1 + 1] = i19;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i22 = 4; 138 > i22; i22++) {
            i23 = Test.iFld1;
            Test.iFld += (((i22 * Test.iFld1) + Test.instanceCount) - Test.iFld);
            i23 -= (int)-43.66210;
        ...
        for (i25 = 5; 190 > i25; i25++) {
            ...
            for (i27 = 8; i27 < 136; ++i27) {
                i23 = i25;
                Test.iArrFld[i27] = Test.byFld;
                for (i29 = 1; i29 < 2; i29++) {
                    Test.dArrFld[i25 - 1] += Test.dFld;
                    Test.dFld += Test.dFld;
                }
                i28 &= Test.iFld1;
                i28 |= i22;
        ...
        try {
            Test.dFld += Test.fFld;
            for (int i31 : Test.iArrFld) {
                for (i32 = 63; i32 > 1; i32--) {
                    Test.fArrFld[i32] *= i25;
                    Test.dFld -= i25;
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.bFld = " + Test.instanceCount + "," + Test.iFld +
            "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test.fFld Test.iFld1 Test.byFld = " + Float.floatToIntBits(Test.fFld) + "," +
