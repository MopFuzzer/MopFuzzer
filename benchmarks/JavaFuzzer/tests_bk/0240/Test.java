...
public class Test {
    ...
    public static void vMeth1(int i3) {
        ...
        int i11=6, i12=9, iArr[]=new int[N];
        boolean b=true;

        FuzzerUtils.init(iArr, -21641);

        vMeth2(i3, i3, Test.instanceCount);
        i11 *= -4549;
        i11 *= i3;
        i3 += (int)-104.84169;
        i12 = 1;
    ...
    public void vMeth(int i, int i1, int i2) {
        ...
        i14 ^= i;
        Test.instanceCount >>= 6965092739739961255L;
        ...
        try {
            for (i20 = 8; i20 < 293; ++i20) {
                for (i22 = 88; i22 > i20; i22--) {
                    by1 += (byte)(((i22 * Test.instanceCount) + i18) - i20);
                    f = 1;
                    do {
                        lArr[i20 - 1][i22 - 1] += 14;
                        i21 -= i21;
                        Test.instanceCount += (long)(((f * f) + f) - i23);
                        i18 = i18;
                    } while (++f < 1);
                    i24 = 1;
                    while (++i24 < 1) {
