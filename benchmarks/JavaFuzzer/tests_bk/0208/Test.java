...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)-19026);
    }
    ...
    public static int iMeth(int i15) {
        ...
        int i16=58652, i17=3, i18=-4546, i19=-14, i20=-2, iArr1[]=new int[N];
        byte by2=46;
        float f4=-1.663F;
        short s=-13097;
        boolean b=false, bArr[]=new boolean[N];
        long l1=52113L, l2=1805695501805421945L, lArr[]=new long[N];
                    ...
                    case 113:
                        ...
                        case 82:
                            ...
                            case 97:
                                ...
                                break;
                            case 101:
                                Test.instanceCount = (long)-2.632F;
                                break;
                            case 100:
                                i16 = (int)d1;
                                break;
    ...
    public static void vMeth1(int i10) {
        ...
        int i11=37314, i13=-19385, i14=48379, i21=-12, i22=-10, iArr[]=new int[N];
        double d=-2.54549, d2=-20.88906, dArr[]=new double[N];
        byte by1=83;
        float f3=2.66F;
        boolean b1=true;
        ...
        switch (((((int)(-(--Test.instanceCount))) >>> 1) % 3) + 58) {
        case 58:
            for (int i12 : iArr) {
                for (i13 = 1; i13 < 4; i13++) {
                    by1 += (byte)(((i13 * i14) + Test.instanceCount) - f3);
                    i14 += (i13 * i13);
                    d *= (i11 + iMeth(i14));
                    d += i13;
                }
    ...
    public static void vMeth(int i3, int i4, long l) {
        ...
        int i5=29840, i6=-19774, i7=113, i8=5, i9=8, iArr2[][]=new int[N][N], iArr3[]=new int[N];
    ...
    public void mainTest(String[] strArr1) {
            ...
            for (f = 7; f < 142; ++f) {
                ...
                case 60:
                    ...
                    while ((i27 += 2) < 2) {
                        ...
                        s1 += (short)i25;
                        i26 -= Test.iFld1;
                        f5 += (((i27 * i26) + Test.iFld1) - Test.iFld1);
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.byFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.byFld);
        FuzzerUtils.out.println("Test.bFld Test.iFld1 iArrFld = " + (Test.bFld ? 1 : 0) + "," + Test.iFld1 + "," +
