...
public class Test {
    ...
    public static void vMeth1() {
        ...
        for (i9 = 174; i9 > 6; --i9) {
            Test.iFld >>>= (int)Test.instanceCount;
            for (f3 = 1; f3 < 9; ++f3) {
                Test.iArrFld1[i9 + 1] = (int)86.41779;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test.dFld += (Test.iFld += (int)((Test.instanceCount + Test.instanceCount) - (-3 - (6 + iArrFld[(Test.iFld >>>
            1) % N][(-64957 >>> 1) % N]))));
        vMeth(11, f4);
        ...
        for (d = 180; d > 4; --d) {
            ...
            do {
                ...
                for (i27 = (int)(d); i27 < 1; i27++) {
                    if (b1) continue;
                    switch (((Test.iFld >>> 1) % 5) + 36) {
                    case 36:
                        i23 = i23;
                        break;
                    case 37:
                        dArrFld[i26 - 1] *= 165;
                        Test.iArrFld1[(int)(d)] >>= -29598;
                        break;
                    case 38:
