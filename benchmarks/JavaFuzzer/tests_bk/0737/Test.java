...
public class Test {
    ...
    public static float fMeth(int i5, boolean b) {
        ...
        long l=-4002142540L;
        int i6=-189, i7=-56665, i8=-130, i9=30775, iArr1[]=new int[N];
        short s=-28619;
        float f=80.548F;
        ...
        for (l = 8; l < 261; l++) {
            for (i7 = 1; i7 < 6; i7++) {
                ...
                do {
                    if (b) {
                        Test.instanceCount += -12352;
                        s += (short)i9;
                    } else if (b) {
                        i8 = -162;
                        dArr1[i9 + 1] += Test.instanceCount;
                        if (b) break;
                    } else if (b) {
                        b = b;
                        i5 = (int)-217L;
    ...
    public static void vMeth() {
        ...
        for (i3 = 14; 397 > i3; ++i3) {
            ...
            for (i10 = i3; i10 < 4; i10++) {
                ...
                if (b1) continue;
                for (i12 = 1; i12 < 1; ++i12) {
                    Test.instanceCount += (((i12 * f1) + i4) - i13);
                    b1 = b1;
                    f1 = (float)0.35905;
                }
            }
    ...
    public long lMeth() {
        ...
        int i1=6, i2=56086, i14=19406, i15=-25746, iArr2[]=new int[N];
        short s1=-13756;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=94, i17=-12, i18=-13, i19=-29778, i20=109, i21=-2, i22=173, i23=-59433, iArr[]=new int[N];
        ...
        while (--i17 > 0) {
            ...
            for (i18 = 6; i18 < 183; ++i18) {
                ...
                while (++i20 < 2) {
                    ...
                    dFld = 12;
                    i >>= i;
                    Test.instanceCount += (((i20 * i19) + i18) - Test.instanceCount);
                    try {
