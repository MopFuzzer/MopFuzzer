...
public class Test {
        ...
        for (i10 = 7; 135 > i10; i10 += 3) {
            for (i12 = 1; 36 > i12; ++i12) {
                ...
                while (--f3 > 0) {
                    ...
                    case 109:
                        try {
                            Test.iArrFld[i10 + 1] = (Test.iFld % -29);
                            i11 = (-72 % i11);
                            Test.iArrFld[i10] = (-163 % Test.iArrFld[(i12 >>> 1) % N]);
    ...
    public static void vMeth(float f1) {
        ...
        int i1=-59570, i2=10, i3=-127, i4=36282, i5=-1, i6=-237, i7=2, iArr[]=new int[N];
        byte by1=-33;
        double d1=-2.47957;
        ...
        i1 = 1;
        while (++i1 < 267) {
            Test.instanceCount += (((i1 * i1) + Test.iFld) - Test.instanceCount);
            for (i2 = 1; i2 < 6; ++i2) {
                try {
                    iArr[i2 - 1] = (Test.iFld % 1520000290);
                    Test.iFld = (Test.iFld / 19168);
                    iArr[i2 + 1] = (Test.iFld % 151);
                } catch (ArithmeticException a_e) {}
                i3 = by1;
                by1 >>= by1;
                iArr = (iArr = (iArr = iArr));
        ...
        for (i4 = 2; i4 < 124; i4++) {
            for (i6 = 1; i6 < 13; ++i6) {
                sArr[i6 - 1] -= (short)iMeth(i1, (byte)(91), Test.iFld);
                i7 = i3;
                Test.iArrFld[i4] %= (int)((long)(f1) | 1);
                d1 = d1;
            }
        }
    ...
    public static long lMeth(boolean b) {
        ...
        i = 1;
        while (++i < 270) {
            Test.instanceCount += (-((by++) >>> (Test.iFld--)));
            vMeth(f4);
            Test.iFld += (-23868 + (i * i));
            f4 += (((i * i) + f4) - i);
    ...
    public void mainTest(String[] strArr1) {
                ...
                if (b2) {
                    for (i21 = 4; i21 < 104; ++i21) {
                        ...
                        default:
                            ...
                            i22 += i21;
                            try {
                                Test.iArrFld[i21 - 1] = (i20 % -60473);
                                Test.iFld = (i19 / -69);
                                Test.iFld = (i20 / Test.iArrFld[i21 - 1]);
                            } catch (ArithmeticException a_e) {}
                            d3 -= i21;
                        }
                        i19 *= i21;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.sFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.sFld);
        FuzzerUtils.out.println("lFld Test.iArrFld lArrFld = " + lFld + "," + FuzzerUtils.checkSum(Test.iArrFld) + ","
