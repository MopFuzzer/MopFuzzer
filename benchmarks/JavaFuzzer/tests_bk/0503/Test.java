...
public class Test {
    ...
    public static long lMeth1(int i4, int i5) {
        ...
        byte by=50;
        int i7=-18799, i8=13, i12=-7, iArr[]=new int[N];
        boolean b=true;
        float f1=-108.491F;
        ...
        for (int i6 : iArr) {
            Test.instanceCount *= (long)(-47.794F + ((-31722 - (i5 - by)) % ((Test.instanceCount - -36703) | 1)));
            for (i7 = 1; i7 < 4; i7++) {
                double d1=64.108813;
                by += (byte)i7;
                if (d1 != (-i8)) {
    ...
    public static long lMeth(long l, double d, float f) {
        ...
        int i=-3, i1=13, i2=2, i3=-189, i13=188, i14=60656, i15=1, iArr1[]=new int[N];
        float f2=1.450F, fArr[][]=new float[N][N];
        ...
        for (i = 11; i < 204; i += 3) {
            for (i2 = 1; i2 < 24; ++i2) {
                Test.instanceCount = Math.max((int)(lMeth1(-1, i) / -17), i3);
                i1 *= (int)l;
            }
            for (i13 = 1; 24 > i13; ++i13) {
                i14 <<= 2629;
                i3 += (((i13 * f2) + i13) - Test.instanceCount);
                l <<= -75;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i16=9, i17=-228, i18=-112, i19=-37, i20=7, i21=2, i22=232, i23=36363, i24=-7, i25=11, i26=-17, i27=72,
            i28=74, i29=-10, iArr2[]=new int[N];
        boolean b1=true;
        ...
        for (i16 = 8; i16 < 311; ++i16) {
            for (i18 = 3; i18 < 83; i18++) {
                ...
                i19 += (((i18 * i17) + i17) - Test.instanceCount);
                i19 = -11745;
            }
            i19 += (i16 * i16);
            if (b1) continue;
        ...
        for (i24 = 12; 287 > i24; i24++) {
            ...
            for (i26 = 91; i24 < i26; i26--) {
                ...
                case 88:
                    ...
                    break;
                default:
                    iFld += (((i26 * i18) + Test.instanceCount) - f4);
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test.instanceCount iFld lArrFld = " + Test.instanceCount + "," + iFld + "," +
