...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -44933L);
    }
    ...
    public static int iMeth(int i3, int i4, long l) {
        ...
        int i5=32123, i6=-79, i7=-180, i9=-12, i10=1041, iArr1[]=new int[N];
        double d=-1.66692;
        float f=1.459F;
        boolean b1=false;
        ...
        for (i5 = 6; i5 < 290; i5++) {
            d = Math.abs(i3--);
            i4 -= (int)((Test.instanceCount--) * (++Test.instanceCount));
            try {
                i3 = (i5 % -32765);
            ...
            i7 = 1;
            while (++i7 < 6) {
                Test.lArrFld[i7] = iMeth1(d, 38628L);
                for (i9 = i7; 1 > i9; i9++) {
                    i3 = i9;
                    f = i9;
                    if (i9 != 0) {
    ...
    public long lMeth(int i1, int i2) {
        ...
        int i11=56253, i12=-163, i13=-9, i14=160, i15=-24217, i16=-13, iArr2[][]=new int[N][N];
        short s=-12010;
        ...
        Test.byFld <<= (byte)iMeth(i1, i1, Test.instanceCount);
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-5, i17=34067, i18=-4, i19=-5, i20=43319, i21=35, i22=-53396, i23=-51468, i24=-12, i25=11544, i26=-50,
            i27=6175, i28=3, i29=172, iArr[]=new int[N];
        ...
        FuzzerUtils.out.println("Test.lFld Test.dFld sFld = " + Test.lFld + "," + Double.doubleToLongBits(Test.dFld) +
            "," + sFld);
