...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.fArrFld, -33.141F);
    }
        ...
        for (i2 = 6; 179 > i2; ++i2) {
            ...
            do {
                for (l = i2; 1 > l; l++) {
                    ...
                    i5 = iMeth1(-12L, f2);
                    try {
                        Test.iFld = (Test.iArrFld[(int)(l + 1)] / i3);
                        i3 = (i1 / i1);
                        i1 = (Test.iArrFld[i2 - 1] / 9423);
                    } catch (ArithmeticException a_e) {}
                    if (b1) {
                        if (i5 != 0) {
    ...
    public int iMeth(short s) {
        ...
        byte by1=-49;
        double d1=0.120587, dArr[]=new double[N];
        ...
        do {
            ...
            i += (int)f;
            vMeth(-13, by1, Test.dFld);
            for (i12 = 1; 8 > i12; i12++) {
                byArrFld[(int)(f + 1)] &= (byte)Test.instanceCount;
                i13 += (i12 * i12);
                for (d1 = i12; d1 < 2; d1++) {
                    i >>= i14;
                    i14 = by1;
                    ...
                    Test.fArrFld[(int)(f - 1)] %= (Test.instanceCount | 1);
                    dArr[(int)(d1 - 1)] = Test.iFld;
                    Test.iFld += (int)(d1 * d1);
                }
            }
        } while (--f > 0);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i15 = 4; i15 < 154; i15++) {
            for (i17 = 7; i17 < 167; i17++) {
                Test.sFld += (short)(((i17 * Test.iFld) + i18) - i18);
                Test.iArrFld = FuzzerUtils.int1array(N, (int)-95);
                for (i19 = i17; i19 < 2; i19++) {
                    i20 += (((i19 * f4) + i19) - Test.instanceCount);
                    switch ((i17 % 8) + 122) {
                    case 122:
                        ...
                        case 68:
                            ...
                            i18 = i18;
                            Test.iFld += (((i19 * f4) + Test.instanceCount) - i20);
                            break;
                        case 70:
                        case 62:
                            ...
                            case 22:
                                ...
                                break;
                            case 23:
                                Test.instanceCount += (((i19 * i15) + Test.instanceCount) - Test.instanceCount);
                    ...
                    case 129:
                        ...
                        break;
                    default:
                        Test.instanceCount = 7789920859517898276L;
                    }
                }
            }
        }
        ...
        FuzzerUtils.out.println("Test.sFld Test.bFld Test.byFld = " + Test.sFld + "," + (Test.bFld ? 1 : 0) + "," +
            Test.byFld);
        FuzzerUtils.out.println("Test.iArrFld Test.fArrFld byArrFld = " + FuzzerUtils.checkSum(Test.iArrFld) + "," +
