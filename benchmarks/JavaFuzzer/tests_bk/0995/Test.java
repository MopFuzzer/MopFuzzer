...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld1, 0.793F);
    }
    ...
    public void vMeth(double d, int i7, float f) {
        ...
        for (float f1 : fArrFld) {
            iFld = iFld;
            for (i14 = 1; i14 < 4; ++i14) {
                Test.instanceCount += (((i14 * Test.instanceCount) + Test.instanceCount) - i15);
    ...
    public int iMeth(long l) {
        ...
        do {
            for (i5 = 1; 7 > i5; ++i5) {
                ...
                i6 = i6;
                iFld = i6;
                iArrFld[i4 + 1][i5 + 1] -= (int)Test.instanceCount;
            }
            for (i16 = 1; i16 < 7; ++i16) {
                for (i18 = 1; i18 < 2; ++i18) {
                    i6 += i4;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 5; i < 171; i++) {
            for (i2 = 1; 151 > i2; i2++) {
                if ((Test.dFld + (12 - iMeth(Test.instanceCount))) > i2) break;
                Test.dFld *= i3;
                iArrFld = iArrFld;
                switch ((((i >>> 1) % 3) * 5) + 61) {
                case 64:
                ...
                case 74:
                    ...
                    for (i20 = 1; i20 < 2; ++i20) {
                        ...
                        iArrFld[i2][i2 - 1] = (int)Test.instanceCount;
                        i1 <<= i3;
                        switch ((i % 8) + 38) {
                        case 38:
                            switch ((i20 % 2) + 23) {
                            case 23:
                                i3 += (i20 * Test.instanceCount);
                                if (b) break;
                                Test.instanceCount <<= 158;
                                break;
                            case 24:
                                b = b;
        ...
        FuzzerUtils.out.println("iFld fFld Test.sFld = " + iFld + "," + Float.floatToIntBits(fFld) + "," + Test.sFld);
        FuzzerUtils.out.println("iArrFld fArrFld Test.fArrFld1 = " + FuzzerUtils.checkSum(iArrFld) + "," +
