...
public class Test {
    ...
    public static void vMeth1(int i6, short s) {
        ...
        float f3=34.438F, fArr1[]=new float[N];
        int i7=-1956, i8=16, i9=-11, i10=-12, i11=-196, iArr1[]=new int[N];
        byte by1=23;
        ...
        while (--i7 > 0) {
            for (i8 = 5; 1 < i8; i8--) {
                ...
                i6 -= 36205;
                Test.instanceCount += (-15958 + (i8 * i8));
                i9 *= s;
                Test.dFld = f3;
                for (i10 = 1; i10 < 2; ++i10) {
                    iArr1[i8] *= (int)Test.dFld;
    ...
    public static int iMeth(double d) {
        ...
        float f2=-89.888F;
        int i3=25563, i4=-6216, i5=-10, i12=16664, i13=-108, i14=5, iArr2[]=new int[N];
        byte by=-110;
        short s1=30221, sArr[]=new short[N];

        FuzzerUtils.init(sArr, (short)13301);
        FuzzerUtils.init(iArr2, 212);

        for (f2 = 3; 274 > f2; ++f2) {
            i3 += (int)Math.abs(Test.instanceCount--);
            d += 158;
            Test.instanceCount += (long)(((i3 - -60.60757) + 232) / (((long)((Test.instanceCount + f2) *
                (--sArr[(int)(f2 + 1)]))) | 1));
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=14, i1=-202, i21=-62904, i22=14, i23=5653, i24=-8, i25=-251, i26=-4, i27=14574, i28=-151, i29=-40580,
            i30=-12823, i31=31936, i32=148, i33=154, iArr[]=new int[N];
        float f4=106.697F;
        boolean b1=true;
        short s2=-31331;
                ...
                for (i27 = 106; i27 > 3; --i27) {
                    for (i29 = 1; i29 < 2; i29++) {
                        ...
                        case 50:
                            ...
                            iArr[i29] *= (int)Test.instanceCount;
                            try {
                                i31 = (i21 / i1);
                                iArr[i29 + 1] = (i26 / i31);
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.dFld Test.bArrFld = " + Test.instanceCount + "," +
