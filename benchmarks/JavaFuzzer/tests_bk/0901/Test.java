...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 0.312F);
    ...
    public static long lMeth(float f1, int i5) {
        ...
        int i6=-110, i7=-8, i8=14, i9=101, i10=253, iArr2[]=new int[N];
        long l1=10L;
        short s=-12676;
    ...
    public static int iMeth(long l) {
        ...
        int i=168, i1=-3, i2=-176, i3=41033, i4=-53468, iArr[]=new int[N], iArr1[]=new int[N];
        double d=1.77040;
        ...
        while (++i1 < 318) {
            for (i2 = 1; i2 < 5; i2++) {
                ...
                for (d = i1; d < 2; ++d) {
                    ...
                    Test.fFld -= i1;
                    i4 = (int)l;
                    Test.bFld = (bArr[i1] = (Test.bFld = (-61559 == (i * i))));
                    Test.fFld = ((Test.fArrFld[i1 - 1]++) + lMeth(Test.fFld, i2));
                }
            }
        }
    ...
    public static void vMeth() {
        ...
        f -= ((-iMeth(Test.instanceCount)) % (Test.instanceCount | 1));
    ...
    public void mainTest(String[] strArr1) {
            ...
            for (i14 = i13; 100 > i14; i14++) {
                ...
                for (i17 = 1; i17 < 1; ++i17) {
                    ...
                    case 89:
                        ...
                        break;
                    case 90:
                        Test.iArrFld[i17 + 1] = 31988;
                        break;
                    case 91:
                        Test.iArrFld[i14] = (int)Test.instanceCount;
                        break;
                    case 92:
                        i18 += (((i17 * i13) + i17) - Test.instanceCount);
                    case 93:
                        i18 >>= Test.byFld;
                        break;
                    case 94:
                        i15 += (((i17 * i16) + i15) - Test.byFld);
                        break;
                    case 95:
                        i15 += i15;
                    case 96:
                    ...
                    case 104:
                        try {
                            i15 = (1894412480 % i16);
                            i15 = (i18 / i14);
                            Test.iArrFld[i13] = (iFld % Test.iArrFld[i13]);
                        } catch (ArithmeticException a_e) {}
                        break;
                    case 105:
                    ...
                    case 138:
                        ...
                        break;
                    case 139:
                        iFld += (((i17 * Test.fFld) + i18) - Test.lFld);
                        break;
                    case 140:
                        i18 >>= s1;
                        break;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.byFld Test.bFld = " + Test.instanceCount + "," + Test.byFld +
            "," + (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test.fFld Test.dFld Test.lFld = " + Float.floatToIntBits(Test.fFld) + "," +
