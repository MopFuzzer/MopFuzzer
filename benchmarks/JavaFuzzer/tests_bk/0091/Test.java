...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -39557);
    }
    ...
    public static int iMeth() {
        ...
        i1 -= (int)(Math.min(--i1, Math.min(i1, i1)) + Long.reverseBytes((long)(i1 + Test.dFld)));
        long meth_res = i1;
    ...
    public static int iMeth1(byte by, int i6) {
        ...
        int i7=-10571, i11=19290, i12=2, iArr[]=new int[N];
        float f2=100.597F;
        double d2=0.93855;
        boolean b=true;
        ...
        iArr[(i6 >>> 1) % N] = (int)(((i7 - 239) * iArr[(i7 >>> 1) % N]) - Test.dFld);
        ...
        do {
            for (i2 = 1; i2 < 9; i2++) {
                ...
                for (i4 = (int)(d1); 2 > i4; i4++) {
                    i3 -= (int)((0.1721 - (i5--)) + ((Test.instanceCount / -29770) + (Test.instanceCount + i3)));
                    i5 -= (int)(--Test.dFld);
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (++d < 235) {
            ...
            do {
                ...
                Test.dFld += i;
                Test.dFld = Test.dFld;
                Test.iArrFld[(int)(d + 1)] %= (int)((long)(f) | 1);
            } while (++i13 < 107);
