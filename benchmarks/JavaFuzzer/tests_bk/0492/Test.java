...
public class Test {
    ...
    public static void vMeth1(long l, int i3) {
        ...
        int i4=-7, i5=-31, i6=96, i7=26416, iArr[]=new int[N];
        float f=-1.473F;
        ...
        for (i4 = 2; i4 < 231; ++i4) {
            ...
            while (++i6 < 7) {
                ...
                i5 = i5;
                i5 += (((i6 * l) + i4) - Test.instanceCount);
                d1 += i4;
                i7 = 1;
                while ((i7 += 2) < 1) {
                    Test.byFld = (byte)205L;
                    i3 += Test.iFld;
                    d2 -= i6;
                    l1 *= i6;
    ...
    public static int iMeth(int i2) {
        ...
        int i8=159, i9=8, i10=-63732, i11=48711, i12=-1, i13=-8, i14=3, iArr1[]=new int[N];
        short s=-26074;
        ...
        for (i8 = 6; i8 < 164; i8++) {
            for (i10 = 1; 10 > i10; i10++) {
                for (i12 = 1; i12 < 2; i12 += 3) {
                    float f1=0.988F;
                    i2 <<= i2;
                    Test.instanceCount += (-219 + (i12 * i12));
                    iArr1[i10] = s;
                    Test.iFld >>= i11;
                    i9 += i12;
                    i14 += (((i12 * s) + i10) - s);
    ...
    public static void vMeth(int i, int i1) {
        ...
        Test.instanceCount -= (Test.instanceCount - (Math.abs(2) + -12072));
        d *= iMeth(i1);
        if (Test.bFld) {
            for (d3 = 8; d3 < 247; d3 += 3) {
                ...
                while (--i16 > 0) {
                    d += i1;
                    i = i15;
                    Test.instanceCount += (i16 | Test.iFld);
                    i -= (int)f2;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f3=56.105F, f4=-50.43F, fArr[]=new float[N];
        double d4=-1.69881;
        short s1=-22146;
