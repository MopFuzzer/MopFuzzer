...
public class Test {
    ...
    public static void vMeth1() {
        ...
        int i5=0, i6=-96, i7=36309, i8=-10, iArr[]=new int[N];
        boolean b=true;
        long l1=82L;
    ...
    public static int iMeth(long l) {
        ...
        Test.instanceCount <<= (long)((++Test.fFld) - ((long)(Test.iFld - d) >>> (Test.instanceCount * Test.iFld)));
        for (i3 = 1; 321 > i3; i3++) {
            vMeth1();
            switch ((((Test.iFld >>> 1) % 5) * 5) + 48) {
            case 63:
                by &= (byte)Test.iFld;
                Test.bArrFld[i3] = b1;
                break;
            ...
            case 68:
                b1 = b1;
                Test.iFld += (((i3 * Test.fFld) + i4) - Test.iFld);
            case 60:
                i4 *= 19;
                break;
            }
    ...
    public static void vMeth(int i2) {
        ...
        byArr[(i2 >>> 1) % N][(i2 >>> 1) % N] = (byte)(i2 + iMeth(Test.instanceCount));
        for (d1 = 7; d1 < 180; ++d1) {
            i2 <<= s1;
            Test.fFld *= i2;
            Test.iFld -= i2;
        ...
        for (i10 = 2; i10 < 303; i10++) {
            Test.iArrFld[i10 + 1] = Test.iFld;
            Test.instanceCount += (((i10 * i2) + i10) - i10);
