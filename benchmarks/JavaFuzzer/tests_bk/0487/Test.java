...
public class Test {
    ...
    public static boolean bMeth(boolean b1, int i4) {
        ...
        int i5=-47, i6=10616, i7=7411, i8=43, i9=-9, i10=-11, iArr[]=new int[N];
        float f2=2.106F;
        short s=-26887;
        ...
        for (i5 = 7; i5 < 141; i5++) {
            for (i7 = 1; i7 < 12; i7++) {
                ...
                if (b1) {
                    for (f2 = 1; f2 < 2; ++f2) {
                        Test.lArrFld[(int)(f2 + 1)][i5 + 1] += (long)(((++iArr[(int)(f2 + 1)]) + (i5 - i8)) + (i5 /
                            (((long)(f2 * i5)) | 1)));
                        s += (short)i6;
                        i8 -= (--i8);
                    }
                    ...
                    vMeth1(b1, Test.instanceCount, i8);
                } else {
                    i9 += (((i7 * i7) + s) - i9);
                    Test.instanceCount = -25094L;
                    iArr = iArr;
                }
                iArr[i5 - 1] = i4;
                s *= (short)i5;
    ...
    public static void vMeth() {
        ...
        for (i12 = 1; i12 < 180; i12++) {
            ...
            i11 -= i14;
            Test.instanceCount += (6380L + (i12 * i12));
        }
        d1 -= Test.fFld;
        for (i15 = 1; i15 < 241; ++i15) {
            Test.lArrFld[i15][i15] += i12;
            i16 += (int)-88.784F;
