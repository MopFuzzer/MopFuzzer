...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, 262863177659983583L);
    }
    ...
    public static void vMeth(float f, long l2, int i3) {
        ...
        boolean b=true;
        int i4=31375, i5=2, i6=-11, i7=56743, i8=191, iArr[]=new int[N];
        short s1=-31610;
        byte by=100;
    ...
    public static byte byMeth(long l1, double d) {
        ...
        float f1=24.102F;
        int i9=2, i10=-8, i11=20301, i12=-14, i13=-8, i14=-46, iArr1[]=new int[N];
        double dArr[]=new double[N];

        FuzzerUtils.init(iArr1, 67);
        FuzzerUtils.init(dArr, 0.66898);

        vMeth(f1, Test.instanceCount, Test.iFld);
        iArr1[(-14 >>> 1) % N] *= (int)1.375F;
        Test.iFld = Test.iFld;
        for (i9 = 1; i9 < 164; i9++) {
            Test.sFld *= (short)Test.iFld;
            Test.instanceCount -= -253L;
            dArr[i9] = i9;
            for (i11 = 1; 10 > i11; ++i11) {
                Test.lArrFld[i11 - 1] <<= 7;
                for (i13 = 1; i13 < 2; ++i13) {
    ...
    public static int iMeth(long l, short s, int i2) {
        ...
        int i15=217, i16=-55253, i17=-36911, i18=-184, iArr2[]=new int[N], iArr3[]=new int[N];

        FuzzerUtils.init(iArr2, -188);
        FuzzerUtils.init(iArr3, -82);

        i2 = byMeth(l, d1);
        Test.lArrFld[(i2 >>> 1) % N] >>= s;
        l += Test.iFld;
        i15 = 1;
        do {
            for (d2 = 1; d2 < 9; ++d2) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            int i1=-110;
            i1 += (int)(((-155L * (i1++)) - iMeth(Test.instanceCount, Test.sFld, i)) + Test.instanceCount);
            for (i19 = i; i19 < 166; ++i19) {
                ...
                if (b1) {
                    ...
                    i20 += (((i19 * i1) + f3) - Test.instanceCount);
                    f3 += (-237 + (i19 * i19));
                } else if (b1) {
                    for (i21 = 1; 1 < i21; --i21) {
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.sFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.sFld);
        FuzzerUtils.out.println("dFld Test.lArrFld iArrFld = " + Double.doubleToLongBits(dFld) + "," +
