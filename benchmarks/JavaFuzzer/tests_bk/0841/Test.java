...
public class Test {
    ...
    public void vMeth2(float f1, int i) {
        ...
        f1 *= i;
        for (i1 = 16; 371 > i1; ++i1) {
            Test.iFld += (((i1 * byFld) + l1) - f1);
        }
        fArrFld[(Test.iFld >>> 1) % N] -= f1;
    ...
    public void vMeth1() {
        ...
        Test.iArrFld[(Test.iFld >>> 1) % N] += (byFld -= byArr[(-5 >>> 1) % N]);
        vMeth2(f2, Test.iFld);
    ...
    public void vMeth(long l, float f) {
        ...
        Test.iArrFld[(Test.iFld >>> 1) % N] *= (int)(((Test.iFld |= Test.iFld) - Long.reverseBytes(-11L)) * (Test.iFld
            *= (int)(87.561F - Test.iFld)));
        vMeth1();
        for (i8 = 128; i8 > 6; i8--) {
            Test.iFld >>= i8;
            Test.iFld = i8;
            for (i10 = 13; i10 > i8; --i10) {
                ...
                i11 += (int)(51L + (i10 * i10));
                if (b1) {
                    Test.iFld += (((i10 * Test.iFld) + i11) - s);
                    for (i12 = 1; i12 > 1; i12 -= 3) {
                        Test.iArrFld[i10 - 1] /= (int)(l | 1);
                        s = (short)i9;
                    }
                } else if (b1) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i16 = 7; i16 < 171; ++i16) {
            ...
            Test.iArrFld[i16 - 1] += 14;
            lArr[i16 + 1] = Test.instanceCount;
            i17 += (((i16 * i16) + i14) - Test.instanceCount);
        }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld byFld = " + Test.instanceCount + "," + Test.iFld + "," +
            byFld);
        FuzzerUtils.out.println("lFld Test.iArrFld fArrFld = " + lFld + "," + FuzzerUtils.checkSum(Test.iArrFld) + ","
