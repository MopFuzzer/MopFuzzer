...
public class Test {
    ...
    public static void vMeth1(long l1) {
        ...
        for (i9 = 10; i9 < 257; ++i9) {
            Test.lArrFld[i9][i9] <<= 30767;
            Test.iArrFld[i9] += Test.byFld;
            i8 += i11;
            i8 = (int)Test.instanceCount;
            i8 *= Test.byFld;
            if (b1) {
                Test.iArrFld1[i9 - 1] += i9;
            } else if (b1) {
    ...
    public static void vMeth(int i4, int i5) {
        ...
        Test.iArrFld1[(203 >>> 1) % N] = (int)((i5 - f) + i5);
        for (i6 = 12; i6 < 196; i6++) {
            f += (((i6 * f) + i5) - Test.instanceCount);
    ...
    public static int iMeth(int i1, int i2, long l) {
        ...
        l -= Test.iArrFld[(153 >>> 1) % N];
        for (int i3 : Test.iArrFld) {
            b = b;
            vMeth(i2, i2);
            if (true) {
                l >>= i2;
                Test.iArrFld1[(i2 >>> 1) % N] = -58868;
            } else if (b) {
                d1 = -156;
                i2 = i3;
            } else {
                for (i17 = 1; i17 < 4; i17++) {
                    Test.fFld += i1;
                    Test.instanceCount += (((i17 * i18) + i17) - l);
                }
                Test.iArrFld1 = Test.iArrFld;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f1=0.340F, fArr[]=new float[N];
        ...
        do {
            ...
            for (i20 = 6; 144 > i20; i20++) {
                ...
                case 8:
                    for (f1 = 1; f1 < 2; ++f1) {
                        if (Test.bFld) break;
                        Test.byFld += (byte)((long)f1 | i22);
                        i21 += (int)(f1 * Test.instanceCount);
                        Test.fFld = i21;
                        Test.instanceCount = i22;
                        Test.instanceCount += (long)(f1 + i21);
                        i21 *= (int)1.318F;
                        fArr[(int)(f1)] -= i21;
                    }
                    i22 -= (int)d2;
            ...
            Test.instanceCount += (((i * i) + i20) - i22);
            Test.lArrFld[i + 1][i - 1] = i21;
            i23 = 1;
            while (++i23 < 144) {
