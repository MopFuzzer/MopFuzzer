...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -62788L);
    }
    ...
    public static void vMeth2(int i8) {
        ...
        int i9=-12, i10=-31450, i11=18, i12=-579, i13=9, i14=182, iArr2[]=new int[N];

        FuzzerUtils.init(iArr2, -247);

        for (i9 = 5; i9 < 350; i9++) {
            for (i11 = 1; i11 < 5; i11++) {
                i12 += (((i11 * Test.fFld) + i12) - i12);
                i10 = i9;
                for (i13 = 1; i13 < 2; i13++) {
                    Test.lArrFld[i13] -= (long)Test.fFld;
                    iArr2[i11 - 1] = i10;
    ...
    public static void vMeth1(boolean b) {
        ...
        float f1=0.961F;
        int i15=248, i16=-7107, i17=-8, i18=-2, i19=-3, i20=-9, i21=124, i22=14, iArr3[]=new int[N];
        byte by1=-10;
    ...
    public static void vMeth(long l) {
        ...
        int i5=75, i6=64933, i7=0, i23=-9, i24=0, iArr1[]=new int[N];
        boolean b1=true;
        ...
        for (i5 = 14; i5 < 312; ++i5) {
            i6 = (iArr1[i5] / (i5 | 1));
            i6 += (int)((Test.instanceCount--) - -60728);
            i6 *= (int)-99.18F;
            switch ((i5 % 7) + 101) {
            case 101:
                Test.lArrFld[i5 - 1] *= 11L;
                i7 = 1;
                do {
                    i6 += (--Test.sFld);
                    switch (((i5 % 4) * 5) + 65) {
                    case 74:
                        vMeth1(true);
                        iArr1[i7 - 1] >>= Test.sFld;
                        for (i23 = 1; i23 < 1; ++i23) {
                            i24 += (((i23 * i24) + Test.fFld) - Test.instanceCount);
                        }
                        i24 = i23;
                        break;
                    case 81:
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-21631, i1=52833, i2=8, i3=-13, i4=161, iArr[][]=new int[N][N];
        byte by=-69;
        short s=-2548, sArr[]=new short[N];
        float f=-107.717F;
        long l1=197L;
        boolean b2=true;
                ...
                case 65:
                    if (b2) {
                        ...
                        while ((i4 += 2) < 2) {
                            ...
                            s += (short)i4;
                            iArr[i4 - 1][i2 + 1] *= (int)(((i3 - f) + (i4 | Test.instanceCount)) + i4);
                            switch ((i % 6) + 111) {
                            case 111:
                                i3 = (int)((Math.min(i4, i) + (Test.lArrFld[(i4 >>> 1) % N]--)) - (--dFld));
                                switch ((i2 % 10) + 65) {
                                case 65:
                                    try {
                                        i3 = (-29691 / i);
                                    ...
                                    break;
                                case 66:
                                    by -= (byte)((~(6 + i3)) - ((-(i2 * Test.instanceCount)) + (f - f)));
                                    break;
                                case 67:
                                    vMeth(l1);
                                case 68:
                                    Test.lArrFld[i4 + 1] ^= i1;
                                    i1 += i;
                                    i1 >>>= i2;
                                    if (true) {
                                        l1 += (i4 + l1);
                                    ...
                                    break;
                                case 69:
                                    iArr[i4][i2 - 1] = (int)Test.instanceCount;
                                    try {
                                        i3 = (i4 % 11031);
                            ...
                            case 112:
                                ...
                                break;
                            case 113:
                                Test.instanceCount += (((i4 * i) + i3) - i1);
                                break;
                            case 114:
                                i1 += (((i4 * Test.instanceCount) + i3) - Test.sFld);
                                break;
                            case 115:
                                i3 = i3;
                                break;
