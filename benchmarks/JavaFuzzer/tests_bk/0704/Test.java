...
public class Test {
        ...
        do {
            ...
            for (i17 = 1; i17 < 5; i17++) {
                ...
                for (d1 = i17; d1 < 2; ++d1) {
                    ...
                    try {
                        i19 = (i16 % i17);
                        Test.iArrFld[i16 + 1] = (i16 % 48205);
                        i18 = (164 / i16);
                    } catch (ArithmeticException a_e) {}
                    Test.sFld *= (short)i1;
                    i1 += (int)(((d1 * by1) + Test.instanceCount) - i1);
                    Test.iArrFld = Test.iArrFld;
                    Test.fFld -= Test.fFld;
                    Test.sFld += (short)((long)d1 ^ Test.instanceCount);
                }
            }
        } while (++i16 < 304);
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=28575, i20=-31196, i21=176, i22=-1, i23=12971, i24=-3, i25=93, i26=-36607, i27=14, i28=-154, i29=-5,
            iArr[]=new int[N];
        boolean b2=true;

        FuzzerUtils.init(iArr, 91);

        i = (int)((Math.min(i, i) - 32602) * (i = (int)lMeth(Test.instanceCount, Test.dFld, i)));
            ...
            for (i22 = i21; i22 < 80; i22++) {
                if (true) {
                    for (i24 = 1; 1 > i24; i24 += 3) {
                        i *= (int)13156L;
                        i += 12894;
                        Test.iArrFld[i22] -= (int)993970860L;
                        if (b2) continue;
                        i25 += (i24 + i23);
                        b2 = b2;
                        i23 += i24;
                ...
                Test.fFld *= i23;
                Test.instanceCount += (long)(26.611F + (i22 * i22));
                iArr[i21 - 1] *= i20;
            }
        } while (++i21 < 315);
        ...
        FuzzerUtils.out.println("Test.sFld iFld Test.byFld = " + Test.sFld + "," + iFld + "," + Test.byFld);
