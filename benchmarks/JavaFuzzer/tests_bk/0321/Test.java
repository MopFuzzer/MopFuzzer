...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.lArrFld, 6614L);
    }
    ...
    public static long lMeth1(int i7, int i8, long l1) {
        ...
        float f1=-53.124F;
        int i9=-38809, i10=25980, i11=239, i12=48, i13=29951, i14=-1, iArr[]=new int[N];
        double d1=-2.26124;
    ...
    public static void vMeth(int i3, int i4, float f) {
        ...
        byte by=-21;
        double d=-88.116334;
        int i5=19341, i6=-176, i15=0, i16=-252, iArr1[]=new int[N];
        ...
        for (d = 19; d < 360; d++) {
            ...
            while (++i6 < 5) {
                f += i6;
                lMeth1(i5, i4, Test.instanceCount);
                i3 = i6;
                by += by;
                iArr1[i6] &= (int)-209L;
                for (i15 = 1; i15 < 1; i15++) {
    ...
    public static long lMeth(long l, int i2) {
        ...
        int i17=70, i18=-19560, i19=12, iArr2[]=new int[N];
        boolean b1=false;
        ...
        vMeth(i2, i2, Test.fFld);
        i17 = 1;
        do {
            iArr2[i17] = (int)Test.dFld;
            if (true) continue;
            i2 = (int)Test.dFld;
        } while (++i17 < 356);
        i18 = 1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 11; i < 180; i++) {
            i1 >>= (int)((i1++) - lMeth(Test.instanceCount, i));
            for (i21 = 148; i21 > 1; i21--) {
                i1 += (i21 + i1);
                i1 += (i21 + i22);
                Test.byArrFld[i21 - 1] = (byte)Test.instanceCount;
            }
            i1 -= i1;
            i23 = 1;
            while (++i23 < 148) {
                ...
                for (i26 = 1; i26 < 1; i26++) {
                    if (b2) break;
                    Test.fFld = i24;
                    Test.instanceCount += -9135035838805521886L;
                    if (b2) continue;
                    f2 += i26;
                    i25 = i21;
        ...
        FuzzerUtils.out.println("Test.byArrFld Test.lArrFld iArrFld = " + FuzzerUtils.checkSum(Test.byArrFld) + "," +
