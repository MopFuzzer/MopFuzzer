...
public class Test {
    ...
    public static int iMeth() {
        ...
        int i9=34869, i11=-160, i12=-54006, i13=-19, iArr1[]=new int[N];
        ...
        for (int i10 : iArr1) {
            for (f1 = 1; f1 < 4; ++f1) {
                ...
                i10 += (int)(((f1 * i11) + Test.instanceCount) - i9);
                for (i12 = 1; i12 < 2; i12++) {
                    sArr[i12] = (short)12;
                }
            }
    ...
    public static void vMeth1() {
        ...
        byte by=-13;
        int i14=8, i15=-222, i16=-2845, iArr2[]=new int[N];
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-58941, i1=-108, i2=7, i3=-239, i4=-14302, i5=-34063, i6=-16598, i7=23, i22=-62, i23=5, i24=27362,
            iArr[]=new int[N];
        ...
        for (i = 3; i < 174; ++i) {
            ...
            for (i6 = 4; i6 < 147; ++i6) {
                ...
                d1 = 1;
                do {
                    Test.instanceCount += (long)(iArr[i6 + 1] + ((i2 + Test.sFld) * (0.517F + iArr[i6 - 1])));
                    i3 += (int)((long)d1 | i4);
                    i7 -= (--i1);
                } while (++d1 < 2);
