...
public class Test {
    ...
    public static int iMeth1() {
        ...
        bArr[(-86 >>> 1) % N] = Test.bFld;
        for (i6 = 10; i6 < 245; i6++) {
            i7 = (int)Test.fFld;
            for (i8 = i6; i8 < 7; ++i8) {
                Test.fFld = i8;
                Test.instanceCount += (((i8 * Test.sFld) + Test.instanceCount) - i7);
                i9 += i8;
    ...
    public static void vMeth(float f2) {
        ...
        boolean b=true;
        float f3=0.53F, f4=-121.440F, fArr1[]=new float[N];
        byte by=-29;
    ...
    public static int iMeth(float f1, long l) {
        ...
        long l1=-1696618430250459757L, lArr1[]=new long[N];
        ...
        for (l1 = 20; l1 < 347; l1++) {
            for (d = 1; d < 5; d++) {
                ...
                Test.iArrFld[(int)(d)] %= (int)-124.924F;
                for (i15 = 1; i15 < 2; i15++) {
                    i14 += Test.sFld;
                    if (Test.bFld) continue;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f=1.846F, fArr[][]=new float[N][N];
        int i=224, i17=17544, i18=-28, i19=-6, i20=-13, i21=-12, i22=-25407, i23=1923, i24=-20980, i25=-8, iArr[]=new
            int[N];
        double d1=1.81332;
        ...
        d1 += iFld;
        d1 *= i17;
        iArrFld2[(i >>> 1) % N][(i18 >>> 1) % N] <<= (int)Test.instanceCount;
        i19 = i;
        for (i20 = 22; i20 < 352; i20 += 3) {
            iFld += (i20 * i20);
            for (i22 = 228; i22 > 10; i22 -= 2) {
                for (i24 = 1; 3 > i24; i24++) {
                    iArr[i20 - 1] = Test.sFld;
                    if (Test.bFld) continue;
                    i23 += (((i24 * i20) + i25) - i17);
                    Test.instanceCount *= Test.instanceCount;
                    i17 += (-9 + (i24 * i24));
                    Test.sFld += (short)(((i24 * i23) + Test.instanceCount) - iFld);
                }
            }
        }
