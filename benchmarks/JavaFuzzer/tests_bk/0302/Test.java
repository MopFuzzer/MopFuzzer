...
public class Test {
    ...
    public static double dMeth(int i5) {
        ...
        float f1=-1.930F;
        short s=4625;
        double d1=-2.36165, dArr[]=new double[N];
    ...
    public static void vMeth(int i4) {
        ...
        float f2=46.617F;
        byte by=-24;
        short s1=-15812, sArr[]=new short[N];
        ...
        for (i13 = 5; i13 < 253; i13++) {
            if (Test.bFld) {
                ...
                f2 -= i4;
                if (false) continue;
                by += (byte)(((i13 * Test.instanceCount) + Test.instanceCount) - i14);
                i4 += i13;
    ...
    public static float fMeth() {
        ...
        int i=33, i1=59632, i2=-1, i3=-38952, i17=-1, i18=-27220, iArr[]=new int[N];
        double d=0.50604;
        float f=34.353F;
    ...
    public void mainTest(String[] strArr1) {
        ...
        boolean b=false;
        float f3=2.558F;
        int i19=248, i20=251, i21=63861, i22=-11, i23=-228, i24=0, i25=34707, i26=13, i27=-254, i28=-224, iArr1[]=new
            int[N];
        short s2=19853;
        ...
        b = ((fMeth() - f3) < 57082);
        lArrFld[(Test.iFld >>> 1) % N] -= -228;
        i19 = 1;
        do {
            for (i20 = 3; i20 < 167; i20++) {
                try {
                    Test.iFld = (iArr1[i19 - 1] % -101347902);
                    iArr1[i20 + 1] = (i21 % Test.iFld);
                    i21 = (1966634906 % i19);
                } catch (ArithmeticException a_e) {}
                Test.instanceCount += (((i20 * i20) + i21) - i19);
            ...
            case 69:
                for (i23 = 1; i23 < 167; ++i23) {
                    ...
                    case 71:
                        i28 = -78;
                    default:
                        i24 += (((i23 * i20) + Test.instanceCount) - i24);
                    }
                }
            }
        } while (++i19 < 150);
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.bFld Test.iFld = " + Test.instanceCount + "," + (Test.bFld ? 1
            : 0) + "," + Test.iFld);
        FuzzerUtils.out.println("Test.byFld dFld Test.bArrFld = " + Test.byFld + "," + Double.doubleToLongBits(dFld) +
