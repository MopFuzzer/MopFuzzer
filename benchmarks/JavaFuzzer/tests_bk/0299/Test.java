...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -40939);
    }
    ...
    public static void vMeth1() {
        ...
        int i3=8, i4=47030, i5=-39, i6=-6, i7=-163, i8=-9, iArr[]=new int[N];
        float f1=2.683F;
        short s=16075;
        boolean b1=true;
        ...
        do {
            ...
            if (b1) {
                ...
                for (i4 = 1; i4 < 7; ++i4) {
                    ...
                    s += (short)(((i4 * i4) + Test.instanceCount) - i6);
                    i6 -= (int)881779436L;
                    for (i7 = 1; i7 < 2; ++i7) {
                        if (true) {
    ...
    public static void vMeth(int i2, byte by) {
        ...
        do {
            ...
            case 28:
                ...
                for (i10 = 1; i10 < 7; ++i10) {
                    i2 += (14 + (i10 * i10));
                    i11 += (((i10 * Test.fFld) + i10) - Test.instanceCount);
                    i11 = i9;
    ...
    public static boolean bMeth(int i1) {
        ...
        for (i12 = 8; i12 < 160; i12++) {
            Test.fFld = i13;
            Test.instanceCount = -2760949743989181626L;
        }
        for (i14 = 369; i14 > 15; --i14) {
            for (i16 = i14; i16 < 5; i16 += 2) {
                for (i18 = 1; i18 < 1; i18++) {
                    ...
                    i13 += Test.iFld;
                    i1 += (((i18 * Test.instanceCount) + i12) - i16);
                    Test.fFld -= i15;
                    i15 = (int)142L;
            ...
            for (i22 = 2; i22 < 66; i22 += 3) {
                ...
                case 28:
                    for (i27 = 1; i27 < 4; ++i27) {
                        ...
                        Test.iFld += (((i27 * Test.instanceCount) + i20) - i24);
                    }
                case 29:
                    Test.dFld = Test.fFld;
                    break;
