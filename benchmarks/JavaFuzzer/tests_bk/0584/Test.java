...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.dArrFld, 0.116032);
    }
    ...
    public static void vMeth() {
        ...
        int i10=8, i15=103, i16=-7647, i17=27, i18=13, i19=17, iArr[]=new int[N];

        FuzzerUtils.init(iArr, 12);

        iArr[(i10 >>> 1) % N] = (int)((-32994 - Test.instanceCount) << i10);
        if (Test.bFld) {
        ...
        for (i15 = 3; 121 > i15; i15++) {
            ...
            for (i17 = i15; i17 < 13; ++i17) {
                ...
                Test.dArrFld[i15 - 1] %= ((long)(Test.dFld) | 1);
                if (i19 != 0) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 7; i < 186; i++) {
            ...
            for (i2 = 2; i2 < 140; i2 += 3) {
                b = (((14 - i2) + i3) != Test.fFld);
            }
            i3 += (int)(((i2 + i3) + (i2 * Test.instanceCount)) - (++i3));
            i1 ^= 212;
            for (i4 = 3; 140 > i4; i4++) {
                i3 *= (int)((--by) - ((Test.instanceCount |= i) * (i5 + 1)));
            }
        }
        ...
        i1 *= (int)Test.dFld;
        iArrFld[(1 >>> 1) % N] += i2;
        Test.dArrFld[(i3 >>> 1) % N] = i5;
        i21 <<= (int)Test.instanceCount;
        Test.dFld = i3;
        Test.dFld *= Test.instanceCount;
        for (i22 = 8; i22 < 136; ++i22) {
            i5 += (((i22 * Test.instanceCount) + i5) - Test.fFld);
            i1 *= i2;
            Test.fFld = i22;
            i5 += (i22 * i22);
            ...
            for (f1 = 3; f1 < 196; ++f1) {
                i23 = i23;
                Test.dArrFld[(int)(f1 + 1)] += Test.instanceCount;
        ...
        FuzzerUtils.out.println("Test.bFld iArrFld Test.dArrFld = " + (Test.bFld ? 1 : 0) + "," +
