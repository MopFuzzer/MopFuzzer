...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -38574L);
    }
    ...
    public static int iMeth(int i4, int i5, int i6) {
        ...
        for (i7 = 176; 9 < i7; i7 -= 2) {
            Test.fFld += i6;
            i8 += (((i7 * Test.instanceCount) + i5) - i8);
        }
        i5 = i7;
        i5 -= i5;
        i4 = i6;
    ...
    public static float fMeth(int i2, int i3) {
        ...
        double d=1.61661;
        int i13=43935, i14=14, i15=0, i16=-5, i17=79, i18=-130, i19=1, iArr[]=new int[N];
        boolean b=false;
        ...
        if (b) {
            for (i15 = 16; i15 < 277; ++i15) {
                ...
                while (++i17 < 6) {
                    i2 = i14;
                    for (i18 = 1; i18 < 1; ++i18) {
                        Test.sFld += (short)(((i18 * Test.fFld) + i19) - Test.instanceCount);
                        d += 2.106442;
                        iArr[i15 - 1] -= i14;
                    }
                }
    ...
    public static void vSmallMeth(long l, long l1) {
        ...
        i -= (int)(--lArr[(i1 >>> 1) % N]);
        Test.instanceCount *= (long)(((-2.43661 - (l1 * Test.fFld)) * (i++)) / (((long)(fMeth(i1, -14) - l1)) | 1));
    ...
    public void mainTest(String[] strArr1) {
        ...
        byte by=-41;
        float f=0.279F;
        int i20=62076, i21=18708, i22=-10276, i23=7, i24=14, i25=65325, iArr1[]=new int[N];
        double d1=-1.89326, dArr[]=new double[N];

        FuzzerUtils.init(dArr, 0.61669);
        FuzzerUtils.init(iArr1, 246);

        for (int smallinvoc=0; smallinvoc<839; smallinvoc++) vSmallMeth(Test.instanceCount, Test.instanceCount);
        by = (byte)1.75130;
        f = 289;
        while ((f -= 3) > 0) {
            dArr[(int)(f - 1)] = f;
        ...
        FuzzerUtils.out.println("bFld iFld Test.lArrFld = " + (bFld ? 1 : 0) + "," + iFld + "," +
