...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -1800923630406713872L);
        FuzzerUtils.init(Test.dArrFld, 50.54318);
    }
    ...
    public static void vSmallMeth() {
        ...
        i2 *= (int)(((i2 * Test.instanceCount) + (i2 + i2)) + i2);
    ...
    public static int iMeth(int i10, double d1) {
        ...
        byte by1=-86;
        int i15=-186, i16=1, i17=216, i18=6, i19=7547, i20=-121, iArr[][]=new int[N][N];

        FuzzerUtils.init(iArr, 5);

        Test.lArrFld[(i10 >>> 1) % N] = (++i10);
        by1 = (byte)(Test.dArrFld[(-6 >>> 1) % N] * ((i10 + by1) << (65 >> i10)));
        i10 -= (int)(iArr[(i10 >>> 1) % N][(i10 >>> 1) % N] % ((long)(dMeth(i10, 0.81624)) | 1));
        i10 = (int)Test.instanceCount;
        for (i15 = 11; i15 < 295; i15++) {
            for (i17 = 1; i17 < 6; ++i17) {
                Test.sFld *= (short)9106;
                Test.fFld = 6;
                for (i19 = 1; i19 < 2; ++i19) {
                    i18 >>= i17;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=14, i1=189, i3=5, i4=4, i5=11, i6=-21187, i7=12, i8=49, i9=29971, i21=-199, i22=5, i23=-9, iArr1[]=new
            int[N];
        float f=0.553F, fArr[]=new float[N];
        double d=-114.109206;
        byte by=-30;
        ...
        for (i5 = 4; i5 < 142; ++i5) {
            ...
            for (d = 5; d < 182; ++d) {
                ...
                vSmallMeth();
                for (i8 = 1; i8 < 2; ++i8) {
                    i7 = (int)((Test.sFld--) * (Math.abs(Test.instanceCount) * (i4 - i4)));
