...
public class Test {
    ...
    public static int iMeth(int i4) {
        ...
        double d1=2.30008;
        long l=-1930120836L;
        int i6=-2956, i7=203, iArr1[]=new int[N];
        boolean b=false;
        float f1=1.275F;
    ...
    public static void vMeth() {
        ...
        for (i8 = 8; i8 < 203; i8++) {
            d2 = 8;
            do {
                Test.instanceCount = 19500;
                if (Test.bFld) {
                    Test.iFld = (int)2.136F;
                    i3 += Test.byFld;
                } else if (Test.bFld) {
                    Test.iArrFld1[(int)(d2 - 1)] = i3;
                    for (i10 = i8; i10 < 1; i10++) {
                        int i12=-11;
                        Test.iFld = (int)Test.instanceCount;
                        d3 -= i10;
                        i12 += (((i10 * Test.lFld) + Test.lFld) - i8);
                        if (false) break;
                        if (i8 != 0) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d4=-43.125074, dArr[]=new double[N];
        float f2=0.907F;
        ...
        for (d4 = 8; d4 < 153; d4 += 2) {
            for (i14 = 9; i14 < 348; ++i14) {
                ...
                do {
                    Test.byFld *= (byte)i17;
                    Test.iArrFld1[(int)(d4 - 1)] <<= i13;
                    iArrFld[i14] -= Test.iFld;
                    iArrFld[i16 - 1] = i18;
                } while (++i16 < 2);
                Test.lFld >>= 21203;
                i15 = 4;
                    ...
                    for (i19 = 1; i19 < 2; ++i19) {
                        ...
                        case 24:
                            ...
                            case 100:
                                ...
                                Test.dFld = i13;
                            case 101:
                                i1 += (((i19 * Test.lFld) + i16) - i13);
                            }
                        case 25:
                            i20 = (int)Test.instanceCount;
                        case 26:
                            Test.iArrFld1[i14 - 1] = Test.sFld;
                            break;
                        }
                    }
                    break;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.byFld Test.iFld = " + Test.instanceCount + "," + Test.byFld +
            "," + Test.iFld);
        FuzzerUtils.out.println("Test.sFld Test.lFld Test.bFld = " + Test.sFld + "," + Test.lFld + "," + (Test.bFld ? 1
            : 0));
        FuzzerUtils.out.println("Test.dFld lFld1 iArrFld = " + Double.doubleToLongBits(Test.dFld) + "," + lFld1 + "," +
            FuzzerUtils.checkSum(iArrFld));
        FuzzerUtils.out.println("Test.iArrFld1 fArrFld = " + FuzzerUtils.checkSum(Test.iArrFld1) + "," +
