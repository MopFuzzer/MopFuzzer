...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 0.998F);
    }
    ...
    public static long lMeth(int i1, long l) {
        ...
        int i8=-177, i9=-7, i10=-4, i11=11, iArr[][]=new int[N][N];
        float f3=9.877F;
    ...
    public static int iMeth(int i) {
        ...
        byte by=-31;
        float f=-54.56F;
        double d=115.95850, dArr[]=new double[N];
        int iArr1[]=new int[N];
        ...
        by += (byte)(--i);
        f += Float.intBitsToFloat((int)(-lMeth(i, Test.instanceCount)));
        d = i;
        i *= by;
        for (int i12 : iArr1) {
            i12 += by;
    ...
    public void mainTest(String[] strArr1) {
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.sFld Test.fArrFld = " + Test.instanceCount + "," + Test.sFld +
