...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.sArrFld, (short)13388);
    }
    ...
    public static int iMeth1(int i5, int i6) {
        ...
        Test.iArrFld[(i6 >>> 1) % N] *= Test.iFld1;
        long meth_res = i5 + i6;
    ...
    public static void vMeth() {
        ...
        float f1=0.105F, fArr1[]=new float[N];
        short s=15605;
        double d=19.13014;
        boolean b=false;
        ...
        for (l = 7; l < 165; l += 2) {
            for (i3 = (int)(l); i3 < 19; ++i3) {
                Test.iFld += (((i3 * Test.instanceCount) + Test.instanceCount) - i3);
                Test.iFld1 -= (int)(((158 + iMeth1(i4, i2)) * l) + 47.920F);
                for (i7 = 1; 1 > i7; i7++) {
            ...
            if (b) {
                ...
                Test.iArrFld[(int)(l)] = (int)4145233137275013923L;
            }
        }
    ...
    public int iMeth(float f) {
        ...
        Test.iFld = (int)(Test.instanceCount = Math.max(Test.iArrFld[(Test.iFld >>> 1) % N] -= 11,
            --Test.iArrFld[(Test.iFld >>> 1) % N]));
        for (i = 3; 372 > i; i += 3) {
            fArr[i] = ((Math.min(Test.iFld, i) ^ (i1 * Test.instanceCount)) * Integer.reverseBytes((int)(-116L <<
                Math.abs(i))));
            vMeth();
            for (i9 = 1; i9 < 13; ++i9) {
                Test.iFld *= i1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (f2 = 1; 256 > f2; ++f2) {
            for (i15 = 5; i15 < 99; ++i15) {
                ...
                for (i17 = 1; i17 < 2; ++i17) {
                    ...
                    i16 += i18;
                    Test.iFld >>= i14;
                    i18 += (((i17 * Test.iFld1) + Test.iFld) - Test.iFld);
                    try {
                        Test.iArrFld[(int)(f2)] = (Test.iFld % i15);
                        i16 = (i15 / i17);
                        i16 = (Test.iArrFld[(int)(f2 + 1)] / Test.iFld1);
                ...
                Test.iFld = 3;
                b2 = b2;
                Test.instanceCount /= 35551L;
                Test.sArrFld[i15 + 1] = FuzzerUtils.short1array(N, (short)25602);
                i16 += (((i15 * Test.instanceCount) + fFld) - i17);
            }
            Test.iFld1 ^= (int)Test.instanceCount;
            Test.iArrFld[(int)(f2 + 1)] -= (int)d1;
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.iFld1 = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.iFld1);
        FuzzerUtils.out.println("fFld Test.iArrFld byArrFld = " + Float.floatToIntBits(fFld) + "," +
