...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)8763);
    }
    ...
    public static long lMeth(long l, float f1) {
        ...
        long l1=-10L;
        int i8=12, i9=1, i10=9, iArr[]=new int[N];
        double d=-16.8841;
    ...
    public static void vMeth1() {
        ...
        for (i2 = 10; 347 > i2; i2++) {
            for (i4 = 1; i4 < 5; ++i4) {
                i6 = 1;
                while (++i6 < 2) {
                    i5 = (int)Math.max(lMeth(Test.instanceCount, f2), Test.instanceCount);
                    i5 += (((i6 * i4) + i2) - i4);
                    i5 += i6;
                    b = false;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i15=-31, i16=52026, i17=40630, i18=-4, i19=-2, i20=18959, i21=250, iArr1[]=new int[N];
        long l2=-168L, l3=26366L;
        boolean b2=true;
        double d1=-16.111413, dArr[]=new double[N];
        ...
        for (l2 = 6; l2 < 232; l2++) {
            ...
            case 33:
                ...
                while (++l3 < 111) {
                    ...
                    iArr1 = iArr1;
                    if (b2) continue;
                    i16 += (int)(((l3 * i16) + Test.instanceCount) - i16);
            ...
            case 42:
                ...
                break;
            case 57:
                i19 += (int)(l2 * Test.instanceCount);
                break;
            case 54:
                i16 = i18;
                break;
            case 45:
                Test.sArrFld[(int)(l2 - 1)] = (short)l3;
                break;
            case 27:
                if (b2) break;
                break;
        ...
        FuzzerUtils.out.println("Test.byFld Test.sFld Test.sArrFld = " + Test.byFld + "," + Test.sFld + "," +
