...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)-6018);
        FuzzerUtils.init(Test.fArrFld, -1.257F);
    }
    ...
    public static void vMeth1(double d, int i3, int i4) {
        ...
        float f=-11.331F, fArr1[][]=new float[N][N];
        double d1=-2.118524;
        int i5=-43025, i6=26, i7=-43828, i8=177, i9=43305, i10=27, i11=4, iArr1[]=new int[N];
        byte by1=-16;
    ...
    public int iMeth(int i1, long l, int i2) {
        ...
        int i12=-123, i13=-223, i14=45375, iArr2[]=new int[N];
        float f1=-2.56F, fArr[]=new float[N];
        double d2=42.86656;
    ...
    public void vMeth() {
        ...
        byte by=105;
        int i15=-1604, i16=-5, i17=6, i18=-23515, i19=13307, i20=109, iArr3[][]=new int[N][N], iArr4[][]=new int[N][N];
        double d3=28.36763;
        short s=31996;
        ...
        by = (byte)(((fFld + Test.iFld) - Test.iFld) - (iMeth(Test.iFld, 1L, Test.iFld) * Test.iFld));
        fFld *= (float)dFld;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i21=-68, i22=7, i23=-17966, i24=181, i25=-13, i26=-52, iArr[]=new int[N];
        double d4=-71.70695, dArr[]=new double[N];
            ...
            case 52:
                ...
                for (i23 = 2; 63 > i23; ++i23) {
                    ...
                    case 114:
                        ...
                        fFld += (((i23 * Test.instanceCount) + Test.instanceCount) - lFld);
                        if (true) {
                            dArr = dArr;
                            Test.iFld += i23;
                        } else {
                ...
                break;
            case 53:
                Test.fArrFld[(i25 >>> 1) % N][(i22 >>> 1) % N] = 0;
                break;
            }
        }
