...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)10144);
    ...
    public static void vMeth1(double d1) {
        ...
        for (i8 = 356; 11 < i8; i8--) {
            ...
            switch ((i8 % 7) + 8) {
            case 8:
                Test.sArrFld[i8 + 1] -= (short)Test.iFld;
                b = b;
                Test.iFld += (144 + (i8 * i8));
                break;
            case 9:
    ...
    public static void vMeth(long l) {
        ...
        int i6=5, i7=-232, iArr[]=new int[N];
        short s=-18557;
        double d2=-24.113715;
        ...
        Test.iFld += (((Test.iFld--) - (13 - Test.iFld)) * ((++Test.iFld) - (Test.iFld--)));
        for (i6 = 260; i6 > 7; i6 -= 2) {
            Test.fFld += (float)((iArr[i6 - 1] <<= (i7 - 44896)) - (++Test.dFld));
            vMeth1(Test.dFld);
            Test.fFld += s;
            Test.fFld = Test.iFld;
            Test.instanceCount = i7;
            try {
                i7 = (Test.iArrFld[i6 - 1] % iArr[i6 - 1]);
                Test.iArrFld[i6 - 1] = (Test.iFld / -49691190);
                i7 = (Test.iFld / i6);
            } catch (ArithmeticException a_e) {}
            Test.instanceCount += (i6 * Test.iFld);
            Test.iArrFld[i6] += (int)l;
            d2 = 1;
            do {
                i7 += (int)(d2 * d2);
                fArr[i6] = (float)d2;
    ...
    public void mainTest(String[] strArr1) {
        ...
        i1 = (int)(Math.min(i1, i1) + ((-13L - (f1 + i1)) - (-(i1 | Test.byFld))));
        for (i2 = 10; i2 < 368; ++i2) {
            for (i4 = 3; i4 < 70; ++i4) {
                i1 = (int)(d - (iMeth() * i3));
                i1 = Test.byFld;
            ...
            while (++i10 < 70) {
                ...
                for (i11 = 1; 1 > i11; ++i11) {
                    ...
                    try {
                        Test.iFld = (i10 % -81);
                        Test.iArrFld[i11 - 1] = (i11 / -48);
                        Test.iArrFld[(i1 >>> 1) % N] = (Test.iArrFld[i2 + 1] % 177);
                    } catch (ArithmeticException a_e) {}
                }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.byFld Test.iFld = " + Test.instanceCount + "," + Test.byFld +
            "," + Test.iFld);
        FuzzerUtils.out.println("Test.fFld Test.dFld sFld = " + Float.floatToIntBits(Test.fFld) + "," +
