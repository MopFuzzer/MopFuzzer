...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -59206);
        FuzzerUtils.init(Test.lArrFld, -2328728810L);
    }
    ...
    public void mainTest(String[] strArr1) {
        ...
        case 123:
            ...
            f = 1;
            do {
                Test.instanceCount += (iMeth(Test.instanceCount, f, i) - 235L);
                dFld += i;
                if (b1) continue;
                ...
                for (l3 = 1; 70 > l3; ++l3) {
                    ...
                    case 41:
                        ...
                        do {
                            ...
                            i *= (int)f;
                            i23 += (i24 + i23);
                            Test.instanceCount = -2608272480L;
                            i25 -= (int)l3;
                            i25 += i24;
                            if (b1) {
                                Test.lArrFld[(int)(l3 + 1)] = by2;
                                byArr1[(int)(l3)] *= (byte)s;
                                byArr1[(int)(l3 - 1)] -= (byte)dFld;
                                i25 = i23;
                            } else {
                                i23 += (((i24 * i26) + i26) - Test.instanceCount);
                                i23 <<= i24;
                    ...
                    case 42:
                        try {
                            i25 = (Test.iArrFld[(int)(f - 1)] % -55);
                            Test.iArrFld[(int)(l3 + 1)] = (i23 % -241);
                            Test.iFld = (54936 / i);
                        } catch (ArithmeticException a_e) {}
                    case 43:
                        i23 |= (int)l3;
