...
public class Test {
    ...
    public static void vMeth(int i3, long l1) {
        ...
        long l2=4L, lArr[][]=new long[N][N];
        int i4=-1, i5=-7, i6=93, i7=-31284, iArr1[][]=new int[N][N];
    ...
    public static int iMeth1(byte by, int i1) {
        ...
        int i2=2, i9=-4, i10=-17616, i11=-34003, i12=-101, iArr2[]=new int[N];
    ...
    public static int iMeth(double d, long l) {
        ...
        byte by2=66;
        int i13=124, i14=-214, i15=-58, i16=-14, iArr3[]=new int[N];
        short s1=20351;
        long l3=-627669296L, lArr2[]=new long[N];
        ...
        Test.instanceCount = iMeth1(by2, i13);
        s1 = (short)i13;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-199, i17=-14190, i18=61, i19=-59096, i20=-123, i21=-23, i22=-9, i23=-14, i24=-159, i25=-57315, i26=-9,
            iArr[]=new int[N];
        double d3=-38.52245;
        ...
        i &= ((++i) - (i -= (iArr[(i >>> 1) % N] = i)));
        iMeth(d3, Test.instanceCount);
        for (f2 = 15; 246 > f2; ++f2) {
            for (i18 = 5; i18 < 109; ++i18) {
                i = 44905;
                i17 += 176;
                Test.byArrFld[(int)(f2)] >>= (byte)i18;
                i17 *= i19;
                i19 += (i18 | Test.instanceCount);
                f3 += (((i18 * i18) + Test.instanceCount) - i19);
                d3 = 15338;
                i17 = s2;
                i17 += (-141 + (i18 * i18));
            ...
            for (i20 = 6; i20 < 109; ++i20) {
                ...
                Test.instanceCount += (((i20 * i20) + i18) - i21);
                i22 += -3213;
            }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.bFld Test.byArrFld = " + Test.instanceCount + "," + (Test.bFld
            ? 1 : 0) + "," + FuzzerUtils.checkSum(Test.byArrFld));
