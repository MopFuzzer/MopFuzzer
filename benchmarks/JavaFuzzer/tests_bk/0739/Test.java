...
public class Test {
    ...
    public static void vMeth1(boolean b2, long l, float f1) {
        ...
        int i2=6, i3=42959, i4=23998, i5=-34418, i6=-11, i7=40, i8=22785, iArr[]=new int[N];
        double d=1.43603;
        float f2=-112.667F;
        ...
        for (i2 = 1; i2 < 374; i2 += 3) {
            ...
            for (i4 = 1; i4 < 13; ++i4) {
                ...
                i6 = 1;
                do {
                    i3 += (((i6 * i6) + Test.instanceCount) - i5);
                } while (++i6 < 2);
            }
            l -= i5;
            i7 = 1;
    ...
    public static void vMeth(boolean b, boolean b1) {
        ...
        int i1=-5, i9=7, i10=-6955, i11=32856, i12=63425, iArr1[]=new int[N];
        float f=-32.151F;
        ...
        b1 = ((Test.instanceCount + (i1 * i1)) != (-(f * i1)));
        vMeth1(false, Test.instanceCount, f);
        iArr1[(i1 >>> 1) % N] <<= i1;
        for (i9 = 16; i9 < 383; i9++) {
            i10 += i9;
            i11 = 1;
