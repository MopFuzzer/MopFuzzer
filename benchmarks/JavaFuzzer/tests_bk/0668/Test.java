...
public class Test {
    ...
    public static void vMeth(float f1) {
        ...
        for (i6 = 7; i6 < 364; ++i6) {
            i8 = 5;
            do {
                Test.instanceCount += (((i8 * i7) + Test.instanceCount) - Test.instanceCount);
                for (i9 = 1; i9 < 1; i9++) {
                    f1 += i8;
        ...
        do {
            ...
            do {
                ...
                for (i19 = 1; i19 < 1; ++i19) {
                    ...
                    i20 -= by;
                    try {
                        i5 = (Test.iArrFld[i19] / Test.iArrFld[i17 + 1]);
                        Test.iArrFld[i19 + 1] = (193 % i5);
                        i5 = (Test.iArrFld[i18] / 198);
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f=0.842F, fArr1[]=new float[N];
        long l=2443633920L;
        double d2=0.113233;
        ...
        for (i1 = 238; i1 > 14; --i1) {
            ...
            case 30:
                for (i3 = 3; i3 < 112; ++i3) {
                    double d=0.94820;
                    d = ((i4 = (i2 + i2)) - (++i));
                    f = (((--i4) + iMeth()) << Test.instanceCount);
                    byFld ^= byFld;
                    Test.instanceCount += i3;
                    Test.iFld = (int)-62.889F;
                    Test.iFld = i4;
                    Test.iArrFld[i1 - 1] -= Test.iFld;
                    i2 = i3;
                    Test.instanceCount -= -35349L;
                    Test.lFld += (((i3 * Test.instanceCount) + i4) - i);
                }
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.iFld Test.lFld = " + Test.instanceCount + "," + Test.iFld +
            "," + Test.lFld);
        FuzzerUtils.out.println("Test.bFld byFld sFld = " + (Test.bFld ? 1 : 0) + "," + byFld + "," + sFld);
