...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -45337);
        FuzzerUtils.init(Test.fArrFld, -105.289F);
    }
    ...
    public static byte byMeth(long l, int i10, int i11) {
        ...
        while (++i12 < 332) {
            ...
            i11 = i12;
            Test.iArrFld[i12][i12 + 1] <<= i12;
            Test.iArrFld[i12][i12 + 1] = (int)Test.fFld;
        }
        l *= l;
        Test.iArrFld[(i10 >>> 1) % N][(i11 >>> 1) % N] *= (int)Test.instanceCount;
    ...
    public static int iMeth() {
        ...
        int i8=-41540, i9=-144, i19=-28050, i20=9, iArr1[]=new int[N];
        double d2=0.10844;
        boolean b1=false;
        byte by1=6;
        ...
        for (i8 = 1; i8 < 177; ++i8) {
            Test.instanceCount = byMeth(Test.instanceCount, 9, i8);
        }
        for (int i18 : iArr1) {
    ...
    public static void vMeth(double d) {
        ...
        int i2=3, i3=-191, i4=-12, i5=-87, i6=-4, i21=-1, i22=-14177, iArr[]=new int[N];
        boolean b=false;
        ...
        do {
            for (i3 = 1; i3 < 6; ++i3) {
                for (i5 = 2; i5 > 1; --i5) {
                    int i7=-57087;
                    i4 += (((i5 * i3) + Test.sFld) - i3);
                    b = (b = ((i5 * Test.fFld) != i6));
                    Test.instanceCount = (long)((by <<= (byte)(-1 + (i3 - Test.instanceCount))) + (++Test.fFld));
                    Test.instanceCount = ((++i6) * ((i3 + i6) / (iArr[i3 - 1] | 1)));
                    i4 = (int)(Test.instanceCount % (((long)((i7 - i7) * Float.intBitsToFloat(i6))) | 1));
                    Test.instanceCount -= (i6 - byArr[i2 + 1]);
                    try {
                        i7 = (-59423 / i6);
                        i7 = (16263 / iArr[i2]);
                        i4 = (i4 / 180);
                ...
                i6 = (int)(Test.instanceCount = (long)((-iMeth()) - Test.fFld));
            }
            if (true) continue;
            for (i21 = i2; i21 < 6; ++i21) {
                b = true;
                i4 += (((i21 * Test.instanceCount) + by) - i3);
            }
        } while (++i2 < 261);
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 12; i < 386; i++) {
            ...
            switch ((i % 7) + 4) {
            case 4:
                Test.instanceCount += (i - ((Test.instanceCount - -15133) - (--i1)));
                vMeth(0.92301);
                sArr[i + 1] += (short)dFld;
                for (i23 = i; i23 < 67; ++i23) {
                    ...
                    case 117:
                        ...
                        for (i26 = 1; i26 < 1; ++i26) {
                            l1 += i24;
                            Test.iArrFld[i23 + 1][i26 - 1] = i26;
                            Test.sFld += (short)-110;
                            Test.sFld += (short)(i26 ^ i23);
                            dFld = Test.sFld;
                            i1 -= (int)Test.fFld;
                            i1 *= i1;
                        }
                        for (i28 = 1; i28 < 1; i28++) {
                            Test.instanceCount *= -5158;
                            byArr1[i23] = by2;
                            Test.iArrFld[i28][i28 + 1] = i25;
                            i24 += i1;
                        }
                    case 118:
                        Test.fFld += (-13 + (i23 * i23));
                        break;
                    case 119:
                        i27 += (i23 ^ i24);
                        break;
