...
public class Test {
    ...
    public static float fMeth(int i7) {
        ...
        int i8=64328, i9=0, i10=82, i11=-28070, i12=-6, i13=-224, i14=4, iArr[]=new int[N];
        float f=-63.374F;
        ...
        for (i8 = 304; 6 < i8; i8 -= 3) {
            for (i10 = 1; i10 < 16; i10++) {
                try {
                    i11 = (37605 % i8);
                    i7 = (Test.iArrFld[i10 - 1][i8 - 1] % i11);
                    Test.iArrFld[i10][i8] = (i11 / 53295);
                } catch (ArithmeticException a_e) {}
                sArr[i8 - 1] = (short)Test.dFld;
                switch (((i8 % 2) * 5) + 20) {
                case 28:
                    for (i12 = 1; i12 < 2; ++i12) {
                        try {
                            i7 = (i10 / Test.iArrFld[i8 - 1][i8 + 1]);
                            iArr[i10 + 1] = (2283 % Test.iArrFld[i8 + 1][i8]);
                            i14 = (i11 % 82);
                        } catch (ArithmeticException a_e) {}
                        i7 += i12;
                        Test.instanceCount += (i12 | Test.instanceCount);
                        i13 += (((i12 * Test.instanceCount) + i14) - i13);
                        f = Test.instanceCount;
                    }
                    switch ((i8 % 2) + 69) {
                    case 69:
                        Test.iArrFld[i8][i10 - 1] -= (int)Test.instanceCount;
    ...
    public static void vMeth1(long l, int i6) {
        ...
        s *= (short)-1708507956L;
        Test.instanceCount -= (long)(((++i6) - fMeth(-242)) * i6);
        i6 = s;
        i15 = 1;
        while (++i15 < 376) {
            i16 = 1;
            while (++i16 < 4) {
                Test.iArrFld[i16 + 1][i15 - 1] = (int)5L;
                Test.instanceCount = i6;
                i17 = 1;
                do {
                    b = b;
                    f1 = i15;
                    Test.iArrFld[i15][i16 - 1] = 0;
                    i6 = i16;
                    Test.iArrFld[i16 - 1][i15 - 1] += -5969;
                    if (i15 != 0) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f2=-18.467F;
        boolean b1=true;
        long l1=8191902120307293311L, lArr1[]=new long[N];
