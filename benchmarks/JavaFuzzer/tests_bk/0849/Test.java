...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, 48503);
    ...
    public static double dMeth(double d, int i6) {
        ...
        float f=103.776F, fArr[]=new float[N];
    ...
    public static long lMeth() {
        ...
        for (i4 = 3; i4 < 179; ++i4) {
            Test.iArrFld[i4][i4 - 1] += (int)dMeth(d1, i5);
            switch ((i4 % 2) + 89) {
            case 89:
                ...
                for (i11 = 1; i11 < 9; i11++) {
                    for (i13 = 1; 2 > i13; ++i13) {
                        ...
                        i5 &= i13;
                        Test.instanceCount = 15637;
                        Test.instanceCount = s;
                        Test.iArrFld[i11 + 1][i11] = i4;
                    }
                }
                break;
            case 90:
    ...
    public static void vMeth(long l, int i, int i1) {
        ...
        for (i2 = 4; 218 > i2; i2++) {
            i += (int)lMeth();
            Test.iArrFld[i2][i2] -= i1;
            i = (int)Test.dFld;
            for (i15 = 1; i15 < 8; i15++) {
                Test.dFld = -159390715L;
                i1 = i1;
                if (b) continue;
            }
    ...
    public void mainTest(String[] strArr1) {
        ...
        byte by1=-70;
        short s1=-31414, sArr[]=new short[N];
        float f3=64.585F, fArr1[]=new float[N];
        boolean b1=true;

        FuzzerUtils.init(fArr1, -60.937F);
        FuzzerUtils.init(sArr, (short)-24913);

        vMeth(Test.instanceCount, i21, i21);
        switch (((-30 >>> 1) % 5) + 117) {
        case 117:
            i21 += i21;
            ...
            while (--i24 > 0) {
                ...
                Test.instanceCount = Test.instanceCount;
                i23 += (((i24 * Test.instanceCount) + i21) - i24);
                i21 += i25;
                i21 -= (int)Test.instanceCount;
                for (i26 = 4; i26 < 64; ++i26) {
                    Test.iArrFld = Test.iArrFld;
                    i27 += (41348 + (i26 * i26));
                    fArr1[i24] -= Test.instanceCount;
                    by1 += (byte)i26;
                }
