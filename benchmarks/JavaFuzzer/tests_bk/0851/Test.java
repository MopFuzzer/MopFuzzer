...
public class Test {
    ...
    public static short sMeth(long l, short s) {
        ...
        int i12=-84, i13=0, i14=-33785, i15=-18, iArr[]=new int[N];
        boolean b=false;
        double d=-1.76146, dArr[]=new double[N];
        float f=-96.50F;
    ...
    public static void vMeth1(int i5, int i6) {
        ...
        int i7=-14, i8=22548, i9=36946, i10=-50, i11=-135, i16=8, iArr1[]=new int[N];
        byte by=-65;
        double d2=26.127270;
        float f1=116.198F;
        long l1=5316712923619809522L, lArr1[]=new long[N];
        short s2=-4122;
        ...
        for (i7 = 22; 364 > i7; i7++) {
            ...
            for (i9 = 1; i9 < 5; ++i9) {
                ...
                while (++i11 < 2) {
                    short s1=4818;
                    by += (byte)(i11 | i7);
                    i5 = (int)((sMeth(61344L, s1) + Test.instanceCount) - i10);
                    s1 = (short)d2;
                }
                f1 -= -46L;
                lArr1[i7 + 1] |= i8;
    ...
    public void mainTest(String[] strArr1) {
        ...
        iArrFld[(i >>> 1) % N] -= i;
        i *= iMeth((int)(Test.instanceCount + (i + i)));
        for (int i2 : iArrFld) {
        ...
        while (++i17 < 316) {
            short s3=22497;
            Test.bArrFld[i17 + 1] = bFld;
            lArr2[i17 - 1] -= (long)113.58293;
            s3 <<= (short)i17;
        }
        i18 = 1;
        while (++i18 < 328) {
            Test.iFld *= (int)1.21013;
        }
        if (bFld) {
            fArrFld[(i17 >>> 1) % N] -= i18;
            for (i19 = 9; i19 < 261; i19 += 3) {
                Test.iFld += (((i19 * Test.iFld) + i18) - Test.instanceCount);
                for (f2 = 298; f2 > i19; f2 -= 3) {
                    d3 = f2;
                    iArrFld[i19] <<= (int)333875370L;
                    if (bFld) break;
                }
                Test.fFld += (float)0.110249;
                Test.fFld += (i19 * i19);
