...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.dArrFld, 89.122155);
    }
    ...
    public static long lMeth1(long l, byte by) {
        ...
        for (i9 = 10; i9 < 178; ++i9) {
            ...
            Test.fFld = i9;
            s += (short)(i9 - i9);
            Test.instanceCount += (((i9 * i8) + i9) - i10);
            for (i11 = 9; 1 < i11; --i11) {
                l += i9;
                Test.instanceCount += (i11 ^ i8);
    ...
    public static long lMeth(int i3, int i4) {
        ...
        for (i5 = 16; i5 < 284; i5 += 3) {
            ...
            do {
                if (b) break;
                f -= (((i3 * i4) - (i6 - i6)) + i7);
                d += (lMeth1(Test.instanceCount, by1) * i3);
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-52481, i1=64335, i21=63706, i22=6, i23=2, i24=-3, i25=9, iArr[]=new int[N];
        byte by2=105;
        short s1=2330;
            ...
            for (i21 = 5; i21 < 109; i21++) {
                ...
                do {
                    ...
                    try {
                        i22 = (iArr[i - 1] / i22);
                        i22 = (i21 / 109834707);
                        iArr[i21] = (-159 / Test.iFld);
                    } catch (ArithmeticException a_e) {}
                    i1 += (i23 * Test.instanceCount);
                    Test.fFld += s1;
                    i1 += (((i23 * i21) + i21) - Test.fFld);
                } while (++i23 < 2);
                iArr[i21] -= i23;
                ...
                case 67:
                    for (i24 = 2; i24 > i; i24--) {
                        ...
                        case 45:
                            ...
                            Test.fFld -= Test.instanceCount;
                        case 46:
                            i1 += (((i24 * Test.instanceCount) + i25) - i);
                            Test.instanceCount >>= -25923;
                            break;
                        case 47:
                            iArr[i24 + 1] -= i;
                        case 48:
        ...
        FuzzerUtils.out.println("Test.iFld Test.dFld dFld1 = " + Test.iFld + "," + Double.doubleToLongBits(Test.dFld) +
