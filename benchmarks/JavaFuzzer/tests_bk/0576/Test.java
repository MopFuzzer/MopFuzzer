...
public class Test {
    ...
    public long lMeth(byte by) {
        ...
        iArr[(iFld >>> 1) % N] = (int)((iArr[(-51 >>> 1) % N] * iFld) + Math.abs(Test.instanceCount));
    ...
    public static void vMeth1(byte by1, float f) {
        ...
        double d=-2.12509, dArr[]=new double[N];
                ...
                case 30:
                    ...
                    for (i4 = 1; i4 < 9; ++i4) {
                        ...
                        case 12:
                            ...
                            i3 += (((i4 * Test.instanceCount) + i3) - Test.instanceCount);
    ...
    public static void vMeth() {
        ...
        byte by2=54;
        float f1=18.582F;
        int i6=-3, i7=-3, i8=-71, iArr2[]=new int[N];
        double d1=0.111986;
        long l=-4112L;
    ...
    public static int iMeth(int i) {
        ...
        int i9=10, i10=5, iArr1[]=new int[N];
        double d2=0.93726;
    ...
    public void mainTest(String[] strArr1) {
        ...
        iFld -= (int)lMeth((byte)(iMeth(Test.iFld1) * Test.instanceCount));
