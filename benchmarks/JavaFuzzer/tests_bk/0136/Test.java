...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.iArrFld, -23886);
    }
    ...
    public static void vMeth2(double d2) {
        ...
        int i11=26069, i12=-52968, i13=-7, i14=0, iArr[]=new int[N];
        float f=-1.447F;
        byte by=96;
    ...
    public void mainTest(String[] strArr1) {
        ...
        float f2=0.724F, fArr1[]=new float[N];
        ...
        for (i1 = 8; i1 < 191; i1 += 2) {
            for (i3 = i1; i3 < 275; i3++) {
                for (i5 = 1; i5 < 1; i5++) {
                    vMeth(Test.instanceCount, 13214, i5);
                }
                i4 = -657;
                if (Test.bFld) continue;
                for (i22 = 1; i22 < 1; i22 += 3) {
                    fArr1 = fArr1;
                    Test.lArrFld[i22 + 1][i1 + 1] = 14;
                ...
                i23 *= -137;
                for (i24 = 1; i24 < 1; ++i24) {
                    Test.iArrFld[i1 - 1][i24 + 1] += (int)Test.instanceCount;
                    i6 = i4;
                }
            }
            i4 <<= (int)7L;
            if (Test.bFld) {
                ...
                try {
                    i23 = (i25 / Test.iArrFld[i1][i1]);
                    i6 = (i6 % i3);
                    Test.iArrFld[i1 - 1][i1 + 1] = (10087 / i3);
