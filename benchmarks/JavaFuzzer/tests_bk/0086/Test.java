...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.fArrFld, -95.573F);
    ...
    public static void vMeth1(int i6, byte by, int i7) {
        ...
        int i8=-107, i9=-40476, i10=587, i11=-370, i12=-14, i13=62693, i14=-9, iArr[]=new int[N];
        boolean b=true;
        ...
        for (long l1 : lArr) {
            i11 = (int)l1;
            Test.fArrFld[(-8247 >>> 1) % N][(11 >>> 1) % N] = i7;
            i12 = 1;
            while (++i12 < 4) {
                switch (((i8 >>> 1) % 2) + 116) {
                case 116:
    ...
    public static void vMeth(long l, double d, int i5) {
        ...
        byte by1=37;
        int i15=145, i16=11, i17=-235, i18=-178, i19=-10, i20=11, iArr1[]=new int[N];
        float f=99.915F;
        ...
        case 119:
            Test.lArrFld[(i18 >>> 1) % N] = Test.lArrFld[(i15 >>> 1) % N];
            break;
        case 120:
            f = i20;
            break;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i = 6; i < 179; ++i) {
            i2 = 1;
            do {
                i1 /= (int)(Math.abs(Test.lArrFld[i][i]++) | 1);
                i1 = ((iMeth() - i1) + 114);
                iArrFld[i2 - 1] = i;
        ...
        for (l2 = 1; l2 < 140; ++l2) {
            ...
            Test.lArrFld[(int)(l2)][(int)(l2)] >>= i30;
            for (i31 = 180; i31 > 6; i31 -= 3) {
                Test.instanceCount = Test.lFld;
                Test.lFld = i29;
                i29 = (int)Test.instanceCount;
                Test.fArrFld[(int)(l2 - 1)][i31 - 1] += i1;
            }
        }
        ...
        FuzzerUtils.out.println("Test.instanceCount bFld Test.lFld = " + Test.instanceCount + "," + (bFld ? 1 : 0) +
            "," + Test.lFld);
        FuzzerUtils.out.println("Test.lArrFld Test.fArrFld Test.byArrFld = " + FuzzerUtils.checkSum(Test.lArrFld) + ","
