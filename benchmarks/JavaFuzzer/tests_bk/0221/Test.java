...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 44.364F);
    }
    ...
    public static long lMeth1() {
        ...
        int i9=37719, i10=9, i11=12, i12=-102, i13=-56111, i14=-1, i15=13, i16=-33102, iArr[]=new int[N];
        boolean b1=true;
        double d=0.120591;
        float f1=-5.806F;
        short s1=-16965;
    ...
    public static void vMeth(int i2) {
        ...
        int i3=-254, i4=16224, i19=-48, i20=-4, i21=-1, i22=-7, iArr1[]=new int[N];
        boolean b2=false;
        double d2=119.81991, dArr[]=new double[N];

        FuzzerUtils.init(dArr, -1.72974);
        FuzzerUtils.init(iArr1, 63093);

        for (i3 = 3; i3 < 140; i3++) {
            lMeth(b2, Test.instanceCount);
            Test.fArrFld[i3][i3 - 1] = Test.fFld;
            i19 = 1;
            while (++i19 < 11) {
                dArr[i3 + 1] %= (i3 | 1);
                Test.fFld *= i20;
                ...
                for (i21 = i3; i21 < 1; ++i21) {
                    Test.instanceCount += (-1946 + (i21 * i21));
    ...
    public void mainTest(String[] strArr1) {
        ...
        long l1=6066791133550936726L, lArr1[][]=new long[N][N];

        FuzzerUtils.init(lArr1, -7965375687630901509L);

        iFld = (int)Double.longBitsToDouble(Test.instanceCount);
        for (i = 4; 254 > i; i++) {
            vMeth(i1);
            iFld += (i + Test.instanceCount);
        }
        Test.fArrFld[(i1 >>> 1) % N] = FuzzerUtils.float1array(N, (float)-5.534F);
        i23 = 1;
        while (++i23 < 226) {
