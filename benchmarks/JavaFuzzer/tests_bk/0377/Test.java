...
public class Test {
    ...
    public static int iMeth(int i3, int i4, int i5) {
        ...
        int i6=-10, i7=40113, i8=150, i9=174, i10=0, i11=-9, iArr2[]=new int[N];
        double d=2.81200;
        float f=1.867F;
    ...
    public static void vMeth(long l, int i2) {
        ...
        float f1=62.137F;
        long l1=151L, lArr[]=new long[N];
        int i19=-138, i20=3, i21=160, iArr1[]=new int[N];
        short s1=-29238;
        ...
        switch (((i2 >>> 1) % 2) + 99) {
        case 99:
            Test.instanceCount -= (i2 - ((i2 + Test.instanceCount) + (i2 * i2)));
            iArr1[(i2 >>> 1) % N] += (int)(((i2 - 14) - (i2 + i2)) + Math.abs(Math.abs(Test.fFld)));
        case 100:
            vMeth1();
            f1 = 1;
            do {
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=19184, i1=-22938, i22=1, i23=110, i24=41232, i25=5, i26=35847, i27=52740, i28=12, i29=-122, iArr[]=new
            int[N];
        byte by=49;
        boolean b3=true;
                    ...
                    if (b3) {
                        for (i28 = 1; i28 < 2; i28++) {
                            ...
                            case 113:
                                ...
                                break;
                            case 106:
                                i1 += (((i28 * Test.instanceCount) + i28) - Test.instanceCount);
                                break;
                            case 119:
                                i29 -= (int)Test.fFld;
                                break;
        ...
        FuzzerUtils.out.println("Test.dFld Test.lFld = " + Double.doubleToLongBits(Test.dFld) + "," + Test.lFld);
