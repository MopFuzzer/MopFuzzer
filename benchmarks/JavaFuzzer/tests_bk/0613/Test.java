...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.fArrFld, 1.696F);
    }
    ...
    public static void vMeth1() {
        ...
        int i5=7, i6=9, i7=60615, i8=-86, i9=1, iArr[]=new int[N];
        boolean b=true;
            ...
            case 112:
                ...
                for (i11 = 1; i11 < 8; ++i11) {
                    ...
                    while (++d1 < 2) {
                        ...
                        Test.instanceCount *= -4434;
                        i10 -= i3;
                        i10 <<= (int)Test.instanceCount;
                        Test.instanceCount += (long)(d1 * d1);
                        Test.byFld >>= (byte)i2;
                        Test.instanceCount += -1030789102153118515L;
                    }
                }
            default:
                Test.byFld = (byte)f3;
    ...
    public static int iMeth(int i, float f) {
        ...
        float f1=3.232F;
        int i1=-51404, i13=-85, i14=1, i15=-124, i16=96, iArr1[]=new int[N];
        double dArr[]=new double[N];

        FuzzerUtils.init(dArr, 31.13662);
        FuzzerUtils.init(iArr1, 237);

        Test.instanceCount = ((i ^= (int)(1.292F * (i + i))) * (-(++i)));
        for (f1 = 12; f1 < 211; ++f1) {
            i1 += (int)f1;
            vMeth(i, i1, i1);
            i += (int)(f1 * f1);
        ...
        for (i15 = 10; i15 < 235; i15++) {
            Test.byFld += (byte)(((i15 * i15) + Test.instanceCount) - i16);
            dArr[i15] += Test.instanceCount;
            switch ((i15 % 2) + 61) {
            case 61:
                Test.instanceCount >>>= 28219;
                f = 2610;
            case 62:
                f -= 53;
                f = i14;
    ...
    public void mainTest(String[] strArr1) {
        ...
        Test.instanceCount -= iMeth(iFld, f4);
        lArrFld[(iFld >>> 1) % N] += (long)Test.dFld;
        iFld = (int)f4;
        iFld = iFld;
                    ...
                    for (i19 = i18; i19 < 89; i19++) {
                        ...
                        case 50:
                            for (i21 = 1; 1 > i21; ++i21) {
                                ...
                                dArr1[i18 + 1] -= Test.dFld;
                                i22 <<= (int)Test.instanceCount;
                            }
                            i23 = 1;
                            while (++i23 < 1) {
                                Test.iFld1 += (-38555 + (i23 * i23));
                        ...
                        case 51:
                            ...
                            i20 -= i19;
                            Test.instanceCount = (long)1.6124;
                            break;
                        case 52:
        ...
        FuzzerUtils.out.println("iFld Test.iFld1 Test.fArrFld = " + iFld + "," + Test.iFld1 + "," +
