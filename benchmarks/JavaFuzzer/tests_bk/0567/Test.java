...
public class Test {
    ...
    public static int iMeth() {
        ...
        int i10=-21, i11=-31704, i12=52280, i13=14, i14=236, i15=-40073, iArr1[][]=new int[N][N];
        float f1=0.660F;
        boolean b=true;
        ...
        if (b) {
            ...
            for (i12 = 294; 7 < i12; --i12) {
                ...
                for (i14 = 1; 6 > i14; ++i14) {
                    ...
                    Test.instanceCount += (((i14 * i15) + Test.instanceCount) - Test.fFld);
                    f1 = 1;
                    while (++f1 < 2) {
                        i15 <<= i14;
                        i15 = i13;
    ...
    public static void vMeth1(int i3, double d, int i4) {
        ...
        int i5=3, i6=7, i7=-53566, i8=104, i9=7, iArr[]=new int[N];
        float f=0.707F, fArr[][]=new float[N][N];
        short s=-9067;
        boolean b1=false;
        ...
        for (l = 288; l > 17; l--) {
            for (i6 = 1; i6 < 6; ++i6) {
                for (i8 = i6; 2 > i8; i8++) {
                    ...
                    case 83:
                        Test.lArrFld[i8 + 1] *= Math.max(-10, Integer.reverseBytes(i5));
                        i9 = (int)dArr[(i4 >>> 1) % N];
                    ...
                    case 65:
                        ...
                        break;
                    case 101:
                        if ((((l / (i5 | 1)) + iArr[i6 + 1]) + iMeth()) != Test.instanceCount) continue;
                        break;
                    case 98:
                        l1 = i6;
                        break;
    ...
    public static void vMeth(int i, int i1) {
        ...
        while (++i16 < 146) {
            ...
            for (i17 = 1; i17 < 11; ++i17) {
                ...
                switch ((i17 % 1) + 31) {
                case 31:
                    i += (((i17 * Test.fFld) + Test.instanceCount) - i17);
                default:
                    s1 -= (short)-12;
                    i18 += (i17 * i17);
                    i = i2;
