...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)20236);
    ...
    public static double dMeth(int i8, int i9) {
        ...
        int i10=-14873, i11=-2, i12=-15211, i13=216, i14=-4, iArr1[]=new int[N];
        float f1=0.309F;
        boolean b1=false;
        ...
        for (i12 = 5; i12 < 302; i12++) {
            ...
            b1 = b1;
            i9 += (((i12 * Test.instanceCount) + i11) - i14);
        }
    ...
    public static int iMeth(int i5) {
        ...
        for (i6 = 3; i6 < 201; i6 += 2) {
            ...
            for (i15 = 1; i15 < 16; i15++) {
                Test.instanceCount -= 1821763405390109454L;
            }
            i5 = i5;
    ...
    public static void vMeth(float f) {
        ...
        int i1=-151, i2=1, i3=14, i4=4688, i19=254, i20=-7125, iArr[]=new int[N];
        boolean b2=false;
        ...
        for (i2 = 8; 204 > i2; i2++) {
            i4 = 1;
            do {
                iArr[i2] = Math.max((int)((i4 >> i3) + (-11 - (Test.byFld - 6L))), Math.abs(iMeth(i4)));
                try {
                    i1 = (36 % i4);
                    i3 = (i3 % i4);
                    iArr[i2 + 1] = (i3 / 96);
                ...
                for (i19 = 1; i19 < 1; i19++) {
                    ...
                    if (b2) {
                        i20 = 1062;
                        Test.instanceCount += (long)(24.735F + (i19 * i19));
                        i1 += i19;
                    } else if (b2) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        while (--i21 > 0) {
            ...
            for (i22 = 2; 64 > i22; ++i22) {
                ...
                f2 = -44909;
                for (i24 = 1; 2 > i24; ++i24) {
                    Test.instanceCount += (-2303 + (i24 * i24));
                    i25 += (int)d;
                    lArr[i22] = i23;
            ...
            for (i27 = 3; i27 < 64; i27 += 2) {
                switch (((i26 >>> 1) % 8) + 97) {
                case 97:
                    Test.instanceCount += (((i27 * i22) + f2) - i);
                case 98:
                    i25 = i23;
                    for (i29 = 1; i29 < 3; i29++) {
                        if (true) {
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.byFld Test.sFld = " + Test.instanceCount + "," + Test.byFld +
            "," + Test.sFld);
        FuzzerUtils.out.println("iArrFld Test.sArrFld Test.iArrFld1 = " + FuzzerUtils.checkSum(iArrFld) + "," +
            FuzzerUtils.checkSum(Test.sArrFld) + "," + FuzzerUtils.checkSum(Test.iArrFld1));
