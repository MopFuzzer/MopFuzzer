...
public class Test {
    ...
    public static void vMeth(int i4) {
        ...
        for (i13 = 7; i13 < 317; ++i13) {
            ...
            for (i15 = 1; i15 < 5; ++i15) {
                i16 >>= -3;
                Test.instanceCount += (long)(-122.785F + (i15 * i15));
                Test.sFld += (short)(i15 * i13);
                Test.instanceCount /= (i16 | 1);
                Test.iArrFld[i15 - 1][i13 - 1] += i16;
                Test.iArrFld[(35 >>> 1) % N][i13 + 1] += (int)8596328985145497614L;
                i16 += (i15 * i15);
                i14 /= (int)(i14 | 1);
            }
            i4 += i13;
