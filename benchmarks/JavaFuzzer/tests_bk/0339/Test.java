...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.fArrFld, -77.885F);
    }
    ...
    public static void vMeth1(int i5, long l) {
        ...
        vMeth2(s2, Test.iFld1, 41);
        Test.iFld = Test.iFld;
        for (i13 = 14; i13 < 390; i13++) {
            try {
                i5 = (48082 / Test.iFld1);
                Test.iArrFld[i13 - 1] = (i14 % Test.iFld1);
                Test.iFld1 = (Test.iFld % 1958221089);
        ...
        for (i15 = 15; 259 > i15; i15++) {
            ...
            try {
                i16 = (i5 / -477589401);
                Test.iFld1 = (Test.iArrFld[i15 + 1] / i13);
                i14 = (-18210 % Test.iArrFld[i15 + 1]);
            } catch (ArithmeticException a_e) {}
            try {
                Test.iFld1 = (i14 / Test.iArrFld[i15 - 1]);
                i17 = (8233 / i17);
                i17 = (i5 / Test.iFld1);
            } catch (ArithmeticException a_e) {}
        }
    ...
    public static void vMeth(int i, short s) {
        ...
        for (i1 = 9; 312 > i1; i1++) {
            for (i3 = 1; 5 > i3; i3++) {
                i = (--i2);
                Test.iArrFld[(i4 >>> 1) % N] >>>= 101;
                vMeth1(Test.iFld1, 5726141217637326055L);
                switch (((i2 >>> 1) % 5) + 4) {
                case 4:
                    i20 = 1;
                    do {
                ...
                case 7:
                    Test.iArrFld[i3 - 1] += i22;
                    break;
                case 8:
                    Test.iFld1 += (((i3 * by1) + by1) - Test.instanceCount);
                    break;
                default:
                    lArr[i1 + 1] = lArr[i3];
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (d1 = 10; d1 < 209; d1++) {
            ...
            try {
                i23 = (-141 / Test.iFld);
                Test.iFld = (Test.iArrFld[(int)(d1)] / 57401);
                Test.iArrFld[(int)(d1)] = (588366591 % i23);
            } catch (ArithmeticException a_e) {}
        ...
        for (i24 = 4; 229 > i24; i24++) {
            ...
            for (i26 = 4; i26 < 112; i26++) {
                Test.iFld = i25;
                for (i28 = 1; i28 < 2; i28++) {
                    i23 += (((i28 * Test.instanceCount) + Test.instanceCount) - i23);
                    i23 = i23;
                    bFld = bFld;
                    Test.iFld1 += 15;
                    i23 = Test.iFld1;
