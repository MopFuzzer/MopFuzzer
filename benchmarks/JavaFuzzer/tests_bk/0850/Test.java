...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.sArrFld, (short)4810);
    }
    ...
    public static void vMeth2(int i5) {
        ...
        int i6=10, i7=28247, i8=20112, i9=61705, i10=8, i11=42017, iArr1[]=new int[N];
    ...
    public static void vMeth1() {
        ...
        int i2=13, i3=20521, i4=14236, i12=14, i13=5063, i14=-58, i15=-51584, i16=102, i17=-34, iArr[][]=new int[N][N];
        short s1=19258;
        float f2=-39.933F;
        boolean b1=false;
        ...
        Test.instanceCount *= iArr[(i2 >>> 1) % N][(i2 >>> 1) % N];
        for (i3 = 15; 280 > i3; i3++) {
            lArr = lArr;
            vMeth2(i3);
            i4 -= i4;
        ...
        for (i12 = 21; 343 > i12; i12 += 3) {
            ...
            if (b1) {
                ...
                for (i14 = 1; i14 < 15; ++i14) {
                    i13 += (((i14 * i15) + Test.instanceCount) - i2);
                    for (i16 = i12; i16 < 2; i16 += 2) {
                        f2 += (((i16 * i3) + Test.iFld) - i12);
                        Test.iFld -= i17;
                    }
                }
            } else if (b1) {
    ...
    public static void vMeth(byte by) {
        ...
        int i=-192, i1=-45616, i18=0, i19=-23025, iArr2[]=new int[N];
        ...
        for (i = 1; i < 237; ++i) {
            if (b2) {
                ...
                d = 1;
                do {
                    lArr1[(int)(d)] += (long)Test.fFld;
                    Test.instanceCount += (long)1.5162;
                } while (++d < 7);
                by += (byte)(i * i);
                for (i18 = 1; i18 < 7; ++i18) {
                    short s2=16684;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i20=-49946, i21=0, i22=64456, i23=88, i24=-150, i25=-20398, i26=10215, i27=14126, i28=-19, iArr3[]=new
            int[N];
        short s4=9321;
        ...
        for (i22 = 6; i22 < 147; i22++) {
            ...
            while (++i24 < 178) {
                ...
                for (i25 = i24; i25 < 1; i25++) {
                    i23 += i25;
                    i26 += (((i25 * Test.instanceCount) + i20) - Test.instanceCount);
                    by1 += (byte)i25;
        ...
        FuzzerUtils.out.println("dFld Test.bFld Test.sArrFld = " + Double.doubleToLongBits(dFld) + "," + (Test.bFld ? 1
            : 0) + "," + FuzzerUtils.checkSum(Test.sArrFld));
