...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, 52662);
    }
    ...
    public static long lMeth2(long l1, int i5) {
        ...
        for (i6 = 7; i6 < 191; ++i6) {
            ...
            for (i8 = i6; i8 < 9; ++i8) {
                for (l2 = 1; l2 > 1; --l2) {
                    Test.iArrFld[i8] <<= i10;
                    Test.instanceCount += (80 + (l2 * l2));
                    i10 += (int)f2;
                    i10 += (int)(l2 * Test.instanceCount);
                    b = b;
                    i5 = i7;
                    i9 = -3493;
                }
    ...
    public static long lMeth1(int i2, int i3) {
        ...
        for (d1 = 17; d1 < 332; ++d1) {
            i4 = (int)((Test.iArrFld[(int)(d1 - 1)]--) + lMeth2(Test.instanceCount, i3));
            i3 += (int)-11L;
            if (b1) {
                b1 = b1;
            }
    ...
    public static long lMeth() {
        ...
        vSmallMeth(i1, Long.reverseBytes((i1 + i1) >> (-(i1 += i1))), (lMeth1(i1, i1) + Test.instanceCount) + i1);
        i14 = 1;
        while (++i14 < 176) {
            for (i15 = 1; 9 > i15; i15++) {
                i17 = 1;
                ...
                Test.instanceCount += (-18563L + (i15 * i15));
                Test.fFld += 93;
                i16 += (((i15 * i1) + by2) - i14);
                d2 += Test.instanceCount;
                Test.fFld += i15;
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (int smallinvoc=0; smallinvoc<728; smallinvoc++) vSmallMeth(5, lArrFld[(iFld1 >>> 1) % N][(iFld >>> 1) %
        ...
        FuzzerUtils.out.println("Test.fFld bFld lArrFld = " + Float.floatToIntBits(Test.fFld) + "," + (bFld ? 1 : 0) +
