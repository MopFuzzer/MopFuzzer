...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.fArrFld, -1.255F);
    }
    ...
    public static long lMeth(long l1) {
        ...
        int i7=-2025, i8=-2, i9=-38523, i10=-27372, i11=6, iArr[]=new int[N];
        float f2=-67.377F;
    ...
    public static int iMeth(float f1, long l) {
        ...
        for (i5 = 17; i5 < 370; ++i5) {
            Test.dFld -= (++lArr[i5 - 1][i5 - 1]);
            i6 = (int)((lMeth(Test.instanceCount) + f1) - 248);
    ...
    public static void vMeth(float f) {
        ...
        int i=1, i1=55062, i2=-25483, i3=13, i4=-13, iArr1[]=new int[N];
        double d=-71.33251;
        ...
        for (i = 3; 266 > i; ++i) {
            ...
            do {
                ...
                for (i3 = 1; i3 > 1; --i3) {
                    switch ((i2 % 4) + 41) {
                    case 41:
                        f *= (iMeth(f, Test.instanceCount) + f);
                        if (true) break;
                    case 42:
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i19 = 2; 168 > i19; ++i19) {
            ...
            i20 -= i20;
            for (f4 = 8; 151 > f4; f4++) {
                Test.iArrFld = FuzzerUtils.int1array(N, (int)-51414);
                lArr1[i19 + 1] = i21;
            ...
            if (Test.bFld) {
                for (i24 = 3; 69 > i24; i24++) {
                    ...
                    for (i26 = 1; i26 < 2; ++i26) {
                        ...
                        try {
                            i23 = (-7576 % i25);
                            i27 = (i27 % Test.iArrFld[i22 + 1]);
                            Test.iArrFld[i24] = (i23 % -58882);
                        } catch (ArithmeticException a_e) {}
                        sFld = (short)i28;
                        Test.iArrFld[i26 + 1] = i21;
                        f3 += (((i26 * f4) + Test.instanceCount) - i20);
                    }
                    i27 -= i21;
