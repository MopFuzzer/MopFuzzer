...
public class Test {
    ...
    public static long lMeth(int i2, long l, boolean b) {
        ...
        Test.iFld1 *= Math.max(i2, --Test.iFld1);
        vMeth1(by1);
        for (i8 = 5; 301 > i8; ++i8) {
            f3 = l;
            ...
            f4 = 1;
            while (++f4 < 6) {
                Test.iFld1 += (int)(f4 * Test.instanceCount);
                i9 -= i2;
                for (i10 = 1; 1 > i10; i10++) {
                    l <<= -111;
                    l = 13;
                    ...
                    try {
                        Test.iFld1 = (-240 / i9);
                        Test.iArrFld[(int)(f4 - 1)] = (i10 % 30579);
                        Test.iFld1 = (-1829199739 % i8);
    ...
    public static void vMeth(int i1, float f) {
        ...
        for (float f1 : fArr) {
            Test.sFld += (short)lMeth(32, -1442312918L, true);
            lArr1[(-1 >>> 1) % N][(i1 >>> 1) % N] <<= Test.iFld1;
            Test.iFld1 ^= i1;
            for (i12 = 1; i12 < 4; i12++) {
                i1 ^= Test.iFld1;
    ...
    public void mainTest(String[] strArr3) {
        ...
        s >>= (short)((i <<= Test.iArrFld[(i >>> 1) % N]) - ((i + i) * (-57074 - (Test.instanceCount--))));
        i += (int)Float.intBitsToFloat((int)(i | (Test.instanceCount * i)));
        vMeth(Test.iFld1, Test.fFld);
        i16 = 1;
        do {
            Test.iFld1 += i16;
            i >>= by2;
            ...
            for (i20 = i16; i20 < 298; i20++) {
                ...
                for (i22 = 1; i22 > 1; i22--) {
                    ...
                    case 15:
                        ...
                        break;
                    case 22:
                        Test.fFld += (55107 + (i22 * i22));
                        s += (short)(((i22 * Test.instanceCount) + i19) - i23);
                        break;
                    case 17:
                        switch ((i20 % 9) + 52) {
                        case 52:
                            Test.instanceCount -= (long)1.89F;
                            by2 += (byte)(i22 ^ i23);
                            i += (int)dFld;
                            break;
                        case 53:
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.sFld Test.iFld1 = " + Test.instanceCount + "," + Test.sFld +
            "," + Test.iFld1);
