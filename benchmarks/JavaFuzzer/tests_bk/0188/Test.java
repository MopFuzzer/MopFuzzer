...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -39991);
    }
    ...
    public static float fMeth(int i17) {
        ...
        int i18=-33782, i19=-9, i20=686, i21=-12, i22=-41, iArr1[]=new int[N], iArr2[][]=new int[N][N];
        long l2=65402L;
        double d=3.64109;
    ...
    public long lMeth(int i14) {
        ...
        int i15=-17, i16=19139, i23=11, iArr[]=new int[N];
        ...
        l1 = 1;
        while (++l1 < 211) {
            Test.instanceCount <<= 46208L;
            Test.sFld += (short)l1;
            Test.sFld += (short)(l1 ^ Test.instanceCount);
            if (iArr[(int)(l1)] <= (((Test.sFld >>> i14) + (++Test.instanceCount)) - iArr[(int)(l1)])) break;
            for (i15 = 1; i15 < 8; i15++) {
    ...
    public void mainTest(String[] strArr1) {
        ...
        for (i1 = 181; 3 < i1; i1 -= 2) {
            ...
            do {
                ...
                for (i24 = 1; i24 < 1; i24 += 2) {
                    Test.instanceCount += (long)-12.980F;
                    i += i25;
                    Test.iArrFld[i24 - 1] <<= byFld;
                    i25 <<= i2;
                    switch ((i4 % 6) + 99) {
                    case 99:
                    ...
                    case 100:
                        ...
                        break;
                    case 101:
                        i += (((i24 * i24) + Test.instanceCount) - fFld);
                        break;
                    case 102:
                        byFld *= (byte)i;
                    case 103:
        ...
        FuzzerUtils.out.println("byFld Test.sFld Test.dFld = " + byFld + "," + Test.sFld + "," +
