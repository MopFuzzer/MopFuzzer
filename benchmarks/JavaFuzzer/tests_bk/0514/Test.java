...
public class Test {
    ...
    static {
        ...
        FuzzerUtils.init(Test.fArrFld, -56.806F);
    ...
    public void vMeth2(float f) {
        ...
        do {
            i10 = i12;
            for (i13 = 1; i13 < 4; ++i13) {
                Test.iArrFld[i13 - 1][i12 + 1] -= (int)f;
    ...
    public void vMeth(int i, int i1) {
        ...
        for (i2 = 8; i2 < 383; i2++) {
            ...
            do {
                ...
                by = (byte)i;
                i3 -= i4;
                i3 -= Short.reverseBytes((short)((i1 - i2) * (Test.instanceCount--)));
            } while (++i4 < 5);
            sFld = (short)i;
            ...
            case 93:
                for (i5 = 1; i5 < 5; ++i5) {
                    Test.bFld = Test.bFld;
                    Test.iArrFld[i2 - 1][i5] = i4;
                }
                i6 += (i2 * i2);
                try {
                    Test.iArrFld[i2 + 1][i2 - 1] = (i1 / -1434168268);
                    i6 = (i2 % -4501);
                    Test.iArrFld[i2][i2 - 1] = (i5 / Test.iArrFld[i2][i2 + 1]);
                } catch (ArithmeticException a_e) {}
                break;
            case 96:
                Test.instanceCount += (i2 * i7);
                try {
                    i = (Test.iArrFld[i2 + 1][i2 + 1] % 1462487715);
                    Test.iArrFld[i2][i2] = (i4 / -180);
                    i = (-637803781 % i6);
                } catch (ArithmeticException a_e) {}
                break;
            default:
    ...
    public void mainTest(String[] strArr1) {
        ...
        do {
            for (i23 = i22; i23 < 68; ++i23) {
                try {
                    i24 = (-15258 / Test.iArrFld[i23 - 1][i22]);
                    i24 = (-420627086 % i22);
                    i24 = (-202 % i24);
                } catch (ArithmeticException a_e) {}
                i24 = i22;
                for (i25 = 1; i25 < 1; i25++) {
                    Test.fArrFld[i25 - 1] = 18135;
                    i24 |= -28292;
                }
                l = 1;
                while (++l < 1) {
                    Test.instanceCount = -1686022684L;
                    Test.iFld += (int)-43075L;
                    Test.iArrFld[i23 - 1][i23] >>= Test.iFld;
                    if (Test.bFld) {
                        try {
                            i24 = (i22 / i22);
                            Test.iFld = (-8732 % i25);
                        ...
                        Test.byArrFld[i22] += (byte)1713979708189432609L;
                        i24 += (int)(l * l);
                    }
                    i24 = (int)l;
                }
        ...
        FuzzerUtils.out.println("Test.instanceCount sFld Test.bFld = " + Test.instanceCount + "," + sFld + "," +
            (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("dFld Test.iFld fFld = " + Double.doubleToLongBits(dFld) + "," + Test.iFld + "," +
            Float.floatToIntBits(fFld));
        FuzzerUtils.out.println("Test.iArrFld Test.fArrFld Test.byArrFld = " + FuzzerUtils.checkSum(Test.iArrFld) + ","
