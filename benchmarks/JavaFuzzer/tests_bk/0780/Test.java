...
public class Test {
    ...
    public static void vMeth1(int i4, float f, long l) {
        ...
        int i5=-61, i6=42, i7=2, i8=-154, iArr[]=new int[N];
        double d=-2.71161, dArr[]=new double[N];
        long l1=-11733L;
    ...
    public static void vMeth() {
        ...
        int i2=-20901, i3=52, i9=13, i10=145, i11=232, i12=48741, i13=-152, iArr1[]=new int[N], iArr2[][]=new int[N][N];
        short s=21699;
        byte by=66;
    ...
    public static int iMeth(int i) {
        ...
        int i1=-63212, i14=-10, i15=-171, iArr3[]=new int[N];
    ...
    public void mainTest(String[] strArr1) {
        ...
        long l2=-200L, l3=-9L;
        int i16=5, i17=-43, i18=-63132, i19=-145, i20=13, i21=8613, i22=-192, i23=-2, iArr4[]=new int[N];
        ...
        for (i20 = 2; i20 < 295; i20 += 3) {
            ...
            switch (((i17 >>> 1) % 2) + 70) {
            case 70:
                Test.sFld /= (short)(i17 | 1);
                l3 = 1;
                do {
                    iArr4[i20] &= 6;
                    for (i22 = 1; i22 < 1; i22++) {
                        Test.fFld += (i22 * i22);
                        Test.instanceCount = -4391419256670290709L;
                        i23 -= (int)Test.fFld;
                        fArr[(int)(l3)] %= (i17 | 1);
                    }
                } while (++l3 < 258);
        ...
        FuzzerUtils.out.println("Test.instanceCount iFld Test.bFld = " + Test.instanceCount + "," + iFld + "," +
            (Test.bFld ? 1 : 0));
        FuzzerUtils.out.println("Test.lFld Test.fFld Test.dFld = " + Test.lFld + "," + Float.floatToIntBits(Test.fFld)
            + "," + Double.doubleToLongBits(Test.dFld));
        FuzzerUtils.out.println("Test.sFld Test.byFld = " + Test.sFld + "," + Test.byFld);
