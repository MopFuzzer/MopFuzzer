...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.iArrFld, -49784);
    }
    ...
    public static void vMeth(int i5, long l1) {
        ...
        while (++i6 < 382) {
            for (i7 = i6; i7 < 4; i7++) {
                Test.iArrFld[i7 - 1] -= (int)((l1 += (i8++)) + ((i6 - Test.sFld) - (l1 -= i6)));
                i5 = iMeth(i7, l1, i6);
            }
            i8 += i6;
            i18 = 1;
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d=2.23741, d2=27.23174, d3=97.95658, dArr[]=new double[N];
        ...
        for (d = 331; 17 < d; d -= 3) {
            if (false) {
                i += (int)(d * d);
                Test.iArrFld[(int)(d - 1)] <<= (Test.iArrFld[(int)(d - 1)] >>= (++Test.iArrFld[(int)(d + 1)]));
                i += (int)((i <<= (++i)) & (-8592 * (i - l)));
            } else {
                i *= (int)(7171L - (-i));
                for (i1 = 11; i1 < 241; ++i1) {
                    i2 <<= (i++);
                    Test.sFld *= (short)8;
                    i = (int)(Math.abs((int)(-(i2 - l))) * Test.instanceCount);
                    b = bArr[(int)(d)];
                    by *= (byte)(i3 * -11L);
                    i3 *= (int)(((Test.fFld + i1) * (Test.fFld * i)) * ((--i3) * (i2 - i)));
                    switch ((int)(((d % 1) * 5) + 36)) {
                    case 39:
                        i += (i1 * i1);
                        i2 = (int)(((i - -4025624426311693254L) * (Test.instanceCount * i3)) - i);
                    default:
