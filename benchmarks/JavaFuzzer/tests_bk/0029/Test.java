...
public class Test {
    ...
    public static void vMeth(int i15, int i16) {
        ...
        int i17=-157, i18=43, i19=49032, i20=23351, i21=61282, i22=0, iArr1[]=new int[N];
        double d2=-1.32617;
    ...
    public static double dMeth(int i11, int i12, double d1) {
        ...
        int i13=48459, i14=36591, i23=12, i24=-22347, i25=-71, i26=46962, iArr[]=new int[N];
        byte by=56;
    ...
    public static int iMeth(boolean b) {
        ...
        for (i9 = 3; i9 < 144; i9++) {
            Test.iFld &= (int)(lArr[i9][i9 + 1]++);
            Test.iFld -= 204;
            Test.instanceCount *= (long)((Test.iFld++) * ((++Test.iFld) % ((long)(dMeth(Test.iFld, Test.iFld, 0.67373))
                | 1)));
            sArr[i9 + 1] += (short)i10;
            ...
            for (i27 = 1; i27 < 11; i27++) {
                ...
                default:
                    Test.iFld1 += (((i27 * Test.instanceCount) + Test.iFld1) - i30);
                }
            }
        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        double d=-61.82232, dArr[][]=new double[N][N];
        boolean b1=true;
        ...
        switch ((((Test.iFld >>> 1) % 7) * 5) + 97) {
        case 127:
            switch ((((Test.iFld >>> 1) % 8) * 5) + 33) {
            case 59:
            case 68:
                for (i = 3; i < 268; i++) {
                    for (i2 = 95; i2 > 5; i2--) {
                    ...
                    Test.iFld = (int)(-((-(i2 + 30.879F)) + (-119 + (i3 * i4))));
                    switch ((i % 4) + 88) {
                    case 88:
                        for (i5 = 95; i5 > 2; i5--) {
                            i1 += (((i5 * fFld) + Test.instanceCount) - Test.instanceCount);
                            for (i7 = 2; i7 > 1; --i7) {
                                long l1=-5662695932484320493L;
                                byte by1=116;
                                i6 -= (int)(((Test.instanceCount * i8) * Test.iFld) - ((iArrFld[i7 - 1] *= i4) - i4));
                                if (b1) {
