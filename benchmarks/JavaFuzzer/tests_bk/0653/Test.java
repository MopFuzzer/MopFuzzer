...
public class Test {
    ...
    public static long lMeth1(long l, float f1) {
        ...
        int i4=-61569, i5=245, i6=66, i7=-32, i8=128, i9=90, i11=-49089, iArr1[]=new int[N];
        boolean b=false;
        float f2=-71.708F;
    ...
    public static int iMeth() {
        ...
        float f3=74.392F;
        boolean b1=false;
        int i12=-9, i13=58153, i14=10, i15=-4, iArr[][]=new int[N][N];
        double d1=55.127664;
        ...
        try {
            ...
            Test.byFld = (byte)((--iArr[(Test.iFld >>> 1) % N][(Test.iFld >>> 1) % N]) % (lMeth1(Test.instanceCount,
                f3) * 2));
            b1 = b1;
            Test.iFld -= Test.iFld;
            try {
    ...
    public long lMeth(double d, int i1) {
        ...
        i1 -= (int)((Double.longBitsToDouble(Test.instanceCount) % ((i1 + s) | 1)) * (--Test.lFld));
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = 1;
        do {
            f += lMeth(Test.dFld, Test.iFld);
            Test.iFld += (i | i);
            for (i20 = i; i20 < 69; ++i20) {
                Test.sFld += (short)i20;
                for (d2 = 1; 1 > d2; d2 += 2) {
                    f -= i20;
                    iArrFld[(int)(d2)][i + 1] *= Test.iFld;
                    Test.instanceCount = Test.lFld;
                    iArrFld[i][i20 - 1] += i21;
                    Test.lFld += (long)(d2 - Test.lFld);
                    iFld1 *= Test.sFld;
                    if (true) continue;
                    Test.lFld += iFld1;
                    Test.iFld >>>= i;
                    Test.lFld += (-140L + (d2 * d2));
                }
                if (b3) break;
            }
            iArrFld[i - 1][i] = i22;
            ...
            for (i25 = 7; 115 > i25; i25++) {
                ...
                for (i27 = 1; i27 < 2; i27++) {
                    ...
                    case 127:
                        ...
                        break;
                    case 139:
                        Test.iFld += (i27 + Test.lFld);
                        i22 -= Test.iFld;
                        f += (((i27 * i20) + i23) - Test.lFld);
                    case 132:
                    case 126:
                        Test.instanceCount += (((i27 * i27) + f) - iFld1);
        ...
        FuzzerUtils.out.println("Test.instanceCount Test.lFld Test.byFld = " + Test.instanceCount + "," + Test.lFld +
            "," + Test.byFld);
        FuzzerUtils.out.println("Test.iFld Test.sFld Test.dFld = " + Test.iFld + "," + Test.sFld + "," +
