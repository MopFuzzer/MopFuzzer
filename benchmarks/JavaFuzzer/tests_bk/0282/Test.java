...
public class Test {
    ...
    static {
        FuzzerUtils.init(Test.lArrFld, -3407904265L);
        FuzzerUtils.init(Test.fArrFld, 0.302F);
    }
    ...
    public static float fMeth1(int i5) {
        ...
        byte by=-24;
        float f1=-2.368F;
        int i11=-2, i12=-7, i13=-63504, i14=-2267, i15=-22467, i16=34120, iArr[]=new int[N];
        boolean b=true;
    ...
    public static float fMeth() {
        ...
        double d1=-2.55508;
        int i2=5, i3=23, i4=199, iArr1[][]=new int[N][N];
        short s=28939;
        float f2=2.212F;
        ...
        do {
            Test.iFld = 75;
            for (i3 = i2; 16 > i3; i3++) {
                i4 += (int)(Double.longBitsToDouble(-(Test.instanceCount * Test.instanceCount)) - (i4--));
                s = (short)i3;
                Test.iFld += (int)fMeth1(i2);
                Test.iFld = i4;
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-32785, i1=-43341, i17=92, i18=-38662, i19=2, i20=13, i21=-12, i22=58696, i23=-14, i24=-42, iArr2[]=new
            int[N];
        double d=2.122828;
        float f3=0.729F, f4=-2.705F, f5=-117.366F;
        short s2=21610;
        long l1=-5435100925283437489L, lArr1[][]=new long[N][N];
        ...
        try {
            for (i = 1; 344 > i; ++i) {
                ...
                Test.iFld -= (int)1723081692584322343L;
            }
            i17 = 298;
            do {
                ...
                for (f3 = 84; f3 > 5; f3 -= 3) {
                    ...
                    dArrFld[(int)(f3)] += Test.instanceCount;
                    ...
                    for (i21 = 1; i21 < 4; i21++) {
                        ...
                        i22 += (((i21 * Test.iFld) + i18) - i21);
                        Test.iFld ^= i19;
                    }
                    i20 = i20;
                    for (i23 = i17; i23 < 4; ++i23) {
                        Test.fArrFld[i17 + 1] = f3;
                        i1 += (14632 + (i23 * i23));
                        i20 = Test.iFld;
                        try {
                            iArr2[(int)(f3)] = (i19 / 137);
                            i20 = (i / -535307014);
                            Test.iFld = (i23 / 1703490652);
                        } catch (ArithmeticException a_e) {}
                        i19 = 125;
                        i22 >>= i20;
                    }
