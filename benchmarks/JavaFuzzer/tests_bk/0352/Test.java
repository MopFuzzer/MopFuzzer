...
public class Test {
    ...
    public static void vMeth(long l, short s1) {
        ...
        double d=46.39750;
        int i5=25, i6=-2, i7=-8, i8=-12, i9=601, i10=-41011, iArr2[]=new int[N];
        long l1=160L;
        byte by=28;
    ...
    public static double dMeth(float f, int i2, int i3) {
        ...
        int i4=59775, i11=-31, i12=153, i13=9, iArr1[]=new int[N];
        short s=10726;
        ...
        while (++i4 < 384) {
            ...
            case 5:
                ...
                case 12:
                    for (i11 = i4; i11 < 4; ++i11) {
                        i2 += (i11 ^ Test.instanceCount);
                        i2 += (((i11 * Test.instanceCount) + i4) - i2);
                    }
                    break;
                case 14:
                    for (d2 = 1; d2 < 4; ++d2) {
            ...
            case 12:
                ...
                break;
            case 13:
                Test.instanceCount += (((i4 * i3) + i4) - Test.instanceCount);
            default:
                i2 += (i4 * i4);
            }
        }
    ...
    public static int iMeth(int i1) {
        ...
        float f1=2.782F;
        int i14=11, i15=6, i16=8, i17=-144, i18=-65265, i19=10, i20=-55357, i21=-228, iArr3[]=new int[N];
        byte byArr1[]=new byte[N];

        FuzzerUtils.init(iArr3, 40906);
        FuzzerUtils.init(byArr1, (byte)30);

        i1 = (int)((i1 + (-(Test.instanceCount + i1))) - (Test.instanceCount--));
        Test.instanceCount -= (long)((dMeth(f1, -13, i1) * i1) + i1);
        iArr3[(i1 >>> 1) % N] -= i1;
        i1 += -192;
        ...
        for (i14 = 225; 10 < i14; i14 -= 3) {
            for (i16 = 1; i16 < 22; i16++) {
                for (i18 = 1; i18 < 2; i18 += 3) {
                    iArr3[i16] >>>= i15;
                    byArr1[i18 - 1] += (byte)Test.instanceCount;
                }
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=-3000, i22=4, i23=-9, i25=245, i26=-3, i27=12, i28=129, i29=-41631, i30=-11229, i31=50, iArr[]=new int[N];
        float f2=-71.261F;
        double d3=88.61667, d4=39.61889;

        FuzzerUtils.init(iArr, -39);

        iArr[(i >>> 1) % N] += (int)((i - Long.reverseBytes(Test.instanceCount)) + iMeth(i));
            ...
            for (i27 = 72; i27 > i22; --i27) {
                ...
                case 114:
                    ...
                    for (d4 = 1; d4 < 1; ++d4) {
                        ...
                        i30 += (-47983 + (d4 * d4));
                        iFld += (int)(d4 * Test.instanceCount);
                    }
                    break;
                default:
                    i30 += (int)Test.instanceCount;
                    i28 += (((i27 * f2) + i29) - Test.instanceCount);
                }
            }
        }
