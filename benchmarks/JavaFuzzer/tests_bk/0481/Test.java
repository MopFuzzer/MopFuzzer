...
public class Test {
    ...
    public static void vMeth1(int i11, double d) {
        ...
        int i12=47, i13=-177, i14=14, i15=-32126, i16=-10, i17=26914, i18=26567, iArr[]=new int[N];
        ...
        if (b) {
            ...
            while (++i12 < 232) {
                ...
                do {
                    ...
                    Test.instanceCount += (134 + (i16 * i16));
                } while (++i16 < 7);
                if (i13 != 0) {
    ...
    public static int iMeth(int i8, int i9, int i10) {
        ...
        for (i19 = 128; 5 < i19; i19--) {
            ...
            while ((i21 -= 2) > 0) {
                i9 = (int)d1;
                i9 += (((i21 * i20) + Test.instanceCount) - i9);
                bArr[i21] = b1;
                i10 *= i8;
                f2 = -2;
            }
            i20 += (((i19 * i9) + Test.instanceCount) - Test.instanceCount);
            for (i22 = 1; 13 > i22; i22++) {
                by -= (byte)f2;
                f2 += (((i22 * i8) + s) - Test.instanceCount);
                i23 += i22;
            }
            i10 += (((i19 * Test.iFld) + i23) - i23);
        }
    ...
    public static void vMeth(int i3, int i4, int i5) {
        ...
        for (i6 = 9; 196 > i6; ++i6) {
            ...
            if (b2) {
                i3 -= (int)(-65257 + ((Test.instanceCount % -15395) * (-Test.instanceCount)));
                iMeth(i5, Test.iFld, i7);
                i5 = (int)Test.lFld;
                Test.iArrFld[i6] = (int)Test.lFld;
                ...
                case 74:
                    try {
                        i4 = (-3851 % Test.iArrFld[i6 - 1]);
                        Test.iArrFld[i6] = (-128 / Test.iFld);
                        i3 = (Test.iArrFld[i6] / i7);
                ...
                case 90:
                    try {
                        Test.iArrFld[i6 + 1] = (i3 / i4);
                        Test.iArrFld[i6 + 1] = (Test.iArrFld[i6] % Test.iArrFld[i6 - 1]);
                        i3 = (Test.iArrFld[i6] % -9);
                    } catch (ArithmeticException a_e) {}
                    break;
                case 45:
                    i5 >>>= i5;
