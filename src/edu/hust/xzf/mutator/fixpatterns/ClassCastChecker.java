 ...
 * @author kui.liu
 */
public class ClassCastChecker extends MutateTemplate_B {
	/*
	...
	public void generatePatches() {
		...
		for (Map.Entry<ITree, String> entity : castExps.entrySet()) {
			...
			if (!"".equals(varName)) { // statements related to variable.
				endPosition = ContextReader.identifyRelatedStatements(suspStmtTree, varName, this.suspCodeEndPos).getFirst();
			}
