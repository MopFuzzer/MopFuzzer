 ...
 * @author kui.liu
 */
public class NullPointerChecker extends MutateTemplate_B {
    ...
    public void generatePatches() {
        ...
        if (!vars.isEmpty()) {
            ...
            if (!vars.isEmpty()) {
                for (String var : vars) {
                    ...
                    suspCodeEndPos = ContextReader.identifyRelatedStatements(suspCodeTree, var, this.suspCodeEndPos).getFirst();
        ...
        if (!suspNullExpStrs.isEmpty()) {
            ...
            int suspCodeEndPos = ContextReader.identifyRelatedStatements(suspCodeTree, expStr, this.suspCodeEndPos).getFirst();
     ...
     * @author kui.liu
     */
    public class NPNullOnSomePathFromReturnValue extends MutateTemplate_B {
